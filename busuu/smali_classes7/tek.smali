...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Ltek;->c:Landroid/content/Context;

    iput-object p2, p0, Ltek;->d:Ljava/lang/String;

    sget-object p2, Lihk;->a:Lugk;
    ...
    iput-object p2, p0, Ltek;->a:Ljava/lang/String;

    new-instance p2, Ljava/util/LinkedHashMap;

    invoke-direct {p2}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object p2, p0, Ltek;->b:Ljava/util/Map;
    ...
    invoke-static {}, Lcom/google/android/gms/ads/internal/zzu;->zzm()Lq7l;

    move-result-object v0

    invoke-virtual {v0, p1}, Lq7l;->b(Landroid/content/Context;)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {v4, p2, v0}, Lvcl;->x(Ljava/lang/Throwable;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Ltek;->b:Ljava/util/Map;
    ...
    invoke-virtual {p1}, Lvcl;->o()Ljava/lang/String;

    move-result-object p1

    invoke-static {p1}, Ljto;->d(Ljava/lang/String;)Z

    move-result p1

    if-nez p1, :cond_4

    iget-object p1, p0, Ltek;->b:Ljava/util/Map;

    invoke-static {}, Lcom/google/android/gms/ads/internal/zzu;->zzo()Lvcl;

    move-result-object p2

    invoke-virtual {p2}, Lvcl;->o()Ljava/lang/String;
...
.method public final a()Landroid/content/Context;
    ...
    iget-object v0, p0, Ltek;->c:Landroid/content/Context;
...
.method public final b()Ljava/lang/String;
    ...
    iget-object v0, p0, Ltek;->d:Ljava/lang/String;
...
.method public final d()Ljava/util/Map;
    ...
    iget-object v0, p0, Ltek;->b:Ljava/util/Map;
