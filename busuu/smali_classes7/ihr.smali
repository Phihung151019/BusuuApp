...
.method public final a(Lbzo;Ljava/util/List;)Ljsj;
    ...
    invoke-virtual {p1, p2}, Laoj;->J(Ljava/lang/String;)Z

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual {p1, p2}, Laoj;->L(Ljava/lang/String;)Ljsj;
    ...
    invoke-virtual {p1, v2}, Laoj;->J(Ljava/lang/String;)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {p1, v2}, Laoj;->L(Ljava/lang/String;)Ljsj;
    ...
    :goto_0
    iget-object v2, p0, Lihr;->c:Lhnr;

    check-cast v1, Lzqj;

    invoke-virtual {v2, v0, p1, v1, p2}, Lhnr;->a(Ljava/lang/String;ILzqj;Ljava/lang/String;)V
