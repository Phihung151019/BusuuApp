...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lt4h;->f:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Paint$FontMetrics;

    invoke-direct {v0}, Landroid/graphics/Paint$FontMetrics;-><init>()V

    sput-object v0, Lt4h;->g:Landroid/graphics/Paint$FontMetrics;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    sput-object v0, Lt4h;->h:Landroid/graphics/Rect;
    ...
    sput-object v0, Lt4h;->i:[I

    invoke-static {}, Lt4h;->h()Lt6h;

    move-result-object v0

    sput-object v0, Lt4h;->j:Lt6h;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    sput-object v0, Lt4h;->k:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    sput-object v0, Lt4h;->l:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Paint$FontMetrics;

    invoke-direct {v0}, Landroid/graphics/Paint$FontMetrics;-><init>()V

    sput-object v0, Lt4h;->m:Landroid/graphics/Paint$FontMetrics;
...
.method public static a(Landroid/graphics/Paint;Ljava/lang/String;)I
    ...
    sget-object v0, Lt4h;->f:Landroid/graphics/Rect;
...
.method public static b(Landroid/graphics/Paint;Ljava/lang/String;)Lqw4;
    .locals 1

    const/4 v0, 0x0

    invoke-static {v0, v0}, Lqw4;->b(FF)Lqw4;

    move-result-object v0

    invoke-static {p0, p1, v0}, Lt4h;->c(Landroid/graphics/Paint;Ljava/lang/String;Lqw4;)V

    return-object v0
.end method

.method public static c(Landroid/graphics/Paint;Ljava/lang/String;Lqw4;)V
    .locals 3

    sget-object v0, Lt4h;->h:Landroid/graphics/Rect;
...
.method public static e(F)F
    ...
    sget-object v0, Lt4h;->a:Landroid/util/DisplayMetrics;
...
.method public static f(Landroid/graphics/Canvas;Landroid/graphics/drawable/Drawable;IIII)V
    ...
    sget-object p2, Lt4h;->k:Landroid/graphics/Rect;
...
.method public static g(Landroid/graphics/Canvas;Ljava/lang/String;FFLandroid/graphics/Paint;Lws8;F)V
    .locals 7

    sget-object v0, Lt4h;->m:Landroid/graphics/Paint$FontMetrics;
    ...
    sget-object v3, Lt4h;->m:Landroid/graphics/Paint$FontMetrics;
    ...
    invoke-static {v2, v0, p6}, Lt4h;->r(FFF)Lqw4;
    ...
    :cond_3
    sget-object p6, Lt4h;->l:Landroid/graphics/Rect;
...
.method public static i(F)I
    ...
    invoke-static {v0, v1}, Lt4h;->w(D)F
...
.method public static j()Lt6h;
    .locals 1

    sget-object v0, Lt4h;->j:Lt6h;
...
.method public static k(Landroid/graphics/Paint;)F
    ...
    sget-object v0, Lt4h;->g:Landroid/graphics/Paint$FontMetrics;

    invoke-static {p0, v0}, Lt4h;->l(Landroid/graphics/Paint;Landroid/graphics/Paint$FontMetrics;)F
...
.method public static m(Landroid/graphics/Paint;)F
    ...
    invoke-static {p0, v0}, Lt4h;->n(Landroid/graphics/Paint;Landroid/graphics/Paint$FontMetrics;)F
...
.method public static r(FFF)Lqw4;
    .locals 1
    ...
    invoke-static {p0, p1, p2}, Lt4h;->s(FFF)Lqw4;
...
.method public static s(FFF)Lqw4;
    .locals 4
    ...
    invoke-static {p2, p0}, Lqw4;->b(FF)Lqw4;
...
.method public static t(Landroid/content/Context;)V
    ...
    sput-object p0, Lt4h;->a:Landroid/util/DisplayMetrics;
