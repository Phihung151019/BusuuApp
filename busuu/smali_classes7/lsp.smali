...
.method public static e(Ljava/lang/String;)Lcom/google/android/gms/internal/measurement/zzbk;
    .locals 2
...
.method public static f(Ljsj;Ljsj;)Z
    .locals 4
    ...
    :cond_0
    instance-of v0, p0, Lzyj;

    const/4 v2, 0x1

    if-nez v0, :cond_8

    instance-of v0, p0, Lnpj;
    ...
    :cond_5
    instance-of v0, p0, Llfj;

    if-eqz v0, :cond_6

    invoke-interface {p0}, Ljsj;->zze()Ljava/lang/Boolean;
...
.method public static h(D)J
    ...
    invoke-static {p0, p1}, Llsp;->g(D)I
...
.method public static j(Ljsj;)Ljava/lang/Object;
    .locals 2

    sget-object v0, Ljsj;->D1:Ljsj;
    ...
    :cond_1
    instance-of v0, p0, Laoj;

    if-eqz v0, :cond_2

    check-cast p0, Laoj;

    invoke-static {p0}, Llsp;->k(Laoj;)Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lydj;->iterator()Ljava/util/Iterator;
    ...
    invoke-static {v1}, Llsp;->j(Ljsj;)Ljava/lang/Object;
...
.method public static k(Laoj;)Ljava/util/Map;
    .locals 4
    ...
    invoke-virtual {p0}, Laoj;->a()Ljava/util/List;
    ...
    invoke-virtual {p0, v2}, Laoj;->L(Ljava/lang/String;)Ljsj;

    move-result-object v3

    invoke-static {v3}, Llsp;->j(Ljsj;)Ljava/lang/Object;
...
.method public static l(Lbzo;)I
    .locals 5

    const-string v0, "runtime.counter"

    invoke-virtual {p0, v0}, Lbzo;->h(Ljava/lang/String;)Ljsj;
    ...
    invoke-static {v1, v2}, Llsp;->g(D)I
    ...
    invoke-direct {v4, v2}, Liij;-><init>(Ljava/lang/Double;)V

    invoke-virtual {p0, v0, v4}, Lbzo;->e(Ljava/lang/String;Ljsj;)V
