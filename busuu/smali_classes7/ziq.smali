...
# static fields
.field public static e:Lcom/google/android/gms/appset/AppSetIdClient;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Lziq;->b:Z

    invoke-static {}, Ljava/util/concurrent/Executors;->newSingleThreadScheduledExecutor()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v1

    iput-object v1, p0, Lziq;->c:Ljava/util/concurrent/ScheduledExecutorService;

    invoke-static {}, Ljava/util/concurrent/Executors;->newSingleThreadExecutor()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    iput-object v0, p0, Lziq;->d:Ljava/util/concurrent/ExecutorService;

    iput-object p1, p0, Lziq;->a:Landroid/content/Context;

    iget-boolean p1, p0, Lziq;->b:Z

    if-nez p1, :cond_0

    new-instance v2, Lh8q;

    const/4 p1, 0x0

    invoke-direct {v2, p0, p1}, Lh8q;-><init>(Lziq;Lr2q;)V
    ...
    iput-boolean p1, p0, Lziq;->b:Z

    :cond_0
    return-void
.end method

.method public static bridge synthetic b(Lziq;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lziq;->a:Landroid/content/Context;

    return-object p0
.end method

.method public static declared-synchronized c(Landroid/content/Context;)Lcom/google/android/gms/appset/AppSetIdClient;
    .locals 2
    ...
    sget-object v1, Lziq;->e:Lcom/google/android/gms/appset/AppSetIdClient;
    ...
    invoke-direct {v1, p0}, Lziq;-><init>(Landroid/content/Context;)V

    sput-object v1, Lziq;->e:Lcom/google/android/gms/appset/AppSetIdClient;
    ...
    :cond_0
    :goto_0
    sget-object p0, Lziq;->e:Lcom/google/android/gms/appset/AppSetIdClient;
    :try_end_0
...
.method public static final e(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lziq;->f(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method public static final g(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v0}, Lodq;-><init>(Ljava/lang/String;)V
...
.method public final a()J
    ...
    iget-object v0, p0, Lziq;->a:Landroid/content/Context;

    invoke-static {v0}, Lziq;->f(Landroid/content/Context;)Landroid/content/SharedPreferences;
...
.method public final synthetic d(Lcom/google/android/gms/tasks/TaskCompletionSource;)V
    .locals 7
    ...
    :cond_0
    :try_start_0
    iget-object v1, p0, Lziq;->a:Landroid/content/Context;

    invoke-static {v1}, Lziq;->g(Landroid/content/Context;)V
    :try_end_0
    .catch Lodq; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1}, Lziq;->f(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    move-result v2
    :try_end_1
    .catch Lodq; {:try_start_1 .. :try_end_1} :catch_1
    ...
    invoke-direct {v0, v1}, Lodq;-><init>(Ljava/lang/String;)V
    ...
    throw v0
    :try_end_2
    .catch Lodq; {:try_start_2 .. :try_end_2} :catch_1
...
.method public final getAppSetIdInfo()Lcom/google/android/gms/tasks/Task;
    ...
    iget-object v1, p0, Lziq;->d:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lvsp;

    invoke-direct {v2, p0, v0}, Lvsp;-><init>(Lziq;Lcom/google/android/gms/tasks/TaskCompletionSource;)V
