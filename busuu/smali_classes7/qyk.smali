...
# direct methods
.method public constructor <init>(Ljava/util/Date;ILjava/util/Set;Landroid/location/Location;ZILejk;Ljava/util/List;ZILjava/lang/String;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lqyk;->a:Ljava/util/Date;

    iput p2, p0, Lqyk;->b:I

    iput-object p3, p0, Lqyk;->c:Ljava/util/Set;

    iput-object p4, p0, Lqyk;->e:Landroid/location/Location;

    iput-boolean p5, p0, Lqyk;->d:Z

    iput p6, p0, Lqyk;->f:I

    iput-object p7, p0, Lqyk;->g:Lejk;

    iput-boolean p9, p0, Lqyk;->i:Z

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lqyk;->h:Ljava/util/List;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lqyk;->j:Ljava/util/Map;
    ...
    iget-object p3, p0, Lqyk;->j:Ljava/util/Map;
    ...
    :cond_2
    iget-object p3, p0, Lqyk;->h:Ljava/util/List;
...
.method public final getBirthday()Ljava/util/Date;
    ...
    iget-object v0, p0, Lqyk;->a:Ljava/util/Date;
...
.method public final getKeywords()Ljava/util/Set;
    ...
    iget-object v0, p0, Lqyk;->c:Ljava/util/Set;
...
.method public final getLocation()Landroid/location/Location;
    ...
    iget-object v0, p0, Lqyk;->e:Landroid/location/Location;
...
.method public final getNativeAdOptions()Lcom/google/android/gms/ads/formats/NativeAdOptions;
    ...
    :cond_2
    iget-object v2, v1, Lejk;->f:Lcom/google/android/gms/ads/internal/client/zzfk;
...
.method public final getNativeAdRequestOptions()Lcom/google/android/gms/ads/nativead/NativeAdOptions;
    ...
    iget-object v0, p0, Lqyk;->g:Lejk;

    invoke-static {v0}, Lejk;->v(Lejk;)Lcom/google/android/gms/ads/nativead/NativeAdOptions;
...
.method public final isUnifiedNativeAdRequested()Z
    ...
    iget-object v0, p0, Lqyk;->h:Ljava/util/List;
...
.method public final zza()Ljava/util/Map;
    ...
    iget-object v0, p0, Lqyk;->j:Ljava/util/Map;
