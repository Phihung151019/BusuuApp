...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llcp;->g:[B

    new-instance v0, Lkcp;

    invoke-direct {v0}, Lkcp;-><init>()V

    sput-object v0, Llcp;->h:Ljava/lang/ThreadLocal;
...
.method public constructor <init>([B[B)V
    ...
    iput-object p2, p0, Llcp;->a:Ljavax/crypto/SecretKey;

    return-void
.end method

.method public static b(Lt7p;)Ly3p;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/GeneralSecurityException;
    ...
    invoke-direct {v0, v1, p0}, Llcp;-><init>([B[B)V
...
.method public static bridge synthetic c(Ljavax/crypto/Cipher;)Z
    ...
    invoke-static {p0}, Llcp;->e(Ljavax/crypto/Cipher;)Z
...
.method public static e(Ljavax/crypto/Cipher;)Z
    ...
    :try_start_0
    sget-object v1, Llcp;->f:[B

    array-length v2, v1

    invoke-static {v1, v0, v2}, Llcp;->d([BII)Ljava/security/spec/AlgorithmParameterSpec;

    move-result-object v1

    new-instance v2, Ljavax/crypto/spec/SecretKeySpec;

    sget-object v3, Llcp;->e:[B
    ...
    sget-object v1, Llcp;->d:[B

    invoke-virtual {p0, v1}, Ljavax/crypto/Cipher;->updateAAD([B)V

    sget-object v1, Llcp;->g:[B
...
.method public final a([B[B)[B
    ...
    iget-object v0, p0, Llcp;->b:[B

    array-length v1, v0

    if-nez v1, :cond_0

    invoke-virtual {p0, p1, p2}, Llcp;->f([B[B)[B
...
.method public final f([B[B)[B
    ...
    sget-object v0, Llcp;->h:Ljava/lang/ThreadLocal;
    ...
    invoke-static {p1, v2, v3}, Llcp;->d([BII)Ljava/security/spec/AlgorithmParameterSpec;

    move-result-object v2

    const/4 v4, 0x2

    iget-object v5, p0, Llcp;->a:Ljavax/crypto/SecretKey;
