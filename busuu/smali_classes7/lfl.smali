...
.method static constructor <clinit>()V
    ...
    sput-object v0, Llfl;->s:Ljava/util/Map;
...
.method public constructor <init>(Landroid/content/Context;Lpgl;ZZLogl;Lqgl;)V
    .locals 0
    ...
    iput-boolean p1, p0, Llfl;->q:Z

    const/4 p1, 0x0

    iput-object p1, p0, Llfl;->r:Ljava/lang/Integer;

    invoke-virtual {p0, p0}, Landroid/view/TextureView;->setSurfaceTextureListener(Landroid/view/TextureView$SurfaceTextureListener;)V

    iput-object p2, p0, Llfl;->c:Lpgl;

    iput-object p6, p0, Llfl;->d:Lqgl;

    iput-boolean p3, p0, Llfl;->n:Z

    iput-boolean p4, p0, Llfl;->e:Z

    invoke-virtual {p6, p0}, Lqgl;->a(Lnfl;)V

    return-void
.end method

.method public static bridge synthetic H(Llfl;)Lmfl;
    .locals 0

    iget-object p0, p0, Llfl;->p:Lmfl;

    return-object p0
.end method

.method public static bridge synthetic I(Llfl;Z)V
    .locals 0
...
.method public static bridge synthetic J(Llfl;Landroid/media/MediaPlayer;)V
    .locals 10
    ...
    iput-object v4, p0, Llfl;->r:Ljava/lang/Integer;
    ...
    iget-object p0, p0, Llfl;->c:Lpgl;

    const-string p1, "onMetadataEvent"

    invoke-interface {p0, p1, v1}, Lzsk;->P(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static bridge synthetic K(Llfl;)Z
    .locals 0

    iget-boolean p0, p0, Llfl;->q:Z
...
.method public final C()V
    ...
    iget-object v1, p0, Llfl;->i:Landroid/net/Uri;
    ...
    invoke-virtual {p0, v1}, Llfl;->D(Z)V
    ...
    iput-object v3, p0, Llfl;->h:Landroid/media/MediaPlayer;

    invoke-virtual {v3, p0}, Landroid/media/MediaPlayer;->setOnBufferingUpdateListener(Landroid/media/MediaPlayer$OnBufferingUpdateListener;)V

    iget-object v3, p0, Llfl;->h:Landroid/media/MediaPlayer;
    ...
    invoke-direct {v3, v4}, Lngl;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Llfl;->m:Lngl;
    ...
    invoke-virtual {v3, v0, v4, v5}, Lngl;->c(Landroid/graphics/SurfaceTexture;II)V

    iget-object v3, p0, Llfl;->m:Lngl;

    invoke-virtual {v3}, Ljava/lang/Thread;->start()V

    iget-object v3, p0, Llfl;->m:Lngl;

    invoke-virtual {v3}, Lngl;->a()Landroid/graphics/SurfaceTexture;
    ...
    iget-object v5, p0, Llfl;->i:Landroid/net/Uri;
    ...
    iget-object v0, p0, Llfl;->h:Landroid/media/MediaPlayer;
    ...
    invoke-virtual {p0, v2}, Llfl;->E(I)V
    :try_end_0
    ...
    :goto_1
    iget-object v3, p0, Llfl;->i:Landroid/net/Uri;
    ...
    invoke-virtual {p0, v0, v2, v1}, Llfl;->onError(Landroid/media/MediaPlayer;II)Z
...
.method public final D(Z)V
    ...
    iput-object v1, p0, Llfl;->h:Landroid/media/MediaPlayer;

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Llfl;->E(I)V
...
.method public final o()J
    ...
    iget-object v0, p0, Llfl;->r:Ljava/lang/Integer;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Llfl;->p()J
...
.method public final onCompletion(Landroid/media/MediaPlayer;)V
    ...
    invoke-virtual {p0, p1}, Llfl;->E(I)V
    ...
    invoke-direct {v0, p0}, Lefl;-><init>(Llfl;)V
...
.method public final onError(Landroid/media/MediaPlayer;II)Z
    ...
    sget-object p1, Llfl;->s:Ljava/util/Map;
    ...
    invoke-virtual {p0, p3}, Llfl;->E(I)V
    ...
    invoke-direct {v0, p0, p2, p1}, Lffl;-><init>(Llfl;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final onMeasure(II)V
    ...
    iget-object p1, p0, Llfl;->m:Lngl;

    if-eqz p1, :cond_a

    invoke-virtual {p1, v0, v1}, Lngl;->b(II)V
...
.method public final onPrepared(Landroid/media/MediaPlayer;)V
    ...
    invoke-direct {v1, p0, p1}, Ldfl;-><init>(Llfl;Landroid/media/MediaPlayer;)V
    ...
    invoke-virtual {p0, p1}, Llfl;->t(I)V

    :cond_0
    iget-boolean p1, p0, Llfl;->e:Z
    ...
    iget-object p1, p0, Llfl;->h:Landroid/media/MediaPlayer;
    ...
    invoke-virtual {p0, p1}, Llfl;->F(F)V
...
.method public final onSurfaceTextureAvailable(Landroid/graphics/SurfaceTexture;II)V
    ...
    invoke-virtual {p0}, Llfl;->C()V

    sget-object p1, Lcom/google/android/gms/ads/internal/util/zzt;->zza:Lcpo;

    new-instance p2, Lgfl;

    invoke-direct {p2, p0}, Lgfl;-><init>(Llfl;)V
...
.method public final onSurfaceTextureDestroyed(Landroid/graphics/SurfaceTexture;)Z
    ...
    invoke-direct {v0, p0}, Lifl;-><init>(Llfl;)V

    invoke-virtual {p1, v0}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    const/4 p1, 0x1

    invoke-virtual {p0, p1}, Llfl;->D(Z)V
...
.method public final onSurfaceTextureSizeChanged(Landroid/graphics/SurfaceTexture;II)V
    ...
    invoke-direct {v0, p0, p2, p3}, Lhfl;-><init>(Llfl;II)V
...
.method public final onWindowVisibilityChanged(I)V
    ...
    invoke-direct {v1, p0, p1}, Lcfl;-><init>(Llfl;I)V
...
.method public final p()J
    ...
    invoke-virtual {p0}, Llfl;->k()I

    move-result v0

    int-to-long v0, v0

    iget-object v2, p0, Llfl;->r:Ljava/lang/Integer;
...
.method public final r()V
    ...
    invoke-virtual {p0, v1}, Llfl;->E(I)V

    sget-object v0, Lcom/google/android/gms/ads/internal/util/zzt;->zza:Lcpo;

    new-instance v2, Lkfl;

    invoke-direct {v2, p0}, Lkfl;-><init>(Llfl;)V
...
.method public final s()V
    ...
    invoke-direct {v2, p0}, Ljfl;-><init>(Llfl;)V
...
.method public final v(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lick;->v(Landroid/net/Uri;)Lick;

    move-result-object v0

    if-eqz v0, :cond_1

    iget-object v1, v0, Lick;->a:Ljava/lang/String;
    ...
    iget-object p1, v0, Lick;->a:Ljava/lang/String;
    ...
    :cond_2
    iput-object p1, p0, Llfl;->i:Landroid/net/Uri;
...
.method public final w()V
    ...
    iput-object v0, p0, Llfl;->h:Landroid/media/MediaPlayer;
...
.method public final zzn()V
    ...
    invoke-virtual {p0, v0}, Llfl;->F(F)V
