...
.method public static B3(Landroid/os/IBinder;)Lwjk;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lujk;-><init>(Landroid/os/IBinder;)V
...
.method public final K(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_0
    invoke-interface {p0}, Lwjk;->zzc()I
    ...
    :cond_1
    invoke-interface {p0}, Lwjk;->zzd()I
    ...
    :cond_2
    invoke-interface {p0}, Lwjk;->zzb()D
    ...
    :cond_3
    invoke-interface {p0}, Lwjk;->zze()Landroid/net/Uri;
    ...
    :cond_4
    invoke-interface {p0}, Lwjk;->zzf()Lcx6;
