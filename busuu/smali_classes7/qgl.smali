...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lqgl;->r:Z

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lcom/google/android/gms/ads/internal/util/client/VersionInfoParcel;Ljava/lang/String;Lpfk;Lmfk;)V
    .locals 6
    ...
    iput-object v0, p0, Lqgl;->f:Lcom/google/android/gms/ads/internal/util/zzbh;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lqgl;->i:Z

    iput-boolean v0, p0, Lqgl;->j:Z

    iput-boolean v0, p0, Lqgl;->k:Z

    iput-boolean v0, p0, Lqgl;->l:Z

    const-wide/16 v1, -0x1

    iput-wide v1, p0, Lqgl;->q:J

    iput-object p1, p0, Lqgl;->a:Landroid/content/Context;

    iput-object p2, p0, Lqgl;->c:Lcom/google/android/gms/ads/internal/util/client/VersionInfoParcel;

    iput-object p3, p0, Lqgl;->b:Ljava/lang/String;

    iput-object p4, p0, Lqgl;->e:Lpfk;

    iput-object p5, p0, Lqgl;->d:Lmfk;

    sget-object p1, Loek;->u:Lwdk;
    ...
    iput-object p1, p0, Lqgl;->h:[Ljava/lang/String;

    new-array p1, v0, [J

    iput-object p1, p0, Lqgl;->g:[J
    ...
    iput-object p3, p0, Lqgl;->h:[Ljava/lang/String;

    new-array p2, p2, [J

    iput-object p2, p0, Lqgl;->g:[J
...
.method public final a(Lnfl;)V
    ...
    iget-object v1, p0, Lqgl;->e:Lpfk;

    iget-object v2, p0, Lqgl;->d:Lmfk;

    invoke-static {v1, v2, v0}, Lhfk;->a(Lpfk;Lmfk;[Ljava/lang/String;)Z

    const/4 v0, 0x1

    iput-boolean v0, p0, Lqgl;->i:Z

    iget-object v0, p0, Lqgl;->e:Lpfk;

    const-string v1, "vpn"

    invoke-virtual {p1}, Lnfl;->q()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lpfk;->d(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, p0, Lqgl;->n:Lnfl;
...
.method public final c()V
    ...
    iput-boolean v0, p0, Lqgl;->m:Z

    iget-boolean v1, p0, Lqgl;->j:Z
    ...
    invoke-static {v1, v2, v3}, Lhfk;->a(Lpfk;Lmfk;[Ljava/lang/String;)Z
...
.method public final d()V
    ...
    sget-boolean v0, Lqgl;->r:Z

    if-eqz v0, :cond_3

    iget-boolean v0, p0, Lqgl;->o:Z
    ...
    iget-object v0, p0, Lqgl;->b:Ljava/lang/String;

    const-string v1, "request"

    invoke-virtual {v5, v1, v0}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lqgl;->n:Lnfl;

    invoke-virtual {v0}, Lnfl;->q()Ljava/lang/String;
    ...
    iget-object v0, p0, Lqgl;->f:Lcom/google/android/gms/ads/internal/util/zzbh;
    ...
    :goto_1
    iget-object v1, p0, Lqgl;->g:[J

    array-length v2, v1

    if-ge v0, v2, :cond_2

    iget-object v2, p0, Lqgl;->h:[Ljava/lang/String;
    ...
    :cond_2
    iget-object v2, p0, Lqgl;->a:Landroid/content/Context;

    iget-object v0, p0, Lqgl;->c:Lcom/google/android/gms/ads/internal/util/client/VersionInfoParcel;
...
.method public final f(Lnfl;)V
    .locals 20

    move-object/from16 v0, p0

    iget-boolean v1, v0, Lqgl;->k:Z

    if-eqz v1, :cond_1

    iget-boolean v1, v0, Lqgl;->l:Z
    ...
    :cond_0
    iget-object v1, v0, Lqgl;->e:Lpfk;

    iget-object v2, v0, Lqgl;->d:Lmfk;
    ...
    iget-boolean v3, v0, Lqgl;->p:Z

    if-eqz v3, :cond_2

    iget-wide v8, v0, Lqgl;->q:J
    ...
    iget-wide v10, v0, Lqgl;->q:J

    sub-long v10, v1, v10

    iget-object v3, v0, Lqgl;->f:Lcom/google/android/gms/ads/internal/util/zzbh;
    ...
    iput-boolean v3, v0, Lqgl;->p:Z

    iput-wide v1, v0, Lqgl;->q:J

    sget-object v1, Loek;->v:Lwdk;
    ...
    invoke-virtual/range {p1 .. p1}, Lnfl;->i()I
    ...
    :goto_0
    iget-object v11, v0, Lqgl;->h:[Ljava/lang/String;
    ...
    iget-object v1, v0, Lqgl;->h:[Ljava/lang/String;
