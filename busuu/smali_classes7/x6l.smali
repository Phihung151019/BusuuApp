...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Le7l;-><init>()V

    sput-object v0, Lx6l;->CREATOR:Landroid/os/Parcelable$Creator;
...
.method public constructor <init>(Landroid/os/ParcelFileDescriptor;)V
    ...
    iput-object p1, p0, Lx6l;->a:Landroid/os/ParcelFileDescriptor;

    const/4 p1, 0x0

    iput-object p1, p0, Lx6l;->b:Landroid/os/Parcelable;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lx6l;->c:Z
...
# virtual methods
.method public final v(Landroid/os/Parcelable$Creator;)Le3d;
    .locals 5

    iget-boolean v0, p0, Lx6l;->c:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lx6l;->a:Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v3, p0, Lx6l;->a:Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v0}, Lbx6;->a(Ljava/io/Closeable;)V
    ...
    :cond_1
    :goto_1
    iget-object p1, p0, Lx6l;->b:Landroid/os/Parcelable;
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    :try_start_0
    iget-object v2, p0, Lx6l;->b:Landroid/os/Parcelable;
    ...
    new-instance v6, Lw6l;

    invoke-direct {v6, v5, v2}, Lw6l;-><init>(Ljava/io/OutputStream;[B)V
    ...
    :goto_1
    iput-object v0, p0, Lx6l;->a:Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {p1, v2, v3, p2, v1}, Ld3d;->p(Landroid/os/Parcel;ILandroid/os/Parcelable;IZ)V
