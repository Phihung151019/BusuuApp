...
.field public final d:Lttj;

.field public final e:Lvuk;

.field public final f:Lbjq;

.field public final g:Ljkr;

.field public final h:Lv8n;


# direct methods
.method public constructor <init>(Landroid/app/Application;Ly8j;Landroid/os/Handler;Ljava/util/concurrent/Executor;Lttj;Lvuk;Lbjq;Ljkr;Lv8n;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Llfr;->a:Landroid/app/Application;

    iput-object p3, p0, Llfr;->b:Landroid/os/Handler;

    iput-object p4, p0, Llfr;->c:Ljava/util/concurrent/Executor;

    iput-object p5, p0, Llfr;->d:Lttj;

    iput-object p6, p0, Llfr;->e:Lvuk;

    iput-object p7, p0, Llfr;->f:Lbjq;

    iput-object p8, p0, Llfr;->g:Ljkr;

    iput-object p9, p0, Llfr;->h:Lv8n;
...
# virtual methods
.method public final synthetic a(Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateSuccessListener;Lfnr;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lvdr;-><init>(Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateSuccessListener;)V

    iget-object p1, p0, Llfr;->b:Landroid/os/Handler;

    invoke-virtual {p1, v0}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    iget-object p1, p2, Lfnr;->b:Lcom/google/android/ump/ConsentInformation$PrivacyOptionsRequirementStatus;
    ...
    iget-object p1, p0, Llfr;->e:Lvuk;

    invoke-virtual {p1}, Lvuk;->c()V

    :cond_0
    return-void
.end method

.method public final synthetic b(Landroid/app/Activity;Lcom/google/android/ump/ConsentRequestParameters;Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateSuccessListener;Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateFailureListener;)V
    .locals 3
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Llfr;->a:Landroid/app/Application;

    invoke-static {v0}, Lysl;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p0, Llfr;->f:Lbjq;

    invoke-virtual {v0, p1, p2}, Lbjq;->c(Landroid/app/Activity;Lcom/google/android/ump/ConsentRequestParameters;)Lcpl;

    move-result-object p1

    invoke-virtual {p0, p1}, Llfr;->d(Lcpl;)Lsrl;

    move-result-object p1

    iget-object p2, p0, Llfr;->g:Ljkr;

    new-instance v0, Lwir;

    invoke-direct {v0, p2, p1}, Lwir;-><init>(Ljkr;Lsrl;)V

    invoke-virtual {v0}, Lwir;->a()Lfnr;

    move-result-object p1

    iget-object p2, p0, Llfr;->d:Lttj;

    iget v0, p1, Lfnr;->a:I

    invoke-virtual {p2, v0}, Lttj;->g(I)V

    iget-object p2, p0, Llfr;->d:Lttj;

    iget-object v0, p1, Lfnr;->b:Lcom/google/android/ump/ConsentInformation$PrivacyOptionsRequirementStatus;

    invoke-virtual {p2, v0}, Lttj;->i(Lcom/google/android/ump/ConsentInformation$PrivacyOptionsRequirementStatus;)V

    iget-object p2, p0, Llfr;->e:Lvuk;

    iget-object v0, p1, Lfnr;->c:Lqxk;

    invoke-virtual {p2, v0}, Lvuk;->d(Lqxk;)V

    iget-object p2, p0, Llfr;->h:Lv8n;

    invoke-virtual {p2}, Lv8n;->a()Ljava/util/concurrent/Executor;

    move-result-object p2

    new-instance v0, Lc2r;

    invoke-direct {v0, p0, p3, p1}, Lc2r;-><init>(Llfr;Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateSuccessListener;Lfnr;)V
    ...
    new-instance p3, Ldcr;

    invoke-direct {p3, p4, p2}, Ldcr;-><init>(Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateFailureListener;Lcom/google/android/gms/internal/consent_sdk/zzg;)V
    ...
    :goto_2
    iget-object p2, p0, Llfr;->b:Landroid/os/Handler;

    new-instance p3, Lq9r;

    invoke-direct {p3, p4, p1}, Lq9r;-><init>(Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateFailureListener;Lcom/google/android/gms/internal/consent_sdk/zzg;)V
...
.method public final c(Landroid/app/Activity;Lcom/google/android/ump/ConsentRequestParameters;Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateSuccessListener;Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateFailureListener;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lf6r;-><init>(Llfr;Landroid/app/Activity;Lcom/google/android/ump/ConsentRequestParameters;Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateSuccessListener;Lcom/google/android/ump/ConsentInformation$OnConsentInfoUpdateFailureListener;)V

    iget-object p1, v1, Llfr;->c:Ljava/util/concurrent/Executor;
...
.method public final d(Lcpl;)Lsrl;
    .locals 11
    ...
    iget-object v5, p0, Llfr;->a:Landroid/app/Application;
    ...
    iget-object v7, p1, Lcpl;->a:Ljava/lang/String;
    ...
    :cond_3
    :goto_1
    iget-object v8, v7, Lvjl;->a:Ljava/lang/String;
    ...
    :cond_4
    iget-object v7, v7, Lvjl;->b:Ljava/lang/Integer;
    ...
    :cond_6
    iget-object v7, p1, Lcpl;->c:Ljava/lang/String;
    ...
    :cond_7
    iget-object v7, p1, Lcpl;->d:Ljava/lang/Boolean;
    ...
    :cond_8
    iget-object v7, p1, Lcpl;->e:Ljava/util/Map;
    ...
    iget-object v8, v7, Llml;->a:Ljava/lang/Integer;
    ...
    :cond_b
    iget-object v8, v7, Llml;->b:Ljava/lang/Integer;
    ...
    :cond_c
    iget-object v8, v7, Llml;->c:Ljava/lang/Double;
    ...
    :cond_d
    iget-object v7, v7, Llml;->d:Ljava/util/List;
    ...
    iget-object v9, v8, Ldll;->a:Ljava/lang/Integer;
    ...
    :cond_e
    iget-object v9, v8, Ldll;->b:Ljava/lang/Integer;
    ...
    :cond_f
    iget-object v9, v8, Ldll;->c:Ljava/lang/Integer;
    ...
    :cond_10
    iget-object v8, v8, Ldll;->d:Ljava/lang/Integer;
    ...
    iget-object v9, v7, Lghl;->a:Ljava/lang/String;
    ...
    :cond_15
    iget-object v9, v7, Lghl;->b:Ljava/lang/String;
    ...
    :cond_16
    iget-object v7, v7, Lghl;->c:Ljava/lang/String;
    ...
    iget-object v7, v7, Ltnl;->a:Ljava/lang/String;
    ...
    :cond_1a
    iget-object p1, p1, Lcpl;->i:Ljava/util/List;
    ...
    invoke-static {v0}, Lsrl;->a(Landroid/util/JsonReader;)Lsrl;
    ...
    iput-object v0, p1, Lsrl;->a:Ljava/lang/String;
