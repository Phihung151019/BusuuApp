...
.field private resultGuardian:Li4j;
    .annotation build Lcom/google/android/gms/common/annotation/KeepName;
    .end annotation
...
.method public static bridge synthetic j(Lcom/google/android/gms/common/api/internal/BasePendingResult;)Lsqc;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lsqc;

    return-object p0
.end method

.method public static l(Lsqc;)V
    .locals 3

    instance-of v0, p0, Lqjc;
    ...
    invoke-interface {v0}, Lqjc;->release()V
    :try_end_0
...
# virtual methods
.method public final b(Ltsa$a;)V
    .locals 2
    ...
    invoke-interface {p1, v1}, Ltsa$a;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final c(JLjava/util/concurrent/TimeUnit;)Lsqc;
    .locals 3
    ...
    invoke-static {v1, v0}, Lnbb;->p(ZLjava/lang/Object;)V
    ...
    invoke-static {p1, p2}, Lnbb;->p(ZLjava/lang/Object;)V

    invoke-virtual {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h()Lsqc;
...
.method public abstract d(Lcom/google/android/gms/common/api/Status;)Lsqc;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final g(Lsqc;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->i(Lsqc;)V
...
.method public final h()Lsqc;
    ...
    invoke-static {v1, v3}, Lnbb;->p(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lsqc;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lsqc;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Ltqc;
...
.method public final i(Lsqc;)V
    .locals 4

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lsqc;

    invoke-interface {p1}, Lsqc;->h()Lcom/google/android/gms/common/api/Status;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Ltqc;

    goto :goto_0

    :cond_0
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Ltqc;

    if-nez p1, :cond_1

    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lsqc;

    instance-of p1, p1, Lqjc;

    if-eqz p1, :cond_2

    new-instance p1, Li4j;

    invoke-direct {p1, p0, v0}, Li4j;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;Lg4j;)V

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->resultGuardian:Li4j;
    ...
    invoke-virtual {v0, p1, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult$a;->a(Ltqc;Lsqc;)V
    ...
    invoke-interface {v2, v3}, Ltsa$a;->a(Lcom/google/android/gms/common/api/Status;)V
