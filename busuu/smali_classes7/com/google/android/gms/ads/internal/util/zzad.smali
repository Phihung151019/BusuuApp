...
.method public static zzc(Landroid/content/Context;)V
    ...
    :cond_0
    :try_start_0
    invoke-static {p0}, Lopo;->k(Landroid/content/Context;)Lopo;

    move-result-object v0

    invoke-static {p0}, Lppo;->j(Landroid/content/Context;)Lppo;

    move-result-object p0

    invoke-virtual {v0}, Lopo;->l()V

    invoke-virtual {v0}, Lopo;->m()V

    invoke-virtual {p0}, Lppo;->k()V

    sget-object v0, Loek;->J2:Lwdk;
