...
.method public static final zza(Landroid/content/Context;Lcom/google/android/gms/ads/internal/overlay/AdOverlayInfoParcel;Z)V
    ...
    :cond_0
    iget-object p2, p1, Lcom/google/android/gms/ads/internal/overlay/AdOverlayInfoParcel;->zzu:Lbjm;

    if-eqz p2, :cond_1

    invoke-interface {p2}, Lbjm;->Y()V

    :cond_1
    iget-object p2, p1, Lcom/google/android/gms/ads/internal/overlay/AdOverlayInfoParcel;->zzd:Lmkl;

    invoke-interface {p2}, Lmkl;->zzi()Landroid/app/Activity;
