...
.method public final K(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-static {p1}, Lwsk;->B3(Landroid/os/IBinder;)Lxsk;

    move-result-object p1

    invoke-static {p2}, Lr6k;->c(Landroid/os/Parcel;)V

    invoke-interface {p0, p1}, Lcom/google/android/gms/ads/internal/client/zzbq;->zzi(Lxsk;)V
    ...
    :pswitch_3
    sget-object p1, Lmsk;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-interface {p0, p1}, Lcom/google/android/gms/ads/internal/client/zzbq;->zzn(Lmsk;)V
    ...
    invoke-static {p1}, Lulk;->B3(Landroid/os/IBinder;)Lvlk;

    move-result-object p1

    invoke-static {p2}, Lr6k;->c(Landroid/os/Parcel;)V

    invoke-interface {p0, p1}, Lcom/google/android/gms/ads/internal/client/zzbq;->zzk(Lvlk;)V
    ...
    invoke-static {p1}, Lrlk;->B3(Landroid/os/IBinder;)Lslk;
    ...
    invoke-interface {p0, p1, p4}, Lcom/google/android/gms/ads/internal/client/zzbq;->zzj(Lslk;Lcom/google/android/gms/ads/internal/client/zzq;)V
    ...
    :pswitch_8
    sget-object p1, Lejk;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-interface {p0, p1}, Lcom/google/android/gms/ads/internal/client/zzbq;->zzo(Lejk;)V
    ...
    invoke-static {p4}, Lnlk;->B3(Landroid/os/IBinder;)Lolk;
    ...
    invoke-static {v0}, Lklk;->B3(Landroid/os/IBinder;)Lllk;

    move-result-object v0

    invoke-static {p2}, Lr6k;->c(Landroid/os/Parcel;)V

    invoke-interface {p0, p1, p4, v0}, Lcom/google/android/gms/ads/internal/client/zzbq;->zzh(Ljava/lang/String;Lolk;Lllk;)V
    ...
    invoke-static {p1}, Lhlk;->B3(Landroid/os/IBinder;)Lilk;

    move-result-object p1

    invoke-static {p2}, Lr6k;->c(Landroid/os/Parcel;)V

    invoke-interface {p0, p1}, Lcom/google/android/gms/ads/internal/client/zzbq;->zzg(Lilk;)V
    ...
    invoke-static {p1}, Lelk;->B3(Landroid/os/IBinder;)Lflk;

    move-result-object p1

    invoke-static {p2}, Lr6k;->c(Landroid/os/Parcel;)V

    invoke-interface {p0, p1}, Lcom/google/android/gms/ads/internal/client/zzbq;->zzf(Lflk;)V
