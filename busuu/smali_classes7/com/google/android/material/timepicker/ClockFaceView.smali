...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lnwb;->materialClockStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lx9c;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Li9c;->ClockFaceView:[I

    sget v1, Lj8c;->Widget_MaterialComponents_TimePicker_Clock:I
    ...
    sget v0, Li9c;->ClockFaceView_clockNumberTextColor:I
    ...
    iput-object v0, p0, Lcom/google/android/material/timepicker/ClockFaceView;->q:Landroid/content/res/ColorStateList;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v1

    sget v2, Ln4c;->material_clockface_view:I

    const/4 v3, 0x1

    invoke-virtual {v1, v2, p0, v3}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    sget v1, Lh3c;->material_clock_hand:I
    ...
    sget v2, Lpzb;->material_clock_hand_padding:I
    ...
    sget v0, Lkyb;->material_timepicker_clockface:I

    invoke-static {p1, v0}, Lx40;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget v1, Li9c;->ClockFaceView_clockFaceBackgroundColor:I

    invoke-static {p1, p2, v1}, Lyw8;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    :goto_0
    invoke-virtual {p0, v0}, Lx9c;->setBackgroundColor(I)V
    ...
    iput-object p1, p0, Lcom/google/android/material/timepicker/ClockFaceView;->h:Lw3;
    ...
    sget p1, Lpzb;->material_time_picker_minimum_screen_height:I
    ...
    sget p1, Lpzb;->material_time_picker_minimum_screen_width:I
    ...
    sget p1, Lpzb;->material_clock_size:I
...
.method public d(I)V
    ...
    invoke-virtual {p0}, Lx9c;->c()I

    move-result v0

    if-eq p1, v0, :cond_0

    invoke-super {p0, p1}, Lx9c;->d(I)V
...
.method public final k()V
    ...
    invoke-virtual {p0, v0, v3, v2}, Lcom/google/android/material/timepicker/ClockFaceView;->l(Landroid/graphics/RectF;Landroid/graphics/Rect;Landroid/widget/TextView;)Landroid/graphics/RadialGradient;
...
.method public final l(Landroid/graphics/RectF;Landroid/graphics/Rect;Landroid/widget/TextView;)Landroid/graphics/RadialGradient;
    .locals 7
    ...
    iget-object p3, p0, Lcom/google/android/material/timepicker/ClockFaceView;->f:Landroid/graphics/RectF;
...
.method public final o(I)V
    ...
    sget v4, Ln4c;->material_clockface_textview:I
    ...
    sget v5, Lh3c;->material_value_index:I
    ...
    iget-object v5, p0, Lcom/google/android/material/timepicker/ClockFaceView;->h:Lw3;

    invoke-static {v4, v5}, Ljbh;->m0(Landroid/view/View;Lw3;)V
