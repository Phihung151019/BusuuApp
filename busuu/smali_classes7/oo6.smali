...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Loo6;->c:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Loo6;->d:Z

    invoke-direct {p0}, Loo6;->P()V
...
.method private P()V
    ...
    invoke-direct {v0, p0}, Loo6$a;-><init>(Loo6;)V
...
.method private R()V
    ...
    invoke-virtual {p0}, Loo6;->componentManager()Lz5;
...
.method public S()V
    ...
    invoke-virtual {p0}, Loo6;->generatedComponent()Ljava/lang/Object;
    ...
    check-cast v1, Lcom/busuu/streaks/EmptyStreaksActivity;

    invoke-interface {v0, v1}, Laf4;->injectEmptyStreaksActivity(Lcom/busuu/streaks/EmptyStreaksActivity;)V
...
.method public _nr_setTrace(Lcom/newrelic/agent/android/tracing/Trace;)V
    ...
    :try_start_0
    iput-object p1, p0, Loo6;->e:Lcom/newrelic/agent/android/tracing/Trace;
    :try_end_0
...
.method public final componentManager()Lz5;
    ...
    iget-object v0, p0, Loo6;->b:Lz5;

    if-nez v0, :cond_1

    iget-object v0, p0, Loo6;->c:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Loo6;->b:Lz5;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Loo6;->Q()Lz5;

    move-result-object v1

    iput-object v1, p0, Loo6;->b:Lz5;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v0, "Hilt_EmptyStreaksActivity#onCreate"

    const-string v1, "Hilt_EmptyStreaksActivity"
    ...
    :try_start_0
    iget-object v2, p0, Loo6;->e:Lcom/newrelic/agent/android/tracing/Trace;
