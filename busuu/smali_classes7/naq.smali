...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lnaq;->a:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v0, 0x0

    iput-object v0, p0, Lnaq;->b:Ljava/util/HashMap;
    ...
    iput-object v1, p0, Lnaq;->c:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1, v2, v3}, Ljava/util/HashMap;-><init>(IF)V

    iput-object v1, p0, Lnaq;->d:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1, v2, v3}, Ljava/util/HashMap;-><init>(IF)V

    iput-object v1, p0, Lnaq;->e:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1, v2, v3}, Ljava/util/HashMap;-><init>(IF)V

    iput-object v1, p0, Lnaq;->f:Ljava/util/HashMap;

    iput-object v0, p0, Lnaq;->g:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lnaq;->i:[Ljava/lang/String;
...
.method public final a(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object p3, p0, Lnaq;->b:Ljava/util/HashMap;
    ...
    iget-object p3, p0, Lnaq;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object p3, p0, Lnaq;->b:Ljava/util/HashMap;

    new-instance p3, Ljava/lang/Object;

    invoke-direct {p3}, Ljava/lang/Object;-><init>()V

    iput-object p3, p0, Lnaq;->g:Ljava/lang/Object;

    sget-object p3, Lt9q;->a:Landroid/net/Uri;

    new-instance v1, Lgaq;

    invoke-direct {v1, p0, v2}, Lgaq;-><init>(Lnaq;Landroid/os/Handler;)V
    ...
    iget-object p3, p0, Lnaq;->c:Ljava/util/HashMap;

    invoke-virtual {p3}, Ljava/util/HashMap;->clear()V

    iget-object p3, p0, Lnaq;->d:Ljava/util/HashMap;

    invoke-virtual {p3}, Ljava/util/HashMap;->clear()V

    iget-object p3, p0, Lnaq;->e:Ljava/util/HashMap;

    invoke-virtual {p3}, Ljava/util/HashMap;->clear()V

    iget-object p3, p0, Lnaq;->f:Ljava/util/HashMap;
    ...
    iput-boolean v1, p0, Lnaq;->h:Z

    :cond_1
    :goto_0
    iget-object p3, p0, Lnaq;->g:Ljava/lang/Object;

    iget-object v1, p0, Lnaq;->b:Ljava/util/HashMap;
    ...
    iget-object p1, p0, Lnaq;->b:Ljava/util/HashMap;
    ...
    :try_start_1
    sget-object v4, Lt9q;->a:Landroid/net/Uri;
    ...
    :try_start_8
    iget-object p1, p0, Lnaq;->g:Ljava/lang/Object;
...
.method public final synthetic b()Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lnaq;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
