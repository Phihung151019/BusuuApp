...
# direct methods
.method public constructor <init>(Lyyp;Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 0

    invoke-static {p1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p1, p0, Lwvp;->d:Lyyp;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    invoke-static {p2}, Lnbb;->f(Ljava/lang/String;)Ljava/lang/String;

    iput-object p2, p0, Lwvp;->a:Ljava/lang/String;

    new-instance p1, Landroid/os/Bundle;

    invoke-direct {p1}, Landroid/os/Bundle;-><init>()V

    iput-object p1, p0, Lwvp;->b:Landroid/os/Bundle;
...
.method public final a()Landroid/os/Bundle;
    ...
    iget-object v0, p0, Lwvp;->c:Landroid/os/Bundle;
    ...
    :cond_0
    iget-object v0, p0, Lwvp;->d:Lyyp;

    iget-object v1, p0, Lwvp;->a:Ljava/lang/String;
    ...
    iget-object v8, v0, Ll9q;->a:Lo3q;

    invoke-virtual {v8}, Lo3q;->w()Lcoj;

    move-result-object v8

    sget-object v9, Llwo;->R0:Lgvo;

    invoke-virtual {v8, v3, v9}, Lcoj;->H(Ljava/lang/String;Lgvo;)Z
    ...
    :cond_a
    iput-object v2, p0, Lwvp;->c:Landroid/os/Bundle;
    :try_end_7
    ...
    iget-object v0, p0, Lwvp;->b:Landroid/os/Bundle;

    iput-object v0, p0, Lwvp;->c:Landroid/os/Bundle;

    :cond_c
    :goto_6
    new-instance v0, Landroid/os/Bundle;

    iget-object v1, p0, Lwvp;->c:Landroid/os/Bundle;
...
.method public final b(Landroid/os/Bundle;)V
    ...
    :goto_0
    iget-object v3, v1, Lwvp;->d:Lyyp;

    invoke-virtual {v3}, Lyyp;->p()Landroid/content/SharedPreferences;
    ...
    iget-object v0, v1, Lwvp;->a:Ljava/lang/String;
    ...
    :cond_1
    iget-object v5, v1, Lwvp;->a:Ljava/lang/String;
    ...
    iget-object v0, v3, Ll9q;->a:Lo3q;

    invoke-virtual {v0}, Lo3q;->w()Lcoj;

    move-result-object v10

    sget-object v11, Llwo;->R0:Lgvo;
    ...
    :cond_7
    invoke-virtual/range {p1 .. p1}, Lo3q;->b()Lemp;
    ...
    invoke-virtual {v0, v11, v8}, Lokp;->b(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :goto_3
    iget-object v8, v1, Lwvp;->d:Lyyp;

    iget-object v8, v8, Ll9q;->a:Lo3q;
    ...
    iput-object v2, v1, Lwvp;->c:Landroid/os/Bundle;
