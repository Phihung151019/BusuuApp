...
.method public static c(Lhik;Ljsj;Ljsj;)Ljsj;
    .locals 0

    invoke-interface {p1}, Ljsj;->zzf()Ljava/util/Iterator;

    move-result-object p1

    invoke-static {p0, p1, p2}, Lzkk;->e(Lhik;Ljava/util/Iterator;Ljsj;)Ljsj;
...
.method public static d(Lhik;Ljsj;Ljsj;)Ljsj;
    .locals 1
...
.method public static e(Lhik;Ljava/util/Iterator;Ljsj;)Ljsj;
    .locals 3
    ...
    invoke-interface {p0, v0}, Lhik;->a(Ljsj;)Lbzo;
    ...
    invoke-virtual {v0, v1}, Lbzo;->b(Lydj;)Ljsj;
    ...
    invoke-virtual {v0}, Lygj;->b()Ljava/lang/String;
...
.method public final a(Ljava/lang/String;Lbzo;Ljava/util/List;)Ljsj;
    ...
    invoke-static {p1, v5, p3}, Llsp;->a(Ljava/lang/String;ILjava/util/List;)V

    invoke-interface {p3, v8}, Ljava/util/List;->get(I)Ljava/lang/Object;

    move-result-object p1

    instance-of p1, p1, Lqxj;
    ...
    invoke-direct {v1, p2, p1}, Llgk;-><init>(Lbzo;Ljava/lang/String;)V

    invoke-static {v1, v0, p3}, Lzkk;->d(Lhik;Ljsj;Ljsj;)Ljsj;
    ...
    invoke-direct {v1, p2, p1}, Lxek;-><init>(Lbzo;Ljava/lang/String;)V
    ...
    invoke-direct {v1, p2, p1}, Lojk;-><init>(Lbzo;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v5}, Lydj;->x(I)Ljsj;

    move-result-object v6

    invoke-interface {v6}, Ljsj;->zzc()Ljava/lang/String;

    move-result-object v6

    invoke-virtual {p2, v6}, Lbzo;->h(Ljava/lang/String;)Ljsj;

    move-result-object v7

    invoke-virtual {v2, v6, v7}, Lbzo;->e(Ljava/lang/String;Ljsj;)V
    ...
    invoke-interface {v5}, Ljsj;->zze()Ljava/lang/Boolean;
    ...
    invoke-virtual {p2, v5}, Lbzo;->b(Lydj;)Ljsj;

    move-result-object v5

    instance-of v6, v5, Lygj;

    if-eqz v6, :cond_5

    check-cast v5, Lygj;

    invoke-virtual {v5}, Lygj;->b()Ljava/lang/String;
    ...
    invoke-virtual {p1, v6}, Lydj;->x(I)Ljsj;

    move-result-object v7

    invoke-interface {v7}, Ljsj;->zzc()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v2, v7}, Lbzo;->h(Ljava/lang/String;)Ljsj;

    move-result-object v9

    invoke-virtual {v5, v7, v9}, Lbzo;->e(Ljava/lang/String;Ljsj;)V
    ...
    :cond_6
    invoke-virtual {v5, v1}, Lbzo;->a(Ljsj;)Ljsj;
    ...
    invoke-static {v1, v0, p3}, Lzkk;->c(Lhik;Ljsj;Ljsj;)Ljsj;
    ...
    invoke-virtual {p2, v1}, Lbzo;->a(Ljsj;)Ljsj;

    move-result-object v1

    invoke-interface {v1}, Ljsj;->zze()Ljava/lang/Boolean;
    ...
    invoke-virtual {p2, v1}, Lbzo;->b(Lydj;)Ljsj;

    move-result-object v1

    instance-of v2, v1, Lygj;

    if-eqz v2, :cond_f

    check-cast v1, Lygj;

    invoke-virtual {v1}, Lygj;->b()Ljava/lang/String;
