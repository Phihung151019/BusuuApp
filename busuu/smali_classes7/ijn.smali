...
.method public final a(Labo;Lpao;)Ltd8;
    ...
    iget-object v2, v1, Lpao;->v:Lorg/json/JSONObject;
    ...
    iget-object v3, v0, Labo;->a:Lxao;

    iget-object v3, v3, Lxao;->a:Lobo;

    new-instance v4, Lmbo;

    invoke-direct {v4}, Lmbo;-><init>()V

    invoke-virtual {v4, v3}, Lmbo;->M(Lobo;)Lmbo;

    invoke-virtual {v4, v2}, Lmbo;->P(Ljava/lang/String;)Lmbo;

    iget-object v2, v3, Lobo;->d:Lcom/google/android/gms/ads/internal/client/zzl;

    iget-object v2, v2, Lcom/google/android/gms/ads/internal/client/zzl;->zzm:Landroid/os/Bundle;

    invoke-static {v2}, Lijn;->d(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-static {v6}, Lijn;->d(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    iget-object v6, v1, Lpao;->v:Lorg/json/JSONObject;
    ...
    iget-object v6, v1, Lpao;->D:Lorg/json/JSONObject;
    ...
    iget-object v8, v1, Lpao;->D:Lorg/json/JSONObject;
    ...
    invoke-virtual {v4, v5}, Lmbo;->h(Lcom/google/android/gms/ads/internal/client/zzl;)Lmbo;

    invoke-virtual {v4}, Lmbo;->j()Lobo;
    ...
    iget-object v7, v4, Lsao;->a:Ljava/util/List;
    ...
    iget-object v4, v4, Lsao;->b:Ljava/lang/String;
    ...
    iget-object v4, v1, Lpao;->w:Ljava/lang/String;

    const-string v6, "allocation_id"

    invoke-virtual {v5, v6, v4}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, v1, Lpao;->F:Ljava/lang/String;
    ...
    iget-object v6, v1, Lpao;->c:Ljava/util/List;
    ...
    iget-object v6, v1, Lpao;->d:Ljava/util/List;
    ...
    iget-object v6, v1, Lpao;->p:Ljava/util/List;
    ...
    iget-object v6, v1, Lpao;->m:Ljava/util/List;
    ...
    iget-object v6, v1, Lpao;->g:Ljava/util/List;
    ...
    iget-object v6, v1, Lpao;->h:Ljava/util/List;
    ...
    iget-object v6, v1, Lpao;->i:Ljava/util/List;
    ...
    iget-object v4, v1, Lpao;->j:Ljava/lang/String;

    const-string v6, "transaction_id"

    invoke-virtual {v5, v6, v4}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, v1, Lpao;->k:Ljava/lang/String;

    const-string v6, "valid_from_timestamp"

    invoke-virtual {v5, v6, v4}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v4, v1, Lpao;->P:Z

    const-string v6, "is_closable_area_disabled"

    invoke-virtual {v5, v6, v4}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V

    iget-object v4, v1, Lpao;->o0:Ljava/lang/String;

    const-string v6, "recursive_server_response_data"

    invoke-virtual {v5, v6, v4}, Landroid/os/BaseBundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v4, v1, Lpao;->l:Lj8l;
    ...
    iget-object v6, v6, Lj8l;->a:Ljava/lang/String;
    ...
    invoke-virtual {v4, v2, v3, v1, v0}, Lijn;->c(Lobo;Landroid/os/Bundle;Lpao;Labo;)Ltd8;
...
.method public final b(Labo;Lpao;)Z
    ...
    iget-object p1, p2, Lpao;->v:Lorg/json/JSONObject;
...
.method public abstract c(Lobo;Landroid/os/Bundle;Lpao;Labo;)Ltd8;
.end method
