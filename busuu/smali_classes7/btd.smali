...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lbtd;->i:[I

    new-array v0, v0, [F

    fill-array-data v0, :array_0

    sput-object v0, Lbtd;->j:[F

    const/4 v0, 0x4

    new-array v1, v0, [I

    sput-object v1, Lbtd;->k:[I

    new-array v0, v0, [F

    fill-array-data v0, :array_1

    sput-object v0, Lbtd;->l:[F
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lbtd;-><init>(I)V
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lbtd;->g:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Lbtd;->h:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Lbtd;->a:Landroid/graphics/Paint;

    invoke-virtual {p0, p1}, Lbtd;->d(I)V

    iget-object p1, p0, Lbtd;->h:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Lbtd;->c:Landroid/graphics/Paint;
...
.method public a(Landroid/graphics/Canvas;Landroid/graphics/Matrix;Landroid/graphics/RectF;IFF)V
    ...
    :goto_0
    iget-object v9, v0, Lbtd;->g:Landroid/graphics/Path;
    ...
    sget-object v17, Lbtd;->k:[I

    sget-object v19, Landroid/graphics/Shader$TileMode;->CLAMP:Landroid/graphics/Shader$TileMode;

    invoke-direct/range {v13 .. v19}, Landroid/graphics/RadialGradient;-><init>(FFF[I[FLandroid/graphics/Shader$TileMode;)V

    iget-object v3, v0, Lbtd;->b:Landroid/graphics/Paint;
    ...
    iget-object v3, v0, Lbtd;->h:Landroid/graphics/Paint;
    ...
    iget-object v6, v0, Lbtd;->b:Landroid/graphics/Paint;
...
.method public b(Landroid/graphics/Canvas;Landroid/graphics/Matrix;Landroid/graphics/RectF;I)V
    ...
    iget-object p4, p0, Lbtd;->c:Landroid/graphics/Paint;
    ...
    iget-object p2, p0, Lbtd;->c:Landroid/graphics/Paint;
...
.method public c()Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lbtd;->a:Landroid/graphics/Paint;
...
.method public d(I)V
    ...
    invoke-static {p1, v0}, Lru1;->o(II)I
    ...
    iget-object p1, p0, Lbtd;->a:Landroid/graphics/Paint;
