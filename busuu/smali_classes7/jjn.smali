...
# direct methods
.method public constructor <init>(Lbnl;Ld7m;Ljgm;Ltjn;Ljfn;)V
    .locals 0

    invoke-direct {p0}, Lijn;-><init>()V

    iput-object p1, p0, Ljjn;->a:Lbnl;

    iput-object p2, p0, Ljjn;->b:Ld7m;

    iput-object p3, p0, Ljjn;->c:Ljgm;

    iput-object p4, p0, Ljjn;->d:Ltjn;

    iput-object p5, p0, Ljjn;->e:Ljfn;
...
.method public final c(Lobo;Landroid/os/Bundle;Lpao;Labo;)Ltd8;
    ...
    iget-object p1, p0, Ljjn;->b:Ld7m;

    iget-object p2, p0, Ljjn;->e:Ljfn;

    invoke-virtual {p1, p2}, Ld7m;->d(Ljfn;)Ld7m;

    :cond_0
    iget-object p1, p0, Ljjn;->a:Lbnl;

    iget-object p2, p0, Ljjn;->b:Ld7m;
    ...
    iget-object p2, p0, Ljjn;->c:Ljgm;

    invoke-interface {p1, p2}, Ldyl;->a(Ljgm;)Ldyl;

    invoke-interface {p1}, Ldyl;->zze()Leyl;

    move-result-object p1

    invoke-virtual {p1}, Leyl;->zzb()Ls3m;
