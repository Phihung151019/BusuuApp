...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lnlm;)V
    .locals 0
...
.method public final a(Labo;Lpao;Lifn;)V
    ...
    iget-object p1, p0, Lgin;->a:Landroid/content/Context;
    ...
    invoke-direct {v6, p0, p3, p1}, Lfin;-><init>(Lgin;Lifn;Lein;)V
    ...
    invoke-interface/range {v1 .. v7}, Ltzk;->K2(Ljava/lang/String;Ljava/lang/String;Lcom/google/android/gms/ads/internal/client/zzl;Lcx6;Lizk;Ljxk;)V
    :try_end_0
...
.method public final bridge synthetic b(Labo;Lpao;Lifn;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v0, p2}, Ljkm;-><init>(Ltlm;Lmkl;)V

    iget-object p2, p0, Lgin;->b:Lnlm;

    invoke-virtual {p2, v1, p1}, Lnlm;->c(Ls2m;Ljkm;)Lgkm;

    move-result-object p1

    invoke-virtual {p1}, Lgkm;->b()La9m;
