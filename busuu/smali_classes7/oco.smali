...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/gms/ads/internal/client/zzcl;)V
    ...
    iput-object v0, p0, Loco;->c:Ljava/util/concurrent/atomic/AtomicReference;

    iput-object p1, p0, Loco;->a:Landroid/content/Context;

    iput-object p2, p0, Loco;->b:Lcom/google/android/gms/ads/internal/client/zzcl;
...
.method public static d(Landroid/content/Context;)Loco;
    .locals 7
    ...
    invoke-static {p0}, Loco;->a(Landroid/content/Context;)Lcom/google/android/gms/ads/internal/client/zzcl;
    ...
    invoke-direct {v1, p0, v4}, Loco;-><init>(Landroid/content/Context;Lcom/google/android/gms/ads/internal/client/zzcl;)V

    sput-object v1, Loco;->d:Loco;
...
# virtual methods
.method public final b()Ldxk;
    .locals 1

    iget-object v0, p0, Loco;->c:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final c(IZI)Lcom/google/android/gms/ads/internal/util/client/VersionInfoParcel;
    ...
    iget-object p1, p0, Loco;->a:Landroid/content/Context;
    ...
    :cond_0
    invoke-virtual {p0}, Loco;->g()Lcom/google/android/gms/ads/internal/client/zzen;
...
.method public final f(Ldxk;)V
    .locals 3

    sget-object v0, Lthk;->a:Lugk;
    ...
    iget-object v0, p0, Loco;->b:Lcom/google/android/gms/ads/internal/client/zzcl;
    ...
    :cond_0
    :try_start_0
    invoke-interface {v0}, Lcom/google/android/gms/ads/internal/client/zzcl;->getAdapterCreator()Ldxk;
    ...
    :goto_0
    iget-object v2, p0, Loco;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_1
    invoke-static {v2, v1, p1}, Lnco;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v0, v1, p1}, Lnco;->a(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
