...
.method public constructor <init>(Landroid/net/Uri;Lbba;)V
    ...
    iput-object p1, p0, Lxh2;->a:Landroid/net/Uri;

    iput-object p2, p0, Lxh2;->b:Lbba;
...
.method public a(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0}, Lxh2;->b(Landroid/net/Uri;)Z
    ...
    invoke-virtual {p0, v0}, Lxh2;->c(Landroid/net/Uri;)Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-virtual {p0}, Lxh2;->d()Landroid/os/Bundle;

    move-result-object v0

    iget-object v3, p0, Lxh2;->a:Landroid/net/Uri;

    const-string v4, "image/*"

    invoke-static {p1, v3, v4, v0, v2}, Lwh2;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/content/res/AssetFileDescriptor;
    ...
    iget-object v4, p0, Lxh2;->a:Landroid/net/Uri;

    invoke-direct {v3, v4}, Lqh2;-><init>(Landroid/net/Uri;)V

    invoke-static {v1, v2, v3}, Lz17;->c(Lokio/BufferedSource;Landroid/content/Context;Lw17$a;)Lw17;

    move-result-object v1

    iget-object v2, p0, Lxh2;->a:Landroid/net/Uri;
...
.method public final d()Landroid/os/Bundle;
    ...
    instance-of v1, v0, Llv3$a;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    check-cast v0, Llv3$a;
    ...
    instance-of v3, v1, Llv3$a;

    if-eqz v3, :cond_3

    check-cast v1, Llv3$a;
