...
.method public constructor <init>(Lhj9;Lg09;Ldf2;ILhj9;)V
    ...
    iput-object p1, p0, Ldd7$j;->a:Lhj9;

    iput-object p2, p0, Ldd7$j;->b:Lg09;

    iput-object p3, p0, Ldd7$j;->c:Ldf2;

    iput p4, p0, Ldd7$j;->d:I

    iput-object p5, p0, Ldd7$j;->e:Lhj9;
...
.method public final measure-3p2s80s(Landroidx/compose/ui/layout/m;Ljava/util/List;J)Lpz8;
    ...
    iget-object v2, p0, Ldd7$j;->e:Lhj9;
    ...
    new-instance v11, Ldd7$j$a;

    iget-object v0, p0, Ldd7$j;->b:Lg09;

    invoke-direct {v11, v0, v5, v6}, Ldd7$j$a;-><init>(Lg09;Ljava/util/List;Ljava/util/Map;)V
