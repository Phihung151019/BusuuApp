...
.method public constructor <init>(Lhuh;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lhuh$e;->d:Lhuh;
...
.method public bridge synthetic e(Laff;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lhuh$e;->f(Laff;Lfuh;)V
...
.method public f(Laff;Lfuh;)V
    ...
    invoke-virtual {p2}, Lnf2;->d()Landroidx/work/NetworkType;

    move-result-object v8

    invoke-static {v8}, Lnuh;->g(Landroidx/work/NetworkType;)I

    move-result v8

    int-to-long v8, v8

    invoke-interface {p1, v6, v8, v9}, Lyef;->w0(IJ)V

    invoke-virtual {p2}, Lnf2;->g()Z

    move-result v6

    int-to-long v8, v6

    invoke-interface {p1, v5, v8, v9}, Lyef;->w0(IJ)V

    invoke-virtual {p2}, Lnf2;->h()Z
    ...
    invoke-virtual {p2}, Lnf2;->b()J

    move-result-wide v2

    invoke-interface {p1, v1, v2, v3}, Lyef;->w0(IJ)V

    invoke-virtual {p2}, Lnf2;->a()J

    move-result-wide v1

    invoke-interface {p1, v0, v1, v2}, Lyef;->w0(IJ)V

    invoke-virtual {p2}, Lnf2;->c()Ljava/util/Set;

    move-result-object p2

    invoke-static {p2}, Lnuh;->i(Ljava/util/Set;)[B
    ...
    :cond_5
    invoke-interface {p1, v7, p2}, Lyef;->z0(I[B)V
