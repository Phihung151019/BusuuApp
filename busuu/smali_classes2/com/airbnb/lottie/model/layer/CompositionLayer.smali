...
.method public constructor <init>(Lcom/airbnb/lottie/LottieDrawable;Lcom/airbnb/lottie/model/layer/Layer;Ljava/util/List;Lcom/airbnb/lottie/LottieComposition;)V
    ...
    invoke-direct {p2, v2}, Lwq8;-><init>(I)V
    ...
    invoke-virtual {p2, v7, v8, v6}, Lwq8;->h(JLjava/lang/Object;)V
    ...
    :cond_4
    :goto_3
    invoke-virtual {p2}, Lwq8;->k()I

    move-result p1

    if-ge v4, p1, :cond_7

    invoke-virtual {p2, v4}, Lwq8;->g(I)J

    move-result-wide p3

    invoke-virtual {p2, p3, p4}, Lwq8;->d(J)Ljava/lang/Object;
