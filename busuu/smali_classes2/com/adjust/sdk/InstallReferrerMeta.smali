...
.method public readReferrer()V
    ...
    :try_start_0
    iget-object v7, p0, Lcom/adjust/sdk/InstallReferrerMeta;->context:Landroid/content/Context;

    const-string v8, "com.facebook.katana.provider.InstallReferrerProvider"

    invoke-static {v7, v8}, Lcom/adjust/sdk/Util;->resolveContentProvider(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {v4, v7}, Lcom/adjust/sdk/Util;->resolveContentProvider(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    :goto_1
    iget-object v7, p0, Lcom/adjust/sdk/InstallReferrerMeta;->logger:Lcom/adjust/sdk/ILogger;

    const-string v8, "InstallReferrerMeta reads installReferrer[%s] actualTimestampInSec[%d] isClick[%b]"
