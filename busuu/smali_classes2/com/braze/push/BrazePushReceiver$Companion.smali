...
.method public final handleAdmRegistrationIntent(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    sget-object v16, Lcom/braze/push/BrazePushReceiver$Companion$handleAdmRegistrationIntent$4;->INSTANCE:Lcom/braze/push/BrazePushReceiver$Companion$handleAdmRegistrationIntent$4;
...
.method public final handlePushNotificationPayload(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    invoke-static {v8}, Lcom/braze/push/BrazeNotificationUtils;->isBrazePushMessage(Landroid/content/Intent;)Z
    ...
    invoke-direct {v4, v10}, Lcom/braze/push/BrazePushReceiver$Companion$handlePushNotificationPayload$3;-><init>(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, v10}, Lcom/braze/models/push/BrazeNotificationPayload$Companion;->getAttachedBrazeExtras(Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object v3

    const-string v4, "extra"

    invoke-virtual {v10, v4, v3}, Landroid/os/Bundle;->putBundle(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v4, v7}, Lcom/braze/BrazeInternal;->getConfigurationProvider(Landroid/content/Context;)Lcom/braze/configuration/BrazeConfigurationProvider;

    move-result-object v11

    invoke-virtual {p0, v7, v11, v10, v3}, Lcom/braze/push/BrazePushReceiver$Companion;->createPayload(Landroid/content/Context;Lcom/braze/configuration/BrazeConfigurationProvider;Landroid/os/Bundle;Landroid/os/Bundle;)Lcom/braze/models/push/BrazeNotificationPayload;

    move-result-object v12

    invoke-virtual {v12}, Lcom/braze/models/push/BrazeNotificationPayload;->isUninstallTrackingPush()Z
    ...
    :cond_4
    invoke-virtual {v12}, Lcom/braze/models/push/BrazeNotificationPayload;->getPushUniqueId()Ljava/lang/String;

    move-result-object v1

    if-eqz v1, :cond_5

    invoke-virtual {v4, v7, v1}, Lcom/braze/BrazeInternal;->validateAndStorePushId(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-direct {v4, v1}, Lcom/braze/push/BrazePushReceiver$Companion$handlePushNotificationPayload$5$1;-><init>(Ljava/lang/String;)V
    ...
    :cond_5
    invoke-static {v12}, Lcom/braze/push/BrazeNotificationUtils;->handleContentCardsSerializedCardIfPresent(Lcom/braze/models/push/BrazeNotificationPayload;)V

    invoke-virtual {v12}, Lcom/braze/models/push/BrazeNotificationPayload;->getShouldFetchTestTriggers()Z

    move-result v1

    if-eqz v1, :cond_6

    invoke-virtual {v11}, Lcom/braze/configuration/BrazeConfigurationProvider;->isInAppMessageTestPushEagerDisplayEnabled()Z
    ...
    :cond_6
    invoke-static {v8}, Lcom/braze/push/BrazeNotificationUtils;->isNotificationMessage(Landroid/content/Intent;)Z
    ...
    invoke-static {v12}, Lcom/braze/push/BrazeNotificationUtils;->getNotificationId(Lcom/braze/models/push/BrazeNotificationPayload;)I
    ...
    invoke-virtual {v12}, Lcom/braze/models/push/BrazeNotificationPayload;->isPushStory()Z
    ...
    :cond_7
    const-string v14, "braze_story_newly_received"
    ...
    invoke-virtual {v10, v14, v13}, Landroid/os/BaseBundle;->putBoolean(Ljava/lang/String;Z)V
    ...
    invoke-direct {v4, v12}, Lcom/braze/push/BrazePushReceiver$Companion$handlePushNotificationPayload$10;-><init>(Lcom/braze/models/push/BrazeNotificationPayload;)V
    ...
    invoke-interface {v1, v12}, Lcom/braze/IBrazeNotificationFactory;->createNotification(Lcom/braze/models/push/BrazeNotificationPayload;)Landroid/app/Notification;
    ...
    invoke-direct {v4, v9}, Lcom/braze/push/BrazePushReceiver$Companion$handlePushNotificationPayload$12;-><init>(Landroidx/core/app/NotificationManagerCompat;)V
    ...
    invoke-virtual {v9, v0, v8, v14}, Landroidx/core/app/NotificationManagerCompat;->notify(Ljava/lang/String;ILandroid/app/Notification;)V

    invoke-static {v7, v10, v12}, Lcom/braze/push/BrazeNotificationUtils;->sendPushMessageReceivedBroadcast(Landroid/content/Context;Landroid/os/Bundle;Lcom/braze/models/push/BrazeNotificationPayload;)V

    invoke-static {v7, v11, v10}, Lcom/braze/push/BrazeNotificationUtils;->wakeScreenIfAppropriate(Landroid/content/Context;Lcom/braze/configuration/BrazeConfigurationProvider;Landroid/os/Bundle;)Z

    invoke-virtual {v12}, Lcom/braze/models/push/BrazeNotificationPayload;->getPushDuration()Ljava/lang/Integer;
    ...
    invoke-static {v7, v2, v8, v0}, Lcom/braze/push/BrazeNotificationUtils;->setNotificationDurationAlarm(Landroid/content/Context;Ljava/lang/Class;II)V

    :cond_a
    invoke-virtual {p0, v7, v12}, Lcom/braze/push/BrazePushReceiver$Companion;->logNotificationMetadata$android_sdk_ui_release(Landroid/content/Context;Lcom/braze/models/push/BrazeNotificationPayload;)V
    ...
    invoke-static {v12}, Lcom/braze/push/BrazeNotificationUtils;->requestGeofenceRefreshIfAppropriate(Lcom/braze/models/push/BrazeNotificationPayload;)Z

    invoke-static {v12}, Lcom/braze/push/BrazeNotificationUtils;->refreshFeatureFlagsIfAppropriate(Lcom/braze/models/push/BrazeNotificationPayload;)Z
...
.method public final logNotificationMetadata$android_sdk_ui_release(Landroid/content/Context;Lcom/braze/models/push/BrazeNotificationPayload;)V
    ...
    invoke-static {v1, v2, v3, v4}, Lfac;->f(JJ)J
    ...
    invoke-static {v3, v4, v1, v2}, Lfac;->f(JJ)J
    ...
    invoke-virtual {v1, v6, v7, v2, v3}, Ly9c$a;->i(JJ)J
