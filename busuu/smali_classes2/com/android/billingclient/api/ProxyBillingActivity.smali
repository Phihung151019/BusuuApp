...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-static {p3, v4}, Ly8n;->a(Landroid/content/Intent;Ljava/lang/String;)I
    ...
    invoke-static {v4, p1}, Ly8n;->j(Ljava/lang/String;Ljava/lang/String;)V

    goto/16 :goto_6

    :cond_3
    :goto_1
    invoke-static {p3, v4}, Ly8n;->e(Landroid/content/Intent;Ljava/lang/String;)Lcom/android/billingclient/api/a;
    ...
    invoke-static {v4, p2}, Ly8n;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, p3}, Ly8n;->j(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5, p3}, Lrml;->b(IILcom/android/billingclient/api/a;)Lddq;

    move-result-object p3

    invoke-virtual {p3}, Lyso;->e()[B
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v2, "ProxyBillingActivity#onCreate"

    const-string v8, "ProxyBillingActivity"

    invoke-static {v8}, Lcom/newrelic/agent/android/tracing/TraceMachine;->startTracing(Ljava/lang/String;)V

    const/4 v9, 0x0

    :try_start_0
    iget-object v3, p0, Lcom/android/billingclient/api/ProxyBillingActivity;->f:Lcom/newrelic/agent/android/tracing/Trace;

    invoke-static {v3, v2, v9}, Lcom/newrelic/agent/android/tracing/TraceMachine;->enterMethod(Lcom/newrelic/agent/android/tracing/Trace;Ljava/lang/String;Ljava/util/ArrayList;)V

    goto :goto_0

    :catch_0
    invoke-static {v9, v2, v9}, Lcom/newrelic/agent/android/tracing/TraceMachine;->enterMethod(Lcom/newrelic/agent/android/tracing/Trace;Ljava/lang/String;Ljava/util/ArrayList;)V
    :try_end_0
    ...
    invoke-static {v8, v0}, Ly8n;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v9}, Landroid/os/ResultReceiver;->send(ILandroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v10, v9}, Landroid/os/ResultReceiver;->send(ILandroid/os/Bundle;)V
    ...
    invoke-static {v8, v6}, Ly8n;->i(Ljava/lang/String;Ljava/lang/String;)V

    const-string v6, "send_cancelled_broadcast_if_finished"

    invoke-virtual {p1, v6, v10}, Landroid/os/BaseBundle;->getBoolean(Ljava/lang/String;Z)Z
