...
.method public static Y(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {p0}, Liji;->a(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;

    move-result-object p0

    invoke-static {p0}, Laei;->a(Landroid/view/WindowMetrics;)Landroid/graphics/Rect;
...
.method public static Z(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {p0}, Lrdi;->a(Landroid/view/WindowManager;)Landroid/view/WindowMetrics;
...
.method private static a(ILandroid/view/Display;)I
    ...
    invoke-static {p1, p0}, Ljji;->a(Landroid/view/Display;I)Landroid/view/RoundedCorner;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p0}, Lkji;->a(Landroid/view/RoundedCorner;)I
