...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lup6;->c:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lup6;->d:Z

    invoke-direct {p0}, Lup6;->P()V
...
.method private P()V
    ...
    new-instance v0, Lup6$a;

    invoke-direct {v0, p0}, Lup6$a;-><init>(Lup6;)V
...
.method private R()V
    ...
    invoke-virtual {p0}, Lup6;->componentManager()Lz5;
...
.method public S()V
    ...
    invoke-virtual {p0}, Lup6;->generatedComponent()Ljava/lang/Object;
    ...
    check-cast v1, Lcom/android/leaderboard/ui/LeaderboardActivity;

    invoke-interface {v0, v1}, Le18;->injectLeaderboardActivity(Lcom/android/leaderboard/ui/LeaderboardActivity;)V
...
.method public _nr_setTrace(Lcom/newrelic/agent/android/tracing/Trace;)V
    ...
    :try_start_0
    iput-object p1, p0, Lup6;->e:Lcom/newrelic/agent/android/tracing/Trace;
    :try_end_0
...
.method public final componentManager()Lz5;
    ...
    iget-object v0, p0, Lup6;->b:Lz5;

    if-nez v0, :cond_1

    iget-object v0, p0, Lup6;->c:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lup6;->b:Lz5;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lup6;->Q()Lz5;

    move-result-object v1

    iput-object v1, p0, Lup6;->b:Lz5;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v0, "Hilt_LeaderboardActivity#onCreate"

    const-string v1, "Hilt_LeaderboardActivity"
    ...
    :try_start_0
    iget-object v2, p0, Lup6;->e:Lcom/newrelic/agent/android/tracing/Trace;
