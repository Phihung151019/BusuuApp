...
.method public constructor <init>(Landroid/content/Context;Lqth;)V
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lqth;

    invoke-virtual {p2}, Lqth;->r()Lrcb;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Lrcb;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lqth;

    invoke-static {v0, v1}, Lhif;->i(Landroid/content/Context;Lqth;)Z
    ...
    :try_start_0
    invoke-interface {v2}, Lguh;->w()Ljava/util/List;
    ...
    iget-object v10, v8, Lfuh;->a:Ljava/lang/String;

    invoke-interface {v2, v9, v10}, Lguh;->h(Landroidx/work/WorkInfo$State;Ljava/lang/String;)I

    iget-object v8, v8, Lfuh;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v2, v8, v9, v10}, Lguh;->r(Ljava/lang/String;J)I

    goto :goto_1

    :cond_1
    invoke-interface {v3}, Lxth;->d()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lqth;

    invoke-virtual {v0}, Lqth;->z()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lqth;

    invoke-virtual {v0}, Lqth;->r()Lrcb;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lrcb;->f(Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Lrcb;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Lrcb;->e(J)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lqth;

    invoke-virtual {v2}, Lqth;->t()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-static {v1, v2, v4, v4}, Lhj5;->a(Landroid/app/ActivityManager;Ljava/lang/String;II)Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Lrcb;

    invoke-virtual {v2}, Lrcb;->a()J
    ...
    invoke-static {v6}, Lij5;->a(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;

    move-result-object v6

    invoke-static {v6}, Ljj5;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {v6}, Lkj5;->a(Landroid/app/ApplicationExitInfo;)J
    ...
    invoke-virtual {v2, v3, v4, v1}, Lyn8;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public run()V
    ...
    invoke-static {v0}, Leth;->d(Landroid/content/Context;)V
    :try_end_1
    ...
    invoke-virtual {v2, v3, v1, v0}, Lyn8;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0}, Landroidx/work/a;->e()Lxf2;
    ...
    invoke-virtual {v1, v3, v4, v2}, Lyn8;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-interface {v0, v2}, Lxf2;->accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v6, v1, v0}, Lyn8;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, v3, v1}, Lyn8;->c(Ljava/lang/String;Ljava/lang/String;)V
