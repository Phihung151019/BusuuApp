...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v0}, Landroidx/work/impl/background/systemalarm/d;-><init>(Landroid/content/Context;Lkjb;Lqth;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lkjb;Lqth;)V
    .locals 3
    ...
    iput-object v1, p0, Landroidx/work/impl/background/systemalarm/d;->j:Lzqe;

    new-instance v1, Landroidx/work/impl/background/systemalarm/a;

    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/d;->j:Lzqe;

    invoke-direct {v1, v0, v2}, Landroidx/work/impl/background/systemalarm/a;-><init>(Landroid/content/Context;Lzqe;)V
    ...
    :goto_0
    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/d;->e:Lqth;

    new-instance p1, Lmuh;

    invoke-virtual {p3}, Lqth;->o()Landroidx/work/a;

    move-result-object v0

    invoke-virtual {v0}, Landroidx/work/a;->k()Lo0d;

    move-result-object v0

    invoke-direct {p1, v0}, Lmuh;-><init>(Lo0d;)V

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/d;->c:Lmuh;
    ...
    :cond_1
    invoke-virtual {p3}, Lqth;->s()Lkjb;

    move-result-object p2

    :goto_1
    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/d;->d:Lkjb;

    invoke-virtual {p3}, Lqth;->w()Lwjf;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/background/systemalarm/d;->b:Lwjf;

    invoke-virtual {p2, p0}, Lkjb;->g(Llm4;)V
...
.method public a(Landroid/content/Intent;I)Z
    ...
    invoke-virtual {p1, v1, p2}, Lyn8;->k(Ljava/lang/String;Ljava/lang/String;)V
...
.method public c()V
    ...
    invoke-virtual {v2, v1, v3}, Lyn8;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/d;->b:Lwjf;

    invoke-interface {v2}, Lwjf;->c()Lhnd;
...
.method public d(Llth;Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/d;->b:Lwjf;
    ...
    invoke-static {v2, p1, p2}, Landroidx/work/impl/background/systemalarm/a;->c(Landroid/content/Context;Llth;Z)Landroid/content/Intent;
...
.method public e()Lkjb;
    .locals 1

    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/d;->d:Lkjb;
...
.method public g()Lqth;
    .locals 1

    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/d;->e:Lqth;

    return-object v0
.end method

.method public h()Lmuh;
    .locals 1

    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/d;->c:Lmuh;
...
.method public final k()V
    ...
    invoke-static {v0, v1}, Lhlh;->b(Landroid/content/Context;Ljava/lang/String;)Landroid/os/PowerManager$WakeLock;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/d;->e:Lqth;

    invoke-virtual {v1}, Lqth;->w()Lwjf;
    ...
    invoke-interface {v1, v2}, Lwjf;->a(Ljava/lang/Runnable;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
