...
.method public constructor <init>(Landroid/content/Context;Lzqe;)V
    .locals 0
    ...
    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/a;->d:Lzqe;
...
.method public static b(Landroid/content/Context;Llth;)Landroid/content/Intent;
    .locals 2
    ...
    invoke-static {v0, p1}, Landroidx/work/impl/background/systemalarm/a;->q(Landroid/content/Intent;Llth;)Landroid/content/Intent;
...
.method public static c(Landroid/content/Context;Llth;Z)Landroid/content/Intent;
    .locals 2
...
.method public static e(Landroid/content/Context;Llth;)Landroid/content/Intent;
    .locals 2
...
.method public static f(Landroid/content/Context;Llth;)Landroid/content/Intent;
    .locals 2
...
.method public static p(Landroid/content/Intent;)Llth;
    .locals 4
    ...
    invoke-direct {v0, v1, p0}, Llth;-><init>(Ljava/lang/String;I)V

    return-object v0
.end method

.method public static q(Landroid/content/Intent;Llth;)Landroid/content/Intent;
    .locals 2
...
.method public d(Llth;Z)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/a;->d:Lzqe;

    invoke-virtual {v2, p1}, Lzqe;->b(Llth;)Lyqe;
...
.method public final h(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    :try_start_0
    invoke-static {p1}, Landroidx/work/impl/background/systemalarm/a;->p(Landroid/content/Intent;)Llth;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/systemalarm/a;->d:Lzqe;

    invoke-virtual {v3, p1}, Lzqe;->d(Llth;)Lyqe;

    move-result-object v3

    invoke-direct {v1, v2, p2, p3, v3}, Landroidx/work/impl/background/systemalarm/c;-><init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/d;Lyqe;)V
    ...
    invoke-virtual {p2, v2, p1}, Lyn8;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final i(Landroid/content/Intent;I)V
    ...
    invoke-virtual {v2, v3, p1}, Lyn8;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v0, v1}, Landroidx/work/impl/background/systemalarm/a;->d(Llth;Z)V
...
.method public final k(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-interface {v2, v3}, Lguh;->o(Ljava/lang/String;)Lfuh;
    ...
    invoke-virtual {p2, v1, p1}, Lyn8;->k(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    iget-object v4, v2, Lfuh;->b:Landroidx/work/WorkInfo$State;
    ...
    invoke-virtual {p2, v1, p3}, Lyn8;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p0, Landroidx/work/impl/background/systemalarm/a;->a:Landroid/content/Context;

    invoke-static {p2, v0, p1, v3, v4}, Lld;->c(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Llth;J)V
    ...
    invoke-virtual {v2, v1, v5}, Lyn8;->a(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/a;->a:Landroid/content/Context;

    invoke-static {v1, v0, p1, v3, v4}, Lld;->c(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Llth;J)V
...
.method public final l(Landroid/content/Intent;Landroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-direct {v3, v0, p1}, Llth;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v2, v3}, Lzqe;->b(Llth;)Lyqe;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/work/impl/background/systemalarm/a;->d:Lzqe;

    invoke-virtual {p1, v0}, Lzqe;->c(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v2, v3, v4}, Lyn8;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p2}, Landroidx/work/impl/background/systemalarm/d;->g()Lqth;

    move-result-object v2

    invoke-virtual {v2, v1}, Lqth;->E(Lyqe;)V
    ...
    invoke-static {v2, v3, v4}, Lld;->a(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Llth;)V
    ...
    invoke-virtual {p2, v1, v2}, Landroidx/work/impl/background/systemalarm/d;->d(Llth;Z)V
...
.method public o(Landroid/content/Intent;ILandroidx/work/impl/background/systemalarm/d;)V
    ...
    invoke-virtual {p1, p2, p3}, Lyn8;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p3, p1}, Lyn8;->k(Ljava/lang/String;Ljava/lang/String;)V
