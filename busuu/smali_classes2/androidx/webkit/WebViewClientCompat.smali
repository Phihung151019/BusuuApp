...
.method public final onReceivedError(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;Landroid/webkit/WebResourceError;)V
    ...
    invoke-direct {v0, p3}, Lanh;-><init>(Landroid/webkit/WebResourceError;)V

    invoke-virtual {p0, p1, p2, v0}, Landroidx/webkit/WebViewClientCompat;->onReceivedError(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;Lzmh;)V
...
.method public final onReceivedError(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;Ljava/lang/reflect/InvocationHandler;)V
    ...
    invoke-direct {v0, p3}, Lanh;-><init>(Ljava/lang/reflect/InvocationHandler;)V
...
.method public onReceivedError(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;Lzmh;)V
    .locals 1
    ...
    :cond_0
    invoke-static {p2}, Lmy;->b(Landroid/webkit/WebResourceRequest;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p3}, Lzmh;->b()I

    move-result v0

    invoke-virtual {p3}, Lzmh;->a()Ljava/lang/CharSequence;
    ...
    invoke-static {p2}, Lmy;->a(Landroid/webkit/WebResourceRequest;)Landroid/net/Uri;
...
.method public final onSafeBrowsingHit(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;ILandroid/webkit/SafeBrowsingResponse;)V
    ...
    invoke-direct {v0, p4}, Ls2d;-><init>(Landroid/webkit/SafeBrowsingResponse;)V

    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/webkit/WebViewClientCompat;->onSafeBrowsingHit(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;ILr2d;)V
...
.method public final onSafeBrowsingHit(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;ILjava/lang/reflect/InvocationHandler;)V
    ...
    invoke-direct {v0, p4}, Ls2d;-><init>(Ljava/lang/reflect/InvocationHandler;)V
...
.method public onSafeBrowsingHit(Landroid/webkit/WebView;Landroid/webkit/WebResourceRequest;ILr2d;)V
    .locals 0
    ...
    invoke-virtual {p4, p1}, Lr2d;->a(Z)V
