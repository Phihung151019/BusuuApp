...
.method public constructor <init>(Lfe;)V
    ...
    iput-object p1, p0, Landroidx/media3/exoplayer/source/s;->a:Lfe;

    invoke-interface {p1}, Lfe;->e()I
    ...
    iput-object v0, p0, Landroidx/media3/exoplayer/source/s;->c:Lgoa;
...
.method public static i(Landroidx/media3/exoplayer/source/s$a;JLjava/nio/ByteBuffer;I)Landroidx/media3/exoplayer/source/s$a;
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/source/s$a;->c:Lee;

    iget-object v1, v1, Lee;->a:[B
...
.method public static j(Landroidx/media3/exoplayer/source/s$a;J[BI)Landroidx/media3/exoplayer/source/s$a;
    ...
    iget-object v2, p0, Landroidx/media3/exoplayer/source/s$a;->c:Lee;

    iget-object v2, v2, Lee;->a:[B
...
.method public static k(Landroidx/media3/exoplayer/source/s$a;Landroidx/media3/decoder/DecoderInputBuffer;Landroidx/media3/exoplayer/source/t$b;Lgoa;)Landroidx/media3/exoplayer/source/s$a;
    .locals 18
    ...
    invoke-virtual {v1, v4}, Lgoa;->Q(I)V
    ...
    iget-object v9, v9, Landroidx/media3/decoder/DecoderInputBuffer;->c:Lz33;

    iget-object v10, v9, Lz33;->a:[B
    ...
    invoke-virtual {v1, v7}, Lgoa;->U(I)V
    ...
    :cond_8
    iget-object v1, v0, Landroidx/media3/exoplayer/source/t$b;->c:Lh7g$a;

    invoke-static {v1}, Lj4h;->i(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lh7g$a;

    iget-object v13, v1, Lh7g$a;->b:[B

    iget-object v14, v9, Lz33;->a:[B

    iget v15, v1, Lh7g$a;->a:I

    iget v4, v1, Lh7g$a;->c:I

    iget v1, v1, Lh7g$a;->d:I

    move/from16 v17, v1

    move/from16 v16, v4

    invoke-virtual/range {v9 .. v17}, Lz33;->c(I[I[I[B[BIII)V
...
.method public static l(Landroidx/media3/exoplayer/source/s$a;Landroidx/media3/decoder/DecoderInputBuffer;Landroidx/media3/exoplayer/source/t$b;Lgoa;)Landroidx/media3/exoplayer/source/s$a;
    .locals 5
    ...
    invoke-static {p0, p1, p2, p3}, Landroidx/media3/exoplayer/source/s;->k(Landroidx/media3/exoplayer/source/s$a;Landroidx/media3/decoder/DecoderInputBuffer;Landroidx/media3/exoplayer/source/t$b;Lgoa;)Landroidx/media3/exoplayer/source/s$a;
    ...
    invoke-virtual {p3, v0}, Lgoa;->Q(I)V

    iget-wide v1, p2, Landroidx/media3/exoplayer/source/t$b;->b:J

    invoke-virtual {p3}, Lgoa;->e()[B
    ...
    invoke-virtual {p1, p3}, Landroidx/media3/decoder/DecoderInputBuffer;->o(I)V
    ...
    invoke-virtual {p1, v0}, Landroidx/media3/decoder/DecoderInputBuffer;->s(I)V
...
.method public final a(Landroidx/media3/exoplayer/source/s$a;)V
    ...
    iget-object v0, p1, Landroidx/media3/exoplayer/source/s$a;->c:Lee;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/media3/exoplayer/source/s;->a:Lfe;

    invoke-interface {v0, p1}, Lfe;->c(Lfe$a;)V
...
.method public b(J)V
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/source/s;->a:Lfe;

    iget-object v0, v0, Landroidx/media3/exoplayer/source/s$a;->c:Lee;

    invoke-interface {v1, v0}, Lfe;->a(Lee;)V
...
.method public f(Landroidx/media3/decoder/DecoderInputBuffer;Landroidx/media3/exoplayer/source/t$b;)V
    ...
    iget-object v1, p0, Landroidx/media3/exoplayer/source/s;->c:Lgoa;

    invoke-static {v0, p1, p2, v1}, Landroidx/media3/exoplayer/source/s;->l(Landroidx/media3/exoplayer/source/s$a;Landroidx/media3/decoder/DecoderInputBuffer;Landroidx/media3/exoplayer/source/t$b;Lgoa;)Landroidx/media3/exoplayer/source/s$a;
...
.method public final h(I)I
    ...
    iget-object v1, v0, Landroidx/media3/exoplayer/source/s$a;->c:Lee;

    if-nez v1, :cond_0

    iget-object v1, p0, Landroidx/media3/exoplayer/source/s;->a:Lfe;

    invoke-interface {v1}, Lfe;->d()Lee;
    ...
    invoke-virtual {v0, v1, v2}, Landroidx/media3/exoplayer/source/s$a;->c(Lee;Landroidx/media3/exoplayer/source/s$a;)V
...
.method public p(Lm83;IZ)I
    ...
    invoke-interface {p1, v1, v0, p2}, Lm83;->read([BII)I
...
.method public q(Lgoa;I)V
    ...
    iget-object v2, v1, Landroidx/media3/exoplayer/source/s$a;->c:Lee;
    ...
    invoke-virtual {p1, v2, v1, v0}, Lgoa;->l([BII)V
