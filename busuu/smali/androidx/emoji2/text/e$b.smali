...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lni5;Landroidx/emoji2/text/e$a;)V
    .locals 1
    ...
    invoke-static {p2, v0}, Lubb;->g(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p2, p0, Landroidx/emoji2/text/e$b;->b:Lni5;
...
.method public c()V
    ...
    :try_start_1
    invoke-virtual {p0}, Landroidx/emoji2/text/e$b;->e()Lej5$b;

    move-result-object v0

    invoke-virtual {v0}, Lej5$b;->b()I
    ...
    invoke-static {v1}, Lu6g;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/emoji2/text/e$a;->a(Landroid/content/Context;Lej5$b;)Landroid/graphics/Typeface;

    move-result-object v1

    iget-object v2, p0, Landroidx/emoji2/text/e$b;->a:Landroid/content/Context;

    invoke-virtual {v0}, Lej5$b;->d()Landroid/net/Uri;

    move-result-object v0

    const/4 v3, 0x0

    invoke-static {v2, v3, v0}, Lugg;->e(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
...
.method public d()V
    ...
    invoke-static {v1}, Lra2;->b(Ljava/lang/String;)Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-direct {v2, p0}, Loi5;-><init>(Landroidx/emoji2/text/e$b;)V
...
.method public final e()Lej5$b;
    ...
    iget-object v2, p0, Landroidx/emoji2/text/e$b;->b:Lni5;

    invoke-virtual {v0, v1, v2}, Landroidx/emoji2/text/e$a;->b(Landroid/content/Context;Lni5;)Lej5$a;

    move-result-object v0
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v0}, Lej5$a;->e()I

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, Lej5$a;->c()[Lej5$b;
