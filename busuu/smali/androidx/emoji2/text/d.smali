...
.method public final f(Ljava/lang/CharSequence;IILwgg;)Z
    .locals 2

    invoke-virtual {p4}, Lwgg;->d()I
    ...
    invoke-virtual {p4, p1}, Lwgg;->m(Z)V
...
.method public j(Ljava/lang/CharSequence;IIIZ)Ljava/lang/CharSequence;
    ...
    invoke-direct {v2, p1}, Lqsg;-><init>(Ljava/lang/CharSequence;)V
    :try_end_0
    ...
    invoke-direct {v2, v3}, Lqsg;-><init>(Landroid/text/Spannable;)V
    :try_end_1
    ...
    :try_start_2
    invoke-virtual {v2, p2, p3, v0}, Lqsg;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;
    ...
    invoke-virtual {v2, v7}, Lqsg;->getSpanStart(Ljava/lang/Object;)I

    move-result v8

    invoke-virtual {v2, v7}, Lqsg;->getSpanEnd(Ljava/lang/Object;)I

    move-result v9

    if-eq v8, p3, :cond_4

    invoke-virtual {v2, v7}, Lqsg;->removeSpan(Ljava/lang/Object;)V
    ...
    :try_start_4
    invoke-virtual {v2}, Lqsg;->length()I

    move-result p2

    invoke-virtual {v2, v3, p2, v0}, Lqsg;->getSpans(IILjava/lang/Class;)[Ljava/lang/Object;
    ...
    invoke-direct {v8, v2, p2}, Landroidx/emoji2/text/d$b;-><init>(Lqsg;Landroidx/emoji2/text/c$j;)V
    :try_end_5
    ...
    invoke-virtual {p1}, Lqsg;->b()Landroid/text/Spannable;
...
.method public final k(Ljava/lang/CharSequence;IIIZLandroidx/emoji2/text/d$c;)Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroidx/emoji2/text/d$f;->c()Lwgg;

    move-result-object v6

    invoke-virtual {p0, p1, v1, p2, v6}, Landroidx/emoji2/text/d;->f(Ljava/lang/CharSequence;IILwgg;)Z
    ...
    invoke-interface {p6, p1, v1, p2, v5}, Landroidx/emoji2/text/d$c;->a(Ljava/lang/CharSequence;IILwgg;)Z
    ...
    invoke-virtual {v0}, Landroidx/emoji2/text/d$f;->b()Lwgg;

    move-result-object p3

    invoke-virtual {p0, p1, v1, p2, p3}, Landroidx/emoji2/text/d;->f(Ljava/lang/CharSequence;IILwgg;)Z
    ...
    invoke-interface {p6, p1, v1, p2, p3}, Landroidx/emoji2/text/d$c;->a(Ljava/lang/CharSequence;IILwgg;)Z
