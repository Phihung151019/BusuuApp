...
# instance fields
.field public p:Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;
...
.method public L2()V
    ...
    invoke-static {v0, p0}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->d(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;Lx34;)V
...
.method public final c3(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p0}, Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;->d(Landroidx/compose/foundation/lazy/layout/LazyLayoutItemAnimator;Lx34;)V
...
.method public z(Lsg2;)V
    ...
    invoke-virtual {v3}, Landroidx/compose/foundation/lazy/layout/b;->p()Lge6;
    ...
    invoke-static {v5, v6}, Loa7;->i(J)I
    ...
    invoke-static {v6, v7}, Loa7;->j(J)I

    move-result v3

    int-to-float v3, v3

    invoke-virtual {v4}, Lge6;->x()J

    move-result-wide v6

    invoke-static {v6, v7}, Loa7;->i(J)I
    ...
    invoke-interface {v6}, Ls34;->g()Le44;

    move-result-object v6

    invoke-interface {v6, v5, v3}, Le44;->b(FF)V

    :try_start_0
    invoke-static {p1, v4}, Lje6;->a(La44;Lge6;)V
    :try_end_0
    ...
    invoke-interface {v4}, Ls34;->g()Le44;
    ...
    invoke-interface {v4, v5, v3}, Le44;->b(FF)V
    ...
    invoke-interface {p1}, Ls34;->g()Le44;
    ...
    invoke-interface {p1, v1, v2}, Le44;->b(FF)V
