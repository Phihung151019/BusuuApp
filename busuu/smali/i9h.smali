...
.method public apply()V
    ...
    invoke-virtual {v4}, Landroidx/constraintlayout/core/state/a;->v()Landroidx/constraintlayout/core/state/a;
    ...
    iget-object v4, p0, Landroidx/constraintlayout/core/state/a;->S:Ljava/lang/Object;

    if-eqz v4, :cond_1

    invoke-virtual {v7, v4}, Landroidx/constraintlayout/core/state/a;->m0(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/a;

    move-result-object v4

    iget v8, p0, Landroidx/constraintlayout/core/state/a;->o:I

    invoke-virtual {v4, v8}, Landroidx/constraintlayout/core/state/a;->J(I)Landroidx/constraintlayout/core/state/a;

    move-result-object v4

    iget v8, p0, Landroidx/constraintlayout/core/state/a;->u:I
    ...
    :cond_1
    iget-object v4, p0, Landroidx/constraintlayout/core/state/a;->T:Ljava/lang/Object;

    if-eqz v4, :cond_2

    invoke-virtual {v7, v4}, Landroidx/constraintlayout/core/state/a;->l0(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/a;
    ...
    invoke-virtual {v7, v8}, Landroidx/constraintlayout/core/state/a;->m0(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/a;
    ...
    invoke-virtual {v3, v10}, Landroidx/constraintlayout/core/state/a;->q(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/a;
    ...
    invoke-virtual {v7, v3}, Landroidx/constraintlayout/core/state/a;->l0(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/a;
    ...
    invoke-virtual {v7, v3}, Landroidx/constraintlayout/core/state/a;->d0(F)V
    ...
    invoke-virtual {v3, v0}, Landroidx/constraintlayout/core/state/a;->q(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/a;
    ...
    invoke-virtual {v3, v0}, Landroidx/constraintlayout/core/state/a;->p(Ljava/lang/Object;)Landroidx/constraintlayout/core/state/a;
    ...
    invoke-virtual {v4, v0}, Landroidx/constraintlayout/core/state/a;->q0(F)Landroidx/constraintlayout/core/state/a;

    :cond_b
    sget-object v0, Li9h$a;->a:[I
    ...
    :cond_c
    invoke-virtual {v4, v2}, Landroidx/constraintlayout/core/state/a;->c0(I)V

    return-void

    :cond_d
    invoke-virtual {v4, v1}, Landroidx/constraintlayout/core/state/a;->c0(I)V
