...
.method public constructor <init>(Landroid/content/Context;Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;Lyvi;Ljava/lang/String;Ld9i;Lh0j;ZLcom/onetrust/otpublishers/headless/Public/DataModel/OTConfiguration;)V
    ...
    iput-object p1, p0, Lrmi;->c:Landroid/content/Context;

    iput-object p2, p0, Lrmi;->g:Ljava/util/ArrayList;

    iput-object p3, p0, Lrmi;->e:Ljava/lang/String;

    iput-object p4, p0, Lrmi;->d:Ljava/lang/String;

    iput-object p6, p0, Lrmi;->b:Ljava/lang/String;

    iput-object p5, p0, Lrmi;->l:Lyvi;

    iput-object p7, p0, Lrmi;->a:Ld9i;

    iput-object p8, p0, Lrmi;->f:Lh0j;

    iput-boolean p9, p0, Lrmi;->j:Z
    ...
    iput-object p2, p0, Lrmi;->h:Lyyi;

    iget-object p1, p0, Lrmi;->c:Landroid/content/Context;
    ...
    iget-object p2, p0, Lrmi;->h:Lyyi;

    iget-object p3, p0, Lrmi;->f:Lh0j;

    invoke-virtual {p2, p3, p1}, Lyyi;->c(Lh0j;I)Lpyi;

    move-result-object p1

    iput-object p1, p0, Lrmi;->i:Lpyi;
    :try_end_0
    ...
    :goto_0
    iput-object p10, p0, Lrmi;->k:Lcom/onetrust/otpublishers/headless/Public/DataModel/OTConfiguration;

    return-void
.end method

.method public static synthetic a(Lrmi;Lbqi;Lrmi$a;Landroid/view/View;)V
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lrmi;->c(Lbqi;Lrmi$a;Landroid/view/View;)V
...
.method public b(Lrmi$a;)V
    .locals 5

    iget-object v0, p0, Lrmi;->g:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lrmi;->l:Lyvi;

    iget-object v1, v1, Lyvi;->t:Lc6i;

    iget-object v1, v1, Lc6i;->c:Ljava/lang/String;

    iget-object v2, p0, Lrmi;->b:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p1, Lrmi$a;->b:Landroid/widget/TextView;

    iget-object v0, v0, Lr6i;->b:Ljava/lang/String;
    ...
    :cond_2
    iget-object v0, p1, Lrmi$a;->b:Landroid/widget/TextView;

    iget-object v2, p0, Lrmi;->l:Lyvi;
    ...
    :cond_3
    iget-object v0, p1, Lrmi$a;->a:Landroid/widget/TextView;

    iget-object v2, p0, Lrmi;->i:Lpyi;
    ...
    :cond_6
    iget-object v0, p0, Lrmi;->l:Lyvi;

    iget-object v0, v0, Lyvi;->g:Ljava/lang/String;

    iget-object v1, p0, Lrmi;->b:Ljava/lang/String;
    ...
    iget-object v1, p1, Lrmi$a;->a:Landroid/widget/TextView;

    invoke-static {v1, v0}, Lebi;->e(Landroid/widget/TextView;Ljava/lang/String;)V

    :cond_8
    iget-object v0, p0, Lrmi;->k:Lcom/onetrust/otpublishers/headless/Public/DataModel/OTConfiguration;
    ...
    iget-object v0, p1, Lrmi$a;->c:Landroid/widget/LinearLayout;

    new-instance v2, Ljmi;

    invoke-direct {v2, p0, v1, p1}, Ljmi;-><init>(Lrmi;Lbqi;Lrmi$a;)V
...
.method public final c(Lbqi;Lrmi$a;Landroid/view/View;)V
    .locals 2
    ...
    iget-object p2, p0, Lrmi;->b:Ljava/lang/String;
    ...
    iget-object p2, p0, Lrmi;->f:Lh0j;

    iput-object p2, p1, Lbqi;->I:Lh0j;

    iget-object p2, p0, Lrmi;->a:Ld9i;

    iput-object p2, p1, Lbqi;->B:Ld9i;

    iget-object p2, p0, Lrmi;->c:Landroid/content/Context;
...
.method public bridge synthetic onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$e0;I)V
    ...
    check-cast p1, Lrmi$a;

    invoke-virtual {p0, p1}, Lrmi;->b(Lrmi$a;)V
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$e0;
    ...
    invoke-direct {p2, p1}, Lrmi$a;-><init>(Landroid/view/View;)V
