...
.method public static i(Landroid/os/CancellationSignal;[Lej5$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
    ...
    :try_start_0
    invoke-virtual {v4}, Lej5$b;->d()Landroid/net/Uri;
...
.method public a(Landroid/content/Context;Lqi5$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Lqi5$d;->d()Ljava/lang/String;
    ...
    invoke-virtual {p0, p2, p4}, Lsgg;->h(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[Lej5$b;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p3, p1}, Lsgg;->i(Landroid/os/CancellationSignal;[Lej5$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-virtual {p0, p1, p4}, Lsgg;->h(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p2, v0, p1}, Lsgg;->i(Landroid/os/CancellationSignal;[Lej5$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    check-cast v4, [Lej5$b;

    invoke-static {p2, v4, p1}, Lsgg;->i(Landroid/os/CancellationSignal;[Lej5$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-virtual {p0, v0, p4}, Lsgg;->h(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public g([Lej5$b;I)Lej5$b;
    .locals 0
...
.method public final h(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Lsgg;->j(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Lsgg;->j(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
