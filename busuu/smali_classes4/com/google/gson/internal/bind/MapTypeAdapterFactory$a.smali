...
# direct methods
.method public constructor <init>(Lcom/google/gson/internal/bind/MapTypeAdapterFactory;Lcom/google/gson/Gson;Ljava/lang/reflect/Type;Lcom/google/gson/TypeAdapter;Ljava/lang/reflect/Type;Lcom/google/gson/TypeAdapter;Lby9;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p7, p0, Lcom/google/gson/internal/bind/MapTypeAdapterFactory$a;->c:Lby9;
...
.method public final e(Lwi7;)Ljava/lang/String;
    .locals 1
    ...
    invoke-virtual {p1}, Lwi7;->t()Lbk7;

    move-result-object p1

    invoke-virtual {p1}, Lbk7;->S()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Lbk7;->L()Ljava/lang/Number;
    ...
    :cond_0
    invoke-virtual {p1}, Lbk7;->N()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Lbk7;->h()Z
    ...
    :cond_1
    invoke-virtual {p1}, Lbk7;->T()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p1}, Lbk7;->x()Ljava/lang/String;
...
.method public f(Lcom/google/gson/stream/JsonReader;)Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/gson/internal/bind/MapTypeAdapterFactory$a;->c:Lby9;

    invoke-interface {v1}, Lby9;->construct()Ljava/lang/Object;
    ...
    sget-object v0, Lek7;->a:Lek7;

    invoke-virtual {v0, p1}, Lek7;->a(Lcom/google/gson/stream/JsonReader;)V
...
.method public g(Lcom/google/gson/stream/JsonWriter;Ljava/util/Map;)V
    ...
    invoke-virtual {v5, v6}, Lcom/google/gson/TypeAdapter;->c(Ljava/lang/Object;)Lwi7;
    ...
    invoke-virtual {v5}, Lwi7;->z()Z

    move-result v4

    if-nez v4, :cond_4

    invoke-virtual {v5}, Lwi7;->G()Z
    ...
    invoke-static {v3, p1}, Lbxe;->b(Lwi7;Lcom/google/gson/stream/JsonWriter;)V
    ...
    invoke-virtual {p0, v3}, Lcom/google/gson/internal/bind/MapTypeAdapterFactory$a;->e(Lwi7;)Ljava/lang/String;
