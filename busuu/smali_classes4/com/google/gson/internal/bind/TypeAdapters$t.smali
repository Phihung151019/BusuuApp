...
.method public bridge synthetic b(Lcom/google/gson/stream/JsonReader;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/google/gson/internal/bind/TypeAdapters$t;->e(Lcom/google/gson/stream/JsonReader;)Lwi7;
...
.method public bridge synthetic d(Lcom/google/gson/stream/JsonWriter;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/gson/internal/bind/TypeAdapters$t;->f(Lcom/google/gson/stream/JsonWriter;Lwi7;)V

    return-void
.end method

.method public e(Lcom/google/gson/stream/JsonReader;)Lwi7;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, v1, v2}, Lxj7;->I(Ljava/lang/String;Lwi7;)V
    ...
    invoke-virtual {v0, v1}, Lii7;->I(Lwi7;)V
    ...
    invoke-direct {v1, p1}, Llt7;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Lbk7;-><init>(Ljava/lang/Number;)V
...
.method public f(Lcom/google/gson/stream/JsonWriter;Lwi7;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-virtual {p2}, Lwi7;->H()Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-virtual {p2}, Lwi7;->t()Lbk7;

    move-result-object p2

    invoke-virtual {p2}, Lbk7;->S()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p2}, Lbk7;->L()Ljava/lang/Number;

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/google/gson/stream/JsonWriter;->C(Ljava/lang/Number;)Lcom/google/gson/stream/JsonWriter;

    return-void

    :cond_1
    invoke-virtual {p2}, Lbk7;->N()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p2}, Lbk7;->h()Z

    move-result p2

    invoke-virtual {p1, p2}, Lcom/google/gson/stream/JsonWriter;->E(Z)Lcom/google/gson/stream/JsonWriter;

    return-void

    :cond_2
    invoke-virtual {p2}, Lbk7;->x()Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/google/gson/stream/JsonWriter;->D(Ljava/lang/String;)Lcom/google/gson/stream/JsonWriter;

    return-void

    :cond_3
    invoke-virtual {p2}, Lwi7;->z()Z
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/gson/internal/bind/TypeAdapters$t;->f(Lcom/google/gson/stream/JsonWriter;Lwi7;)V
