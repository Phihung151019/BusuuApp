...
.method private h()V
    ...
    iget-object v0, p0, Lqp6;->k:Landroid/content/ContextWrapper;
    ...
    iput-object v0, p0, Lqp6;->k:Landroid/content/ContextWrapper;
...
.method public j()V
    ...
    iget-boolean v0, p0, Lqp6;->m:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lqp6;->m:Z
    ...
    invoke-interface {v0, v1}, Lhc6;->injectGrammarReviewTopicFragment(Lcc6;)V
