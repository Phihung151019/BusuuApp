...
.method public constructor <init>(I)V
    ...
    iput-object p1, p0, Lop6;->p:Ljava/lang/Object;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lop6;->q:Z
...
.method private Q()V
    ...
    iget-object v0, p0, Lop6;->m:Landroid/content/ContextWrapper;
    ...
    iput-object v0, p0, Lop6;->m:Landroid/content/ContextWrapper;
...
.method public R()V
    ...
    iget-boolean v0, p0, Lop6;->q:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lop6;->q:Z

    invoke-virtual {p0}, Lop6;->generatedComponent()Ljava/lang/Object;
    ...
    invoke-interface {v0, v1}, Lp86;->injectGrammarHighlighterExerciseFragment(Lo86;)V
...
.method public final componentManager()Lbl5;
    ...
    iget-object v0, p0, Lop6;->o:Lbl5;

    if-nez v0, :cond_1

    iget-object v0, p0, Lop6;->p:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lop6;->o:Lbl5;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lop6;->P()Lbl5;

    move-result-object v1

    iput-object v1, p0, Lop6;->o:Lbl5;
...
.method public bridge synthetic componentManager()Low5;
    ...
    invoke-virtual {p0}, Lop6;->componentManager()Lbl5;
