...
# direct methods
.method public constructor <init>(Lcom/busuu/domain/model/LanguageDomainModel;ZLua6;)V
    .locals 0

    iput-object p1, p0, Lua6$c;->a:Lcom/busuu/domain/model/LanguageDomainModel;

    iput-boolean p2, p0, Lua6$c;->b:Z

    iput-object p3, p0, Lua6$c;->c:Lua6;
...
.method public static synthetic a(Lua6;Z)Lqrg;
    .locals 0

    invoke-static {p0, p1}, Lua6$c;->b(Lua6;Z)Lqrg;
...
.method public static final b(Lua6;Z)Lqrg;
    .locals 11
    ...
    invoke-virtual {p0}, Lua6;->getAnalyticsSender()Lfg;

    move-result-object v0

    const-string v1, "ecommerce_origin"

    const-string v2, "grammar_review_banner"
    ...
    const-string v3, "grammar_review"
    ...
    const-string v4, "grammar_review_banner"
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lua6$c;->invoke(Landroidx/compose/runtime/Composer;I)V
...
.method public final invoke(Landroidx/compose/runtime/Composer;I)V
    ...
    iget-object v0, p0, Lua6$c;->a:Lcom/busuu/domain/model/LanguageDomainModel;
    ...
    iget-boolean v0, p0, Lua6$c;->b:Z

    if-eqz v0, :cond_2

    sget v1, Ls6c;->grammar_review_banner_free_tries_title:I
    ...
    :cond_2
    sget v1, Ls6c;->grammar_review_banner_no_free_tries_title:I
    ...
    sget v1, Ls6c;->grammar_review_banner_free_tries_body:I
    ...
    :cond_3
    sget v1, Ls6c;->grammar_review_banner_no_free_tries_body:I
    ...
    iget-object p2, p0, Lua6$c;->c:Lua6;

    invoke-virtual {p2}, Lua6;->getPresenter()Lhb6;

    move-result-object p2

    invoke-virtual {p2}, Lhb6;->getGrammarReviewAttempts()Ltma;
    ...
    invoke-direct {v7, p2, v0}, Lxa6;-><init>(Lua6;Z)V
