...
.method public createPrimaryFeedback()Leu;
    ...
    invoke-virtual {p0}, Loeg;->getExercise()Lskg;

    move-result-object v1

    invoke-virtual {v1}, Lskg;->hasNotes()Z

    move-result v1

    if-eqz v1, :cond_0

    sget v1, Lr6c;->feedback_notes_subtitle:I
    ...
    invoke-virtual {v2}, Lskg;->getNotes()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lbkg;->getCorrectAnswerNote()Ljava/lang/String;
...
.method public getExercise()Lskg;
    .locals 1

    iget-object v0, p0, Loeg;->b:Lskg;
