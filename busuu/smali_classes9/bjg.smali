...
.method public constructor <init>(Ljava/io/InputStream;)V
    ...
    iput-object v0, p0, Lbjg;->d:Ljava/util/concurrent/ConcurrentNavigableMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lbjg;->e:Ljava/util/Set;

    :try_start_0
    invoke-virtual {p0, p1}, Lbjg;->h(Ljava/io/InputStream;)Z
    :try_end_0
...
# virtual methods
.method public d(Ljava/lang/String;Z)Lbxh;
    .locals 2

    const-string p2, "zoneId"

    invoke-static {p1, p2}, Llh7;->i(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    iget-object p2, p0, Lbjg;->d:Ljava/util/concurrent/ConcurrentNavigableMap;
    ...
    check-cast p2, Lbjg$a;

    invoke-virtual {p2, p1}, Lbjg$a;->c(Ljava/lang/String;)Lbxh;
...
.method public e()Ljava/util/Set;
    ...
    iget-object v1, p0, Lbjg;->c:Ljava/util/List;
...
.method public final h(Ljava/io/InputStream;)Z
    ...
    invoke-virtual {p0, p1}, Lbjg;->i(Ljava/io/InputStream;)Ljava/lang/Iterable;
    ...
    iget-object v1, p0, Lbjg;->d:Ljava/util/concurrent/ConcurrentNavigableMap;

    invoke-static {v0}, Lbjg$a;->a(Lbjg$a;)Ljava/lang/String;
    ...
    check-cast v1, Lbjg$a;

    if-eqz v1, :cond_1

    invoke-static {v1}, Lbjg$a;->a(Lbjg$a;)Ljava/lang/String;
...
.method public final i(Ljava/io/InputStream;)Ljava/lang/Iterable;
    ...
    iput-object v3, p0, Lbjg;->c:Ljava/util/List;
    ...
    :cond_3
    new-instance v7, Lbjg$a;

    aget-object v10, v1, v6

    invoke-direct {v7, v10, v8, v9, v3}, Lbjg$a;-><init>(Ljava/lang/String;[Ljava/lang/String;[SLjava/util/concurrent/atomic/AtomicReferenceArray;)V
