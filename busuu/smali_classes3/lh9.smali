...
.method public constructor <init>(Lex;Llg6;Lacg;)V
    ...
    iput-object p1, p0, Llh9;->a:Lex;

    iput-object p2, p0, Llh9;->b:Llg6;

    iput-object p3, p0, Llh9;->c:Lacg;
...
.method public lowerToUpperLayer(Lcom/busuu/android/api/course/model/ApiComponent;)Lf12;
    ...
    invoke-virtual {v0}, Lcom/busuu/android/api/course/model/ApiExerciseContent;->getDistractorEntities()Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Llh9;->a:Lex;

    invoke-virtual {v0}, Lcom/busuu/android/api/course/model/ApiExerciseContent;->getProblemEntity()Ljava/lang/String;
    ...
    sget-object v12, Lcom/busuu/legacy_domain_model/DisplayLanguage;->INTERFACE:Lcom/busuu/legacy_domain_model/DisplayLanguage;

    invoke-static {v13}, Lve7;->d(Ljava/lang/Object;)V

    invoke-direct/range {v6 .. v13}, Lkz8;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/busuu/android/common/course/enums/ComponentType;Lah4;Ljava/util/List;Lcom/busuu/legacy_domain_model/DisplayLanguage;Lzbg;)V

    invoke-static {v10}, Lys1;->e(Ljava/lang/Object;)Ljava/util/List;

    move-result-object p1

    invoke-virtual {v6, p1}, Lf12;->setEntities(Ljava/util/List;)V

    iget-object p1, p0, Llh9;->b:Llg6;

    invoke-virtual {p1, v0}, Llg6;->toJson(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v6, p1}, Lf12;->setContentOriginalJson(Ljava/lang/String;)V
...
.method public bridge synthetic lowerToUpperLayer(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Llh9;->lowerToUpperLayer(Lcom/busuu/android/api/course/model/ApiComponent;)Lf12;
...
.method public bridge synthetic upperToLowerLayer(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Llh9;->upperToLowerLayer(Lf12;)Lcom/busuu/android/api/course/model/ApiComponent;
