...
.method public b()V
    ...
    invoke-virtual {p0}, Loq6;->generatedComponent()Ljava/lang/Object;
    ...
    check-cast v1, Lcom/busuu/android/base_ui/view/NextUpButton;

    invoke-interface {v0, v1}, Los9;->injectNextUpButton(Lcom/busuu/android/base_ui/view/NextUpButton;)V
...
.method public final componentManager()Lnbh;
    ...
    iget-object v0, p0, Loq6;->a:Lnbh;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Loq6;->a()Lnbh;

    move-result-object v0

    iput-object v0, p0, Loq6;->a:Lnbh;
...
.method public bridge synthetic componentManager()Low5;
    ...
    invoke-virtual {p0}, Loq6;->componentManager()Lnbh;
