...
.method private dispatchMessage(Landroid/content/Intent;)V
    ...
    invoke-direct {v3, p0, v1, v2}, Laz3;-><init>(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/util/concurrent/ExecutorService;)V

    :try_start_0
    invoke-virtual {v3}, Laz3;->a()Z
    ...
    invoke-virtual {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessagingService;->onMessageReceived(Lcom/google/firebase/messaging/d;)V
...
.method private getRpc(Landroid/content/Context;)Lf0d;
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->rpc:Lf0d;
    ...
    invoke-direct {v0, p1}, Lf0d;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->rpc:Lf0d;

    :cond_0
    iget-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->rpc:Lf0d;
...
.method private handleMessageIntent(Landroid/content/Intent;)V
    ...
    :cond_0
    invoke-direct {p0, p0}, Lcom/google/firebase/messaging/FirebaseMessagingService;->getRpc(Landroid/content/Context;)Lf0d;

    move-result-object v0

    new-instance v1, Lhr1;

    invoke-direct {v1, p1}, Lhr1;-><init>(Landroid/content/Intent;)V

    invoke-virtual {v0, v1}, Lf0d;->b(Lhr1;)Lcom/google/android/gms/tasks/Task;
...
.method public getStartCommandIntent(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {p1}, Lbpd;->c()Landroid/content/Intent;
...
.method public setRpcForTesting(Lf0d;)V
    .locals 0

    iput-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->rpc:Lf0d;
