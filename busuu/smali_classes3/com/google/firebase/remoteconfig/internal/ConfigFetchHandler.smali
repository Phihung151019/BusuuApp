...
.method public constructor <init>(Ls65;Ltsb;Ljava/util/concurrent/Executor;Lmq1;Ljava/util/Random;Lfb2;Lcom/google/firebase/remoteconfig/internal/ConfigFetchHttpClient;Lcom/google/firebase/remoteconfig/internal/d;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->a:Ls65;

    iput-object p2, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->b:Ltsb;

    iput-object p3, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->c:Ljava/util/concurrent/Executor;

    iput-object p4, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->d:Lmq1;

    iput-object p5, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->e:Ljava/util/Random;

    iput-object p6, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->f:Lfb2;
    ...
    iput-object p8, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->h:Lcom/google/firebase/remoteconfig/internal/d;
...
.method public static synthetic c(Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;Ljava/util/Date;Lcom/google/android/gms/tasks/Task;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {p0, p2, p1}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->x(Lcom/google/android/gms/tasks/Task;Ljava/util/Date;)V
...
.method public final f(JLjava/util/Date;)Z
    ...
    iget-object v0, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->h:Lcom/google/firebase/remoteconfig/internal/d;

    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/internal/d;->f()Ljava/util/Date;

    move-result-object v0

    sget-object v1, Lcom/google/firebase/remoteconfig/internal/d;->f:Ljava/util/Date;
...
.method public i()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/internal/d;->h()J
...
.method public j(J)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {v2}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler$FetchType;->b()Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->f:Lfb2;
    ...
    invoke-direct {v3, p0, p1, p2, v0}, Lgb2;-><init>(Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;JLjava/util/Map;)V
...
.method public final k(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Map;)Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler$a;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/internal/d;->e()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/google/firebase/remoteconfig/internal/d;->b()Ljava/util/Map;
    ...
    iget-object p2, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->h:Lcom/google/firebase/remoteconfig/internal/d;
    ...
    invoke-virtual {p2, p3, p4}, Lcom/google/firebase/remoteconfig/internal/d;->n(J)V
    ...
    invoke-virtual {p2, p3}, Lcom/google/firebase/remoteconfig/internal/d;->m(Ljava/lang/String;)V

    :cond_1
    iget-object p2, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->h:Lcom/google/firebase/remoteconfig/internal/d;

    invoke-virtual {p2}, Lcom/google/firebase/remoteconfig/internal/d;->j()V
    :try_end_1
    ...
    invoke-virtual {p0, p2, v9}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->v(ILjava/util/Date;)Lcom/google/firebase/remoteconfig/internal/d$a;
    ...
    invoke-virtual {p0, p2, p3}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->u(Lcom/google/firebase/remoteconfig/internal/d$a;I)Z
...
.method public final l(Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;Ljava/util/Map;)Lcom/google/android/gms/tasks/Task;
    ...
    :cond_0
    iget-object p2, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->f:Lfb2;

    invoke-virtual {p1}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler$a;->d()Lcom/google/firebase/remoteconfig/internal/b;

    move-result-object p3

    invoke-virtual {p2, p3}, Lfb2;->i(Lcom/google/firebase/remoteconfig/internal/b;)Lcom/google/android/gms/tasks/Task;

    move-result-object p2

    iget-object p3, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->c:Ljava/util/concurrent/Executor;

    new-instance p4, Lkb2;

    invoke-direct {p4, p1}, Lkb2;-><init>(Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler$a;)V
...
.method public final m(Lcom/google/android/gms/tasks/Task;JLjava/util/Map;)Lcom/google/android/gms/tasks/Task;
    ...
    iget-object v0, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->d:Lmq1;
    ...
    invoke-virtual {p0, p2, p3, v4}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->f(JLjava/util/Date;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-static {v4}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler$a;->c(Ljava/util/Date;)Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler$a;
    ...
    :cond_0
    invoke-virtual {p0, v4}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->o(Ljava/util/Date;)Ljava/util/Date;
    ...
    :cond_1
    iget-object p1, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->a:Ls65;

    invoke-interface {p1}, Ls65;->getId()Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct/range {v0 .. v5}, Lhb2;-><init>(Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;Lcom/google/android/gms/tasks/Task;Lcom/google/android/gms/tasks/Task;Ljava/util/Date;Ljava/util/Map;)V
    ...
    :goto_0
    iget-object p2, v1, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->c:Ljava/util/concurrent/Executor;

    new-instance p3, Lib2;

    invoke-direct {p3, p0, v4}, Lib2;-><init>(Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;Ljava/util/Date;)V
...
.method public n(Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler$FetchType;I)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {p1}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler$FetchType;->b()Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->f:Lfb2;
    ...
    invoke-direct {v1, p0, v0}, Ljb2;-><init>(Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;Ljava/util/Map;)V
...
.method public final p()Ljava/lang/Long;
    ...
    iget-object v0, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->b:Ltsb;
    ...
    invoke-interface {v0, v1}, Lnf;->f(Z)Ljava/util/Map;
...
.method public final s()Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->b:Ltsb;

    invoke-interface {v1}, Ltsb;->get()Ljava/lang/Object;
    ...
    invoke-interface {v1, v2}, Lnf;->f(Z)Ljava/util/Map;
...
.method public final u(Lcom/google/firebase/remoteconfig/internal/d$a;I)Z
    .locals 1
...
.method public final v(ILjava/util/Date;)Lcom/google/firebase/remoteconfig/internal/d$a;
    .locals 0
    ...
    invoke-virtual {p0, p2}, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->w(Ljava/util/Date;)V

    :cond_0
    iget-object p1, p0, Lcom/google/firebase/remoteconfig/internal/ConfigFetchHandler;->h:Lcom/google/firebase/remoteconfig/internal/d;
...
.method public final w(Ljava/util/Date;)V
    ...
    invoke-virtual {p1, v0, v3}, Lcom/google/firebase/remoteconfig/internal/d;->l(ILjava/util/Date;)V
...
.method public final x(Lcom/google/android/gms/tasks/Task;Ljava/util/Date;)V
    ...
    invoke-virtual {p1, p2}, Lcom/google/firebase/remoteconfig/internal/d;->r(Ljava/util/Date;)V
    ...
    invoke-virtual {p1}, Lcom/google/firebase/remoteconfig/internal/d;->s()V
