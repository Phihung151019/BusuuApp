...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lzv1;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static a(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;
    ...
    invoke-static {p2, p1, p3}, Lzv1;->f(Ljava/lang/String;Lcom/google/firebase/messaging/c;Landroid/content/pm/PackageManager;)Landroid/content/Intent;
    ...
    invoke-static {p1}, Lzv1;->q(Lcom/google/firebase/messaging/c;)Z
    ...
    :cond_1
    invoke-static {}, Lzv1;->g()I

    move-result p1

    const/high16 p3, 0x40000000    # 2.0f

    invoke-static {p3}, Lzv1;->l(I)I
...
.method public static b(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;)Landroid/app/PendingIntent;
    ...
    invoke-static {p2}, Lzv1;->q(Lcom/google/firebase/messaging/c;)Z
    ...
    invoke-static {p0, p1, p2}, Lzv1;->c(Landroid/content/Context;Landroid/content/Context;Landroid/content/Intent;)Landroid/app/PendingIntent;
...
.method public static d(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/os/Bundle;)Lzv1$a;
    .locals 5
    ...
    invoke-direct {v3, p1, p3}, Lvu9$e;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, p3}, Lvu9$e;->n(Ljava/lang/CharSequence;)Lvu9$e;

    new-instance v4, Lvu9$c;

    invoke-direct {v4}, Lvu9$c;-><init>()V

    invoke-virtual {v4, p3}, Lvu9$c;->a(Ljava/lang/CharSequence;)Lvu9$c;

    move-result-object p3

    invoke-virtual {v3, p3}, Lvu9$e;->G(Lvu9$j;)Lvu9$e;
    ...
    invoke-static {v2, v1, v0, p3, p4}, Lzv1;->m(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I

    move-result p3

    invoke-virtual {v3, p3}, Lvu9$e;->E(I)Lvu9$e;

    invoke-static {v0, p2, v1}, Lzv1;->n(Ljava/lang/String;Lcom/google/firebase/messaging/c;Landroid/content/res/Resources;)Landroid/net/Uri;

    move-result-object p3

    if-eqz p3, :cond_2

    invoke-virtual {v3, p3}, Lvu9$e;->F(Landroid/net/Uri;)Lvu9$e;

    :cond_2
    invoke-static {p0, p2, v0, v2}, Lzv1;->a(Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/content/pm/PackageManager;)Landroid/app/PendingIntent;

    move-result-object p3

    invoke-virtual {v3, p3}, Lvu9$e;->m(Landroid/app/PendingIntent;)Lvu9$e;

    invoke-static {p0, p1, p2}, Lzv1;->b(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;)Landroid/app/PendingIntent;

    move-result-object p0

    if-eqz p0, :cond_3

    invoke-virtual {v3, p0}, Lvu9$e;->s(Landroid/app/PendingIntent;)Lvu9$e;
    ...
    invoke-static {p1, p0, p4}, Lzv1;->h(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    invoke-virtual {v3, p0}, Lvu9$e;->l(I)Lvu9$e;
    ...
    invoke-virtual {v3, p0}, Lvu9$e;->i(Z)Lvu9$e;
    ...
    invoke-virtual {v3, p0}, Lvu9$e;->w(Z)Lvu9$e;
    ...
    invoke-virtual {v3, p0}, Lvu9$e;->I(Ljava/lang/CharSequence;)Lvu9$e;
    ...
    invoke-virtual {v3, p0}, Lvu9$e;->z(I)Lvu9$e;
    ...
    invoke-virtual {v3, p0}, Lvu9$e;->K(I)Lvu9$e;
    ...
    invoke-virtual {v3, p0}, Lvu9$e;->x(I)Lvu9$e;
    ...
    invoke-virtual {v3, p1}, Lvu9$e;->D(Z)Lvu9$e;

    invoke-virtual {p0}, Ljava/lang/Long;->longValue()J

    move-result-wide p3

    invoke-virtual {v3, p3, p4}, Lvu9$e;->L(J)Lvu9$e;
    ...
    invoke-virtual {v3, p0}, Lvu9$e;->J([J)Lvu9$e;
    ...
    invoke-virtual {v3, p4, p1, p0}, Lvu9$e;->v(III)Lvu9$e;

    :cond_b
    invoke-static {p2}, Lzv1;->i(Lcom/google/firebase/messaging/c;)I

    move-result p0

    invoke-virtual {v3, p0}, Lvu9$e;->r(I)Lvu9$e;

    new-instance p0, Lzv1$a;

    invoke-static {p2}, Lzv1;->o(Lcom/google/firebase/messaging/c;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, v3, p1, p3}, Lzv1$a;-><init>(Lvu9$e;Ljava/lang/String;I)V

    return-object p0
.end method

.method public static e(Landroid/content/Context;Lcom/google/firebase/messaging/c;)Lzv1$a;
    .locals 2
    ...
    invoke-static {v0, v1}, Lzv1;->j(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    invoke-static {p0, v1, v0}, Lzv1;->k(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;

    move-result-object v1

    invoke-static {p0, p0, p1, v1, v0}, Lzv1;->d(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/c;Ljava/lang/String;Landroid/os/Bundle;)Lzv1$a;
...
.method public static g()I
    ...
    sget-object v0, Lzv1;->a:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public static m(Landroid/content/pm/PackageManager;Landroid/content/res/Resources;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    invoke-static {p1, v0}, Lzv1;->p(Landroid/content/res/Resources;I)Z
    ...
    invoke-static {v1, p3}, Lcom/newrelic/agent/android/instrumentation/LogInstrumentation;->w(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {p1, p3}, Lzv1;->p(Landroid/content/res/Resources;I)Z
