...
.method public bridge synthetic a(Ljava/lang/Object;IILzaa;)Lxoc;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lgpc;->c(Landroid/net/Uri;IILzaa;)Lxoc;
...
.method public bridge synthetic b(Ljava/lang/Object;Lzaa;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lgpc;->h(Landroid/net/Uri;Lzaa;)Z
...
.method public c(Landroid/net/Uri;IILzaa;)Lxoc;
    ...
    invoke-virtual {p0, p1, p2}, Lgpc;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    invoke-virtual {p0, p2, p1}, Lgpc;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    iget-object p3, p0, Lgpc;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Lj44;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    iget-object p1, p0, Lgpc;->a:Landroid/content/Context;
...
.method public final g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-virtual {p0, p1, p2}, Lgpc;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-virtual {p0, p2}, Lgpc;->e(Landroid/net/Uri;)I
...
.method public h(Landroid/net/Uri;Lzaa;)Z
    .locals 0
