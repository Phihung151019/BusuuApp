...
.method public constructor <init>(Lex;Llg6;Lacg;)V
    ...
    iput-object p1, p0, Llbg;->a:Lex;

    iput-object p2, p0, Llbg;->b:Llg6;

    iput-object p3, p0, Llbg;->c:Lacg;
...
.method public lowerToUpperLayer(Lcom/busuu/android/api/course/model/ApiComponent;)Lf12;
    ...
    invoke-direct {v0, v1, v2}, Lkbg;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, "null cannot be cast to non-null type com.busuu.android.api.course.model.ApiTranslationExerciseContent"

    invoke-static {v1, v2}, Lve7;->e(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast v1, Lcom/busuu/android/api/course/model/ApiTranslationExerciseContent;

    invoke-virtual {v1}, Lcom/busuu/android/api/course/model/ApiExerciseContent;->getEntityId()Ljava/lang/String;

    move-result-object v2

    iget-object v3, p0, Llbg;->a:Lex;
    ...
    invoke-virtual {v1}, Lcom/busuu/android/api/course/model/ApiTranslationExerciseContent;->getInstructionsMonolingualId()Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lkbg;->setMonolingualInstruction(Lzbg;)V

    invoke-virtual {v1}, Lcom/busuu/android/api/course/model/ApiTranslationExerciseContent;->getShowEntityAudio()Z

    move-result p1

    invoke-virtual {v0, p1}, Lkbg;->setShowEntityAudio(Z)V

    invoke-virtual {v1}, Lcom/busuu/android/api/course/model/ApiTranslationExerciseContent;->getShowEntityImage()Z

    move-result p1

    invoke-virtual {v0, p1}, Lkbg;->setShowEntityImage(Z)V

    invoke-virtual {v1}, Lcom/busuu/android/api/course/model/ApiTranslationExerciseContent;->getShowEntityText()Z

    move-result p1

    invoke-virtual {v0, p1}, Lkbg;->setShowEntityText(Z)V

    invoke-virtual {v1}, Lcom/busuu/android/api/course/model/ApiTranslationExerciseContent;->getSubType()Ljava/lang/String;

    move-result-object p1

    invoke-static {p1}, Lmbg;->mapTypingExerciseType(Ljava/lang/String;)Lcom/busuu/android/common/course/model/TypingExerciseType;

    move-result-object p1

    invoke-virtual {v0, p1}, Lkbg;->setSubType(Lcom/busuu/android/common/course/model/TypingExerciseType;)V

    iget-object p1, p0, Llbg;->b:Llg6;
...
.method public bridge synthetic lowerToUpperLayer(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Llbg;->lowerToUpperLayer(Lcom/busuu/android/api/course/model/ApiComponent;)Lf12;
...
.method public bridge synthetic upperToLowerLayer(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Llbg;->upperToLowerLayer(Lf12;)Ljava/lang/Void;
