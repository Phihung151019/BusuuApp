...
.method public constructor <init>(Lcom/google/gson/Gson;Lac3;Ldcg;)V
    ...
    iput-object p1, p0, Lea2;->a:Lcom/google/gson/Gson;

    iput-object p2, p0, Lea2;->b:Lac3;

    iput-object p3, p0, Lea2;->c:Ldcg;
...
.method public final lowerToUpperLayer(Lvn4;Ljava/util/List;)Lf12;
    ...
    iget-object v1, p0, Lea2;->a:Lcom/google/gson/Gson;
    ...
    invoke-virtual {p1}, Lda3;->getEntityId()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lea2;->b:Lac3;

    invoke-interface {v2, v1, p2}, Lac3;->loadEntity(Ljava/lang/String;Ljava/util/List;)Lah4;
    ...
    iget-object v1, p0, Lea2;->c:Ldcg;

    invoke-virtual {p1}, Lda3;->getTitleTranslationId()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lfa2;->setTitle(Lzbg;)V

    iget-object v1, p0, Lea2;->c:Ldcg;

    invoke-virtual {p1}, Lda3;->getContentProviderId()Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lfa2;->setContentProvider(Lzbg;)V

    iget-object v1, p0, Lea2;->c:Ldcg;

    invoke-virtual {p1}, Lda3;->getInstructions()Ljava/lang/String;
    ...
    invoke-virtual {v0, p2}, Lhn4;->setInstructions(Lzbg;)V

    iget-object p2, p0, Lea2;->a:Lcom/google/gson/Gson;
