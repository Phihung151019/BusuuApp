...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "grammarMCQExercise",
        "upperToLowerLayer",
        "(Lcom/busuu/android/common/course/model/grammar/GrammarMCQExercise;)Lcom/busuu/android/api/course/model/ApiComponent;",
        "apiComponent",
        "lowerToUpperLayer",
        "(Lcom/busuu/android/api/course/model/ApiComponent;)Lcom/busuu/android/common/course/model/grammar/GrammarMCQExercise;",
        "a",
        "Lex;",
        "b",
        "Lacg;",
...
.method public constructor <init>(Lex;Lacg;Llg6;)V
    ...
    iput-object p1, p0, Lz86;->a:Lex;

    iput-object p2, p0, Lz86;->b:Lacg;

    iput-object p3, p0, Lz86;->c:Llg6;
...
# virtual methods
.method public lowerToUpperLayer(Lcom/busuu/android/api/course/model/ApiComponent;)Lcom/busuu/android/common/course/model/grammar/GrammarMCQExercise;
    .locals 12
    ...
    invoke-virtual {v1, v6, v7, v8}, Lex;->mapApiToDomainEntity(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;)Lah4;
    ...
    invoke-virtual {v1, v7, v8, v9}, Lex;->mapApiToDomainEntities(Ljava/util/List;Ljava/util/Map;Ljava/util/Map;)Ljava/util/List;

    move-result-object v7

    iget-object v1, p0, Lz86;->b:Lacg;
    ...
    invoke-virtual {v1, v8, p1}, Lacg;->lowerToUpperLayer(Ljava/lang/String;Ljava/util/Map;)Lzbg;

    move-result-object v8

    invoke-static {v5}, Lcom/busuu/android/common/course/model/grammar/GrammarMCQExercise$ExerciseType;->fromComponentType(Lcom/busuu/android/common/course/enums/ComponentType;)Lcom/busuu/android/common/course/model/grammar/GrammarMCQExercise$ExerciseType;

    move-result-object v9

    sget-object v10, Lcom/busuu/legacy_domain_model/DisplayLanguage;->COURSE:Lcom/busuu/legacy_domain_model/DisplayLanguage;
...
.method public bridge synthetic lowerToUpperLayer(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lz86;->lowerToUpperLayer(Lcom/busuu/android/api/course/model/ApiComponent;)Lcom/busuu/android/common/course/model/grammar/GrammarMCQExercise;
...
.method public upperToLowerLayer(Lcom/busuu/android/common/course/model/grammar/GrammarMCQExercise;)Lcom/busuu/android/api/course/model/ApiComponent;
    .locals 1

    const-string v0, "grammarMCQExercise"
...
.method public bridge synthetic upperToLowerLayer(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast p1, Lcom/busuu/android/common/course/model/grammar/GrammarMCQExercise;

    invoke-virtual {p0, p1}, Lz86;->upperToLowerLayer(Lcom/busuu/android/common/course/model/grammar/GrammarMCQExercise;)Lcom/busuu/android/api/course/model/ApiComponent;
