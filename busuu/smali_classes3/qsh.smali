...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {}, Lqsh;->a()Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    move-result-object v0

    invoke-direct {p0, p1, p2, v0}, Lqsh;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object v0, p0, Lqsh;->d:Ljava/util/Queue;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lqsh;->f:Z

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Lqsh;->a:Landroid/content/Context;
    ...
    iput-object p1, p0, Lqsh;->b:Landroid/content/Intent;

    iput-object p3, p0, Lqsh;->c:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final b()V
    ...
    :goto_0
    iget-object v0, p0, Lqsh;->d:Ljava/util/Queue;
    ...
    check-cast v0, Lqsh$a;

    invoke-virtual {v0}, Lqsh$a;->d()V
...
.method public final declared-synchronized c()V
    ...
    iget-object v2, p0, Lqsh;->e:Lnsh;

    invoke-virtual {v2, v0}, Lnsh;->b(Lqsh$a;)V

    goto :goto_0

    :cond_3
    invoke-virtual {p0}, Lqsh;->e()V
    :try_end_0
...
.method public declared-synchronized d(Landroid/content/Intent;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v0, p1}, Lqsh$a;-><init>(Landroid/content/Intent;)V

    iget-object p1, p0, Lqsh;->c:Ljava/util/concurrent/ScheduledExecutorService;

    invoke-virtual {v0, p1}, Lqsh$a;->c(Ljava/util/concurrent/ScheduledExecutorService;)V

    iget-object p1, p0, Lqsh;->d:Ljava/util/Queue;

    invoke-interface {p1, v0}, Ljava/util/Queue;->add(Ljava/lang/Object;)Z

    invoke-virtual {p0}, Lqsh;->c()V

    invoke-virtual {v0}, Lqsh$a;->e()Lcom/google/android/gms/tasks/Task;
...
.method public final e()V
    ...
    iget-object v2, p0, Lqsh;->a:Landroid/content/Context;

    iget-object v3, p0, Lqsh;->b:Landroid/content/Intent;

    const/16 v4, 0x41

    invoke-virtual {v0, v2, v3, p0, v4}, Lfd2;->a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
...
.method public declared-synchronized onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-boolean p1, p0, Lqsh;->f:Z

    instance-of p1, p2, Lnsh;
