...
.method public constructor <init>(Lex;Llg6;Lacg;)V
    ...
    iput-object p1, p0, Lcme;->a:Lex;

    iput-object p2, p0, Lcme;->b:Llg6;

    iput-object p3, p0, Lcme;->c:Lacg;
...
.method public lowerToUpperLayer(Lcom/busuu/android/api/course/model/ApiComponent;)Lf12;
    ...
    invoke-direct {v1, v2, v3}, Lbme;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p0, Lcme;->a:Lex;

    invoke-virtual {v0}, Lcom/busuu/android/api/course/model/ApiExerciseContent;->getQuestion()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lbme;->setQuestion(Lah4;)V

    iget-object v3, p0, Lcme;->b:Llg6;

    invoke-virtual {v3, v0}, Llg6;->toJson(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1, v3}, Lf12;->setContentOriginalJson(Ljava/lang/String;)V

    iget-object v3, p0, Lcme;->c:Lacg;
    ...
    invoke-virtual {v3, v0, p1}, Lacg;->lowerToUpperLayer(Ljava/lang/String;Ljava/util/Map;)Lzbg;
...
.method public bridge synthetic lowerToUpperLayer(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcme;->lowerToUpperLayer(Lcom/busuu/android/api/course/model/ApiComponent;)Lf12;
...
.method public bridge synthetic upperToLowerLayer(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcme;->upperToLowerLayer(Lf12;)Lcom/busuu/android/api/course/model/ApiComponent;
