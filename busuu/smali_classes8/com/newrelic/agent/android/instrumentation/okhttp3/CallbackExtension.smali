...
.method public constructor <init>(Lqb1;Lcom/newrelic/agent/android/instrumentation/TransactionState;Lcom/newrelic/agent/android/instrumentation/okhttp3/CallExtension;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/newrelic/agent/android/instrumentation/okhttp3/CallbackExtension;->impl:Lqb1;
...
.method public onFailure(Lhb1;Ljava/io/IOException;)V
    ...
    iget-object p1, p0, Lcom/newrelic/agent/android/instrumentation/okhttp3/CallbackExtension;->impl:Lqb1;
    ...
    invoke-interface {p1, v0, p2}, Lqb1;->onFailure(Lhb1;Ljava/io/IOException;)V
...
.method public onResponse(Lhb1;Lokhttp3/n;)V
    ...
    invoke-direct {p0, p2}, Lcom/newrelic/agent/android/instrumentation/okhttp3/CallbackExtension;->checkResponse(Lokhttp3/n;)Lokhttp3/n;

    move-result-object p1

    iget-object p2, p0, Lcom/newrelic/agent/android/instrumentation/okhttp3/CallbackExtension;->impl:Lqb1;

    iget-object v0, p0, Lcom/newrelic/agent/android/instrumentation/okhttp3/CallbackExtension;->callExtension:Lcom/newrelic/agent/android/instrumentation/okhttp3/CallExtension;

    invoke-interface {p2, v0, p1}, Lqb1;->onResponse(Lhb1;Lokhttp3/n;)V
