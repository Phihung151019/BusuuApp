...
.method public constructor <init>(Landroid/graphics/Paint;Lo57;)V
    ...
    iput-object p1, p0, Lm35;->c:Landroid/graphics/Paint;

    sget-object p2, Landroid/graphics/Paint$Style;->STROKE:Landroid/graphics/Paint$Style;

    invoke-virtual {p1, p2}, Landroid/graphics/Paint;->setStyle(Landroid/graphics/Paint$Style;)V

    iget-object p1, p0, Lm35;->c:Landroid/graphics/Paint;
...
.method public a(Landroid/graphics/Canvas;Lk6h;III)V
    ...
    invoke-virtual {p2}, Ll35;->e()I

    move-result p3

    int-to-float v1, p3

    invoke-virtual {p2}, Ll35;->g()I
    ...
    invoke-virtual {p2}, Ll35;->f()I

    move-result p3

    int-to-float v1, p3

    invoke-virtual {p2}, Ll35;->h()I
    ...
    :cond_4
    :goto_0
    iget-object p2, p0, Lm35;->c:Landroid/graphics/Paint;
    ...
    iget-object p4, p0, Lco0;->b:Lo57;

    invoke-virtual {p4}, Lo57;->l()I

    move-result p4

    int-to-float p4, p4

    iget-object p5, p0, Lm35;->c:Landroid/graphics/Paint;

    invoke-virtual {p1, p2, p3, p4, p5}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    iget-object p4, p0, Lm35;->c:Landroid/graphics/Paint;
