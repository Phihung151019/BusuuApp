...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "fetchPresentation",
        "(Lio/purchasely/ext/Purchasely;Ljava/lang/String;Lio/purchasely/ext/PLYPresentationProperties;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;",
        "fetchAsyncPresentation",
        "(Lio/purchasely/ext/Purchasely;Lio/purchasely/ext/PLYPresentationProperties;Lio/purchasely/ext/PLYPresentationDisplayMode;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;",
        "core-5.2.3_release"
    }
    k = 0x2
    mv = {
...
# direct methods
.method public static final fetchAsyncPresentation(Lio/purchasely/ext/Purchasely;Lio/purchasely/ext/PLYPresentationProperties;Lio/purchasely/ext/PLYPresentationDisplayMode;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 27
    ...
    :goto_1
    iget-object v0, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->result:Ljava/lang/Object;

    invoke-static {}, Lxe7;->f()Ljava/lang/Object;

    move-result-object v1

    iget v2, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->label:I
    ...
    iget-object v1, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->L$1:Ljava/lang/Object;

    check-cast v1, Lio/purchasely/ext/PLYPresentation;

    iget-object v2, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->L$0:Ljava/lang/Object;
    ...
    :cond_3
    iget-object v2, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->L$1:Ljava/lang/Object;

    check-cast v2, Lio/purchasely/ext/PLYPresentationDisplayMode;

    iget-object v5, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->L$0:Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lio/purchasely/managers/PLYManager;->isConfigured()Z
    ...
    iput-object v2, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->L$0:Ljava/lang/Object;

    move-object/from16 v6, p2

    iput-object v6, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->L$1:Ljava/lang/Object;

    iput v5, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->label:I

    invoke-static {v0, v4, v7, v5, v4}, Lio/purchasely/managers/PLYManager;->configure$default(Lio/purchasely/managers/PLYManager;Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v4, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->L$1:Ljava/lang/Object;

    iput v3, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->label:I
    ...
    invoke-virtual {v3, v0}, Lio/purchasely/managers/PLYPresentationManager;->toPublicPresentation$core_5_2_3_release(Lio/purchasely/models/PLYInternalPresentation;)Lio/purchasely/ext/PLYPresentation;
    ...
    iput-object v0, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->L$1:Ljava/lang/Object;

    iput v10, v7, Lio/purchasely/ext/Purchasely_PresentationKt$fetchAsyncPresentation$1;->label:I

    invoke-virtual {v3, v7}, Lio/purchasely/ext/PLYPresentationMetadata;->log$core_5_2_3_release(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_8
    invoke-interface {v7}, Lkotlin/coroutines/Continuation;->getContext()Lwo2;

    move-result-object v1

    invoke-static {v1}, Luh7;->k(Lwo2;)V
...
.method public static synthetic fetchAsyncPresentation$default(Lio/purchasely/ext/Purchasely;Lio/purchasely/ext/PLYPresentationProperties;Lio/purchasely/ext/PLYPresentationDisplayMode;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Error;
    ...
    :cond_0
    invoke-static {p0, p1, p2, p3}, Lio/purchasely/ext/Purchasely_PresentationKt;->fetchAsyncPresentation(Lio/purchasely/ext/Purchasely;Lio/purchasely/ext/PLYPresentationProperties;Lio/purchasely/ext/PLYPresentationDisplayMode;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public static final fetchPresentation(Lio/purchasely/ext/Purchasely;Ljava/lang/String;Lio/purchasely/ext/PLYPresentationProperties;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 23
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v17 .. v22}, Lio/purchasely/ext/Purchasely_PresentationKt;->fetchAsyncPresentation$default(Lio/purchasely/ext/Purchasely;Lio/purchasely/ext/PLYPresentationProperties;Lio/purchasely/ext/PLYPresentationDisplayMode;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
...
.method public static synthetic fetchPresentation$default(Lio/purchasely/ext/Purchasely;Ljava/lang/String;Lio/purchasely/ext/PLYPresentationProperties;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
    .locals 18
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Error;
    ...
    :goto_2
    invoke-static {v1, v0, v2, v3}, Lio/purchasely/ext/Purchasely_PresentationKt;->fetchPresentation(Lio/purchasely/ext/Purchasely;Ljava/lang/String;Lio/purchasely/ext/PLYPresentationProperties;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public static final getPresentationView(Lio/purchasely/ext/Purchasely;Landroid/content/Context;Lio/purchasely/ext/PLYPresentationProperties;Lkotlin/jvm/functions/Function2;Lio/purchasely/ext/PLYPresentationDisplayMode;Z)Lio/purchasely/views/presentation/PLYPresentationView;
    ...
    invoke-virtual {v1, p2, p5, p3}, Lio/purchasely/managers/PLYPresentationManager;->configureNewPresentation$core_5_2_3_release(Lio/purchasely/ext/PLYPresentationProperties;ZLkotlin/jvm/functions/Function2;)V

    new-instance v2, Lio/purchasely/views/presentation/PLYPresentationView;

    invoke-static {p0, p2}, Lpfg;->a(Ljava/lang/Object;Ljava/lang/Object;)Ltma;
    ...
    invoke-direct/range {v2 .. v9}, Lio/purchasely/views/presentation/PLYPresentationView;-><init>(Landroid/content/Context;Landroid/os/Bundle;Landroid/util/AttributeSet;IIILri3;)V
