...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sendDeeplinkView$core_5_2_3_release",
        "(Lio/purchasely/ext/PLYDeepLink;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;",
        "sendDeeplinkView",
        "deepLink",
        "Lio/purchasely/ext/PLYPresentation;",
        "openDeeplinkActivity$core_5_2_3_release",
        ...
        "waitingList",
        "Ljava/util/List;",
        "getWaitingList$core_5_2_3_release",
        "()Ljava/util/List;",
        "Lrj9;",
        "mutex",
        "Lrj9;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/purchasely/ext/PLYDeeplinkManager;->mutex:Lrj9;
...
.method public static synthetic a(Lio/purchasely/ext/PLYDeepLink;Lio/purchasely/ext/PLYPresentation;)Lqrg;
    .locals 0

    invoke-static {p0, p1}, Lio/purchasely/ext/PLYDeeplinkManager;->sendDeeplinkView$lambda$0(Lio/purchasely/ext/PLYDeepLink;Lio/purchasely/ext/PLYPresentation;)Lqrg;
...
.method public static final synthetic access$getMutex$p()Lrj9;
    .locals 1

    sget-object v0, Lio/purchasely/ext/PLYDeeplinkManager;->mutex:Lrj9;
...
.method public static synthetic openDeeplinkActivity$core_5_2_3_release$default(Lio/purchasely/ext/PLYDeeplinkManager;Lio/purchasely/ext/PLYDeepLink;Lio/purchasely/ext/PLYPresentation;Lkotlin/coroutines/Continuation;ILjava/lang/Object;)Ljava/lang/Object;
    .locals 0
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3}, Lio/purchasely/ext/PLYDeeplinkManager;->openDeeplinkActivity$core_5_2_3_release(Lio/purchasely/ext/PLYDeepLink;Lio/purchasely/ext/PLYPresentation;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method private final placement(Ljava/util/List;Landroid/net/Uri;)Z
    ...
    invoke-static {v7, p2}, Lve7;->f(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct/range {v1 .. v9}, Lio/purchasely/ext/PLYDeepLink$Presentation;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lio/purchasely/ext/PLYPresentationDisplayMode;Ljava/lang/String;ILri3;)V
...
.method private final plan(Ljava/util/List;Landroid/net/Uri;)Z
    ...
    invoke-static {p1, v1}, Lht1;->t0(Ljava/util/List;I)Ljava/lang/Object;
    ...
    new-instance v2, Lio/purchasely/ext/PLYDeepLink$Presentation;
    ...
    invoke-static {v8, p2}, Lve7;->f(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct/range {v2 .. v10}, Lio/purchasely/ext/PLYDeepLink$Presentation;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lio/purchasely/ext/PLYPresentationDisplayMode;Ljava/lang/String;ILri3;)V
...
.method private final product(Ljava/util/List;Landroid/net/Uri;)Z
    ...
    invoke-static {p1, v2}, Lht1;->t0(Ljava/util/List;I)Ljava/lang/Object;
    ...
    new-instance v3, Lio/purchasely/ext/PLYDeepLink$Presentation;
    ...
    invoke-static {v9, p2}, Lve7;->f(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct/range {v3 .. v11}, Lio/purchasely/ext/PLYDeepLink$Presentation;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lio/purchasely/ext/PLYPresentationDisplayMode;Ljava/lang/String;ILri3;)V
...
.method private static final sendDeeplinkView$lambda$0(Lio/purchasely/ext/PLYDeepLink;Lio/purchasely/ext/PLYPresentation;)Lqrg;
    .locals 6
    ...
    invoke-direct {v3, p0, p1, v1}, Lio/purchasely/ext/PLYDeeplinkManager$sendDeeplinkView$2$1;-><init>(Lio/purchasely/ext/PLYDeepLink;Lio/purchasely/ext/PLYPresentation;Lkotlin/coroutines/Continuation;)V
...
# virtual methods
.method public final getWaitingList$core_5_2_3_release()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final handle(Landroid/net/Uri;)Z
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lbze;->B(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    invoke-static {v1, v0}, Lht1;->j0(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    invoke-direct {v0, p1, v1}, Ltma;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v1, p1, v0}, Ltma;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :sswitch_4
    const-string v2, "presentations_preview"
    ...
    invoke-direct {v0, p1, v4}, Ltma;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final openDeeplinkActivity$core_5_2_3_release(Lio/purchasely/ext/PLYDeepLink;Lio/purchasely/ext/PLYPresentation;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 24
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v8, Lio/purchasely/ext/PLYPresentationProperties;

    move-object v0, v1

    check-cast v0, Lio/purchasely/ext/PLYDeepLink$Presentation;

    invoke-virtual {v0}, Lio/purchasely/ext/PLYDeepLink$Presentation;->getPlacementId()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lio/purchasely/ext/PLYDeepLink$Presentation;->getPresentationId()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lio/purchasely/ext/PLYDeepLink$Presentation;->getProductId()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lio/purchasely/ext/PLYDeepLink$Presentation;->getPlanId()Ljava/lang/String;
    ...
    invoke-static {v5, v8, v0, v2}, Lio/purchasely/ext/Purchasely_PresentationKt;->fetchAsyncPresentation(Lio/purchasely/ext/Purchasely;Lio/purchasely/ext/PLYPresentationProperties;Lio/purchasely/ext/PLYPresentationDisplayMode;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :cond_11
    sget-object v6, Lio/purchasely/ext/PLYUIViewType;->EVENT_PRESENTATION:Lio/purchasely/ext/PLYUIViewType;
    ...
    new-instance v8, Lio/purchasely/views/PLYActivity$Properties;
    ...
    invoke-direct/range {v8 .. v17}, Lio/purchasely/views/PLYActivity$Properties;-><init>(Lio/purchasely/ext/PLYUIViewType;Ljava/lang/String;Ljava/lang/String;Lio/purchasely/ext/PLYPresentationDisplayMode;Ljava/lang/String;Ljava/lang/String;Lio/purchasely/ext/PLYPresentation;ILri3;)V

    invoke-virtual {v4, v1, v8}, Lio/purchasely/views/PLYActivity$Companion;->newIntent(Landroid/content/Context;Lio/purchasely/views/PLYActivity$Properties;)Landroid/content/Intent;
...
.method public final sendDeeplinkView$core_5_2_3_release(Lio/purchasely/ext/PLYDeepLink;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 24
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, v3, v0}, Lio/purchasely/ext/PLYDeeplinkManager$sendDeeplinkView$1;-><init>(Lio/purchasely/ext/PLYDeeplinkManager;Lkotlin/coroutines/Continuation;)V
    ...
    new-instance v7, Lio/purchasely/ext/PLYPresentationProperties;
    ...
    invoke-static {v5, v7, v0, v2}, Lio/purchasely/ext/Purchasely_PresentationKt;->fetchAsyncPresentation(Lio/purchasely/ext/Purchasely;Lio/purchasely/ext/PLYPresentationProperties;Lio/purchasely/ext/PLYPresentationDisplayMode;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v4, v1, v0}, Lwea;-><init>(Lio/purchasely/ext/PLYDeepLink;Lio/purchasely/ext/PLYPresentation;)V
