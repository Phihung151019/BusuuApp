...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(ILjava/util/Map;Lio/purchasely/ext/ComponentState;Ljava/lang/String;Ljava/lang/Boolean;Lio/purchasely/views/presentation/models/SelectOption;Lio/purchasely/views/presentation/models/Action;Ljava/util/List;Ljava/util/List;Ljava/lang/Boolean;Ljava/util/List;Lnnd;)V",
        "self",
        "Lz72;",
        "output",
        "Lzmd;",
        ...
        "Lqrg;",
        "write$Self",
        "(Lio/purchasely/views/presentation/models/Stack;Lz72;Lzmd;)V",
        "Companion",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lio/purchasely/views/presentation/models/Stack$Companion;-><init>(Lri3;)V
    ...
    sput-object v6, Lio/purchasely/views/presentation/models/Stack;->$childSerializers:[Lam7;
    ...
    sput-object v0, Lio/purchasely/views/presentation/models/Stack;->$cachedSerializer$delegate:Lot7;
...
.method private static final synthetic _init_$_anonymous_()Lam7;
    ...
    const-class v1, Lio/purchasely/views/presentation/models/Stack;

    invoke-static {v1}, Lthc;->b(Ljava/lang/Class;)Lkl7;

    move-result-object v2

    const-class v1, Lio/purchasely/views/presentation/models/HStack;

    invoke-static {v1}, Lthc;->b(Ljava/lang/Class;)Lkl7;

    move-result-object v1

    const-class v3, Lio/purchasely/views/presentation/models/VStack;
    ...
    sget-object v5, Lio/purchasely/views/presentation/models/HStack$$serializer;->INSTANCE:Lio/purchasely/views/presentation/models/HStack$$serializer;

    aput-object v5, v4, v6

    sget-object v5, Lio/purchasely/views/presentation/models/VStack$$serializer;->INSTANCE:Lio/purchasely/views/presentation/models/VStack$$serializer;
    ...
    invoke-direct/range {v0 .. v5}, Lked;-><init>(Ljava/lang/String;Lkl7;[Lkl7;[Lam7;[Ljava/lang/annotation/Annotation;)V
...
.method public static final synthetic access$get$cachedSerializer$delegate$cp()Lot7;
    ...
    sget-object v0, Lio/purchasely/views/presentation/models/Stack;->$cachedSerializer$delegate:Lot7;

    return-object v0
.end method

.method public static synthetic d()Lam7;
    .locals 1

    invoke-static {}, Lio/purchasely/views/presentation/models/Stack;->_init_$_anonymous_()Lam7;
...
.method public static final synthetic write$Self(Lio/purchasely/views/presentation/models/Stack;Lz72;Lzmd;)V
    .locals 0
