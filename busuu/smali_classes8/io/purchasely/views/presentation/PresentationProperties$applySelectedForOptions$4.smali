...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lio/purchasely/views/presentation/PresentationProperties;->applySelectedForOptions(Ljava/lang/String;Ljava/util/List;ZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
.end annotation
...
# direct methods
.method public constructor <init>(Lio/purchasely/views/presentation/PresentationProperties;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;ZLio/purchasely/models/Select;Lkotlin/coroutines/Continuation;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    new-instance v0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;
    ...
    invoke-direct/range {v0 .. v10}, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;-><init>(Lio/purchasely/views/presentation/PresentationProperties;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;ZLio/purchasely/models/Select;Lkotlin/coroutines/Continuation;)V

    iput-object p1, v0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->L$0:Ljava/lang/Object;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->invoke(Lkp2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final invoke(Lkp2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->create(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v2, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4$1;

    iget-object v3, p0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->this$0:Lio/purchasely/views/presentation/PresentationProperties;

    iget-object v4, p0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->$selectId:Ljava/lang/String;

    iget-object v5, p0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->$optionsSelected:Ljava/util/List;

    iget-object v6, p0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->$children:Ljava/util/List;

    iget-object v7, p0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->$containers:Ljava/util/List;

    iget-object v8, p0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->$carousels:Ljava/util/List;

    iget-object v9, p0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->$options:Ljava/util/List;

    iget-boolean v10, p0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->$isDefault:Z

    iget-object v11, p0, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4;->$select:Lio/purchasely/models/Select;

    const/4 v12, 0x0

    invoke-direct/range {v2 .. v12}, Lio/purchasely/views/presentation/PresentationProperties$applySelectedForOptions$4$1;-><init>(Lio/purchasely/views/presentation/PresentationProperties;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;ZLio/purchasely/models/Select;Lkotlin/coroutines/Continuation;)V
