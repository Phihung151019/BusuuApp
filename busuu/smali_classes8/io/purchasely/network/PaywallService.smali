...
.method public constructor <init>(Lio/purchasely/network/NetworkInterceptor;Lio/purchasely/network/AnalyticsInterceptor;)V
    ...
    invoke-direct {p0}, Lio/purchasely/network/PaywallService;->buildRetrofit()Lkrc;

    move-result-object p1

    iput-object p1, p0, Lio/purchasely/network/PaywallService;->retrofit:Lkrc;
...
.method private final buildRetrofit()Lkrc;
    ...
    invoke-direct {p0}, Lio/purchasely/network/PaywallService;->provideOkHttpClient()Lh2a;
    ...
    invoke-virtual {v1}, Lio/purchasely/ext/PLYAPIEnvironment;->getPaywallUrl$core_5_2_3_release()Ljava/lang/String;
...
.method private final provideOkHttpClient()Lh2a;
    ...
    iput-object v0, p0, Lio/purchasely/network/PaywallService;->cache:Lokhttp3/b;

    new-instance v0, Lh2a$a;

    invoke-direct {v0}, Lh2a$a;-><init>()V

    iget-object v1, p0, Lio/purchasely/network/PaywallService;->cache:Lokhttp3/b;
...
.method public final getRetrofit()Lkrc;
    ...
    iget-object v0, p0, Lio/purchasely/network/PaywallService;->retrofit:Lkrc;
...
.method public final reset()V
    ...
    iput-object v0, p0, Lio/purchasely/network/PaywallService;->retrofit:Lkrc;
