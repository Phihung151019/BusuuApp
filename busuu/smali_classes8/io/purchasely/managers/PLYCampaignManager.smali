...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lqrg;",
        "processEvent",
        "(Lio/purchasely/ext/PLYEvent;Ljava/util/List;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;",
        "trigger",
        "processTrigger",
        "(Lio/purchasely/models/PLYTrigger;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;",
        "",
        ...
        "isCampaignStatusActive$core_5_2_3_release",
        "isCampaignStatusActive",
        "isWithinExposureWindow$core_5_2_3_release",
        "isWithinExposureWindow",
        "isWithinFrequencyCap$core_5_2_3_release",
        "isWithinFrequencyCap",
        "",
        "displayCount",
        "isWithinImpressionCap$core_5_2_3_release",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/purchasely/managers/PLYCampaignManager;->job:Ll02;
...
# virtual methods
.method public final executeActions(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 7
    ...
    invoke-direct {v0, p0, p4}, Lio/purchasely/managers/PLYCampaignManager$executeActions$1;-><init>(Lio/purchasely/managers/PLYCampaignManager;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-static {p4, p2, v4, v0}, Lio/purchasely/common/ActionExtensionKt;->start(Lio/purchasely/views/presentation/models/Action;Ljava/lang/String;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public getJob()Ll02;
    ...
    sget-object v0, Lio/purchasely/managers/PLYCampaignManager;->job:Ll02;
...
.method public bridge synthetic getJob()Lqh7;
    ...
    invoke-virtual {p0}, Lio/purchasely/managers/PLYCampaignManager;->getJob()Ll02;
...
.method public final isCampaignStatusActive$core_5_2_3_release(Lio/purchasely/models/PLYCampaign;Ljava/util/Date;)Z
    .locals 3
...
.method public final isEligibleForCampaign(Lio/purchasely/models/PLYCampaign;Ljava/util/Date;)Z
    ...
    :goto_0
    invoke-virtual {p0, p1, p2}, Lio/purchasely/managers/PLYCampaignManager;->isCampaignStatusActive$core_5_2_3_release(Lio/purchasely/models/PLYCampaign;Ljava/util/Date;)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Lio/purchasely/managers/PLYCampaignManager;->isWithinExposureWindow$core_5_2_3_release(Lio/purchasely/models/PLYCampaign;Ljava/util/Date;)Z
    ...
    :cond_2
    invoke-virtual {p0, p1, v0}, Lio/purchasely/managers/PLYCampaignManager;->isWithinImpressionCap$core_5_2_3_release(Lio/purchasely/models/PLYCampaign;I)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2}, Lio/purchasely/managers/PLYCampaignManager;->isWithinFrequencyCap$core_5_2_3_release(Lio/purchasely/models/PLYCampaign;Ljava/util/Date;)Z
...
.method public final isWithinExposureWindow$core_5_2_3_release(Lio/purchasely/models/PLYCampaign;Ljava/util/Date;)Z
    .locals 8
...
.method public final isWithinFrequencyCap$core_5_2_3_release(Lio/purchasely/models/PLYCampaign;Ljava/util/Date;)Z
    .locals 8
...
.method public final isWithinImpressionCap$core_5_2_3_release(Lio/purchasely/models/PLYCampaign;I)Z
    .locals 4
...
.method public final processEvent(Lio/purchasely/ext/PLYEvent;Ljava/util/List;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v4, Lio/purchasely/models/PLYTrigger;

    invoke-virtual {v4}, Lio/purchasely/models/PLYTrigger;->getEvent()Ljava/lang/String;
    ...
    :goto_1
    check-cast v3, Lio/purchasely/models/PLYTrigger;
    ...
    const-string v1, "Trigger matched for event: "
    ...
    invoke-static {p2, p1, v2, v0, v2}, Lio/purchasely/ext/PLYLogger;->d$default(Lio/purchasely/ext/PLYLogger;Ljava/lang/String;Ljava/lang/Throwable;ILjava/lang/Object;)V

    sget-object p1, Lio/purchasely/managers/PLYCampaignManager;->INSTANCE:Lio/purchasely/managers/PLYCampaignManager;

    invoke-virtual {p1, v3, p3, p4}, Lio/purchasely/managers/PLYCampaignManager;->processTrigger(Lio/purchasely/models/PLYTrigger;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
...
.method public final processTrigger(Lio/purchasely/models/PLYTrigger;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p2}, Lht1;->f0(Ljava/lang/Iterable;)Lmmd;

    move-result-object p2

    new-instance v0, Lsea;

    invoke-direct {v0, p1}, Lsea;-><init>(Lio/purchasely/models/PLYTrigger;)V

    invoke-static {p2, v0}, Ltmd;->o(Lmmd;Lkotlin/jvm/functions/Function1;)Lmmd;
    ...
    invoke-static {p2}, Ltmd;->B(Lmmd;)Ljava/util/List;
    ...
    invoke-virtual {v0, v1, p1, p2, p3}, Lio/purchasely/managers/PLYCampaignManager;->executeActions(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
