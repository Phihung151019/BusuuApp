...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "startUserTransfer$core_5_2_3_release",
...
.field private static jobMigration:Lqh7;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/purchasely/managers/PLYUserManager;->job:Ll02;
...
.method public static final synthetic access$setJobMigration$p(Lqh7;)V
    .locals 0

    sput-object p0, Lio/purchasely/managers/PLYUserManager;->jobMigration:Lqh7;
...
.method public final close()V
    ...
    sget-object v0, Lio/purchasely/managers/PLYUserManager;->jobMigration:Lqh7;
...
.method public getJob()Ll02;
    ...
    sget-object v0, Lio/purchasely/managers/PLYUserManager;->job:Ll02;
...
.method public bridge synthetic getJob()Lqh7;
    ...
    invoke-virtual {p0}, Lio/purchasely/managers/PLYUserManager;->getJob()Ll02;
...
.method public final getUserData$core_5_2_3_release()Lio/purchasely/models/PLYUserDataRegistration;
    .locals 15
    ...
    invoke-static {v3, v9}, Landroid/provider/Settings$Global;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v4, Lio/purchasely/models/UserDevice;
    ...
    invoke-direct/range {v4 .. v14}, Lio/purchasely/models/UserDevice;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILri3;)V

    sget-object v0, Lio/purchasely/managers/PLYIntegrationManager;->INSTANCE:Lio/purchasely/managers/PLYIntegrationManager;

    invoke-virtual {v0}, Lio/purchasely/managers/PLYIntegrationManager;->getAttributes()Ljava/util/EnumMap;
    ...
    invoke-direct {v6, v7, v5}, Ltma;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :cond_0
    invoke-static {v3}, Luu8;->x(Ljava/lang/Iterable;)Ljava/util/Map;

    move-result-object v0

    new-instance v3, Lio/purchasely/models/UserData;

    invoke-direct {v3, v1, v2, v4, v0}, Lio/purchasely/models/UserData;-><init>(Ljava/lang/String;Ljava/lang/String;Lio/purchasely/models/UserDevice;Ljava/util/Map;)V

    new-instance v0, Lio/purchasely/models/PLYUserDataRegistration;

    invoke-direct {v0, v3}, Lio/purchasely/models/PLYUserDataRegistration;-><init>(Lio/purchasely/models/UserData;)V
...
.method public final resetUser(Ljava/lang/String;Lkotlin/jvm/functions/Function1;Z)V
    ...
    invoke-virtual {v3, v4}, Lio/purchasely/managers/PLYEventManager;->newEvent(Lio/purchasely/ext/PLYEvent;)Lqh7;
    ...
    invoke-virtual {p0, p2}, Lio/purchasely/managers/PLYUserManager;->startUserTransfer$core_5_2_3_release(Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {v3, p3, p1}, Lio/purchasely/managers/PLYUserManager$resetUser$2;-><init>(ZLkotlin/coroutines/Continuation;)V
...
.method public final startUserTransfer$core_5_2_3_release(Lkotlin/jvm/functions/Function1;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v8, v1, v0, p1, v4}, Lio/purchasely/managers/PLYUserManager$startUserTransfer$1;-><init>(Lefc;ILkotlin/jvm/functions/Function1;Lkotlin/coroutines/Continuation;)V
    ...
    sput-object p1, Lio/purchasely/managers/PLYUserManager;->jobMigration:Lqh7;
