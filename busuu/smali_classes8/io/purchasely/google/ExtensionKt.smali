...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "toPLYPurchaseState",
        "(Lktb;)Lio/purchasely/ext/PLYPurchaseState;",
        "",
        "Lujb;",
        "Lio/purchasely/models/PLYPlan;",
        "plan",
        "findProductForPlan",
        "(Ljava/util/List;Lio/purchasely/models/PLYPlan;)Lujb;",
...
# direct methods
.method public static final findProductForPlan(Ljava/util/List;Lio/purchasely/models/PLYPlan;)Lujb;
    .locals 7
    ...
    invoke-virtual {v3}, Lujb;->f()Ljava/util/List;
    ...
    invoke-virtual {v5}, Lujb$e;->a()Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lujb;->d()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lujb;->d()Ljava/lang/String;
...
.method public static final toPLYError(Lio/purchasely/ext/State$Error;)Lio/purchasely/models/PLYError;
    ...
    invoke-direct {v0, v2, v1, v2}, Lio/purchasely/models/PLYError$Unknown;-><init>(Ljava/lang/Exception;ILri3;)V
    ...
    :pswitch_0
    sget-object p0, Lio/purchasely/models/PLYError$GoogleError;->INSTANCE:Lio/purchasely/models/PLYError$GoogleError;

    return-object p0

    :pswitch_1
    sget-object p0, Lio/purchasely/models/PLYError$GoogleDeveloperError;->INSTANCE:Lio/purchasely/models/PLYError$GoogleDeveloperError;

    return-object p0

    :pswitch_2
    sget-object p0, Lio/purchasely/models/PLYError$StoreProductNotAvailable;->INSTANCE:Lio/purchasely/models/PLYError$StoreProductNotAvailable;

    return-object p0

    :pswitch_3
    sget-object p0, Lio/purchasely/models/PLYError$BillingUnavailable;->INSTANCE:Lio/purchasely/models/PLYError$BillingUnavailable;

    return-object p0

    :pswitch_4
    sget-object p0, Lio/purchasely/models/PLYError$CloudServiceNetworkConnectionFailed;->INSTANCE:Lio/purchasely/models/PLYError$CloudServiceNetworkConnectionFailed;

    return-object p0

    :pswitch_5
    sget-object p0, Lio/purchasely/models/PLYError$PaymentCancelled;->INSTANCE:Lio/purchasely/models/PLYError$PaymentCancelled;
...
.method public static final toPLYPurchaseState(Lktb;)Lio/purchasely/ext/PLYPurchaseState;
    .locals 1
