...
.method public static accept(Ljava/lang/Object;Lgaf;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p1, p0}, Lgaf;->onError(Ljava/lang/Throwable;)V

    return v1

    :cond_1
    invoke-interface {p1, p0}, Lgaf;->onNext(Ljava/lang/Object;)V
...
.method public static accept(Ljava/lang/Object;Lu0a;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p1, p0}, Lu0a;->onError(Ljava/lang/Throwable;)V

    return v1

    :cond_1
    invoke-interface {p1, p0}, Lu0a;->onNext(Ljava/lang/Object;)V
...
.method public static acceptFull(Ljava/lang/Object;Lgaf;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    iget-object p0, p0, Lio/reactivex/internal/util/NotificationLite$c;->a:Liaf;
...
.method public static acceptFull(Ljava/lang/Object;Lu0a;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    iget-object p0, p0, Lio/reactivex/internal/util/NotificationLite$a;->a:Ldz3;
...
.method public static disposable(Ldz3;)Ljava/lang/Object;
    .locals 1

    new-instance v0, Lio/reactivex/internal/util/NotificationLite$a;

    invoke-direct {v0, p0}, Lio/reactivex/internal/util/NotificationLite$a;-><init>(Ldz3;)V
...
.method public static getDisposable(Ljava/lang/Object;)Ldz3;
    .locals 0
...
.method public static getSubscription(Ljava/lang/Object;)Liaf;
    .locals 0
...
.method public static subscription(Liaf;)Ljava/lang/Object;
    .locals 1

    new-instance v0, Lio/reactivex/internal/util/NotificationLite$c;

    invoke-direct {v0, p0}, Lio/reactivex/internal/util/NotificationLite$c;-><init>(Liaf;)V
