...
.method public static complete(Laz8;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Laz8;->onSubscribe(Ldz3;)V

    invoke-interface {p0}, Laz8;->onComplete()V

    return-void
.end method

.method public static complete(Ln02;)V
    .locals 1

    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, Ln02;->onSubscribe(Ldz3;)V

    invoke-interface {p0}, Ln02;->onComplete()V

    return-void
.end method

.method public static complete(Lu0a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lu0a;->onSubscribe(Ldz3;)V
...
.method public static error(Ljava/lang/Throwable;Laz8;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p0}, Laz8;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Li0e;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, p0}, Li0e;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Ln02;)V
    .locals 1
    ...
    invoke-interface {p1, p0}, Ln02;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lu0a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
