...
.method private animateWindowIn()V
    ...
    invoke-virtual {p0, v1}, Lp30;->findViewById(I)Landroid/view/View;
...
.method private loadSheet(Lio/intercom/android/sdk/api/Api;)V
    ...
    invoke-virtual {p1, v0, v1}, Lio/intercom/android/sdk/api/Api;->fetchSheet(Ljava/util/HashMap;Lpb1;)V
...
.method private setUpToolbar(Lio/intercom/android/sdk/Provider;)V
    ...
    invoke-static {p0, v2}, Lei2;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, v4, v7, v5, v6}, Landroid/graphics/drawable/ScaleDrawable;-><init>(Landroid/graphics/drawable/Drawable;IFF)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v0, "parcel_is_home_screen"
    ...
    iget-object p1, p0, Lio/intercom/android/sdk/activities/IntercomSheetActivity;->webView:Landroid/webkit/WebView;

    invoke-direct {v2, p1}, Lio/intercom/android/sdk/conversation/JavascriptRunner;-><init>(Landroid/webkit/WebView;)V
    ...
    iget-object p1, v4, Lio/intercom/android/sdk/activities/IntercomSheetActivity;->containerView:Landroid/view/View;

    sget v0, Lio/intercom/android/sdk/R$id;->error_layout_sheet:I
    ...
    iput-object p1, v4, Lio/intercom/android/sdk/activities/IntercomSheetActivity;->intercomErrorView:Lio/intercom/android/sdk/views/IntercomErrorView;

    iget-object v0, v4, Lio/intercom/android/sdk/activities/IntercomSheetActivity;->appConfigProvider:Lio/intercom/android/sdk/Provider;
    ...
    iget-object p1, v4, Lio/intercom/android/sdk/activities/IntercomSheetActivity;->intercomErrorView:Lio/intercom/android/sdk/views/IntercomErrorView;

    new-instance v0, Lio/intercom/android/sdk/activities/IntercomSheetActivity$2;

    invoke-direct {v0, p0}, Lio/intercom/android/sdk/activities/IntercomSheetActivity$2;-><init>(Lio/intercom/android/sdk/activities/IntercomSheetActivity;)V
...
.method public onSubmitSheetAction(Ljava/util/Map;)V
    ...
    invoke-virtual {v0, v1, p1, v2}, Lio/intercom/android/sdk/api/Api;->submitSheet(Ljava/lang/String;Ljava/util/Map;Lpb1;)V
