...
.field private final inboxRowLayout:Landroidx/constraintlayout/widget/ConstraintLayout;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lio/intercom/android/sdk/views/InboxRowLayout;->inboxRowLayout:Landroidx/constraintlayout/widget/ConstraintLayout;
...
.method private setRowParticipantDetails(Lio/intercom/android/sdk/models/Conversation;Ljava/lang/String;Lio/intercom/android/sdk/models/TeamPresence;Lio/intercom/android/sdk/identity/AppConfig;)V
    ...
    invoke-virtual {p2, p3, v1, p4}, Lio/intercom/android/sdk/views/AuthorAvatarView;->loadAvatarWithActiveState(Lio/intercom/android/sdk/models/Avatar;ZLio/intercom/android/sdk/identity/AppConfig;)V
    ...
    invoke-virtual {p1, p3, p4}, Lio/intercom/android/sdk/views/AuthorAvatarView;->loadAvatar(Lio/intercom/android/sdk/models/Avatar;Lio/intercom/android/sdk/identity/AppConfig;)V
    ...
    invoke-virtual {p1, p3, p4}, Lio/intercom/android/sdk/views/AuthorAvatarView;->loadAvatars(Ljava/util/List;Lio/intercom/android/sdk/identity/AppConfig;)V
...
# virtual methods
.method public updateConversation(Lio/intercom/android/sdk/models/Conversation;Lio/intercom/android/sdk/identity/UserIdentity;Lio/intercom/android/sdk/identity/AppConfig;Lio/intercom/android/sdk/models/TeamPresence;Lio/intercom/android/sdk/utilities/TimeFormatter;)V
    .locals 5
    ...
    invoke-virtual {p5, v0, v1}, Lio/intercom/android/sdk/utilities/TimeFormatter;->getFormattedTime(J)Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, p1, p2, p4, p3}, Lio/intercom/android/sdk/views/InboxRowLayout;->setRowParticipantDetails(Lio/intercom/android/sdk/models/Conversation;Ljava/lang/String;Lio/intercom/android/sdk/models/TeamPresence;Lio/intercom/android/sdk/identity/AppConfig;)V
    ...
    sget p3, Lio/intercom/android/sdk/R$color;->intercom_accessibility_black:I

    invoke-static {v2, p3}, Lei2;->c(Landroid/content/Context;I)I
    ...
    sget p3, Lio/intercom/android/sdk/R$color;->intercom_accessibility_grey:I
    ...
    invoke-virtual {p1, p2}, Lio/intercom/android/sdk/views/AuthorAvatarView;->hideActiveStateIndicator(Ljava/lang/Boolean;)V
...
.method public updateVerticalPadding(I)V
    ...
    iget-object v0, p0, Lio/intercom/android/sdk/views/InboxRowLayout;->inboxRowLayout:Landroidx/constraintlayout/widget/ConstraintLayout;

    invoke-virtual {v0}, Landroid/view/View;->getPaddingLeft()I

    move-result v1

    iget-object v2, p0, Lio/intercom/android/sdk/views/InboxRowLayout;->inboxRowLayout:Landroidx/constraintlayout/widget/ConstraintLayout;
