...
.method private uploadMetrics(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {v0, p1, p2, v1}, Lio/intercom/android/sdk/api/Api;->sendMetrics(Ljava/util/List;Ljava/util/List;Lpb1;)V
...
.method public loadMetrics()Ljava/util/List;
    ...
    new-instance v3, Lio/intercom/android/sdk/metrics/MetricsStore$5;

    invoke-direct {v3, p0, v0}, Lio/intercom/android/sdk/metrics/MetricsStore$5;-><init>(Lio/intercom/android/sdk/metrics/MetricsStore;Ljava/util/List;)V

    iget-object v4, p0, Lio/intercom/android/sdk/metrics/MetricsStore;->deleteOnFailureHandler:Lio/intercom/android/sdk/persistence/JsonStorage$LoadFailureHandler;

    const-class v5, Lio/intercom/android/sdk/metrics/MetricObject;

    invoke-virtual {v1, v2, v5, v3, v4}, Lio/intercom/android/sdk/persistence/JsonStorage;->loadFilesInDirectory(Ljava/io/File;Ljava/lang/Class;Lio/intercom/android/sdk/persistence/JsonStorage$LoadHandler;Lio/intercom/android/sdk/persistence/JsonStorage$LoadFailureHandler;)V
...
.method public loadOpsMetrics()Ljava/util/List;
    ...
    new-instance v3, Lio/intercom/android/sdk/metrics/MetricsStore$6;

    invoke-direct {v3, p0, v0}, Lio/intercom/android/sdk/metrics/MetricsStore$6;-><init>(Lio/intercom/android/sdk/metrics/MetricsStore;Ljava/util/List;)V
