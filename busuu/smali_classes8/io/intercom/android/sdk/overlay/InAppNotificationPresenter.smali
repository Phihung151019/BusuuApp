...
.method private addNewNotifications(Ljava/util/List;Landroid/view/ViewGroup;)V
    ...
    iget-object v10, v7, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->activity:Landroid/app/Activity;
    ...
    :goto_2
    iget-object v1, v7, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->notifications:Ljava/util/Map;
    ...
    iget-object v1, v7, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->inflater:Landroid/view/LayoutInflater;

    iget-boolean v3, v7, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->hasAnimated:Z

    xor-int/lit8 v3, v3, 0x1

    iget v4, v7, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->bottomPadding:I

    invoke-virtual {v2, p2, v1, v3, v4}, Lio/intercom/android/sdk/overlay/InAppNotification;->display(Landroid/view/ViewGroup;Landroid/view/LayoutInflater;ZI)V
...
.method private updateNotifications(Ljava/util/List;Ljava/util/Map;Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {p2}, Lio/intercom/android/sdk/overlay/InAppNotification;->getPosition()I
    ...
    invoke-virtual {p2, v4}, Lio/intercom/android/sdk/overlay/InAppNotification;->moveBackward(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {p2, p3}, Lio/intercom/android/sdk/overlay/InAppNotification;->setPosition(I)V

    goto :goto_1

    :cond_5
    invoke-virtual {p0, v3, v4, v5}, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->addNewView(Lio/intercom/android/sdk/models/Conversation;Landroid/view/ViewGroup;Ljava/util/Map;)V

    invoke-virtual {p0, v6, v5, v4}, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->syncUpdates(Ljava/util/List;Ljava/util/Map;Landroid/view/ViewGroup;)V
...
.method public addNewView(Lio/intercom/android/sdk/models/Conversation;Landroid/view/ViewGroup;Ljava/util/Map;)V
    ...
    iget-object p1, v8, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->inflater:Landroid/view/LayoutInflater;

    const/4 v0, 0x1

    iget v1, v8, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->bottomPadding:I

    invoke-virtual {v2, p2, p1, v0, v1}, Lio/intercom/android/sdk/overlay/InAppNotification;->display(Landroid/view/ViewGroup;Landroid/view/LayoutInflater;ZI)V
...
.method public syncUpdates(Ljava/util/List;Ljava/util/Map;Landroid/view/ViewGroup;)V
    ...
    iget-object v8, v2, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->inflater:Landroid/view/LayoutInflater;

    const/4 v9, 0x0

    iget v10, v2, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->bottomPadding:I
    ...
    :goto_2
    iget-object p3, v2, Lio/intercom/android/sdk/overlay/InAppNotificationPresenter;->notifications:Ljava/util/Map;
