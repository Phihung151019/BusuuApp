...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "tailDispatch",
        "B",
        "(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;Lujf;Z)Lujf;",
        "f",
        "oldIndex",
        "newIndex",
        "t",
...
.field public static final l:Lxgf;
...
.field public final e:Lz36;

.field public final f:Lz36;

.field public final g:Lvoc;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$a;-><init>(Lri3;)V
    ...
    sput-object v0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->l:Lxgf;
...
.method public constructor <init>(IIJLjava/lang/String;)V
    ...
    invoke-direct {p2}, Lz36;-><init>()V

    iput-object p2, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->e:Lz36;

    new-instance p2, Lz36;

    invoke-direct {p2}, Lz36;-><init>()V

    iput-object p2, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f:Lz36;
    ...
    invoke-direct {p2, p3}, Lvoc;-><init>(I)V

    iput-object p2, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lvoc;
...
.method public static synthetic i(Lkotlinx/coroutines/scheduling/CoroutineScheduler;Ljava/lang/Runnable;ZZILjava/lang/Object;)V
    .locals 1
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g(Ljava/lang/Runnable;ZZ)V
...
.method public final B(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;Lujf;Z)Lujf;
    .locals 2
    ...
    iget-object p1, p1, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->a:Lauh;

    invoke-virtual {p1, p2, p3}, Lauh;->a(Lujf;Z)Lujf;
...
.method public final c(Lujf;)Z
    ...
    iget-object v0, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f:Lz36;

    invoke-virtual {v0, p1}, Lrm8;->a(Ljava/lang/Object;)Z
    ...
    :cond_0
    iget-object v0, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->e:Lz36;
...
.method public final d()I
    ...
    iget-object v0, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lvoc;
    ...
    iget-object v5, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lvoc;

    invoke-virtual {v5, v2}, Lvoc;->b(I)Ljava/lang/Object;
    ...
    iget-object v6, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lvoc;

    invoke-virtual {v6, v2, v5}, Lvoc;->c(ILjava/lang/Object;)V
...
.method public final e(Ljava/lang/Runnable;Z)Lujf;
    .locals 3

    sget-object v0, Likf;->f:Labd;

    invoke-virtual {v0}, Labd;->a()J
    ...
    iput-wide v0, p1, Lujf;->a:J

    iput-boolean p2, p1, Lujf;->b:Z

    return-object p1

    :cond_0
    invoke-static {p1, v0, v1, p2}, Likf;->b(Ljava/lang/Runnable;JZ)Lujf;
...
.method public final g(Ljava/lang/Runnable;ZZ)V
    ...
    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->e(Ljava/lang/Runnable;Z)Lujf;

    move-result-object p1

    iget-boolean p2, p1, Lujf;->b:Z
    ...
    invoke-virtual {p0, v2, p1, p3}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->B(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;Lujf;Z)Lujf;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->c(Lujf;)Z
    ...
    invoke-virtual {p0, v0, v1, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->y(JZ)V
...
.method public final n(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;)I
    ...
    :goto_0
    sget-object v0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->l:Lxgf;
...
.method public final o()Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;
    ...
    iget-object v2, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lvoc;

    invoke-virtual {v2, v1}, Lvoc;->b(I)Ljava/lang/Object;
...
.method public final r(Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;)Z
    .locals 9
    ...
    iget-object v7, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lvoc;

    invoke-virtual {v7, v1}, Lvoc;->b(I)Ljava/lang/Object;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lvoc;

    invoke-virtual {v1}, Lvoc;->a()I
    ...
    iget-object v9, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lvoc;

    invoke-virtual {v9, v8}, Lvoc;->b(I)Ljava/lang/Object;
    ...
    :cond_0
    iget-object v10, v9, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->a:Lauh;

    invoke-virtual {v10}, Lauh;->i()I
...
.method public final w(J)V
    ...
    :goto_0
    iget-object v4, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lvoc;

    invoke-virtual {v4, v1}, Lvoc;->b(I)Ljava/lang/Object;
    ...
    :cond_1
    iget-object v4, v4, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->a:Lauh;

    iget-object v5, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f:Lz36;

    invoke-virtual {v4, v5}, Lauh;->j(Lz36;)V
    ...
    :cond_3
    iget-object p1, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->f:Lz36;

    invoke-virtual {p1}, Lrm8;->b()V

    iget-object p1, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->e:Lz36;
    ...
    invoke-virtual {v0, v2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$c;->e(Z)Lujf;
    ...
    invoke-virtual {p1}, Lrm8;->e()Ljava/lang/Object;
    ...
    :cond_6
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->v(Lujf;)V
