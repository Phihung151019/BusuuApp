...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$e;

    const-string v1, "LONG"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$e;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$f;

    const-string v3, "FLOAT"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$f;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v3, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$g;

    const-string v5, "DOUBLE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$g;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v5, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$h;

    const-string v7, "BOOLEAN_ARRAY"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$h;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v7, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$i;

    const-string v9, "BYTE_ARRAY"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$i;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v9, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$j;

    const-string v11, "SHORT_ARRAY"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$j;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v11, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$k;

    const-string v13, "CHARACTER_ARRAY"

    const/4 v14, 0x6

    invoke-direct {v11, v13, v14}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$k;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v13, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$l;
    ...
    invoke-direct {v13, v15, v2}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$l;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v15, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$m;
    ...
    invoke-direct {v15, v2, v4}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$m;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v2, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$a;
    ...
    invoke-direct {v2, v4, v6}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$a;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v4, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$b;
    ...
    invoke-direct {v4, v6, v8}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$b;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v6, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$c;
    ...
    invoke-direct {v6, v8, v10}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$c;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v8, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$d;
    ...
    invoke-direct {v8, v10, v12}, Lnet/bytebuddy/implementation/HashCodeMethod$ValueTransformer$d;-><init>(Ljava/lang/String;I)V
...
.method public synthetic constructor <init>(Ljava/lang/String;ILnet/bytebuddy/implementation/HashCodeMethod$a;)V
    .locals 0
...
.method public static of(Lnet/bytebuddy/description/type/TypeDefinition;)Lnet/bytebuddy/implementation/bytecode/StackManipulation;
    ...
    invoke-interface {v0, p0}, Lnet/bytebuddy/implementation/bytecode/member/MethodInvocation$d;->virtual(Lnet/bytebuddy/description/type/TypeDescription;)Lnet/bytebuddy/implementation/bytecode/StackManipulation;
