.class public Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;
...
.method public constructor <init>(Lnet/bytebuddy/implementation/Implementation$SpecialMethodInvocation;ZZ)V
    ...
    iput-object p1, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->a:Lnet/bytebuddy/implementation/Implementation$SpecialMethodInvocation;

    iput-boolean p2, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->b:Z

    iput-boolean p3, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->c:Z
...
.method public apply(La99;Lnet/bytebuddy/implementation/Implementation$Context;)Lnet/bytebuddy/implementation/bytecode/StackManipulation$c;
    ...
    iget-boolean v0, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->c:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->a:Lnet/bytebuddy/implementation/Implementation$SpecialMethodInvocation;
    ...
    :goto_0
    iget-boolean v1, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->b:Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_2
    iget-boolean v2, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->b:Z

    check-cast p1, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;

    iget-boolean v3, p1, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->b:Z
    ...
    :cond_3
    iget-boolean v2, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->c:Z

    iget-boolean v3, p1, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->c:Z
    ...
    :cond_4
    iget-object v2, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->a:Lnet/bytebuddy/implementation/Implementation$SpecialMethodInvocation;

    iget-object p1, p1, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->a:Lnet/bytebuddy/implementation/Implementation$SpecialMethodInvocation;
...
.method public hashCode()I
    ...
    iget-object v1, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->a:Lnet/bytebuddy/implementation/Implementation$SpecialMethodInvocation;
    ...
    iget-boolean v1, p0, Lnet/bytebuddy/implementation/bind/annotation/DefaultMethod$Binder$a;->c:Z
