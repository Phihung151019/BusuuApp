...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lnet/bytebuddy/implementation/bind/annotation/AllArguments$Binder;->a:Lu89$d;
    ...
    sput-object v1, Lnet/bytebuddy/implementation/bind/annotation/AllArguments$Binder;->b:Lu89$d;
    ...
    sput-object v0, Lnet/bytebuddy/implementation/bind/annotation/AllArguments$Binder;->c:Lu89$d;
...
.method public bind(Lnet/bytebuddy/description/annotation/AnnotationDescription$g;Lu89;Lkna;Lnet/bytebuddy/implementation/Implementation$Target;Lnet/bytebuddy/implementation/bytecode/assign/Assigner;Lnet/bytebuddy/implementation/bytecode/assign/Assigner$Typing;)Lnet/bytebuddy/implementation/bind/MethodDelegationBinder$ParameterBinding;
    ...
    sget-object p3, Lnet/bytebuddy/description/type/TypeDescription$Generic;->X0:Lnet/bytebuddy/description/type/TypeDescription$Generic;
    ...
    invoke-interface {p3}, Lnet/bytebuddy/description/type/TypeDescription$Generic;->e()Lnet/bytebuddy/description/type/TypeDescription$Generic;
    ...
    sget-object v0, Lnet/bytebuddy/implementation/bind/annotation/AllArguments$Binder;->b:Lu89$d;
    ...
    sget-object v4, Lnet/bytebuddy/implementation/bind/annotation/AllArguments$Binder;->c:Lu89$d;

    invoke-interface {p1, v4}, Lnet/bytebuddy/description/annotation/AnnotationDescription;->g(Lu89$d;)Lnet/bytebuddy/description/annotation/AnnotationValue;

    move-result-object v4

    invoke-interface {v4, v3}, Lnet/bytebuddy/description/annotation/AnnotationValue;->a(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-static {p4, p2}, Ln92;->a(Ljava/lang/Object;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v0, v7}, Lnet/bytebuddy/implementation/bytecode/StackManipulation$b;-><init>([Lnet/bytebuddy/implementation/bytecode/StackManipulation;)V
    ...
    :cond_6
    sget-object v0, Lnet/bytebuddy/implementation/bind/annotation/AllArguments$Binder;->a:Lu89$d;
    ...
    invoke-interface {v0, v5}, Lnet/bytebuddy/description/annotation/AnnotationValue;->c(Ljava/lang/ClassLoader;)Lnet/bytebuddy/description/annotation/AnnotationValue$j;

    move-result-object v0

    const-class v5, Lnet/bytebuddy/implementation/bind/annotation/AllArguments$Assignment;

    invoke-interface {v0, v5}, Lnet/bytebuddy/description/annotation/AnnotationValue$j;->a(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lnet/bytebuddy/implementation/bind/annotation/AllArguments$Assignment;

    invoke-virtual {v0}, Lnet/bytebuddy/implementation/bind/annotation/AllArguments$Assignment;->a()Z
    ...
    invoke-static {p3}, Lnet/bytebuddy/implementation/bytecode/collection/ArrayFactory;->c(Lnet/bytebuddy/description/type/TypeDescription$Generic;)Lnet/bytebuddy/implementation/bytecode/collection/ArrayFactory;

    move-result-object p2

    invoke-virtual {p2, v3}, Lnet/bytebuddy/implementation/bytecode/collection/ArrayFactory;->e(Ljava/util/List;)Lnet/bytebuddy/implementation/bytecode/StackManipulation;
