...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/implementation/ToStringMethod$PrefixResolver$Default$a;

    const-string v1, "FULLY_QUALIFIED_CLASS_NAME"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lnet/bytebuddy/implementation/ToStringMethod$PrefixResolver$Default$a;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lnet/bytebuddy/implementation/ToStringMethod$PrefixResolver$Default$b;

    const-string v3, "CANONICAL_CLASS_NAME"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lnet/bytebuddy/implementation/ToStringMethod$PrefixResolver$Default$b;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v3, Lnet/bytebuddy/implementation/ToStringMethod$PrefixResolver$Default$c;

    const-string v5, "SIMPLE_CLASS_NAME"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lnet/bytebuddy/implementation/ToStringMethod$PrefixResolver$Default$c;-><init>(Ljava/lang/String;I)V
...
# virtual methods
.method public abstract synthetic resolve(Lnet/bytebuddy/description/type/TypeDescription;)Ljava/lang/String;
.end method
