...
.method public constructor <init>(Ljava/lang/String;IZ)V
    ...
    iput-boolean p3, p0, Lnet/bytebuddy/implementation/auxiliary/TrivialType;->a:Z
...
.method public make(Ljava/lang/String;Lnet/bytebuddy/ClassFileVersion;Lnet/bytebuddy/implementation/MethodAccessorFactory;)Lnet/bytebuddy/dynamic/a;
    ...
    invoke-virtual {p3, p2}, Lnet/bytebuddy/ByteBuddy;->q(Lnet/bytebuddy/dynamic/scaffold/TypeValidation;)Lnet/bytebuddy/ByteBuddy;
    ...
    invoke-virtual {p2, p3}, Lnet/bytebuddy/ByteBuddy;->p(Lnet/bytebuddy/dynamic/scaffold/MethodGraph$Compiler;)Lnet/bytebuddy/ByteBuddy;
    ...
    invoke-virtual {p2, p3, v0}, Lnet/bytebuddy/ByteBuddy;->k(Ljava/lang/Class;Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy;)Lnet/bytebuddy/dynamic/a$a;

    move-result-object p2

    iget-boolean p3, p0, Lnet/bytebuddy/implementation/auxiliary/TrivialType;->a:Z

    if-eqz p3, :cond_0

    const-class p3, Lnet/bytebuddy/implementation/auxiliary/a$b;

    invoke-static {p3}, Lnet/bytebuddy/description/annotation/AnnotationDescription$d;->c(Ljava/lang/Class;)Lnet/bytebuddy/description/annotation/AnnotationDescription$d;

    move-result-object p3

    const/4 v0, 0x0

    invoke-virtual {p3, v0}, Lnet/bytebuddy/description/annotation/AnnotationDescription$d;->b(Z)Lnet/bytebuddy/description/annotation/AnnotationDescription;
    ...
    :goto_0
    invoke-interface {p2, p3}, Lnet/bytebuddy/dynamic/a$a;->u(Ljava/util/Collection;)Lnet/bytebuddy/dynamic/a$a;
