...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/agent/builder/AgentBuilder$LocationStrategy$ForClassLoader$a;

    const-string v1, "STRONG"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lnet/bytebuddy/agent/builder/AgentBuilder$LocationStrategy$ForClassLoader$a;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lnet/bytebuddy/agent/builder/AgentBuilder$LocationStrategy$ForClassLoader$b;

    const-string v3, "WEAK"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lnet/bytebuddy/agent/builder/AgentBuilder$LocationStrategy$ForClassLoader$b;-><init>(Ljava/lang/String;I)V
...
# virtual methods
.method public abstract synthetic classFileLocator(Ljava/lang/ClassLoader;Lfh7;)Lnet/bytebuddy/dynamic/ClassFileLocator;
.end method
...
.method public withFallbackTo(Ljava/util/Collection;)Lnet/bytebuddy/agent/builder/AgentBuilder$LocationStrategy;
    ...
    new-instance v2, Lnet/bytebuddy/agent/builder/AgentBuilder$LocationStrategy$b;

    invoke-direct {v2, v1}, Lnet/bytebuddy/agent/builder/AgentBuilder$LocationStrategy$b;-><init>(Lnet/bytebuddy/dynamic/ClassFileLocator;)V
...
.method public withFallbackTo(Ljava/util/List;)Lnet/bytebuddy/agent/builder/AgentBuilder$LocationStrategy;
    ...
    new-instance p1, Lnet/bytebuddy/agent/builder/AgentBuilder$LocationStrategy$a;

    invoke-direct {p1, v0}, Lnet/bytebuddy/agent/builder/AgentBuilder$LocationStrategy$a;-><init>(Ljava/util/List;)V
