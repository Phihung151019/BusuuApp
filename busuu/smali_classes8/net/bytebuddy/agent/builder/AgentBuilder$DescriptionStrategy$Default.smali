...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$Default$a;
    ...
    invoke-direct {v0, v1, v2, v3}, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$Default$a;-><init>(Ljava/lang/String;IZ)V
    ...
    new-instance v1, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$Default$b;

    const-string v4, "POOL_ONLY"

    invoke-direct {v1, v4, v3, v2}, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$Default$b;-><init>(Ljava/lang/String;IZ)V
    ...
    new-instance v4, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$Default$c;

    const-string v5, "POOL_FIRST"

    const/4 v6, 0x2

    invoke-direct {v4, v5, v6, v2}, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$Default$c;-><init>(Ljava/lang/String;IZ)V
...
.method public constructor <init>(Ljava/lang/String;IZ)V
    ...
    iput-boolean p3, p0, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$Default;->a:Z

    return-void
.end method

.method public synthetic constructor <init>(Ljava/lang/String;IZLva;)V
    .locals 0
...
# virtual methods
.method public abstract synthetic apply(Ljava/lang/String;Ljava/lang/Class;Lnet/bytebuddy/pool/TypePool;Lnet/bytebuddy/agent/builder/AgentBuilder$CircularityLock;Ljava/lang/ClassLoader;Lfh7;)Lnet/bytebuddy/description/type/TypeDescription;
.end method

.method public isLoadedFirst()Z
    .locals 1

    iget-boolean v0, p0, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$Default;->a:Z
...
.method public withSuperTypeLoading()Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy;
    ...
    new-instance v0, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$a;

    invoke-direct {v0, p0}, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$a;-><init>(Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy;)V
...
.method public withSuperTypeLoading(Ljava/util/concurrent/ExecutorService;)Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy;
    ...
    new-instance v0, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$a$a;

    invoke-direct {v0, p0, p1}, Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy$a$a;-><init>(Lnet/bytebuddy/agent/builder/AgentBuilder$DescriptionStrategy;Ljava/util/concurrent/ExecutorService;)V
