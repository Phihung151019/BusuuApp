...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/agent/builder/AgentBuilder$TypeStrategy$Default$a;

    const-string v1, "REBASE"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lnet/bytebuddy/agent/builder/AgentBuilder$TypeStrategy$Default$a;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lnet/bytebuddy/agent/builder/AgentBuilder$TypeStrategy$Default$b;

    const-string v3, "REDEFINE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lnet/bytebuddy/agent/builder/AgentBuilder$TypeStrategy$Default$b;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v3, Lnet/bytebuddy/agent/builder/AgentBuilder$TypeStrategy$Default$c;

    const-string v5, "REDEFINE_FROZEN"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lnet/bytebuddy/agent/builder/AgentBuilder$TypeStrategy$Default$c;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v5, Lnet/bytebuddy/agent/builder/AgentBuilder$TypeStrategy$Default$d;

    const-string v7, "DECORATE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lnet/bytebuddy/agent/builder/AgentBuilder$TypeStrategy$Default$d;-><init>(Ljava/lang/String;I)V
...
.method public synthetic constructor <init>(Ljava/lang/String;ILva;)V
    .locals 0
...
# virtual methods
.method public abstract synthetic builder(Lnet/bytebuddy/description/type/TypeDescription;Lnet/bytebuddy/ByteBuddy;Lnet/bytebuddy/dynamic/ClassFileLocator;Lx89;Ljava/lang/ClassLoader;Lfh7;Ljava/security/ProtectionDomain;)Lnet/bytebuddy/dynamic/a$a;
.end method
