...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$f;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$a;

    const-string v1, "NO_CONSTRUCTORS"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$a;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$b;

    const-string v3, "DEFAULT_CONSTRUCTOR"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$b;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v3, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$c;

    const-string v5, "IMITATE_SUPER_CLASS"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$c;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v5, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$d;

    const-string v7, "IMITATE_SUPER_CLASS_PUBLIC"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$d;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v7, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$e;

    const-string v9, "IMITATE_SUPER_CLASS_OPENING"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$e;-><init>(Ljava/lang/String;I)V
...
.method public synthetic constructor <init>(Ljava/lang/String;ILnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$a;)V
    .locals 0
...
# virtual methods
.method public abstract a(Lnet/bytebuddy/description/type/TypeDescription;)Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public abstract b(Lnet/bytebuddy/dynamic/scaffold/MethodRegistry;Lnet/bytebuddy/implementation/attribute/MethodAttributeAppender$c;)Lnet/bytebuddy/dynamic/scaffold/MethodRegistry;
.end method
...
.method public extractConstructors(Lnet/bytebuddy/description/type/TypeDescription;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default;->a(Lnet/bytebuddy/description/type/TypeDescription;)Ljava/util/List;
    ...
    invoke-virtual {p0, v4}, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default;->c(I)I
...
.method public inject(Lnet/bytebuddy/description/type/TypeDescription;Lnet/bytebuddy/dynamic/scaffold/MethodRegistry;)Lnet/bytebuddy/dynamic/scaffold/MethodRegistry;
    ...
    invoke-virtual {p0, p2, p1}, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default;->b(Lnet/bytebuddy/dynamic/scaffold/MethodRegistry;Lnet/bytebuddy/implementation/attribute/MethodAttributeAppender$c;)Lnet/bytebuddy/dynamic/scaffold/MethodRegistry;
...
.method public with(Lnet/bytebuddy/implementation/attribute/MethodAttributeAppender$c;)Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy;
    .locals 1

    new-instance v0, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$f;

    invoke-direct {v0, p0, p1}, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$f;-><init>(Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default;Lnet/bytebuddy/implementation/attribute/MethodAttributeAppender$c;)V
...
.method public withInheritedAnnotations()Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy;
    ...
    invoke-direct {v0, p0, v1}, Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default$f;-><init>(Lnet/bytebuddy/dynamic/scaffold/subclass/ConstructorStrategy$Default;Lnet/bytebuddy/implementation/attribute/MethodAttributeAppender$c;)V
