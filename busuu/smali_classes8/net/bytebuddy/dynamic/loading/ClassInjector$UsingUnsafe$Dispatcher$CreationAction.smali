...
.method public bridge synthetic run()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lnet/bytebuddy/dynamic/loading/ClassInjector$UsingUnsafe$Dispatcher$CreationAction;->run()Lnet/bytebuddy/dynamic/loading/ClassInjector$UsingUnsafe$Dispatcher$b;
...
.method public run()Lnet/bytebuddy/dynamic/loading/ClassInjector$UsingUnsafe$Dispatcher$b;
    .locals 16
    .annotation build Ledu/umd/cs/findbugs/annotations/SuppressFBWarnings;
        justification = "Exception should not be rethrown but trigger a fallback."
        value = {
    ...
    new-instance v0, Lnet/bytebuddy/dynamic/loading/ClassInjector$UsingUnsafe$Dispatcher$c;

    const-string v1, "Use of Unsafe was disabled by system property"

    invoke-direct {v0, v1}, Lnet/bytebuddy/dynamic/loading/ClassInjector$UsingUnsafe$Dispatcher$c;-><init>(Ljava/lang/String;)V
    ...
    new-instance v6, Lnet/bytebuddy/dynamic/loading/ClassInjector$UsingUnsafe$Dispatcher$a;

    invoke-direct {v6, v8, v0}, Lnet/bytebuddy/dynamic/loading/ClassInjector$UsingUnsafe$Dispatcher$a;-><init>(Ljava/lang/Object;Ljava/lang/reflect/Method;)V
    :try_end_1
    ...
    invoke-virtual {v6, v4}, Lnet/bytebuddy/ByteBuddy;->g(Ljava/lang/Class;)Lnet/bytebuddy/dynamic/a$a;
    ...
    invoke-interface {v6, v9}, Lnet/bytebuddy/dynamic/a$a;->v(Ljava/lang/String;)Lnet/bytebuddy/dynamic/a$a;

    move-result-object v6

    invoke-interface {v6}, Lnet/bytebuddy/dynamic/a$a;->q()Lnet/bytebuddy/dynamic/a$a;

    move-result-object v6

    new-instance v9, Lnet/bytebuddy/asm/d;

    invoke-direct {v9}, Lnet/bytebuddy/asm/d;-><init>()V

    invoke-static {}, Lnet/bytebuddy/matcher/m;->b()Lnet/bytebuddy/matcher/l$a;

    move-result-object v10

    invoke-virtual {v9, v10}, Lnet/bytebuddy/asm/d;->a(Lnet/bytebuddy/matcher/l;)Lnet/bytebuddy/asm/d;

    move-result-object v9

    invoke-interface {v6, v9}, Lnet/bytebuddy/dynamic/a$a;->C(Lnet/bytebuddy/asm/AsmVisitorWrapper;)Lnet/bytebuddy/dynamic/a$a;

    move-result-object v6

    invoke-interface {v6}, Lnet/bytebuddy/dynamic/a$a;->B()Lnet/bytebuddy/dynamic/a$d;
    ...
    invoke-interface {v6, v4, v9}, Lnet/bytebuddy/dynamic/a$d;->e(Ljava/lang/ClassLoader;Lnet/bytebuddy/dynamic/loading/ClassLoadingStrategy;)Lnet/bytebuddy/dynamic/a$c;

    move-result-object v4

    invoke-interface {v4}, Lnet/bytebuddy/dynamic/a$c;->d()Ljava/lang/Class;
    ...
    new-instance v1, Lnet/bytebuddy/dynamic/loading/ClassInjector$UsingUnsafe$Dispatcher$a;

    invoke-virtual {v3, v7}, Ljava/lang/reflect/Field;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    invoke-direct {v1, v3, v2}, Lnet/bytebuddy/dynamic/loading/ClassInjector$UsingUnsafe$Dispatcher$a;-><init>(Ljava/lang/Object;Ljava/lang/reflect/Method;)V
    :try_end_3
