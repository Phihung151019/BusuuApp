...
.method public constructor <init>(Lnet/bytebuddy/description/type/TypeDescription$Generic;Lnet/bytebuddy/description/annotation/AnnotationDescription$g;)V
    ...
    invoke-static {}, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference$Factory;->a()Lu89$d;
    ...
    invoke-static {}, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference$Factory;->b()Lu89$d;
    ...
    const-class v3, Lnet/bytebuddy/asm/Advice$k;
    ...
    invoke-static {}, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference$Factory;->c()Lu89$d;
...
.method public constructor <init>(Lnet/bytebuddy/description/type/TypeDescription$Generic;ZLnet/bytebuddy/implementation/bytecode/assign/Assigner$Typing;Z)V
    ...
    iput-object p1, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->a:Lnet/bytebuddy/description/type/TypeDescription$Generic;

    iput-boolean p2, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->b:Z

    iput-object p3, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->c:Lnet/bytebuddy/implementation/bytecode/assign/Assigner$Typing;

    iput-boolean p4, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->d:Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_2
    iget-boolean v2, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->b:Z

    check-cast p1, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;

    iget-boolean v3, p1, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->b:Z
    ...
    :cond_3
    iget-boolean v2, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->d:Z

    iget-boolean v3, p1, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->d:Z
    ...
    :cond_4
    iget-object v2, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->c:Lnet/bytebuddy/implementation/bytecode/assign/Assigner$Typing;

    iget-object v3, p1, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->c:Lnet/bytebuddy/implementation/bytecode/assign/Assigner$Typing;
    ...
    :cond_5
    iget-object v2, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->a:Lnet/bytebuddy/description/type/TypeDescription$Generic;

    iget-object p1, p1, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->a:Lnet/bytebuddy/description/type/TypeDescription$Generic;
...
.method public hashCode()I
    ...
    iget-object v1, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->a:Lnet/bytebuddy/description/type/TypeDescription$Generic;
    ...
    iget-boolean v1, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->b:Z

    add-int/2addr v0, v1

    mul-int/lit8 v0, v0, 0x1f

    iget-object v1, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->c:Lnet/bytebuddy/implementation/bytecode/assign/Assigner$Typing;
    ...
    iget-boolean v1, p0, Lnet/bytebuddy/asm/Advice$OffsetMapping$ForThisReference;->d:Z
