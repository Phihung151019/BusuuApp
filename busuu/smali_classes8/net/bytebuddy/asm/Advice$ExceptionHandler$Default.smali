...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/asm/Advice$ExceptionHandler$Default$a;

    const-string v1, "SUPPRESSING"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lnet/bytebuddy/asm/Advice$ExceptionHandler$Default$a;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lnet/bytebuddy/asm/Advice$ExceptionHandler$Default$b;

    const-string v3, "PRINTING"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lnet/bytebuddy/asm/Advice$ExceptionHandler$Default$b;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v3, Lnet/bytebuddy/asm/Advice$ExceptionHandler$Default$c;

    const-string v5, "RETHROWING"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lnet/bytebuddy/asm/Advice$ExceptionHandler$Default$c;-><init>(Ljava/lang/String;I)V
...
# virtual methods
.method public abstract synthetic resolve(Lu89;Lnet/bytebuddy/description/type/TypeDescription;)Lnet/bytebuddy/implementation/bytecode/StackManipulation;
.end method
