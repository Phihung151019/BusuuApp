...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher$a;
    ...
    invoke-direct/range {v0 .. v5}, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher$a;-><init>(Ljava/lang/String;ICCZ)V
    ...
    new-instance v1, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher$b;
    ...
    invoke-direct/range {v1 .. v6}, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher$b;-><init>(Ljava/lang/String;ICCZ)V
    ...
    new-instance v2, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher$c;

    sget-object v8, Lnet/bytebuddy/ClassFileVersion;->f:Lnet/bytebuddy/ClassFileVersion;

    invoke-static {v8}, Lnet/bytebuddy/ClassFileVersion;->p(Lnet/bytebuddy/ClassFileVersion;)Lnet/bytebuddy/ClassFileVersion;

    move-result-object v3

    sget-object v9, Lnet/bytebuddy/ClassFileVersion;->r:Lnet/bytebuddy/ClassFileVersion;

    invoke-virtual {v3, v9}, Lnet/bytebuddy/ClassFileVersion;->j(Lnet/bytebuddy/ClassFileVersion;)Z
    ...
    invoke-direct/range {v2 .. v7}, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher$c;-><init>(Ljava/lang/String;ICCZ)V
    ...
    new-instance v10, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher$d;
    ...
    const-string v11, "JAVA_17_CAPABLE_VM"
    ...
    invoke-direct/range {v10 .. v15}, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher$d;-><init>(Ljava/lang/String;ICCZ)V

    sput-object v10, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;->JAVA_17_CAPABLE_VM:Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;

    const/4 v3, 0x4

    new-array v3, v3, [Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;
    ...
    sput-object v3, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;->$VALUES:[Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;

    invoke-static {v8}, Lnet/bytebuddy/ClassFileVersion;->p(Lnet/bytebuddy/ClassFileVersion;)Lnet/bytebuddy/ClassFileVersion;

    move-result-object v3

    invoke-virtual {v3, v9}, Lnet/bytebuddy/ClassFileVersion;->g(Lnet/bytebuddy/ClassFileVersion;)Z

    move-result v4

    if-eqz v4, :cond_0

    sput-object v10, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;->CURRENT:Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;

    return-void

    :cond_0
    sget-object v4, Lnet/bytebuddy/ClassFileVersion;->o:Lnet/bytebuddy/ClassFileVersion;

    invoke-virtual {v3, v4}, Lnet/bytebuddy/ClassFileVersion;->g(Lnet/bytebuddy/ClassFileVersion;)Z
    ...
    :cond_1
    sget-object v2, Lnet/bytebuddy/ClassFileVersion;->j:Lnet/bytebuddy/ClassFileVersion;

    invoke-virtual {v3, v2}, Lnet/bytebuddy/ClassFileVersion;->g(Lnet/bytebuddy/ClassFileVersion;)Z
...
.method public constructor <init>(Ljava/lang/String;ICCZ)V
    ...
    iput-char p3, p0, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;->a:C

    iput-char p4, p0, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;->b:C

    iput-boolean p5, p0, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;->c:Z

    return-void
.end method

.method public synthetic constructor <init>(Ljava/lang/String;ICCZLnet/bytebuddy/description/annotation/AnnotationValue$a;)V
    .locals 0
...
.method public toArrayErrorString(Lnet/bytebuddy/description/annotation/AnnotationValue$Sort;)Ljava/lang/String;
    ...
    iget-boolean v1, p0, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;->c:Z
    ...
    :cond_0
    invoke-virtual {p1}, Lnet/bytebuddy/description/annotation/AnnotationValue$Sort;->a()I
...
.method public toSourceString(Ljava/util/List;)Ljava/lang/String;
    ...
    iget-char v1, p0, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;->a:C
    ...
    :cond_1
    iget-char p1, p0, Lnet/bytebuddy/description/annotation/AnnotationValue$RenderingDispatcher;->b:C
