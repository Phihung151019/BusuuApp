...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator$a;
    ...
    invoke-direct/range {v0 .. v6}, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator$a;-><init>(Ljava/lang/String;IZZZZ)V
    ...
    new-instance v1, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator$b;
    ...
    invoke-direct/range {v1 .. v7}, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator$b;-><init>(Ljava/lang/String;IZZZZ)V
    ...
    new-instance v6, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator$c;
    ...
    invoke-direct/range {v6 .. v12}, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator$c;-><init>(Ljava/lang/String;IZZZZ)V
...
.method public constructor <init>(Ljava/lang/String;IZZZZ)V
    ...
    iput-boolean p3, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator;->a:Z

    iput-boolean p4, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator;->b:Z

    iput-boolean p5, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator;->c:Z

    iput-boolean p6, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator;->d:Z

    return-void
.end method

.method public synthetic constructor <init>(Ljava/lang/String;IZZZZLnet/bytebuddy/description/type/TypeDescription$a;)V
    .locals 0
...
.method public onGenericArray(Lnet/bytebuddy/description/type/TypeDescription$Generic;)Ljava/lang/Boolean;
    ...
    iget-boolean p1, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator;->a:Z
...
.method public onNonGenericType(Lnet/bytebuddy/description/type/TypeDescription$Generic;)Ljava/lang/Boolean;
    ...
    iget-boolean v0, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator;->a:Z
    ...
    :cond_0
    iget-boolean v0, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator;->b:Z
    ...
    :cond_1
    iget-boolean v0, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator;->d:Z
...
.method public onTypeVariable(Lnet/bytebuddy/description/type/TypeDescription$Generic;)Ljava/lang/Boolean;
    ...
    iget-boolean p1, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$Visitor$Validator;->c:Z
