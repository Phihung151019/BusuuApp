.class public Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;
...
.method public constructor <init>(Ljava/lang/reflect/Constructor;I[Ljava/lang/Class;)V
    ...
    iput-object p1, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->b:Ljava/lang/reflect/Constructor;

    iput p2, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->c:I

    iput-object p3, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->d:[Ljava/lang/Class;
...
.method public X0()Lnet/bytebuddy/description/type/TypeDescription$Generic;
    ...
    iget-object v0, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->e:Lnet/bytebuddy/description/type/TypeDescription$Generic;
    ...
    :cond_0
    iget-object v0, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->b:Ljava/lang/reflect/Constructor;

    invoke-virtual {v0}, Ljava/lang/reflect/Constructor;->getGenericParameterTypes()[Ljava/lang/reflect/Type;

    move-result-object v0

    iget-object v1, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->d:[Ljava/lang/Class;
    ...
    iget v1, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->c:I

    aget-object v0, v0, v1

    invoke-virtual {p0}, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->Y0()Lnet/bytebuddy/description/type/TypeDescription$Generic$AnnotationReader;
    ...
    :cond_1
    iget v0, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->c:I
    ...
    :cond_2
    iput-object v0, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->e:Lnet/bytebuddy/description/type/TypeDescription$Generic;
...
.method public Y0()Lnet/bytebuddy/description/type/TypeDescription$Generic$AnnotationReader;
    ...
    iget-object v1, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->b:Ljava/lang/reflect/Constructor;

    iget v2, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->c:I
...
.method public r1()Lnet/bytebuddy/description/type/TypeDescription;
    ...
    iget-object v0, p0, Lnet/bytebuddy/description/type/TypeDescription$Generic$b$d;->d:[Ljava/lang/Class;
