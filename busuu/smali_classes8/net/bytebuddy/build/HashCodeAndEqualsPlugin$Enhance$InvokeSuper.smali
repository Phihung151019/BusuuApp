...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/build/HashCodeAndEqualsPlugin$Enhance$InvokeSuper$a;

    const-string v1, "IF_DECLARED"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lnet/bytebuddy/build/HashCodeAndEqualsPlugin$Enhance$InvokeSuper$a;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lnet/bytebuddy/build/HashCodeAndEqualsPlugin$Enhance$InvokeSuper$b;

    const-string v3, "IF_ANNOTATED"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lnet/bytebuddy/build/HashCodeAndEqualsPlugin$Enhance$InvokeSuper$b;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v3, Lnet/bytebuddy/build/HashCodeAndEqualsPlugin$Enhance$InvokeSuper$c;

    const-string v5, "ALWAYS"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lnet/bytebuddy/build/HashCodeAndEqualsPlugin$Enhance$InvokeSuper$c;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v5, Lnet/bytebuddy/build/HashCodeAndEqualsPlugin$Enhance$InvokeSuper$d;

    const-string v7, "NEVER"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lnet/bytebuddy/build/HashCodeAndEqualsPlugin$Enhance$InvokeSuper$d;-><init>(Ljava/lang/String;I)V
...
.method public synthetic constructor <init>(Ljava/lang/String;ILnet/bytebuddy/build/HashCodeAndEqualsPlugin$a;)V
    .locals 0
