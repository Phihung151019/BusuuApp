...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/build/Plugin$Engine$TypeStrategy$Default$a;

    const-string v1, "REDEFINE"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lnet/bytebuddy/build/Plugin$Engine$TypeStrategy$Default$a;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lnet/bytebuddy/build/Plugin$Engine$TypeStrategy$Default$b;

    const-string v3, "REBASE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lnet/bytebuddy/build/Plugin$Engine$TypeStrategy$Default$b;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v3, Lnet/bytebuddy/build/Plugin$Engine$TypeStrategy$Default$c;

    const-string v5, "DECORATE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lnet/bytebuddy/build/Plugin$Engine$TypeStrategy$Default$c;-><init>(Ljava/lang/String;I)V
...
# virtual methods
.method public abstract synthetic builder(Lnet/bytebuddy/ByteBuddy;Lnet/bytebuddy/description/type/TypeDescription;Lnet/bytebuddy/dynamic/ClassFileLocator;)Lnet/bytebuddy/dynamic/a$a;
.end method
