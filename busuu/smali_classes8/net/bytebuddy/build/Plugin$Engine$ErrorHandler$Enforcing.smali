...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lnet/bytebuddy/build/Plugin$Engine$ErrorHandler$Enforcing$a;

    const-string v1, "ALL_TYPES_RESOLVED"

    const/4 v2, 0x0

    invoke-direct {v0, v1, v2}, Lnet/bytebuddy/build/Plugin$Engine$ErrorHandler$Enforcing$a;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v1, Lnet/bytebuddy/build/Plugin$Engine$ErrorHandler$Enforcing$b;

    const-string v3, "NO_LIVE_INITIALIZERS"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lnet/bytebuddy/build/Plugin$Engine$ErrorHandler$Enforcing$b;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v3, Lnet/bytebuddy/build/Plugin$Engine$ErrorHandler$Enforcing$c;

    const-string v5, "CLASS_FILES_ONLY"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lnet/bytebuddy/build/Plugin$Engine$ErrorHandler$Enforcing$c;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v5, Lnet/bytebuddy/build/Plugin$Engine$ErrorHandler$Enforcing$d;

    const-string v7, "MANIFEST_REQUIRED"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lnet/bytebuddy/build/Plugin$Engine$ErrorHandler$Enforcing$d;-><init>(Ljava/lang/String;I)V
...
.method public onError(Lnet/bytebuddy/description/type/TypeDescription;Lnet/bytebuddy/build/a;Ljava/lang/Throwable;)V
    .locals 0
