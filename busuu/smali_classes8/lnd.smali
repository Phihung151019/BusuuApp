...
.method public constructor <init>(Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;Z)V
    ...
    invoke-direct {p0, v0}, Ljod;-><init>(Lri3;)V

    iput-object p1, p0, Llnd;->a:Ljava/util/Map;

    iput-object p2, p0, Llnd;->b:Ljava/util/Map;

    iput-object p3, p0, Llnd;->c:Ljava/util/Map;

    iput-object p4, p0, Llnd;->d:Ljava/util/Map;

    iput-object p5, p0, Llnd;->e:Ljava/util/Map;

    iput-boolean p6, p0, Llnd;->f:Z
...
.method public a(Lnod;)V
    ...
    iget-object v0, p0, Llnd;->a:Ljava/util/Map;
    ...
    instance-of v4, v1, Lyj2$a;

    if-eqz v4, :cond_0

    invoke-static {v3, v2}, Lve7;->e(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast v1, Lyj2$a;

    invoke-virtual {v1}, Lyj2$a;->b()Lam7;
    ...
    invoke-interface {p1, v3, v1}, Lnod;->d(Lkl7;Lam7;)V

    goto :goto_0

    :cond_0
    instance-of v2, v1, Lyj2$b;

    if-eqz v2, :cond_1

    check-cast v1, Lyj2$b;

    invoke-virtual {v1}, Lyj2$b;->b()Lkotlin/jvm/functions/Function1;

    move-result-object v1

    invoke-interface {p1, v3, v1}, Lnod;->e(Lkl7;Lkotlin/jvm/functions/Function1;)V
    ...
    :cond_2
    iget-object v0, p0, Llnd;->b:Ljava/util/Map;
    ...
    invoke-static {v5, v2}, Lve7;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {v4, v6}, Lve7;->e(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-interface {p1, v3, v5, v4}, Lnod;->a(Lkl7;Lkl7;Lam7;)V

    goto :goto_1

    :cond_4
    iget-object v0, p0, Llnd;->c:Ljava/util/Map;
    ...
    invoke-static {v1, v5}, Lve7;->e(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v1, v3}, Lagg;->f(Ljava/lang/Object;I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lkotlin/jvm/functions/Function1;

    invoke-interface {p1, v4, v1}, Lnod;->c(Lkl7;Lkotlin/jvm/functions/Function1;)V

    goto :goto_2

    :cond_5
    iget-object v0, p0, Llnd;->e:Ljava/util/Map;
    ...
    invoke-interface {p1, v4, v1}, Lnod;->b(Lkl7;Lkotlin/jvm/functions/Function1;)V
...
.method public b(Lkl7;Ljava/util/List;)Lam7;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {p1, p2}, Lyj2;->a(Ljava/util/List;)Lam7;
...
.method public d()Z
    ...
    iget-boolean v0, p0, Llnd;->f:Z

    return v0
.end method

.method public e(Lkl7;Ljava/lang/String;)Lps3;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1, v0}, Lagg;->m(Ljava/lang/Object;I)Z
...
.method public f(Lkl7;Ljava/lang/Object;)Lond;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-interface {p1, p2}, Lkl7;->b(Ljava/lang/Object;)Z
