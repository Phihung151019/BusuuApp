...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lap6;->v:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lap6;->w:Z
...
.method private D()V
    ...
    iget-object v0, p0, Lap6;->s:Landroid/content/ContextWrapper;
    ...
    iput-object v0, p0, Lap6;->s:Landroid/content/ContextWrapper;
...
.method public F()V
    ...
    invoke-virtual {p0}, Lap6;->generatedComponent()Ljava/lang/Object;
    ...
    check-cast v1, Lcom/busuu/android/social/details/fragment/flagabuse/FlagProfileAbuseDialog;

    invoke-interface {v0, v1}, Lwb5;->injectFlagProfileAbuseDialog(Lcom/busuu/android/social/details/fragment/flagabuse/FlagProfileAbuseDialog;)V
...
.method public final componentManager()Lbl5;
    ...
    iget-object v0, p0, Lap6;->u:Lbl5;

    if-nez v0, :cond_1

    iget-object v0, p0, Lap6;->v:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lap6;->u:Lbl5;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lap6;->C()Lbl5;

    move-result-object v1

    iput-object v1, p0, Lap6;->u:Lbl5;
...
.method public bridge synthetic componentManager()Low5;
    ...
    invoke-virtual {p0}, Lap6;->componentManager()Lbl5;
