...
.method public c()V
    ...
    iget-boolean v0, p0, Lyn6;->c:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lyn6;->c:Z

    invoke-virtual {p0}, Lyn6;->generatedComponent()Ljava/lang/Object;
    ...
    check-cast v1, Lcom/busuu/android/referral/ui/banners/CourseReferralBannerView;

    invoke-interface {v0, v1}, Lyx2;->injectCourseReferralBannerView(Lcom/busuu/android/referral/ui/banners/CourseReferralBannerView;)V
...
.method public final componentManager()Lnbh;
    ...
    iget-object v0, p0, Lyn6;->b:Lnbh;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lyn6;->b()Lnbh;

    move-result-object v0

    iput-object v0, p0, Lyn6;->b:Lnbh;
...
.method public bridge synthetic componentManager()Low5;
    ...
    invoke-virtual {p0}, Lyn6;->componentManager()Lnbh;
