...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "t",
        "Loac;",
        "getAcceptedInvitationsView",
        "()Landroid/widget/TextView;",
        "acceptedInvitationsView",
        "u",
        "getFriendsInFreeTrialView",
        "friendsInFreeTrialView",
        "v",
        "getDaysEarnedView",
        "daysEarnedView",
...
.method static constructor <clinit>()V
    ...
    const-string v2, "acceptedInvitationsView"

    const-string v3, "getAcceptedInvitationsView()Landroid/widget/TextView;"
    ...
    const-string v3, "friendsInFreeTrialView"

    const-string v5, "getFriendsInFreeTrialView()Landroid/widget/TextView;"
    ...
    const-string v5, "daysEarnedView"

    const-string v6, "getDaysEarnedView()Landroid/widget/TextView;"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v1 .. v6}, Lpgc;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;IILri3;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lpgc;->u:Loac;

    sget p1, Lv2c;->days_earned_number:I

    invoke-static {p0, p1}, Lbu0;->bindView(Landroid/view/View;I)Loac;

    move-result-object p1

    iput-object p1, p0, Lpgc;->v:Loac;
...
.method public synthetic constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILri3;)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lpgc;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    return-void
.end method

.method private final getAcceptedInvitationsView()Landroid/widget/TextView;
    .locals 3

    iget-object v0, p0, Lpgc;->t:Loac;

    sget-object v1, Lpgc;->x:[Lwl7;
...
.method private final getDaysEarnedView()Landroid/widget/TextView;
    .locals 3

    iget-object v0, p0, Lpgc;->v:Loac;
...
.method private final getFriendsInFreeTrialView()Landroid/widget/TextView;
    .locals 3

    iget-object v0, p0, Lpgc;->u:Loac;
...
.method public getLayoutRes()I
    ...
    sget v0, La4c;->view_generic_invite_friends_card:I
...
.method public final populate(Ljava/util/List;Lt07;)V
    ...
    invoke-direct {p0}, Lpgc;->getAcceptedInvitationsView()Landroid/widget/TextView;
    ...
    invoke-virtual {v3}, Lu2h;->isInFreeTrial()Z
    ...
    invoke-direct {p0}, Lpgc;->getFriendsInFreeTrialView()Landroid/widget/TextView;
    ...
    invoke-direct {p0}, Lpgc;->getDaysEarnedView()Landroid/widget/TextView;
    ...
    invoke-direct {p0}, Lpgc;->getFriendsContainer()Landroidx/recyclerview/widget/RecyclerView;
