...
.method private a0()V
    ...
    invoke-direct {v0, p0}, Les6$a;-><init>(Les6;)V
...
.method private c0()V
    ...
    invoke-virtual {p0}, Les6;->componentManager()Lz5;
...
.method public final componentManager()Lz5;
    ...
    iget-object v0, p0, Les6;->g:Lz5;

    if-nez v0, :cond_1

    iget-object v0, p0, Les6;->h:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Les6;->g:Lz5;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Les6;->b0()Lz5;

    move-result-object v1

    iput-object v1, p0, Les6;->g:Lz5;
...
.method public d0()V
    ...
    invoke-virtual {p0}, Les6;->generatedComponent()Ljava/lang/Object;
    ...
    check-cast v1, Lcom/busuu/android/social/languagefilter/SocialLanguageFilterActivity;

    invoke-interface {v0, v1}, Lbce;->injectSocialLanguageFilterActivity(Lcom/busuu/android/social/languagefilter/SocialLanguageFilterActivity;)V
