...
.method private g()V
    ...
    iget-object v0, p0, Lhp6;->b:Landroid/content/ContextWrapper;
    ...
    iput-object v0, p0, Lhp6;->b:Landroid/content/ContextWrapper;
...
.method public final componentManager()Lbl5;
    ...
    iget-object v0, p0, Lhp6;->d:Lbl5;

    if-nez v0, :cond_1

    iget-object v0, p0, Lhp6;->e:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lhp6;->d:Lbl5;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lhp6;->f()Lbl5;

    move-result-object v1

    iput-object v1, p0, Lhp6;->d:Lbl5;
...
.method public bridge synthetic componentManager()Low5;
    ...
    invoke-virtual {p0}, Lhp6;->componentManager()Lbl5;
...
.method public h()V
    ...
    iget-boolean v0, p0, Lhp6;->f:Z

    if-nez v0, :cond_0

    const/4 v0, 0x1

    iput-boolean v0, p0, Lhp6;->f:Z

    invoke-virtual {p0}, Lhp6;->generatedComponent()Ljava/lang/Object;
    ...
    invoke-interface {v0, v1}, Lqt5;->injectFriendsFragment(Lot5;)V
