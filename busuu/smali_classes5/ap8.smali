...
.method static constructor <clinit>()V
    ...
    const-string v3, "getCancelButton()Landroid/widget/TextView;"
    ...
    const-string v5, "getLoginButton()Landroid/widget/TextView;"
    ...
    sput-object v2, Lap8;->c:[Lwl7;

    const/16 v0, 0x8

    sput v0, Lap8;->$stable:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget p1, Ly2c;->cancel:I

    invoke-static {p0, p1}, Lbu0;->bindView(Landroid/view/View;I)Loac;

    move-result-object p1

    iput-object p1, p0, Lap8;->a:Loac;

    sget p1, Ly2c;->login:I

    invoke-static {p0, p1}, Lbu0;->bindView(Landroid/view/View;I)Loac;

    move-result-object p1

    iput-object p1, p0, Lap8;->b:Loac;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    sget p2, Ld4c;->view_login_redirect_prompt:I
...
.method public synthetic constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILri3;)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lap8;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public static synthetic a(Lkotlin/jvm/functions/Function0;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Lap8;->d(Lkotlin/jvm/functions/Function0;Landroid/view/View;)V
...
.method public static synthetic b(Lkotlin/jvm/functions/Function0;Landroid/view/View;)V
    ...
    invoke-static {p0, p1}, Lap8;->c(Lkotlin/jvm/functions/Function0;Landroid/view/View;)V
...
.method private final getCancelButton()Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lap8;->a:Loac;

    sget-object v1, Lap8;->c:[Lwl7;
...
.method private final getLoginButton()Landroid/widget/TextView;
    .locals 3

    iget-object v0, p0, Lap8;->b:Loac;
...
# virtual methods
.method public final populate(Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0}, Lap8;->getCancelButton()Landroid/widget/TextView;

    move-result-object v0

    new-instance v1, Lyo8;

    invoke-direct {v1, p1}, Lyo8;-><init>(Lkotlin/jvm/functions/Function0;)V

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-direct {p0}, Lap8;->getLoginButton()Landroid/widget/TextView;

    move-result-object p1

    new-instance v0, Lzo8;

    invoke-direct {v0, p2}, Lzo8;-><init>(Lkotlin/jvm/functions/Function0;)V
