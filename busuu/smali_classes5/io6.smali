...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio6;->h:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lio6;->i:Z

    invoke-direct {p0}, Lio6;->a0()V
...
.method private a0()V
    ...
    new-instance v0, Lio6$a;

    invoke-direct {v0, p0}, Lio6$a;-><init>(Lio6;)V
...
.method private c0()V
    ...
    invoke-virtual {p0}, Lio6;->componentManager()Lz5;
...
.method public final componentManager()Lz5;
    ...
    iget-object v0, p0, Lio6;->g:Lz5;

    if-nez v0, :cond_1

    iget-object v0, p0, Lio6;->h:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lio6;->g:Lz5;

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lio6;->b0()Lz5;

    move-result-object v1

    iput-object v1, p0, Lio6;->g:Lz5;
...
.method public d0()V
    ...
    invoke-virtual {p0}, Lio6;->generatedComponent()Ljava/lang/Object;
    ...
    check-cast v1, Lcom/busuu/android/settings/notification/EditNotificationsActivity;

    invoke-interface {v0, v1}, Lja4;->injectEditNotificationsActivity(Lcom/busuu/android/settings/notification/EditNotificationsActivity;)V
