...
.method static constructor <clinit>()V
    ...
    const-string v5, "getBubble()Landroid/view/View;"
    ...
    const-string v6, "getTitle()Landroid/view/View;"
    ...
    const-string v7, "getSubtitle()Landroid/view/View;"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v1 .. v6}, Logc;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;IILri3;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Logc;->a:Loac;

    sget p1, Lv2c;->icon_bubble:I

    invoke-static {p0, p1}, Lbu0;->bindView(Landroid/view/View;I)Loac;

    move-result-object p1

    iput-object p1, p0, Logc;->b:Loac;

    sget p1, Lv2c;->title:I

    invoke-static {p0, p1}, Lbu0;->bindView(Landroid/view/View;I)Loac;

    move-result-object p1

    iput-object p1, p0, Logc;->c:Loac;

    sget p1, Lv2c;->subtitle:I

    invoke-static {p0, p1}, Lbu0;->bindView(Landroid/view/View;I)Loac;

    move-result-object p1

    iput-object p1, p0, Logc;->d:Loac;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    sget p2, La4c;->view_generic_header_card:I
...
.method public synthetic constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILri3;)V
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Logc;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
# virtual methods
.method public final getBubble()Landroid/view/View;
    .locals 3

    iget-object v0, p0, Logc;->b:Loac;

    sget-object v1, Logc;->e:[Lwl7;
...
.method public final getSubtitle()Landroid/view/View;
    .locals 3

    iget-object v0, p0, Logc;->d:Loac;
...
.method public final getTitle()Landroid/view/View;
    .locals 3

    iget-object v0, p0, Logc;->c:Loac;
