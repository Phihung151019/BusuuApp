...
.method public static b([[BI)Ldu0;
    .locals 8
    ...
    invoke-direct {v0, v2, v4}, Ldu0;-><init>(II)V

    invoke-virtual {v0}, Ldu0;->b()V

    invoke-virtual {v0}, Ldu0;->e()I
    ...
    invoke-virtual {v0, v7, v2}, Ldu0;->g(II)V
...
.method public static c(Lkea;Ljava/lang/String;IIIIZ)Ldu0;
    .locals 3
    ...
    invoke-virtual {p0, p1, p2, p6}, Lkea;->e(Ljava/lang/String;IZ)V

    invoke-virtual {p0}, Lkea;->f()Lln0;
    ...
    invoke-virtual {p1, p2, p6}, Lln0;->b(II)[[B
    ...
    invoke-virtual {p0, p3, p1}, Lln0;->b(II)[[B

    move-result-object p0

    if-eqz v0, :cond_3

    invoke-static {p0}, Lnea;->d([[B)[[B

    move-result-object p0

    :cond_3
    invoke-static {p0, p5}, Lnea;->b([[BI)Ldu0;
    ...
    :cond_4
    invoke-static {p1, p5}, Lnea;->b([[BI)Ldu0;
...
.method public a(Ljava/lang/String;Lcom/google/zxing/BarcodeFormat;IILjava/util/Map;)Ldu0;
    ...
    invoke-virtual {v1, v3}, Lkea;->h(Z)V
    ...
    invoke-virtual {v1, v3}, Lkea;->i(Lcom/google/zxing/pdf417/encoder/Compaction;)V
    ...
    invoke-virtual {v3}, Lsv3;->a()I

    move-result v4

    invoke-virtual {v3}, Lsv3;->c()I

    move-result v5

    invoke-virtual {v3}, Lsv3;->b()I

    move-result v6

    invoke-virtual {v3}, Lsv3;->d()I

    move-result v3

    invoke-virtual {v1, v4, v5, v6, v3}, Lkea;->j(IIII)V
    ...
    invoke-virtual {v1, v3}, Lkea;->k(Ljava/nio/charset/Charset;)V
    ...
    invoke-static/range {v1 .. v7}, Lnea;->c(Lkea;Ljava/lang/String;IIIIZ)Ldu0;
