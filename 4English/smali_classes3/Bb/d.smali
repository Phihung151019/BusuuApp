...
.method public a(Lxb/b;)Z
    ...
    :cond_1
    iget-object v0, p0, LBb/d;->m:Ljava/util/List;
...
.method public b(Lxb/b;)Z
    ...
    iput-object v0, p0, LBb/d;->m:Ljava/util/List;
...
.method public c(Lxb/b;)Z
    ...
    invoke-virtual {p0, p1}, LBb/d;->a(Lxb/b;)Z
...
.method d(Ljava/util/List;)V
    ...
    :try_start_0
    invoke-interface {v1}, Lxb/b;->dispose()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p1, v0}, Lyb/a;-><init>(Ljava/lang/Iterable;)V
...
.method public dispose()V
    ...
    iput-boolean v0, p0, LBb/d;->q:Z

    iget-object v0, p0, LBb/d;->m:Ljava/util/List;

    const/4 v1, 0x0

    iput-object v1, p0, LBb/d;->m:Ljava/util/List;

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p0, v0}, LBb/d;->d(Ljava/util/List;)V
