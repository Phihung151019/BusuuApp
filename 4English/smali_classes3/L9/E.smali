...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, LL9/m;-><init>()V

    return-void
.end method

.method public static a2(Ljava/lang/String;)LL9/E;
    .locals 2
...
.method public bridge synthetic I(LNa/a;)V
    ...
    invoke-virtual {p0, p1}, LL9/E;->Z1(LL9/h;)V
...
.method public bridge synthetic S1()LLa/b;
    ...
    invoke-virtual {p0}, LL9/E;->b2()LS8/d;
...
.method public Z1(LL9/h;)V
    ...
    invoke-virtual {p1}, Lcom/tdtapp/englisheveryday/entities/T;->getStoryPackDetailData()Lcom/tdtapp/englisheveryday/entities/T$a;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lcom/tdtapp/englisheveryday/entities/T$a;->getStories()Ljava/util/List;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v0, p0, LL9/E;->K:Landroid/widget/TextView;

    invoke-virtual {p1}, Lcom/tdtapp/englisheveryday/entities/T$a;->getName()Ljava/lang/String;
    ...
    iget-object v0, p0, LL9/E;->I:LL9/D;

    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView$h;->s()V

    invoke-virtual {p0}, LL9/m;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {p1}, Lcom/tdtapp/englisheveryday/entities/T$a;->getThumb()Ljava/lang/String;
    ...
    iget-object v0, p0, LL9/E;->M:Landroid/widget/ImageView;
...
.method public b2()LS8/d;
    ...
    iget-object v2, p0, LL9/E;->L:Ljava/lang/String;

    invoke-direct {v0, v1, v2, p0}, LL9/G;-><init>(Landroid/content/Context;Ljava/lang/String;LS8/e;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, LL9/E;->L:Ljava/lang/String;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, LL9/E;->L:Ljava/lang/String;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p0}, LL9/E$a;-><init>(LL9/E;)V
    ...
    iput-object p2, p0, LL9/E;->M:Landroid/widget/ImageView;
    ...
    iput-object p2, p0, LL9/E;->K:Landroid/widget/TextView;
    ...
    iput-object p2, p0, LL9/E;->J:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p2, p0, LL9/E;->J:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p1, p0, LL9/E;->N:Ljava/util/List;

    new-instance p2, LL9/D;

    invoke-direct {p2, p1, p0}, LL9/D;-><init>(Ljava/util/List;LL9/n;)V

    iput-object p2, p0, LL9/E;->I:LL9/D;

    iget-object p1, p0, LL9/E;->J:Landroidx/recyclerview/widget/RecyclerView;
