...
.method protected N(II)V
    ...
    invoke-interface {v0, p1, p2}, LO7/a;->B0(II)LMe/b;
...
.method protected z(Ljava/lang/Object;)Ljava/util/List;
    ...
    check-cast p1, Lcom/tdtapp/englisheveryday/entities/home/a;

    invoke-virtual {p1}, Lcom/tdtapp/englisheveryday/entities/home/a;->getData()Lcom/tdtapp/englisheveryday/entities/home/a$a;
    ...
    :try_start_0
    invoke-virtual {p1}, Lcom/tdtapp/englisheveryday/entities/home/a$a;->getHomeBlogItems()Ljava/util/List;

    move-result-object v0

    const-class v1, Lcom/tdtapp/englisheveryday/entities/BlogAd;
