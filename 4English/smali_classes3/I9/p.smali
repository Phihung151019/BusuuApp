...
.method public static a2(Ljava/lang/String;)LI9/p;
    .locals 2
...
.method public bridge synthetic I(LNa/a;)V
    ...
    invoke-virtual {p0, p1}, LI9/p;->Z1(LI9/f;)V
...
.method public bridge synthetic S1()LLa/b;
    ...
    invoke-virtual {p0}, LI9/p;->b2()LS8/d;
...
.method public Z1(LI9/f;)V
    ...
    check-cast p1, Lcom/tdtapp/englisheveryday/entities/z;

    invoke-virtual {p1}, Lcom/tdtapp/englisheveryday/entities/z;->getListeningPackDetailData()Lcom/tdtapp/englisheveryday/entities/z$a;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p1}, Lcom/tdtapp/englisheveryday/entities/z$a;->getListening()Ljava/util/List;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v0, p0, LI9/p;->K:Landroid/widget/TextView;

    invoke-virtual {p1}, Lcom/tdtapp/englisheveryday/entities/z$a;->getName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p0, LI9/p;->N:Ljava/util/List;
    ...
    iget-object v0, p0, LI9/p;->I:LL9/D;

    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView$h;->s()V

    invoke-virtual {p0}, LI9/i;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {p1}, Lcom/tdtapp/englisheveryday/entities/z$a;->getThumb()Ljava/lang/String;
    ...
    iget-object v0, p0, LI9/p;->M:Landroid/widget/ImageView;
...
.method public b2()LS8/d;
    ...
    iget-object v2, p0, LI9/p;->L:Ljava/lang/String;

    invoke-direct {v0, v1, v2, p0}, LI9/r;-><init>(Landroid/content/Context;Ljava/lang/String;LS8/e;)V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, LI9/p;->L:Ljava/lang/String;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p0}, LI9/p$a;-><init>(LI9/p;)V
    ...
    iput-object p2, p0, LI9/p;->M:Landroid/widget/ImageView;
    ...
    iput-object p2, p0, LI9/p;->K:Landroid/widget/TextView;
    ...
    iput-object p2, p0, LI9/p;->J:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p2, p0, LI9/p;->J:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p1, p0, LI9/p;->N:Ljava/util/List;

    new-instance p2, LL9/D;

    invoke-direct {p2, p1, p0}, LL9/D;-><init>(Ljava/util/List;LL9/n;)V

    iput-object p2, p0, LI9/p;->I:LL9/D;

    iget-object p1, p0, LI9/p;->J:Landroidx/recyclerview/widget/RecyclerView;
...
.method public x0(Lcom/tdtapp/englisheveryday/entities/NewsV2;)V
    .locals 3
    ...
    invoke-static {v0, p1, v1, v2}, Lcom/tdtapp/englisheveryday/features/newsdetail/NewsDetailWebviewActivity;->H2(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)V
