...
.field private static d:Lcom/google/firebase/messaging/k0;
...
.method private static e(Landroid/content/Context;Landroid/content/Intent;Z)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-static {p0, v0}, Lcom/google/firebase/messaging/m;->f(Landroid/content/Context;Ljava/lang/String;)Lcom/google/firebase/messaging/k0;
    ...
    invoke-virtual {p2, p0}, Lcom/google/firebase/messaging/U;->e(Landroid/content/Context;)Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-static {p0, v0, p1}, Lcom/google/firebase/messaging/f0;->f(Landroid/content/Context;Lcom/google/firebase/messaging/k0;Landroid/content/Intent;)V

    goto :goto_0

    :cond_1
    invoke-virtual {v0, p1}, Lcom/google/firebase/messaging/k0;->d(Landroid/content/Intent;)Lcom/google/android/gms/tasks/Task;
...
.method private static f(Landroid/content/Context;Ljava/lang/String;)Lcom/google/firebase/messaging/k0;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/m;->d:Lcom/google/firebase/messaging/k0;

    if-nez v1, :cond_0

    new-instance v1, Lcom/google/firebase/messaging/k0;

    invoke-direct {v1, p0, p1}, Lcom/google/firebase/messaging/k0;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    sput-object v1, Lcom/google/firebase/messaging/m;->d:Lcom/google/firebase/messaging/k0;
    ...
    :cond_0
    :goto_0
    sget-object p0, Lcom/google/firebase/messaging/m;->d:Lcom/google/firebase/messaging/k0;
...
.method private static synthetic h(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/Integer;
    ...
    invoke-virtual {v0, p0, p1}, Lcom/google/firebase/messaging/U;->g(Landroid/content/Context;Landroid/content/Intent;)I
