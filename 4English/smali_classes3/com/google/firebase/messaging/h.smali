...
.field private q:Landroid/os/Binder;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/h;->m:Ljava/util/concurrent/ExecutorService;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/messaging/h;->s:Ljava/lang/Object;

    const/4 v0, 0x0

    iput v0, p0, Lcom/google/firebase/messaging/h;->u:I
...
.method private d(Landroid/content/Intent;)V
    ...
    invoke-static {p1}, Lcom/google/firebase/messaging/f0;->c(Landroid/content/Intent;)V

    :cond_0
    iget-object p1, p0, Lcom/google/firebase/messaging/h;->s:Ljava/lang/Object;

    monitor-enter p1

    :try_start_0
    iget v0, p0, Lcom/google/firebase/messaging/h;->u:I
    ...
    iget v0, p0, Lcom/google/firebase/messaging/h;->t:I
...
.method private j(Landroid/content/Intent;)Lcom/google/android/gms/tasks/Task;
    ...
    iget-object v1, p0, Lcom/google/firebase/messaging/h;->m:Ljava/util/concurrent/ExecutorService;
...
.method public final declared-synchronized onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, Lcom/google/firebase/messaging/h;->q:Landroid/os/Binder;
    ...
    invoke-direct {p1, v0}, Lcom/google/firebase/messaging/h0;-><init>(Lcom/google/firebase/messaging/h0$a;)V

    iput-object p1, p0, Lcom/google/firebase/messaging/h;->q:Landroid/os/Binder;
...
.method public onDestroy()V
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/h;->m:Ljava/util/concurrent/ExecutorService;
...
.method public final onStartCommand(Landroid/content/Intent;II)I
    ...
    iget-object p2, p0, Lcom/google/firebase/messaging/h;->s:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    iput p3, p0, Lcom/google/firebase/messaging/h;->t:I

    iget p3, p0, Lcom/google/firebase/messaging/h;->u:I

    add-int/lit8 p3, p3, 0x1

    iput p3, p0, Lcom/google/firebase/messaging/h;->u:I
