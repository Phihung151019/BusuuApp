...
# static fields
.field private static e:Lcom/google/firebase/messaging/U;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/U;->b:Ljava/lang/Boolean;

    iput-object v0, p0, Lcom/google/firebase/messaging/U;->c:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/messaging/U;->d:Ljava/util/Queue;
...
.method private a(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/firebase/messaging/U;->f(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/String;
    ...
    :cond_1
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/google/firebase/messaging/U;->e(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-static {p1, p2}, Lcom/google/firebase/messaging/f0;->h(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method static declared-synchronized b()Lcom/google/firebase/messaging/U;
    .locals 2
...
.method private declared-synchronized f(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/String;
    ...
    :goto_0
    iget-object p1, p0, Lcom/google/firebase/messaging/U;->a:Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method c()Landroid/content/Intent;
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/U;->d:Ljava/util/Queue;
...
.method d(Landroid/content/Context;)Z
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/U;->c:Ljava/lang/Boolean;
    ...
    iput-object p1, p0, Lcom/google/firebase/messaging/U;->c:Ljava/lang/Boolean;

    :cond_1
    iget-object p1, p0, Lcom/google/firebase/messaging/U;->b:Ljava/lang/Boolean;
    ...
    :cond_2
    iget-object p1, p0, Lcom/google/firebase/messaging/U;->c:Ljava/lang/Boolean;
...
.method e(Landroid/content/Context;)Z
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/U;->b:Ljava/lang/Boolean;
    ...
    iput-object p1, p0, Lcom/google/firebase/messaging/U;->b:Ljava/lang/Boolean;
...
.method public g(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/firebase/messaging/U;->a(Landroid/content/Context;Landroid/content/Intent;)I
