...
.method private synthetic lambda$setApplicationContext$0(Landroid/content/Context;Lcom/google/firebase/perf/session/PerfSession;)V
    ...
    invoke-virtual {p1, p2, v0}, Lcom/google/firebase/perf/session/gauges/GaugeManager;->logGaugeMetadata(Ljava/lang/String;LH6/d;)Z

    :cond_0
    return-void
.end method

.method private logGaugeMetadataIfCollectionEnabled(LH6/d;)V
    .locals 2
    ...
    invoke-virtual {v0, v1, p1}, Lcom/google/firebase/perf/session/gauges/GaugeManager;->logGaugeMetadata(Ljava/lang/String;LH6/d;)Z

    :cond_0
    return-void
.end method

.method private startOrStopCollectingGauges(LH6/d;)V
    .locals 2
    ...
    invoke-virtual {v0, v1, p1}, Lcom/google/firebase/perf/session/gauges/GaugeManager;->startCollectingGauges(Lcom/google/firebase/perf/session/PerfSession;LH6/d;)V
...
.method public initializeGaugeCollection()V
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/perf/session/SessionManager;->logGaugeMetadataIfCollectionEnabled(LH6/d;)V

    invoke-direct {p0, v0}, Lcom/google/firebase/perf/session/SessionManager;->startOrStopCollectingGauges(LH6/d;)V
...
.method public onUpdateAppState(LH6/d;)V
    ...
    invoke-super {p0, p1}, Lcom/google/firebase/perf/application/b;->onUpdateAppState(LH6/d;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/firebase/perf/session/SessionManager;->updatePerfSession(LH6/d;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/perf/session/SessionManager;->startOrStopCollectingGauges(LH6/d;)V
...
.method public setApplicationContext(Landroid/content/Context;)V
    ...
    invoke-direct {v2, p0, p1, v0}, LE6/b;-><init>(Lcom/google/firebase/perf/session/SessionManager;Landroid/content/Context;Lcom/google/firebase/perf/session/PerfSession;)V
...
.method public updatePerfSession(LH6/d;)V
    .locals 4
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/perf/session/SessionManager;->logGaugeMetadataIfCollectionEnabled(LH6/d;)V
...
.method public updatePerfSessionIfExpired()Z
    ...
    invoke-virtual {p0, v0}, Lcom/google/firebase/perf/session/SessionManager;->updatePerfSession(LH6/d;)V
