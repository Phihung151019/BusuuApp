...
# static fields
.field private static final q:Ljava/lang/String; = "RecaptchaActivity"

.field private static final s:Ljava/util/concurrent/ExecutorService;

.field private static t:J

.field private static final u:LW4/v;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->s:Ljava/util/concurrent/ExecutorService;

    const-wide/16 v0, 0x0

    sput-wide v0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->t:J

    invoke-static {}, LW4/v;->a()LW4/v;

    move-result-object v0

    sput-object v0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->u:LW4/v;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->m:Z
...
.method private final k0()V
    ...
    sget-object v0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->u:LW4/v;
...
.method private final l0(Lcom/google/android/gms/common/api/Status;)V
    .locals 2
    ...
    sget-object p1, Lcom/google/firebase/auth/internal/RecaptchaActivity;->u:LW4/v;
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    :cond_0
    sget-object p1, Lcom/google/firebase/auth/internal/RecaptchaActivity;->q:Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/google/firebase/auth/internal/RecaptchaActivity;->k0()V
    ...
    sget-wide v2, Lcom/google/firebase/auth/internal/RecaptchaActivity;->t:J
    ...
    iput-boolean p1, p0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->m:Z
...
.method protected final onResume()V
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/auth/internal/RecaptchaActivity;->l0(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v5, v6, v7, v4}, LW4/A;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v5, Lcom/google/firebase/auth/internal/RecaptchaActivity;->q:Ljava/lang/String;
    ...
    invoke-static {v5}, LW4/f;->a(Ljava/lang/String;)Lcom/google/android/gms/common/api/Status;

    move-result-object v5

    invoke-direct {p0, v5}, Lcom/google/firebase/auth/internal/RecaptchaActivity;->l0(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-static {v4}, LP4/f;->o(Ljava/lang/String;)LP4/f;

    move-result-object v1

    invoke-virtual {v1}, LP4/f;->r()Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1}, LW4/B;->a(Landroid/content/Context;Ljava/lang/String;)LW4/B;

    move-result-object v0

    invoke-virtual {v0, v3}, LW4/B;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-wide v3, Lcom/google/firebase/auth/internal/RecaptchaActivity;->t:J

    iput-boolean v2, p0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->m:Z
    ...
    invoke-virtual {v4, v3}, La0/a;->d(Landroid/content/Intent;)Z
    ...
    :cond_5
    iget-boolean v0, p0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->m:Z
    ...
    invoke-direct/range {v3 .. v8}, Lcom/google/android/gms/internal/firebase-auth-api/zzwg;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;LP4/f;Lcom/google/android/gms/internal/firebase-auth-api/zzwi;)V

    sget-object v3, Lcom/google/firebase/auth/internal/RecaptchaActivity;->s:Ljava/util/concurrent/ExecutorService;
    ...
    sget-object v2, Lcom/google/firebase/auth/internal/RecaptchaActivity;->q:Ljava/lang/String;
    ...
    :goto_1
    iput-boolean v1, p0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->m:Z
...
.method protected final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/google/firebase/auth/internal/RecaptchaActivity;->m:Z
...
.method public final zzb(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri$Builder;
    ...
    invoke-static {p1}, LP4/f;->o(Ljava/lang/String;)LP4/f;

    move-result-object v9

    invoke-static {v9}, Lcom/google/firebase/auth/FirebaseAuth;->getInstance(LP4/f;)Lcom/google/firebase/auth/FirebaseAuth;
    ...
    invoke-virtual/range {v2 .. v7}, LW4/A;->e(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v2

    invoke-virtual {v9}, LP4/f;->r()Ljava/lang/String;

    move-result-object v3

    invoke-static {v2, v3}, LW4/B;->a(Landroid/content/Context;Ljava/lang/String;)LW4/B;

    move-result-object v2

    invoke-virtual {v2}, LW4/B;->c()Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/auth/internal/RecaptchaActivity;->l0(Lcom/google/android/gms/common/api/Status;)V
...
.method public final zze(Ljava/lang/String;Lcom/google/android/gms/common/api/Status;)V
    ...
    :cond_0
    invoke-direct {p0, p2}, Lcom/google/firebase/auth/internal/RecaptchaActivity;->l0(Lcom/google/android/gms/common/api/Status;)V
