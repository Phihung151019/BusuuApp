...
.field private static final t:LW4/v;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->t:LW4/v;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->m:Ljava/util/concurrent/Executor;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->q:Z
...
.method private final l0()V
    ...
    invoke-virtual {v1, v0}, La0/a;->d(Landroid/content/Intent;)Z

    move-result v0

    if-nez v0, :cond_0

    sget-object v0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->t:LW4/v;

    const-string v1, "WEB_CONTEXT_CANCELED"

    invoke-static {v1}, LW4/f;->a(Ljava/lang/String;)Lcom/google/android/gms/common/api/Status;

    move-result-object v1

    invoke-virtual {v0, p0, v1}, LW4/v;->d(Landroid/content/Context;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v0, p0}, LW4/v;->b(Landroid/content/Context;)V
...
.method private final m0(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-static {v0, p1}, LW4/u;->b(Landroid/content/Intent;Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v0, v1, p1}, LW4/v;->d(Landroid/content/Context;Lcom/google/android/gms/common/api/Status;)V

    goto :goto_0

    :cond_0
    sget-object p1, Lcom/google/firebase/auth/internal/GenericIdpActivity;->t:LW4/v;

    invoke-virtual {p1, p0}, LW4/v;->b(Landroid/content/Context;)V
...
# virtual methods
.method public final k0(Landroid/net/Uri$Builder;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri$Builder;
    .locals 21
    ...
    invoke-virtual/range {v5 .. v13}, LW4/A;->d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {v15}, LP4/f;->o(Ljava/lang/String;)LP4/f;
    ...
    invoke-virtual {v5}, LP4/f;->r()Ljava/lang/String;

    move-result-object v5

    invoke-static {v6, v5}, LW4/B;->a(Landroid/content/Context;Ljava/lang/String;)LW4/B;

    move-result-object v5

    invoke-virtual {v5}, LW4/B;->c()Ljava/lang/String;
    ...
    invoke-direct {v0, v1}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->m0(Lcom/google/android/gms/common/api/Status;)V
...
.method protected final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {p0}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->l0()V
    ...
    iput-boolean p1, p0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->q:Z
...
.method protected final onResume()V
    ...
    invoke-static {v0}, LW4/u;->a(Ljava/lang/String;)Lcom/google/android/gms/common/api/Status;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->m0(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {v2, p0, v6, v5}, LW4/A;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)LW4/z;
    ...
    invoke-virtual {v2}, LW4/z;->a()Ljava/lang/String;

    move-result-object v5

    invoke-static {v5}, LP4/f;->o(Ljava/lang/String;)LP4/f;
    ...
    invoke-static {v0, v5}, LW4/B;->a(Landroid/content/Context;Ljava/lang/String;)LW4/B;

    move-result-object v0

    invoke-virtual {v0, v4}, LW4/B;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v4}, Lcom/google/android/gms/internal/firebase-auth-api/zzaaa;-><init>(LW4/z;Ljava/lang/String;)V

    invoke-virtual {v2}, LW4/z;->e()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2}, LW4/z;->b()Ljava/lang/String;
    ...
    iput-boolean v3, p0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->q:Z
    ...
    invoke-virtual {v5, v1}, La0/a;->d(Landroid/content/Intent;)Z
    ...
    :cond_7
    iget-boolean v0, p0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->q:Z
    ...
    invoke-static {v8}, Lcom/google/android/gms/internal/firebase-auth-api/zzyb;->zzg(LP4/f;)Z
    ...
    invoke-direct/range {v4 .. v9}, Lcom/google/android/gms/internal/firebase-auth-api/zzwg;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/content/Intent;LP4/f;Lcom/google/android/gms/internal/firebase-auth-api/zzwi;)V

    iget-object v1, p0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->m:Ljava/util/concurrent/Executor;
    ...
    :cond_8
    invoke-virtual {v8}, LP4/f;->q()LP4/n;
    ...
    invoke-virtual {p0, v0, v1, v5, v6}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->k0(Landroid/net/Uri$Builder;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri$Builder;
    ...
    :goto_2
    iput-boolean v2, p0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->q:Z
...
.method protected final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/google/firebase/auth/internal/GenericIdpActivity;->q:Z
...
.method public final zzb(Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri$Builder;
    ...
    invoke-virtual {p0, v0, p1, p2, p3}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->k0(Landroid/net/Uri$Builder;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri$Builder;
...
.method public final zze(Ljava/lang/String;Lcom/google/android/gms/common/api/Status;)V
    ...
    :cond_0
    invoke-direct {p0, p2}, Lcom/google/firebase/auth/internal/GenericIdpActivity;->m0(Lcom/google/android/gms/common/api/Status;)V
...
.method public final zzf(Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-direct {p2}, Landroidx/browser/customtabs/d$d;-><init>()V
    ...
    invoke-virtual {p2, p0, p1}, Landroidx/browser/customtabs/d;->a(Landroid/content/Context;Landroid/net/Uri;)V
