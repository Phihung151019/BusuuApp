.class Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;
...
.method constructor <init>(Lcom/tdtapp/englisheveryday/features/vocabulary/s1;)V
    ...
    iput-object p1, p0, Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;->m:Lcom/tdtapp/englisheveryday/features/vocabulary/s1;
...
.method public static synthetic a(Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;Ljava/util/List;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;->d(Ljava/util/List;)V

    return-void
.end method

.method public static synthetic b(Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;Ljava/util/List;)Ljava/util/List;
    .locals 0

    invoke-direct {p0, p1}, Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;->c(Ljava/util/List;)Ljava/util/List;
...
.method private synthetic c(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;->m:Lcom/tdtapp/englisheveryday/features/vocabulary/s1;
...
.method private synthetic d(Ljava/util/List;)V
    ...
    iget-object p1, p0, Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;->m:Lcom/tdtapp/englisheveryday/features/vocabulary/s1;
...
.method public onDataChanged()V
    ...
    invoke-static {v0}, Lcom/tdtapp/englisheveryday/features/vocabulary/s1;->c2(Lcom/tdtapp/englisheveryday/features/vocabulary/s1;)LX9/X;
    ...
    iget-object v1, p0, Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;->m:Lcom/tdtapp/englisheveryday/features/vocabulary/s1;
    ...
    new-instance v2, Lcom/tdtapp/englisheveryday/features/vocabulary/w1;

    invoke-direct {v2, p0, v1}, Lcom/tdtapp/englisheveryday/features/vocabulary/w1;-><init>(Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;Ljava/util/List;)V
    ...
    new-instance v2, Lcom/tdtapp/englisheveryday/features/vocabulary/x1;

    invoke-direct {v2, p0}, Lcom/tdtapp/englisheveryday/features/vocabulary/x1;-><init>(Lcom/tdtapp/englisheveryday/features/vocabulary/s1$d;)V
