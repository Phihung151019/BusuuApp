...
# instance fields
.field m:Lcom/onesignal/JobIntentService$CompatJobEngine;

.field q:Lcom/onesignal/JobIntentService$WorkEnqueuer;

.field s:Lcom/onesignal/JobIntentService$CommandProcessor;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/onesignal/JobIntentService;->x:Ljava/lang/Object;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcom/onesignal/JobIntentService;->y:Ljava/util/HashMap;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/onesignal/JobIntentService;->t:Z

    iput-boolean v0, p0, Lcom/onesignal/JobIntentService;->u:Z

    iput-boolean v0, p0, Lcom/onesignal/JobIntentService;->v:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/onesignal/JobIntentService;->w:Ljava/util/ArrayList;
...
.method public static c(Landroid/content/Context;Landroid/content/ComponentName;ILandroid/content/Intent;Z)V
    ...
    sget-object v0, Lcom/onesignal/JobIntentService;->x:Ljava/lang/Object;
...
.method static f(Landroid/content/Context;Landroid/content/ComponentName;ZIZ)Lcom/onesignal/JobIntentService$WorkEnqueuer;
    ...
    sget-object v1, Lcom/onesignal/JobIntentService;->y:Ljava/util/HashMap;
...
.method a()Lcom/onesignal/JobIntentService$GenericWorkItem;
    ...
    iget-object v0, p0, Lcom/onesignal/JobIntentService;->m:Lcom/onesignal/JobIntentService$CompatJobEngine;
    ...
    :cond_0
    iget-object v0, p0, Lcom/onesignal/JobIntentService;->w:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/onesignal/JobIntentService;->w:Ljava/util/ArrayList;
...
.method b()Z
    ...
    iget-object v0, p0, Lcom/onesignal/JobIntentService;->s:Lcom/onesignal/JobIntentService$CommandProcessor;

    if-eqz v0, :cond_0

    iget-boolean v1, p0, Lcom/onesignal/JobIntentService;->t:Z
...
.method e(Z)V
    ...
    iput-object v0, p0, Lcom/onesignal/JobIntentService;->s:Lcom/onesignal/JobIntentService$CommandProcessor;

    iget-object v0, p0, Lcom/onesignal/JobIntentService;->q:Lcom/onesignal/JobIntentService$WorkEnqueuer;
    ...
    :cond_0
    iget-object p1, p0, Lcom/onesignal/JobIntentService;->s:Lcom/onesignal/JobIntentService$CommandProcessor;
...
.method i()V
    ...
    :try_start_0
    iput-object v1, p0, Lcom/onesignal/JobIntentService;->s:Lcom/onesignal/JobIntentService$CommandProcessor;
    ...
    :cond_0
    iget-boolean v1, p0, Lcom/onesignal/JobIntentService;->v:Z

    if-nez v1, :cond_1

    iget-object v1, p0, Lcom/onesignal/JobIntentService;->q:Lcom/onesignal/JobIntentService$WorkEnqueuer;
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object p1, p0, Lcom/onesignal/JobIntentService;->m:Lcom/onesignal/JobIntentService$CompatJobEngine;
...
.method public onCreate()V
    ...
    iput-object v0, p0, Lcom/onesignal/JobIntentService;->m:Lcom/onesignal/JobIntentService$CompatJobEngine;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/onesignal/JobIntentService;->q:Lcom/onesignal/JobIntentService$WorkEnqueuer;
...
.method public onDestroy()V
    ...
    :try_start_0
    iput-boolean v1, p0, Lcom/onesignal/JobIntentService;->v:Z
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    iget-object p2, p0, Lcom/onesignal/JobIntentService;->q:Lcom/onesignal/JobIntentService$WorkEnqueuer;

    invoke-virtual {p2}, Lcom/onesignal/JobIntentService$WorkEnqueuer;->serviceStartReceived()V

    iget-object p2, p0, Lcom/onesignal/JobIntentService;->w:Ljava/util/ArrayList;
