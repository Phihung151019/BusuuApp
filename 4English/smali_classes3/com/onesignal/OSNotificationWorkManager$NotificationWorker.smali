...
.method private a(Landroid/content/Context;ILorg/json/JSONObject;ZLjava/lang/Long;)V
    ...
    invoke-direct {v7, v0, p3, p2}, Lcom/onesignal/v0;-><init>(Ljava/util/List;Lorg/json/JSONObject;I)V

    new-instance p2, Lcom/onesignal/x0;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/onesignal/x0;-><init>(Landroid/content/Context;Lcom/onesignal/v0;Lorg/json/JSONObject;ZZLjava/lang/Long;)V

    new-instance p3, Lcom/onesignal/F0;

    invoke-direct {p3, p2, v7}, Lcom/onesignal/F0;-><init>(Lcom/onesignal/x0;Lcom/onesignal/v0;)V

    sget-object p2, Lcom/onesignal/h1;->m:Lcom/onesignal/h1$F;

    if-eqz p2, :cond_0

    :try_start_0
    invoke-interface {p2, p1, p3}, Lcom/onesignal/h1$F;->remoteNotificationReceived(Landroid/content/Context;Lcom/onesignal/F0;)V
    :try_end_0
    ...
    invoke-static {p2, p4, p1}, Lcom/onesignal/h1;->b(Lcom/onesignal/h1$z;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {p3, v7}, Lcom/onesignal/F0;->b(Lcom/onesignal/v0;)V
