...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;LE/n;)V
    ...
    invoke-virtual {v7, p2}, Lcom/google/android/material/textfield/z;->A(LE/n;)V

    if-nez v6, :cond_4

    invoke-virtual {p2, v0}, LE/n;->H0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, LE/n;->H0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v3}, LE/n;->H0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, LE/n;->s0(Ljava/lang/CharSequence;)V

    invoke-virtual {p2, v6}, LE/n;->D0(Z)V
    ...
    :goto_5
    invoke-virtual {p2, v4}, LE/n;->u0(I)V
    ...
    :goto_6
    invoke-virtual {p2, v2}, LE/n;->n0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v0}, LE/n;->t0(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/android/material/textfield/s;->o(Landroid/view/View;LE/n;)V
