...
.field private final u:Landroidx/appcompat/widget/I;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, p3, v0}, LC4/a;->c(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    iput p3, p0, Lcom/google/android/material/textfield/v;->y:F
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/v;->z:Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2, p3}, Lw4/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p3

    iput-object p3, p0, Lcom/google/android/material/textfield/v;->B:Landroid/content/res/ColorStateList;
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/v;->v:Landroid/view/accessibility/AccessibilityManager;

    new-instance p3, Landroidx/appcompat/widget/I;

    invoke-direct {p3, p1}, Landroidx/appcompat/widget/I;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lcom/google/android/material/textfield/v;->u:Landroidx/appcompat/widget/I;

    const/4 p1, 0x1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/I;->I(Z)V

    invoke-virtual {p3, p0}, Landroidx/appcompat/widget/I;->C(Landroid/view/View;)V

    const/4 p1, 0x2

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/I;->H(I)V

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object p1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/I;->m(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/I;->K(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method static synthetic b(Lcom/google/android/material/textfield/v;)Landroidx/appcompat/widget/I;
    .locals 0

    iget-object p0, p0, Lcom/google/android/material/textfield/v;->u:Landroidx/appcompat/widget/I;
...
.method private j()I
    ...
    iget-object v5, p0, Lcom/google/android/material/textfield/v;->u:Landroidx/appcompat/widget/I;

    invoke-virtual {v5}, Landroidx/appcompat/widget/I;->w()I
    ...
    :cond_3
    iget-object v0, p0, Lcom/google/android/material/textfield/v;->u:Landroidx/appcompat/widget/I;

    invoke-virtual {v0}, Landroidx/appcompat/widget/I;->getBackground()Landroid/graphics/drawable/Drawable;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/v;->u:Landroidx/appcompat/widget/I;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/I;->m(Landroid/widget/ListAdapter;)V
...
.method public setDropDownBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/I;->b(Landroid/graphics/drawable/Drawable;)V
...
.method public setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/I;->L(Landroid/widget/AdapterView$OnItemSelectedListener;)V
