...
# static fields
.field private static final A:Lio/grpc/internal/D$g;
...
.field private final j:Lkb/q0;

.field private final k:LJ4/t;
...
.field private final p:Lkb/d0$h;

.field private q:Z

.field private r:Lkb/d0$e;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v0}, Lio/grpc/internal/D;->v(Ljava/lang/ClassLoader;)Lio/grpc/internal/D$g;

    move-result-object v0

    sput-object v0, Lio/grpc/internal/D;->A:Lio/grpc/internal/D$g;

    return-void
.end method

.method protected constructor <init>(Ljava/lang/String;Ljava/lang/String;Lkb/d0$b;Lio/grpc/internal/M0$d;LJ4/t;Z)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object p1, Lio/grpc/internal/D$d;->m:Lio/grpc/internal/D$d;
    ...
    iput-object p4, p0, Lio/grpc/internal/D;->h:Lio/grpc/internal/M0$d;
    ...
    invoke-static {p2, p4}, LJ4/o;->p(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p4, v2, p2}, LJ4/o;->k(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p2, p4, p1}, LJ4/o;->q(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p3}, Lkb/d0$b;->a()I
    ...
    :goto_1
    invoke-virtual {p3}, Lkb/d0$b;->c()Lkb/i0;
    ...
    iput-object p1, p0, Lio/grpc/internal/D;->a:Lkb/i0;

    invoke-static {p6}, Lio/grpc/internal/D;->s(Z)J
    ...
    iput-object p1, p0, Lio/grpc/internal/D;->k:LJ4/t;

    invoke-virtual {p3}, Lkb/d0$b;->f()Lkb/q0;
    ...
    iput-object p1, p0, Lio/grpc/internal/D;->j:Lkb/q0;

    invoke-virtual {p3}, Lkb/d0$b;->b()Ljava/util/concurrent/Executor;
    ...
    invoke-virtual {p3}, Lkb/d0$b;->e()Lkb/d0$h;
    ...
    iput-object p1, p0, Lio/grpc/internal/D;->p:Lkb/d0$h;
...
.method private A()Ljava/util/List;
    ...
    invoke-direct {v3, v4}, Lkb/y;-><init>(Ljava/net/SocketAddress;)V
    ...
    :try_start_1
    invoke-static {v0}, LJ4/y;->f(Ljava/lang/Throwable;)V
...
.method private B()Lkb/d0$c;
    ...
    invoke-virtual {p0}, Lio/grpc/internal/D;->u()Lio/grpc/internal/D$f;
    ...
    invoke-interface {v1, v2}, Lio/grpc/internal/D$f;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {}, Lio/grpc/internal/D;->r()Ljava/lang/String;

    move-result-object v2

    invoke-static {v0, v1, v2}, Lio/grpc/internal/D;->x(Ljava/util/List;Ljava/util/Random;Ljava/lang/String;)Lkb/d0$c;
    ...
    invoke-static {v0}, Lkb/d0$c;->b(Lkb/m0;)Lkb/d0$c;
    ...
    iget-object v1, p0, Lio/grpc/internal/D;->p:Lkb/d0$h;

    invoke-virtual {v1, v0}, Lkb/d0$h;->a(Ljava/util/Map;)Lkb/d0$c;
...
.method static synthetic f(Lio/grpc/internal/D;)Lkb/q0;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/D;->j:Lkb/q0;
...
.method static synthetic h(Lio/grpc/internal/D;)Ljava/lang/String;
    .locals 0
...
.method static synthetic i(Lio/grpc/internal/D;)Lkb/y;
    .locals 0
    ...
    invoke-direct {p0}, Lio/grpc/internal/D;->n()Lkb/y;
...
.method static synthetic j(Lio/grpc/internal/D;)J
    .locals 2
...
.method static synthetic k(Lio/grpc/internal/D;)LJ4/t;
    .locals 0

    iget-object p0, p0, Lio/grpc/internal/D;->k:LJ4/t;

    return-object p0
.end method

.method static synthetic l(Lio/grpc/internal/D;Z)Z
    .locals 0
...
.method private m()Z
    ...
    iget-object v0, p0, Lio/grpc/internal/D;->k:LJ4/t;

    sget-object v1, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v0, v1}, LJ4/t;->d(Ljava/util/concurrent/TimeUnit;)J
...
.method private n()Lkb/y;
    ...
    iget-object v1, p0, Lio/grpc/internal/D;->a:Lkb/i0;

    invoke-interface {v1, v0}, Lkb/i0;->a(Ljava/net/SocketAddress;)Lkb/h0;
    ...
    invoke-direct {v1, v0}, Lkb/y;-><init>(Ljava/net/SocketAddress;)V
...
.method private static r()Ljava/lang/String;
    ...
    sget-object v0, Lio/grpc/internal/D;->B:Ljava/lang/String;
    ...
    sput-object v0, Lio/grpc/internal/D;->B:Ljava/lang/String;
    :try_end_0
...
.method static v(Ljava/lang/ClassLoader;)Lio/grpc/internal/D$g;
    .locals 4
    ...
    check-cast p0, Lio/grpc/internal/D$g;
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_0

    invoke-interface {p0}, Lio/grpc/internal/D$g;->b()Ljava/lang/Throwable;
...
.method static w(Ljava/util/Map;Ljava/util/Random;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v2, v3, v1}, LJ4/A;->a(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_3
    :goto_1
    invoke-static {p0}, Lio/grpc/internal/D;->t(Ljava/util/Map;)Ljava/lang/Double;
    ...
    invoke-static {v4, v5, v0}, LJ4/A;->a(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_5
    invoke-static {p0}, Lio/grpc/internal/D;->q(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-direct {p2, p0}, LJ4/B;-><init>(Ljava/lang/String;)V

    throw p2
.end method

.method static x(Ljava/util/List;Ljava/util/Random;Ljava/lang/String;)Lkb/d0$c;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-static {p0}, Lio/grpc/internal/D;->y(Ljava/util/List;)Ljava/util/List;
    ...
    :try_start_1
    invoke-static {v1, p1, p2}, Lio/grpc/internal/D;->w(Ljava/util/Map;Ljava/util/Random;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-virtual {p1, p0}, Lkb/m0;->q(Ljava/lang/Throwable;)Lkb/m0;

    move-result-object p0

    invoke-static {p0}, Lkb/d0$c;->b(Lkb/m0;)Lkb/d0$c;
    ...
    :cond_2
    invoke-static {v1}, Lkb/d0$c;->a(Ljava/lang/Object;)Lkb/d0$c;
...
.method private z()V
    ...
    invoke-direct {p0}, Lio/grpc/internal/D;->m()Z
    ...
    iget-object v2, p0, Lio/grpc/internal/D;->r:Lkb/d0$e;

    invoke-direct {v1, p0, v2}, Lio/grpc/internal/D$e;-><init>(Lio/grpc/internal/D;Lkb/d0$e;)V
...
.method public b()V
    ...
    iget-object v0, p0, Lio/grpc/internal/D;->r:Lkb/d0$e;
    ...
    invoke-direct {p0}, Lio/grpc/internal/D;->z()V
...
.method public c()V
    ...
    iget-object v1, p0, Lio/grpc/internal/D;->h:Lio/grpc/internal/M0$d;
...
.method public d(Lkb/d0$e;)V
    ...
    iget-object v0, p0, Lio/grpc/internal/D;->h:Lio/grpc/internal/M0$d;
    ...
    iput-object p1, p0, Lio/grpc/internal/D;->r:Lkb/d0$e;
...
.method protected o(Z)Lio/grpc/internal/D$c;
    .locals 4
    ...
    :try_start_0
    invoke-direct {p0}, Lio/grpc/internal/D;->A()Ljava/util/List;
    ...
    sget-object p1, Lkb/m0;->t:Lkb/m0;
    ...
    invoke-virtual {p1, v2}, Lkb/m0;->r(Ljava/lang/String;)Lkb/m0;

    move-result-object p1

    invoke-virtual {p1, v1}, Lkb/m0;->q(Ljava/lang/Throwable;)Lkb/m0;

    move-result-object p1

    invoke-static {v0, p1}, Lio/grpc/internal/D$c;->d(Lio/grpc/internal/D$c;Lkb/m0;)Lkb/m0;
    ...
    invoke-direct {p0}, Lio/grpc/internal/D;->B()Lkb/d0$c;

    move-result-object p1

    invoke-static {v0, p1}, Lio/grpc/internal/D$c;->f(Lio/grpc/internal/D$c;Lkb/d0$c;)Lkb/d0$c;

    :cond_1
    return-object v0
.end method

.method protected u()Lio/grpc/internal/D$f;
    .locals 3
    ...
    invoke-static {v0, v1, v2}, Lio/grpc/internal/D;->C(ZZLjava/lang/String;)Z
    ...
    check-cast v0, Lio/grpc/internal/D$f;

    if-nez v0, :cond_1

    sget-object v1, Lio/grpc/internal/D;->A:Lio/grpc/internal/D$g;

    if-eqz v1, :cond_1

    invoke-interface {v1}, Lio/grpc/internal/D$g;->a()Lio/grpc/internal/D$f;
