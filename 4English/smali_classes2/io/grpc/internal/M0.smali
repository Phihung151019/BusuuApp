...
.method constructor <init>(Lio/grpc/internal/M0$e;)V
    ...
    iput-object v0, p0, Lio/grpc/internal/M0;->a:Ljava/util/IdentityHashMap;

    iput-object p1, p0, Lio/grpc/internal/M0;->b:Lio/grpc/internal/M0$e;
...
.method static synthetic a(Lio/grpc/internal/M0;)Ljava/util/IdentityHashMap;
    ...
    iget-object p0, p0, Lio/grpc/internal/M0;->a:Ljava/util/IdentityHashMap;
...
.method static synthetic b(Lio/grpc/internal/M0;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iget-object p0, p0, Lio/grpc/internal/M0;->c:Ljava/util/concurrent/ScheduledExecutorService;
...
.method static synthetic c(Lio/grpc/internal/M0;Ljava/util/concurrent/ScheduledExecutorService;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iput-object p1, p0, Lio/grpc/internal/M0;->c:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public static d(Lio/grpc/internal/M0$d;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p0}, Lio/grpc/internal/M0;->e(Lio/grpc/internal/M0$d;)Ljava/lang/Object;
...
.method public static f(Lio/grpc/internal/M0$d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p0, p1}, Lio/grpc/internal/M0;->g(Lio/grpc/internal/M0$d;Ljava/lang/Object;)Ljava/lang/Object;
...
.method declared-synchronized e(Lio/grpc/internal/M0$d;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v0, p0, Lio/grpc/internal/M0;->a:Ljava/util/IdentityHashMap;
    ...
    invoke-interface {p1}, Lio/grpc/internal/M0$d;->a()Ljava/lang/Object;

    move-result-object v1

    invoke-direct {v0, v1}, Lio/grpc/internal/M0$c;-><init>(Ljava/lang/Object;)V

    iget-object v1, p0, Lio/grpc/internal/M0;->a:Ljava/util/IdentityHashMap;
...
.method declared-synchronized g(Lio/grpc/internal/M0$d;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v2, v1}, LJ4/o;->v(ZLjava/lang/Object;)V

    iget-object v1, p0, Lio/grpc/internal/M0;->c:Ljava/util/concurrent/ScheduledExecutorService;

    if-nez v1, :cond_3

    iget-object v1, p0, Lio/grpc/internal/M0;->b:Lio/grpc/internal/M0$e;

    invoke-interface {v1}, Lio/grpc/internal/M0$e;->a()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v1

    iput-object v1, p0, Lio/grpc/internal/M0;->c:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v3, p0, v0, p1, p2}, Lio/grpc/internal/M0$b;-><init>(Lio/grpc/internal/M0;Lio/grpc/internal/M0$c;Lio/grpc/internal/M0$d;Ljava/lang/Object;)V
