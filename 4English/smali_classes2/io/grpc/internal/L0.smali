...
.method private static f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Set;
    ...
    :cond_0
    invoke-static {p0}, Lio/grpc/internal/L0;->u(Ljava/util/List;)Ljava/util/Set;
...
.method static p(Ljava/util/Map;)Ljava/util/Set;
    ...
    invoke-static {p0, v0}, Lio/grpc/internal/L0;->f(Ljava/util/Map;Ljava/lang/String;)Ljava/util/Set;

    move-result-object p0

    if-nez p0, :cond_0

    const-class p0, Lkb/m0$b;
    ...
    :cond_0
    sget-object v1, Lkb/m0$b;->s:Lkb/m0$b;
    ...
    invoke-static {v1, v2, v0}, LJ4/A;->a(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method static s(Ljava/util/Map;)Ljava/util/Set;
    ...
    invoke-static {v2, v3, v0}, LJ4/A;->a(ZLjava/lang/String;Ljava/lang/Object;)V
...
.method private static u(Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-static {v4, v7, v1}, LJ4/A;->a(ZLjava/lang/String;Ljava/lang/Object;)V

    invoke-static {v3}, Lkb/m0;->i(I)Lkb/m0;

    move-result-object v3

    invoke-virtual {v3}, Lkb/m0;->n()Lkb/m0$b;

    move-result-object v3

    invoke-virtual {v3}, Lkb/m0$b;->d()I
    ...
    invoke-static {v5, v2, v1}, LJ4/A;->a(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v2}, Lkb/m0$b;->valueOf(Ljava/lang/String;)Lkb/m0$b;
    ...
    invoke-direct {v0, v1, p0}, LJ4/B;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method static v(Ljava/util/Map;)Lio/grpc/internal/D0$D;
    ...
    invoke-static {v2, v5}, LJ4/o;->v(ZLjava/lang/Object;)V
    ...
    invoke-static {v3, v1}, LJ4/o;->v(ZLjava/lang/Object;)V

    new-instance v1, Lio/grpc/internal/D0$D;

    invoke-direct {v1, v0, p0}, Lio/grpc/internal/D0$D;-><init>(FF)V
...
.method public static y(Ljava/util/List;Lkb/W;)Lkb/d0$c;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1, v2}, Lkb/W;->d(Ljava/lang/String;)Lkb/V;
    ...
    const-class p0, Lio/grpc/internal/L0;
    ...
    invoke-virtual {v3, p0}, Lkb/V;->e(Ljava/util/Map;)Lkb/d0$c;

    move-result-object p0

    invoke-virtual {p0}, Lkb/d0$c;->d()Lkb/m0;
    ...
    invoke-virtual {p0}, Lkb/d0$c;->c()Ljava/lang/Object;

    move-result-object p0

    invoke-direct {p1, v3, p0}, Lio/grpc/internal/L0$b;-><init>(Lkb/V;Ljava/lang/Object;)V
    ...
    :cond_3
    sget-object p0, Lkb/m0;->g:Lkb/m0;
    ...
    invoke-virtual {p0, p1}, Lkb/m0;->r(Ljava/lang/String;)Lkb/m0;
...
.method public static z(Ljava/util/Map;)Lio/grpc/internal/L0$a;
    ...
    invoke-direct {v1, v0, p0}, Lio/grpc/internal/L0$a;-><init>(Ljava/lang/String;Ljava/util/Map;)V
