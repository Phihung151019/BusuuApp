.class public final Lorg/readium/r2/streamer/server/handler/JSHandler;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/readium/r2/streamer/server/handler/JSHandler$Companion;
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lorg/readium/r2/streamer/server/handler/JSHandler;",
...
# static fields
.field public static final Companion:Lorg/readium/r2/streamer/server/handler/JSHandler$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lorg/readium/r2/streamer/server/handler/JSHandler$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lorg/readium/r2/streamer/server/handler/JSHandler$Companion;-><init>(Lkotlin/jvm/internal/g;)V

    sput-object v0, Lorg/readium/r2/streamer/server/handler/JSHandler;->Companion:Lorg/readium/r2/streamer/server/handler/JSHandler$Companion;

    const-class v0, Lorg/readium/r2/streamer/server/handler/JSHandler;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    const-string v1, "JSHandler::class.java.simpleName"

    invoke-static {v0, v1}, Lkotlin/jvm/internal/n;->b(Ljava/lang/Object;Ljava/lang/String;)V

    sput-object v0, Lorg/readium/r2/streamer/server/handler/JSHandler;->TAG:Ljava/lang/String;
...
.method public get(Lorg/nanohttpd/router/a$j;Ljava/util/Map;Lorg/nanohttpd/protocols/http/c;)Lze/c;
    ...
    sget-object v0, Lorg/readium/r2/streamer/server/handler/JSHandler;->TAG:Ljava/lang/String;
    ...
    invoke-direct {p0, p3, v0, p1}, Lorg/readium/r2/streamer/server/handler/JSHandler;->createResponse(Lze/d;Ljava/lang/String;Ljava/lang/String;)Lze/c;
    ...
    :goto_1
    sget-object p2, Lorg/readium/r2/streamer/server/handler/JSHandler;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/readium/r2/streamer/server/handler/JSHandler;->getMimeType()Ljava/lang/String;
