...
# instance fields
.field private final a:Ljava/nio/file/FileSystem;
...
.method public constructor <init>(Ljava/nio/file/FileSystem;)V
    ...
    iput-object p1, p0, Lokio/w;->a:Ljava/nio/file/FileSystem;

    return-void
.end method

.method private final a(Lokio/E;Z)Ljava/util/List;
    .locals 5
    ...
    invoke-direct {p0, p1}, Lokio/w;->f(Lokio/E;)Ljava/nio/file/Path;
    ...
    :try_start_0
    invoke-static {v0, v3, v2, v3}, Ltc/a;->b(Ljava/nio/file/Path;Ljava/lang/String;ILjava/lang/Object;)Ljava/util/List;
    ...
    sget-object v4, Lokio/E;->q:Lokio/E$a;

    invoke-static {v4, v0, v1, v2, v3}, Lokio/E$a;->f(Lokio/E$a;Ljava/nio/file/Path;ZILjava/lang/Object;)Lokio/E;
    ...
    :cond_0
    invoke-static {p2}, Lic/r;->z(Ljava/util/List;)V
...
.method private final f(Lokio/E;)Ljava/nio/file/Path;
    .locals 2

    iget-object v0, p0, Lokio/w;->a:Ljava/nio/file/FileSystem;
...
.method public appendingSink(Lokio/E;Z)Lokio/L;
    ...
    :cond_0
    invoke-static {v0}, Lic/r;->a(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p1}, Lokio/y;->h(Ljava/io/OutputStream;)Lokio/L;
...
.method public atomicMove(Lokio/E;Lokio/E;)V
    ...
    invoke-direct {p0, p2}, Lokio/w;->f(Lokio/E;)Ljava/nio/file/Path;
...
.method public canonicalize(Lokio/E;)Lokio/E;
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lokio/E$a;->f(Lokio/E$a;Ljava/nio/file/Path;ZILjava/lang/Object;)Lokio/E;
...
.method public createDirectory(Lokio/E;Z)V
    ...
    invoke-virtual {p0, p1}, Lokio/w;->metadataOrNull(Lokio/E;)Lokio/k;
...
.method public list(Lokio/E;)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v0}, Lokio/w;->a(Lokio/E;Z)Ljava/util/List;
...
.method public metadataOrNull(Lokio/E;)Lokio/k;
    ...
    invoke-virtual {p0, p1}, Lokio/x;->d(Ljava/nio/file/Path;)Lokio/k;
...
.method public openReadOnly(Lokio/E;)Lokio/j;
    ...
    invoke-direct {v1, v0, p1}, Lokio/v;-><init>(ZLjava/nio/channels/FileChannel;)V
...
.method public openReadWrite(Lokio/E;ZZ)Lokio/j;
    ...
    invoke-direct {p2, p3, p1}, Lokio/v;-><init>(ZLjava/nio/channels/FileChannel;)V
...
.method public source(Lokio/E;)Lokio/N;
    ...
    invoke-static {v0}, Lokio/y;->l(Ljava/io/InputStream;)Lokio/N;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-interface {v0}, LDc/d;->n()Ljava/lang/String;
