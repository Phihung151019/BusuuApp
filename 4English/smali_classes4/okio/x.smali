...
.method public atomicMove(Lokio/E;Lokio/E;)V
    ...
    :try_start_0
    invoke-virtual {p1}, Lokio/E;->B()Ljava/nio/file/Path;

    move-result-object p1

    invoke-virtual {p2}, Lokio/E;->B()Ljava/nio/file/Path;
...
.method protected final d(Ljava/nio/file/Path;)Lokio/k;
    .locals 14
    ...
    sget-object v2, Lokio/E;->q:Lokio/E$a;

    const/4 v5, 0x0

    const/4 v6, 0x1

    invoke-static {v2, p1, v5, v6, v0}, Lokio/E$a;->f(Lokio/E$a;Ljava/nio/file/Path;ZILjava/lang/Object;)Lokio/E;
    ...
    invoke-direct {p0, p1}, Lokio/x;->e(Ljava/nio/file/attribute/FileTime;)Ljava/lang/Long;
    ...
    invoke-direct/range {v2 .. v12}, Lokio/k;-><init>(ZZLokio/E;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/lang/Long;Ljava/util/Map;ILkotlin/jvm/internal/g;)V
