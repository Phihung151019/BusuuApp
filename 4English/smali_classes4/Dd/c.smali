...
.method private final c(LDd/g0;LHd/k;LHd/n;)Z
    .locals 3
    ...
    invoke-interface {v0, p2}, LHd/p;->y0(LHd/i;)Z
    ...
    invoke-interface {v0, p2}, LHd/p;->E(LHd/k;)Z
    ...
    invoke-interface {v0, p1, p3}, LHd/p;->w0(LHd/n;LHd/n;)Z
...
.method private final e(LDd/g0;LHd/k;LHd/k;)Z
    .locals 4
    ...
    sget-boolean v1, LDd/f;->b:Z

    if-eqz v1, :cond_1

    invoke-interface {v0, p2}, LHd/p;->g(LHd/k;)Z
    ...
    invoke-interface {v0, v1}, LHd/p;->Q(LHd/n;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p1, p2}, LDd/g0;->l(LHd/i;)Z

    move-result v1

    :cond_0
    invoke-interface {v0, p3}, LHd/p;->g(LHd/k;)Z

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {p1, p3}, LDd/g0;->l(LHd/i;)Z

    move-result v1

    :cond_1
    invoke-interface {v0, p3}, LHd/p;->W(LHd/k;)Z
    ...
    :cond_2
    invoke-interface {v0, p2}, LHd/p;->O(LHd/i;)Z

    move-result v1

    if-nez v1, :cond_9

    invoke-interface {v0, p2}, LHd/p;->D0(LHd/i;)Z
    ...
    invoke-interface {v0, v1}, LHd/p;->z0(LHd/d;)Z
    ...
    sget-object v3, LDd/g0$c$b;->a:LDd/g0$c$b;

    invoke-virtual {v1, p1, p2, v3}, LDd/c;->a(LDd/g0;LHd/k;LDd/g0$c;)Z
    ...
    :cond_5
    invoke-interface {v0, p3}, LHd/p;->O(LHd/i;)Z
    ...
    :cond_6
    sget-object v2, LDd/g0$c$d;->a:LDd/g0$c$d;

    invoke-virtual {v1, p1, p3, v2}, LDd/c;->a(LDd/g0;LHd/k;LDd/g0$c;)Z
    ...
    :cond_7
    invoke-interface {v0, p2}, LHd/p;->q(LHd/k;)Z
    ...
    :cond_8
    invoke-interface {v0, p3}, LHd/p;->f(LHd/k;)LHd/n;

    move-result-object p3

    invoke-virtual {v1, p1, p2, p3}, LDd/c;->b(LDd/g0;LHd/k;LHd/n;)Z
...
# virtual methods
.method public final a(LDd/g0;LHd/k;LDd/g0$c;)Z
    .locals 16
    ...
    invoke-interface {v2, v1}, LHd/p;->q(LHd/k;)Z
    ...
    invoke-interface {v2, v1}, LHd/p;->W(LHd/k;)Z
    ...
    :cond_0
    invoke-interface {v2, v1}, LHd/p;->O(LHd/i;)Z
    ...
    invoke-interface {v2, v7}, LHd/p;->W(LHd/k;)Z
    ...
    invoke-interface {v2, v9}, LHd/p;->q(LHd/k;)Z

    move-result v10

    if-eqz v10, :cond_6

    invoke-interface {v2, v9}, LHd/p;->W(LHd/k;)Z
    ...
    :cond_6
    invoke-interface {v2, v9}, LHd/p;->O(LHd/i;)Z
...
.method public final b(LDd/g0;LHd/k;LHd/n;)Z
    .locals 16
    ...
    invoke-direct {v4, v0, v1, v2}, LDd/c;->c(LDd/g0;LHd/k;LHd/n;)Z
    ...
    invoke-interface {v3, v7}, LHd/p;->W(LHd/k;)Z
    ...
    sget-object v10, LDd/c;->a:LDd/c;

    invoke-direct {v10, v0, v9, v2}, LDd/c;->c(LDd/g0;LHd/k;LHd/n;)Z
...
.method public final d(LDd/g0;LHd/k;LHd/k;)Z
    .locals 1
    ...
    invoke-direct {p0, p1, p2, p3}, LDd/c;->e(LDd/g0;LHd/k;LHd/k;)Z
