...
.method public constructor <init>(ZLokio/f;Ljava/util/Random;ZZJ)V
    ...
    invoke-interface {p2}, Lokio/f;->getBuffer()Lokio/e;
...
.method private final writeControlFrame(ILokio/h;)V
    ...
    invoke-virtual {v1, p1}, Lokio/e;->Y(I)Lokio/e;
    ...
    invoke-virtual {p1, v1}, Lokio/e;->V([B)Lokio/e;
    ...
    invoke-virtual {p1, p2}, Lokio/e;->T(Lokio/h;)Lokio/e;
    ...
    invoke-virtual {p1, p2}, Lokio/e;->C(Lokio/e$a;)Lokio/e$a;

    iget-object p1, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lokio/e$a;

    invoke-virtual {p1, v0, v1}, Lokio/e$a;->e(J)I
...
.method public final writeClose(ILokio/h;)V
    ...
    invoke-virtual {v0, p1}, Lokio/e;->q0(I)Lokio/e;

    if-eqz p2, :cond_2

    invoke-virtual {v0, p2}, Lokio/e;->T(Lokio/h;)Lokio/e;
...
.method public final writeMessageFrame(ILokio/h;)V
    ...
    invoke-virtual {v1, v0}, Lokio/e;->Y(I)Lokio/e;
    ...
    invoke-virtual {v0, p1, p2}, Lokio/e;->o0(J)Lokio/e;
    ...
    invoke-virtual {v0, v1}, Lokio/e;->V([B)Lokio/e;
    ...
    invoke-virtual {v2, v3}, Lokio/e;->C(Lokio/e$a;)Lokio/e$a;

    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lokio/e$a;

    invoke-virtual {v2, v0, v1}, Lokio/e$a;->e(J)I
    ...
    invoke-interface {p1}, Lokio/f;->l()Lokio/f;
