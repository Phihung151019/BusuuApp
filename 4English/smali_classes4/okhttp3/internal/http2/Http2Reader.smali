...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, LCc/h;->o(II)LCc/g;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, LCc/h;->m(LCc/e;I)LCc/e;

    move-result-object p2

    invoke-virtual {p2}, LCc/e;->d()I

    move-result v1

    invoke-virtual {p2}, LCc/e;->f()I

    move-result v2

    invoke-virtual {p2}, LCc/e;->h()I
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v1, v2}, Lokio/g;->B0(J)Lokio/h;
    ...
    invoke-virtual {p1}, Lokio/h;->b0()Ljava/lang/String;
