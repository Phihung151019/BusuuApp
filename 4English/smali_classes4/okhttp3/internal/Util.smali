...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeUnit",
        "skipAll",
        "(Lokio/N;ILjava/util/concurrent/TimeUnit;)Z",
        "timeout",
        "discard",
        "Ljava/net/Socket;",
        "peerName",
        ...
        "predicate",
        "filterList",
        "(Ljava/lang/Iterable;Lwc/l;)Ljava/util/List;",
        "",
        "EMPTY_BYTE_ARRAY",
        "[B",
        "EMPTY_HEADERS",
...
.field private static final UNICODE_BOMS:Lokio/C;

.field public static final UTC:Ljava/util/TimeZone;

.field private static final VERIFY_AS_IP_ADDRESS:LPd/l;
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lokio/C;->t:Lokio/C$a;

    sget-object v2, Lokio/h;->t:Lokio/h$a;

    const-string v3, "efbbbf"

    invoke-virtual {v2, v3}, Lokio/h$a;->b(Ljava/lang/String;)Lokio/h;

    move-result-object v3

    const-string v4, "feff"

    invoke-virtual {v2, v4}, Lokio/h$a;->b(Ljava/lang/String;)Lokio/h;

    move-result-object v4

    const-string v5, "fffe"

    invoke-virtual {v2, v5}, Lokio/h$a;->b(Ljava/lang/String;)Lokio/h;

    move-result-object v5

    const-string v6, "0000ffff"

    invoke-virtual {v2, v6}, Lokio/h$a;->b(Ljava/lang/String;)Lokio/h;

    move-result-object v6

    const-string v7, "ffff0000"

    invoke-virtual {v2, v7}, Lokio/h$a;->b(Ljava/lang/String;)Lokio/h;

    move-result-object v2

    filled-new-array {v3, v4, v5, v6, v2}, [Lokio/h;

    move-result-object v2

    invoke-virtual {v1, v2}, Lokio/C$a;->d([Lokio/h;)Lokio/C;

    move-result-object v1

    sput-object v1, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokio/C;
    ...
    sput-object v1, Lokhttp3/internal/Util;->VERIFY_AS_IP_ADDRESS:LPd/l;
    ...
    invoke-static {v0, v1}, LPd/n;->x0(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "Client"

    invoke-static {v0, v1}, LPd/n;->z0(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;
...
.method public static final asFactory(Lokhttp3/EventListener;)Lokhttp3/EventListener$Factory;
    ...
    invoke-direct {v0, p0}, Lbe/a;-><init>(Lokhttp3/EventListener;)V
...
.method public static final canParseAsIpAddress(Ljava/lang/String;)Z
    ...
    sget-object v0, Lokhttp3/internal/Util;->VERIFY_AS_IP_ADDRESS:LPd/l;
...
.method public static final concat([Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {p0}, Lic/j;->F([Ljava/lang/Object;)I
...
.method public static final delimiterOffset(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {p1, v0, v3, v1, v2}, LPd/n;->Q(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
...
.method public static final discard(Lokio/N;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(Lokio/N;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static final filterList(Ljava/lang/Iterable;Lwc/l;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {v0}, Lkotlin/jvm/internal/I;->a(Ljava/lang/Object;)Ljava/util/List;
...
.method public static final ignoreIoExceptions(Lwc/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static final indexOfControlOrNonAscii(Ljava/lang/String;)I
    ...
    invoke-static {v2, v3}, Lkotlin/jvm/internal/n;->h(II)I
...
.method public static final isCivilized(Lokhttp3/internal/io/FileSystem;Ljava/io/File;)Z
    ...
    invoke-interface {p0, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokio/L;
    ...
    invoke-static {v0, p0}, Lsc/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public static final isHealthy(Ljava/net/Socket;Lokio/g;)Z
    ...
    invoke-interface {p1}, Lokio/g;->K0()Z
...
.method public static final isSensitiveHeader(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0, v1}, LPd/n;->z(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public static final readBomAsCharset(Lokio/g;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    ...
    sget-object v0, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokio/C;

    invoke-interface {p0, v0}, Lokio/g;->M1(Lokio/C;)I
    ...
    invoke-virtual {p0}, LPd/d;->b()Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p0}, LPd/d;->a()Ljava/nio/charset/Charset;
...
.method public static final skipAll(Lokio/N;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0}, Lokio/N;->timeout()Lokio/O;
    ...
    invoke-interface {p0, p1, v7, v8}, Lokio/N;->read(Lokio/e;J)J
...
.method public static final threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v0, p0, p1}, Lbe/b;-><init>(Ljava/lang/String;Z)V
...
.method public static final threadName(Ljava/lang/String;Lwc/a;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static final toHeaderList(Lokhttp3/Headers;)Ljava/util/List;
    ...
    invoke-static {v1, v0}, LCc/h;->o(II)LCc/g;
...
.method public static final toHeaders(Ljava/util/List;)Lokhttp3/Headers;
    ...
    invoke-virtual {v2}, Lokio/h;->b0()Ljava/lang/String;
...
.method public static final toHostHeader(Lokhttp3/HttpUrl;Z)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v4, v1, v2}, LPd/n;->R(Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZILjava/lang/Object;)Z
...
.method public static final toImmutableList(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0}, Lic/r;->N0(Ljava/util/Collection;)Ljava/util/List;
...
.method public static final withSuppressed(Ljava/lang/Exception;Ljava/util/List;)Ljava/lang/Throwable;
    ...
    invoke-static {p0, v0}, Lhc/a;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final writeMedium(Lokio/f;I)V
    ...
    invoke-interface {p0, v0}, Lokio/f;->L0(I)Lokio/f;
    ...
    invoke-interface {p0, p1}, Lokio/f;->L0(I)Lokio/f;
