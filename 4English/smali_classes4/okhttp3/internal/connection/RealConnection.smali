...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {p1, v2, v6, v2}, LPd/n;->i(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Lwc/a;)V
    ...
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lwc/a;)V
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-virtual {v5, v6, v7, v8}, Lokio/O;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/O;
    ...
    invoke-static {v2, p3, v1}, LPd/n;->z(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p1}, Lokio/e;->K0()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-interface {v2}, Lokio/f;->getBuffer()Lokio/e;
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    invoke-interface {v1}, Lokio/N;->timeout()Lokio/O;
    ...
    invoke-virtual {v0, v3, v4, v5}, Lokio/O;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/O;
