...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Lokio/p;)V
    .locals 0

    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Lokio/p;)V
...
.method private final detachTimeout(Lokio/p;)V
    .locals 2

    invoke-virtual {p1}, Lokio/p;->a()Lokio/O;

    move-result-object v0

    sget-object v1, Lokio/O;->NONE:Lokio/O;

    invoke-virtual {p1, v1}, Lokio/p;->b(Lokio/O;)Lokio/p;
...
.method private final isChunked(Lokhttp3/Request;)Z
    ...
    invoke-static {v1, p1, v0}, LPd/n;->z(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private final newChunkedSink()Lokio/L;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lokio/N;
    .locals 2
...
.method private final newFixedLengthSource(J)Lokio/N;
    .locals 2
...
.method private final newKnownLengthSink()Lokio/L;
    .locals 2
...
.method private final newUnknownLengthSource()Lokio/N;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lokio/L;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lokio/L;
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lokio/L;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lokio/N;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lokio/N;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lokio/N;
    ...
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lokio/N;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lokio/N;ILjava/util/concurrent/TimeUnit;)Z

    invoke-interface {p1}, Lokio/N;->close()V
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;
    ...
    invoke-interface {p1, v0}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;
