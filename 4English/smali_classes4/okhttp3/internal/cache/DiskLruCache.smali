...
.field public static final LEGAL_KEY_PATTERN:LPd/l;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/cache/DiskLruCache;->LEGAL_KEY_PATTERN:LPd/l;
...
.method private final newJournalWriter()Lokio/f;
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lokio/L;
    ...
    invoke-direct {v1, v0, v2}, Lokhttp3/internal/cache/FaultHidingSink;-><init>(Lokio/L;Lwc/l;)V
...
.method private final readJournal()V
    ...
    invoke-interface {v1, v2}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lokio/N;
    ...
    invoke-static {v1, v0}, Lsc/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private final readJournalLine(Ljava/lang/String;)V
    ...
    invoke-static {v7, v5, v8, v3, v4}, LPd/n;->L(Ljava/lang/String;Ljava/lang/String;ZILjava/lang/Object;)Z
    ...
    invoke-static/range {v10 .. v15}, LPd/n;->I0(Ljava/lang/CharSequence;[CZIILjava/lang/Object;)Ljava/util/List;
...
.method private final validateKey(Ljava/lang/String;)V
    ...
    sget-object v0, Lokhttp3/internal/cache/DiskLruCache;->LEGAL_KEY_PATTERN:LPd/l;
...
.method public final declared-synchronized completeEdit$okhttp(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    invoke-interface {p2, v4}, Lokio/f;->L0(I)Lokio/f;
    ...
    invoke-interface {p1, v1}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;
...
.method public final declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    invoke-interface {p2, p3}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;

    move-result-object p3

    const/16 v1, 0x20

    invoke-interface {p3, v1}, Lokio/f;->L0(I)Lokio/f;

    move-result-object p3

    invoke-interface {p3, p1}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;
...
.method public final declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v1, v2}, Lokio/f;->L0(I)Lokio/f;

    move-result-object v1

    invoke-interface {v1, p1}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;

    move-result-object p1

    const/16 v1, 0xa

    invoke-interface {p1, v1}, Lokio/f;->L0(I)Lokio/f;
...
.method public final declared-synchronized rebuildJournal$okhttp()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokio/L;
    ...
    invoke-interface {v0, v1}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;
    ...
    invoke-interface {v0, v3, v4}, Lokio/f;->u0(J)Lokio/f;
    ...
    invoke-interface {v4, v5}, Lokio/f;->L0(I)Lokio/f;
