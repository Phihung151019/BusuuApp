...
.method public constructor <init>(Lokio/N;)V
    ...
    invoke-interface {v0}, Lokio/g;->a0()Ljava/lang/String;
...
.method private final readCertificateList(Lokio/g;)Ljava/util/List;
    ...
    invoke-interface {p1}, Lokio/g;->a0()Ljava/lang/String;
    ...
    sget-object v6, Lokio/h;->t:Lokio/h$a;

    invoke-virtual {v6, v4}, Lokio/h$a;->a(Ljava/lang/String;)Lokio/h;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v5, v4}, Lokio/e;->T(Lokio/h;)Lokio/e;

    invoke-virtual {v5}, Lokio/e;->J1()Ljava/io/InputStream;
...
.method private final writeCertList(Lokio/f;Ljava/util/List;)V
    ...
    invoke-interface {p1, v0, v1}, Lokio/f;->u0(J)Lokio/f;
    ...
    invoke-static/range {v2 .. v7}, Lokio/h$a;->g(Lokio/h$a;[BIIILjava/lang/Object;)Lokio/h;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lokio/L;
    ...
    invoke-interface {p1, v3, v4}, Lokio/f;->u0(J)Lokio/f;
    ...
    invoke-interface {p1, v5}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;

    move-result-object v5

    invoke-interface {v5, v4}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;
    ...
    invoke-interface {v4, v2}, Lokio/f;->L0(I)Lokio/f;
    ...
    invoke-interface {p1, v5, v6}, Lokio/f;->u0(J)Lokio/f;
    ...
    invoke-interface {p1, v3}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;
    ...
    invoke-interface {v3, v5}, Lokio/f;->I(Ljava/lang/String;)Lokio/f;

    move-result-object v3

    invoke-interface {v3, v2}, Lokio/f;->L0(I)Lokio/f;
    ...
    invoke-interface {v0, v5, v6}, Lokio/f;->u0(J)Lokio/f;
    ...
    invoke-interface {p1, v2}, Lokio/f;->L0(I)Lokio/f;
