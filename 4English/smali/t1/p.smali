...
.method public static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    :cond_3
    invoke-static {p1}, Lt1/p;->d(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    :goto_1
    invoke-static {p1, p0}, Lt1/p;->g(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static b(Landroid/graphics/Bitmap;Ll1/b;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    :cond_3
    invoke-static {p0}, Lt1/p;->d(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;

    move-result-object v5

    invoke-interface {p1, v3, v4, v5}, Ll1/b;->d(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    :cond_4
    invoke-static {p0, p1}, Lt1/p;->g(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static f(Landroid/graphics/Bitmap;Ll1/b;I)Landroid/graphics/Bitmap;
    .locals 4
    ...
    invoke-static {p2, v0}, Lt1/p;->e(ILandroid/graphics/Matrix;)V
    ...
    invoke-interface {p1, v1, v2, v3}, Ll1/b;->d(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
