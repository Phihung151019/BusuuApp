...
.method private a(FI)V
    ...
    :cond_1
    invoke-direct {p0, p2}, Lcom/google/android/exoplayer2/audio/X;->o(I)V
    ...
    invoke-direct {p0, v2, v3, v4}, Lcom/google/android/exoplayer2/audio/X;->f([SII)[S
    ...
    invoke-direct {p0, v7, v3, v0, p1}, Lcom/google/android/exoplayer2/audio/X;->n([SIII)S
    ...
    invoke-direct {p0, v2}, Lcom/google/android/exoplayer2/audio/X;->u(I)V
...
.method private b(F)V
    ...
    invoke-direct {p0, v1}, Lcom/google/android/exoplayer2/audio/X;->c(I)I
    ...
    invoke-direct {p0, v2, v1}, Lcom/google/android/exoplayer2/audio/X;->g([SI)I
    ...
    invoke-direct {p0, v3, v1, p1, v2}, Lcom/google/android/exoplayer2/audio/X;->w([SIFI)I
    ...
    invoke-direct {p0, v3, v1, p1, v2}, Lcom/google/android/exoplayer2/audio/X;->m([SIFI)I
    ...
    invoke-direct {p0, v1}, Lcom/google/android/exoplayer2/audio/X;->v(I)V
...
.method private c(I)I
    ...
    invoke-direct {p0, v1, p1, v0}, Lcom/google/android/exoplayer2/audio/X;->d([SII)V
...
.method private d([SII)V
    ...
    invoke-direct {p0, v0, v1, p3}, Lcom/google/android/exoplayer2/audio/X;->f([SII)[S
...
.method private g([SI)I
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lcom/google/android/exoplayer2/audio/X;->h([SIII)I
    ...
    :cond_1
    invoke-direct {p0, p1, p2, v0}, Lcom/google/android/exoplayer2/audio/X;->e([SII)V

    iget-object v2, p0, Lcom/google/android/exoplayer2/audio/X;->i:[S
    ...
    invoke-direct {p0, v2, v5, v3, v4}, Lcom/google/android/exoplayer2/audio/X;->h([SIII)I
    ...
    :cond_2
    iget v0, p0, Lcom/google/android/exoplayer2/audio/X;->g:I
    ...
    invoke-direct {p0, p1, p2, v3, v2}, Lcom/google/android/exoplayer2/audio/X;->h([SIII)I
    ...
    :cond_4
    invoke-direct {p0, p1, p2, v1}, Lcom/google/android/exoplayer2/audio/X;->e([SII)V

    iget-object p1, p0, Lcom/google/android/exoplayer2/audio/X;->i:[S

    invoke-direct {p0, p1, v5, v3, v2}, Lcom/google/android/exoplayer2/audio/X;->h([SIII)I
    ...
    invoke-direct {p0, p2, v0}, Lcom/google/android/exoplayer2/audio/X;->q(II)Z
...
.method private h([SIII)I
    ...
    iput v2, p0, Lcom/google/android/exoplayer2/audio/X;->u:I

    div-int/2addr v4, v1

    iput v4, p0, Lcom/google/android/exoplayer2/audio/X;->v:I
...
.method private m([SIFI)I
    ...
    invoke-direct {p0, v0, v1, v8}, Lcom/google/android/exoplayer2/audio/X;->f([SII)[S
    ...
    invoke-static/range {v0 .. v7}, Lcom/google/android/exoplayer2/audio/X;->p(II[SI[SI[SI)V
...
.method private o(I)V
    ...
    invoke-direct {p0, v1, v2, v0}, Lcom/google/android/exoplayer2/audio/X;->f([SII)[S
...
.method private r()V
    ...
    invoke-direct {p0, v1, v4, v2}, Lcom/google/android/exoplayer2/audio/X;->d([SII)V
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, v1}, Lcom/google/android/exoplayer2/audio/X;->b(F)V
...
.method private u(I)V
    ...
    iget v3, p0, Lcom/google/android/exoplayer2/audio/X;->o:I
...
.method public s()V
    ...
    invoke-direct {p0, v1, v0, v3}, Lcom/google/android/exoplayer2/audio/X;->f([SII)[S
    ...
    invoke-direct {p0}, Lcom/google/android/exoplayer2/audio/X;->r()V
...
.method public t(Ljava/nio/ShortBuffer;)V
    ...
    invoke-direct {p0, v2, v3, v0}, Lcom/google/android/exoplayer2/audio/X;->f([SII)[S
