...
.method private static b(LG1/f;Lt1/m;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 3
    ...
    invoke-virtual {p0, p1}, LG1/f;->mark(I)V

    goto :goto_0

    :cond_0
    invoke-virtual {p1}, Lt1/m;->b()V
    ...
    invoke-virtual {p0}, LG1/f;->reset()V
    :try_end_0
...
.method private c(LG1/f;Lt1/m;Landroid/graphics/BitmapFactory$Options;Ll1/b;IIILi1/a;)Landroid/graphics/Bitmap;
    .locals 4

    invoke-static {p1, p8}, Lcom/bumptech/glide/load/resource/bitmap/a;->d(Ljava/io/InputStream;Li1/a;)Landroid/graphics/Bitmap$Config;
    ...
    invoke-interface {p4, p5, p6, p8}, Ll1/b;->e(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    :cond_0
    invoke-static {p1, p2, p3}, Lcom/bumptech/glide/load/resource/bitmap/a;->b(LG1/f;Lt1/m;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method private static d(Ljava/io/InputStream;Li1/a;)Landroid/graphics/Bitmap$Config;
    .locals 6
    ...
    sget-object v2, Li1/a;->m:Li1/a;

    if-eq p1, v2, :cond_5

    sget-object v2, Li1/a;->q:Li1/a;
...
# virtual methods
.method public a(Ljava/io/InputStream;Ll1/b;IILi1/a;)Landroid/graphics/Bitmap;
    .locals 22
    ...
    invoke-direct {v3, v0, v13}, Lt1/m;-><init>(Ljava/io/InputStream;[B)V

    invoke-static {v3}, LG1/c;->b(Ljava/io/InputStream;)LG1/c;

    move-result-object v15

    new-instance v4, LG1/f;

    invoke-direct {v4, v15}, LG1/f;-><init>(Ljava/io/InputStream;)V

    const/high16 v0, 0x500000

    :try_start_0
    invoke-virtual {v15, v0}, LG1/c;->mark(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_2
    invoke-virtual {v15}, LG1/c;->reset()V
    :try_end_2
    ...
    invoke-virtual {v9, v4, v3, v14}, Lcom/bumptech/glide/load/resource/bitmap/a;->f(LG1/f;Lt1/m;Landroid/graphics/BitmapFactory$Options;)[I
    ...
    invoke-direct/range {v1 .. v9}, Lcom/bumptech/glide/load/resource/bitmap/a;->c(LG1/f;Lt1/m;Landroid/graphics/BitmapFactory$Options;Ll1/b;IIILi1/a;)Landroid/graphics/Bitmap;

    move-result-object v1

    invoke-virtual {v15}, LG1/c;->a()Ljava/io/IOException;
    ...
    invoke-static {v1, v10, v0}, Lt1/p;->f(Landroid/graphics/Bitmap;Ll1/b;I)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v10, v1}, Ll1/b;->a(Landroid/graphics/Bitmap;)Z
    ...
    :cond_4
    :goto_3
    invoke-virtual {v11, v12}, LG1/a;->c([B)Z

    invoke-virtual {v11, v13}, LG1/a;->c([B)Z

    invoke-virtual {v15}, LG1/c;->release()V
...
.method public f(LG1/f;Lt1/m;Landroid/graphics/BitmapFactory$Options;)[I
    .locals 1
