...
.method static a(Landroid/content/Context;Ly0/i;)Ly0/e;
    .locals 3

    new-instance v0, LA0/c;

    invoke-direct {v0, p0, p1}, LA0/c;-><init>(Landroid/content/Context;Ly0/i;)V

    const-class p1, Landroidx/work/impl/background/systemjob/SystemJobService;

    const/4 v1, 0x1

    invoke-static {p0, p1, v1}, LG0/g;->a(Landroid/content/Context;Ljava/lang/Class;Z)V

    invoke-static {}, Landroidx/work/m;->c()Landroidx/work/m;

    move-result-object p0

    sget-object p1, Ly0/f;->a:Ljava/lang/String;
...
.method public static b(Landroidx/work/b;Landroidx/work/impl/WorkDatabase;Ljava/util/List;)V
    ...
    invoke-interface {v0, p0}, LF0/q;->n(I)Ljava/util/List;

    move-result-object p0

    const/16 v1, 0xc8

    invoke-interface {v0, v1}, LF0/q;->i(I)Ljava/util/List;
    ...
    invoke-interface {v0, v5, v2, v3}, LF0/q;->k(Ljava/lang/String;J)I
    ...
    invoke-interface {v0}, Ly0/e;->d()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-interface {v0, p0}, Ly0/e;->c([LF0/p;)V
    ...
    invoke-interface {p2}, Ly0/e;->d()Z

    move-result v0

    if-nez v0, :cond_4

    invoke-interface {p2, p0}, Ly0/e;->c([LF0/p;)V
