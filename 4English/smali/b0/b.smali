...
.field private final t:Ljava/io/RandomAccessFile;

.field private final u:Ljava/nio/channels/FileChannel;

.field private final v:Ljava/nio/channels/FileLock;
...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, Lb0/b;->m:Ljava/io/File;

    iput-object p2, p0, Lb0/b;->s:Ljava/io/File;

    invoke-static {p1}, Lb0/b;->k(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Lb0/b;->q:J
    ...
    iput-object p2, p0, Lb0/b;->t:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Lb0/b;->u:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, Lb0/b;->v:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, Lb0/b;->u:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, Lb0/b;->b(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, Lb0/b;->t:Ljava/io/RandomAccessFile;
...
.method private a()V
    ...
    iget-object v0, p0, Lb0/b;->s:Ljava/io/File;

    new-instance v1, Lb0/b$a;

    invoke-direct {v1, p0}, Lb0/b$a;-><init>(Lb0/b;)V
    ...
    iget-object v2, p0, Lb0/b;->s:Ljava/io/File;
...
.method private static d(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lb0/b;->b(Ljava/io/Closeable;)V
...
.method private static k(Ljava/io/File;)J
    ...
    invoke-static {p0}, Lb0/c;->c(Ljava/io/File;)J
...
.method private static m(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    .locals 7

    invoke-static {p0}, Lb0/b;->e(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p1}, Lb0/b;->g(Ljava/io/File;)J
...
.method private t(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, Lb0/b;->m:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, Lb0/b;->e(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    new-instance v8, Lb0/b$b;

    iget-object v9, v0, Lb0/b;->s:Ljava/io/File;

    invoke-direct {v8, v9, v7}, Lb0/b$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lb0/b;->k(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Lb0/b$b;->m:J
...
.method private u()Ljava/util/List;
    ...
    iget-object v6, v1, Lb0/b;->m:Ljava/io/File;
    ...
    invoke-direct/range {p0 .. p0}, Lb0/b;->a()V
    ...
    iget-object v0, v1, Lb0/b;->m:Ljava/io/File;
    ...
    new-instance v11, Lb0/b$b;

    iget-object v12, v1, Lb0/b;->s:Ljava/io/File;

    invoke-direct {v11, v12, v0}, Lb0/b$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v11, v6}, Lb0/b;->d(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Lb0/b;->k(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, Lb0/b$b;->m:J
    :try_end_1
...
.method public close()V
    ...
    iget-object v0, p0, Lb0/b;->v:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    iget-object v0, p0, Lb0/b;->u:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/spi/AbstractInterruptibleChannel;->close()V

    iget-object v0, p0, Lb0/b;->t:Ljava/io/RandomAccessFile;
...
.method p(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lb0/b;->m:Ljava/io/File;
    ...
    iget-object v0, p0, Lb0/b;->m:Ljava/io/File;

    iget-wide v2, p0, Lb0/b;->q:J

    invoke-static {p1, v0, v2, v3, p2}, Lb0/b;->m(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Lb0/b;->t(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {p0}, Lb0/b;->u()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, Lb0/b;->m:Ljava/io/File;

    invoke-static {v0}, Lb0/b;->g(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Lb0/b;->q:J
    ...
    invoke-static/range {v2 .. v8}, Lb0/b;->v(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
