...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/b;->B:Landroidx/appcompat/widget/J;
...
.method private B()Landroidx/appcompat/widget/K;
    .locals 5
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->B:Landroidx/appcompat/widget/J;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/K;->T(Landroidx/appcompat/widget/J;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/I;->K(Landroid/widget/AdapterView$OnItemClickListener;)V

    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/I;->J(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->E:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/I;->C(Landroid/view/View;)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->D:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/I;->F(I)V

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/I;->I(Z)V

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/I;->H(I)V
...
.method private H(Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/b;->B()Landroidx/appcompat/widget/K;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/I;->m(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/I;->E(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/b;->D:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/I;->F(I)V
    ...
    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/K;->U(Z)V

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/K;->R(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Landroidx/appcompat/widget/I;->C(Landroid/view/View;)V

    iget v8, p0, Landroidx/appcompat/view/menu/b;->D:I
    ...
    :goto_3
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/I;->f(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/I;->M(Z)V

    invoke-virtual {v4, v7}, Landroidx/appcompat/widget/I;->i(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/I;->i(I)V
    ...
    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/I;->G(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroidx/appcompat/view/menu/b$d;-><init>(Landroidx/appcompat/widget/K;Landroidx/appcompat/view/menu/e;I)V

    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->y:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/I;->a()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/I;->o()Landroid/widget/ListView;
...
.method public b(Landroidx/appcompat/view/menu/e;Z)V
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/K;

    invoke-virtual {v1, v2}, Landroidx/appcompat/widget/K;->S(Ljava/lang/Object;)V

    iget-object v1, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/K;

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/I;->D(I)V

    :cond_2
    iget-object v0, v0, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/K;
...
.method public dismiss()V
    ...
    iget-object v3, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/K;

    invoke-virtual {v3}, Landroidx/appcompat/widget/I;->c()Z

    move-result v3

    if-eqz v3, :cond_0

    iget-object v2, v2, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/K;
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroidx/appcompat/view/menu/b$d;->a:Landroidx/appcompat/widget/K;

    invoke-virtual {v4}, Landroidx/appcompat/widget/I;->c()Z
