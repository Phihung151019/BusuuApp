...
.field private final h0:Landroidx/appcompat/widget/t;

.field private i0:Landroidx/appcompat/widget/i;

.field private j0:Landroidx/appcompat/widget/SwitchCompat$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->l0:Landroid/util/Property;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v2, p0, Landroidx/appcompat/widget/SwitchCompat;->a0:Z

    new-instance v3, Landroid/graphics/Rect;

    invoke-direct {v3}, Landroid/graphics/Rect;-><init>()V

    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->k0:Landroid/graphics/Rect;
    ...
    iput-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/text/TextPaint;
    ...
    invoke-static {p1, p2, v7, p3, v1}, Landroidx/appcompat/widget/X;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/X;
    ...
    invoke-static/range {v5 .. v11}, Landroidx/core/view/Y;->o0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    sget v4, Lf/j;->G2:I

    invoke-virtual {v3, v4}, Landroidx/appcompat/widget/X;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v3, v4}, Landroidx/appcompat/widget/X;->p(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3, v4, v2}, Landroidx/appcompat/widget/X;->a(IZ)Z
    ...
    invoke-virtual {v3, v4, v1}, Landroidx/appcompat/widget/X;->f(II)I
    ...
    invoke-virtual {v3, v4, v1}, Landroidx/appcompat/widget/X;->a(IZ)Z
    ...
    invoke-virtual {v3, v4}, Landroidx/appcompat/widget/X;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v3, v4, v5}, Landroidx/appcompat/widget/X;->k(II)I

    move-result v4

    invoke-static {v4, v0}, Landroidx/appcompat/widget/E;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v4

    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->s:Landroid/graphics/PorterDuff$Mode;

    if-eq v6, v4, :cond_3

    iput-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->s:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->w:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v3, v0, v1}, Landroidx/appcompat/widget/X;->n(II)I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->h0:Landroidx/appcompat/widget/t;
...
.method private a(Z)V
    ...
    :goto_0
    sget-object v1, Landroidx/appcompat/widget/SwitchCompat;->l0:Landroid/util/Property;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->g0:Landroid/animation/ObjectAnimator;

    const-wide/16 v1, 0xfa

    invoke-virtual {p1, v1, v2}, Landroid/animation/ObjectAnimator;->setDuration(J)Landroid/animation/ObjectAnimator;

    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->g0:Landroid/animation/ObjectAnimator;
...
.method private d()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->g0:Landroid/animation/ObjectAnimator;
...
.method private g(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->f0:Landroid/text/method/TransformationMethod;
...
.method private getEmojiTextViewHelper()Landroidx/appcompat/widget/i;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->i0:Landroidx/appcompat/widget/i;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->i0:Landroidx/appcompat/widget/i;
...
.method private getThumbOffset()I
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/e0;->b(Landroid/view/View;)Z
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/E;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method private h(FF)Z
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->k0:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->k0:Landroid/graphics/Rect;
...
.method private i(Ljava/lang/CharSequence;)Landroid/text/Layout;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/text/TextPaint;
...
.method private k()V
    ...
    :cond_0
    invoke-static {p0, v0}, Landroidx/core/view/Y;->K0(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method private p()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->j0:Landroidx/appcompat/widget/SwitchCompat$b;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->j0:Landroidx/appcompat/widget/SwitchCompat$b;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->e0:Landroid/text/Layout;

    iget-boolean p1, p0, Landroidx/appcompat/widget/SwitchCompat;->I:Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->k0:Landroid/graphics/Rect;
    ...
    invoke-static {v6}, Landroidx/appcompat/widget/E;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v6, Landroidx/appcompat/widget/E;->c:Landroid/graphics/Rect;

    :goto_0
    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->v:Landroid/graphics/drawable/Drawable;
...
.method public jumpDrawablesToCurrentState()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->g0:Landroid/animation/ObjectAnimator;
...
.method public m(Landroid/content/Context;I)V
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/SwitchCompat;->c0:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/X;->f(II)I
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/text/TextPaint;
    ...
    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/X;->k(II)I

    move-result p2

    sget v2, Lf/j;->V2:I

    invoke-virtual {p1, v2, v1}, Landroidx/appcompat/widget/X;->k(II)I
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/X;->a(IZ)Z
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/SwitchCompat;->f0:Landroid/text/method/TransformationMethod;
    ...
    :goto_1
    iget-object p2, p0, Landroidx/appcompat/widget/SwitchCompat;->E:Ljava/lang/CharSequence;

    invoke-direct {p0, p2}, Landroidx/appcompat/widget/SwitchCompat;->setTextOnInternal(Ljava/lang/CharSequence;)V

    iget-object p2, p0, Landroidx/appcompat/widget/SwitchCompat;->G:Ljava/lang/CharSequence;
...
.method public n(Landroid/graphics/Typeface;I)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/text/TextPaint;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Landroidx/appcompat/widget/E;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_4
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->e0:Landroid/text/Layout;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->c0:Landroid/content/res/ColorStateList;

    if-eqz v6, :cond_5

    iget-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/text/TextPaint;
    ...
    :cond_5
    iget-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/text/TextPaint;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->k0:Landroid/graphics/Rect;

    iget-object p3, p0, Landroidx/appcompat/widget/SwitchCompat;->v:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/E;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onMeasure(II)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->e0:Landroid/text/Layout;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->e0:Landroid/text/Layout;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->d0:Landroid/text/Layout;

    invoke-virtual {v4}, Landroid/text/Layout;->getWidth()I

    move-result v4

    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->e0:Landroid/text/Layout;
...
.method public setSwitchTypeface(Landroid/graphics/Typeface;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b0:Landroid/text/TextPaint;
