...
.method constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/e;)V
    ...
    invoke-virtual {p3}, Landroidx/work/impl/background/systemalarm/e;->f()LH0/a;
    ...
    invoke-direct {p3, p1, p2, v0}, LB0/d;-><init>(Landroid/content/Context;LH0/a;LB0/c;)V

    iput-object p3, p0, Landroidx/work/impl/background/systemalarm/c;->d:LB0/d;
...
.method a()V
    ...
    invoke-interface {v0}, LF0/q;->c()Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemalarm/c;->d:LB0/d;
    ...
    iget-object v5, v4, LF0/p;->a:Ljava/lang/String;

    invoke-virtual {v4}, LF0/p;->a()J
    ...
    invoke-virtual {v4}, LF0/p;->b()Z

    move-result v6

    if-eqz v6, :cond_1

    iget-object v6, p0, Landroidx/work/impl/background/systemalarm/c;->d:LB0/d;

    invoke-virtual {v6, v5}, LB0/d;->c(Ljava/lang/String;)Z
    ...
    iget-object v1, v1, LF0/p;->a:Ljava/lang/String;
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/systemalarm/c;->d:LB0/d;
