...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/y;->c:Landroidx/recyclerview/widget/RecyclerView$v;
...
.method private e()V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/y;->c:Landroidx/recyclerview/widget/RecyclerView$v;

    invoke-virtual {v0, v1}, Landroidx/recyclerview/widget/RecyclerView;->p1(Landroidx/recyclerview/widget/RecyclerView$v;)V
...
.method private h()V
    ...
    invoke-virtual {v0, v1}, Landroidx/recyclerview/widget/RecyclerView;->o(Landroidx/recyclerview/widget/RecyclerView$v;)V
...
.method private i(Landroidx/recyclerview/widget/RecyclerView$q;II)Z
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/y;->d(Landroidx/recyclerview/widget/RecyclerView$q;)Landroidx/recyclerview/widget/RecyclerView$A;
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Landroidx/recyclerview/widget/y;->g(Landroidx/recyclerview/widget/RecyclerView$q;II)I
    ...
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView$q;->Y1(Landroidx/recyclerview/widget/RecyclerView$A;)V
...
.method public a(II)Z
    ...
    :cond_2
    invoke-direct {p0, v0, p1, p2}, Landroidx/recyclerview/widget/y;->i(Landroidx/recyclerview/widget/RecyclerView$q;II)Z
...
.method protected abstract d(Landroidx/recyclerview/widget/RecyclerView$q;)Landroidx/recyclerview/widget/RecyclerView$A;
.end method

.method public abstract f(Landroidx/recyclerview/widget/RecyclerView$q;)Landroid/view/View;
.end method

.method public abstract g(Landroidx/recyclerview/widget/RecyclerView$q;II)I
.end method
...
.method j()V
    ...
    :cond_1
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/y;->f(Landroidx/recyclerview/widget/RecyclerView$q;)Landroid/view/View;
    ...
    :cond_2
    invoke-virtual {p0, v0, v1}, Landroidx/recyclerview/widget/y;->c(Landroidx/recyclerview/widget/RecyclerView$q;Landroid/view/View;)[I
