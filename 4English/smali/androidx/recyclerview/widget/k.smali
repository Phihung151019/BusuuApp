...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/recyclerview/widget/k;->u:Ljava/lang/ThreadLocal;

    new-instance v0, Landroidx/recyclerview/widget/k$a;

    invoke-direct {v0}, Landroidx/recyclerview/widget/k$a;-><init>()V

    sput-object v0, Landroidx/recyclerview/widget/k;->v:Ljava/util/Comparator;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/k;->t:Ljava/util/ArrayList;
...
.method private b()V
    ...
    iget-object v5, v4, Landroidx/recyclerview/widget/RecyclerView;->y0:Landroidx/recyclerview/widget/k$b;
    ...
    :cond_1
    iget-object v2, p0, Landroidx/recyclerview/widget/k;->t:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Landroidx/recyclerview/widget/k;->t:Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Landroidx/recyclerview/widget/k;->t:Ljava/util/ArrayList;
    ...
    :cond_6
    iget-object v0, p0, Landroidx/recyclerview/widget/k;->t:Ljava/util/ArrayList;

    sget-object v1, Landroidx/recyclerview/widget/k;->v:Ljava/util/Comparator;
...
.method private c(Landroidx/recyclerview/widget/k$c;J)V
    ...
    invoke-direct {p0, v2, p1, v0, v1}, Landroidx/recyclerview/widget/k;->i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$F;

    move-result-object p1

    if-eqz p1, :cond_1

    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$F;->q:Ljava/lang/ref/WeakReference;
    ...
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView$F;->q:Ljava/lang/ref/WeakReference;
...
.method private d(J)V
    ...
    :goto_0
    iget-object v1, p0, Landroidx/recyclerview/widget/k;->t:Ljava/util/ArrayList;
...
.method static e(Landroidx/recyclerview/widget/RecyclerView;I)Z
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView;->v:Landroidx/recyclerview/widget/f;
    ...
    iget-object v3, p0, Landroidx/recyclerview/widget/RecyclerView;->v:Landroidx/recyclerview/widget/f;

    invoke-virtual {v3, v2}, Landroidx/recyclerview/widget/f;->i(I)Landroid/view/View;

    move-result-object v3

    invoke-static {v3}, Landroidx/recyclerview/widget/RecyclerView;->q0(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$F;
...
.method private h(Landroidx/recyclerview/widget/RecyclerView;J)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView;->k1()V

    :cond_1
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->y0:Landroidx/recyclerview/widget/k$b;
    ...
    iget-object v1, p1, Landroidx/recyclerview/widget/RecyclerView;->z0:Landroidx/recyclerview/widget/RecyclerView$B;
    ...
    invoke-direct {p0, p1, v2, p2, p3}, Landroidx/recyclerview/widget/k;->i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$F;
    :try_end_0
...
.method private i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$F;
    ...
    :cond_0
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->s:Landroidx/recyclerview/widget/RecyclerView$x;
    ...
    invoke-virtual {v0, p2, v2, p3, p4}, Landroidx/recyclerview/widget/RecyclerView$x;->N(IZJ)Landroidx/recyclerview/widget/RecyclerView$F;

    move-result-object p2

    if-eqz p2, :cond_3

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$F;->u()Z

    move-result p3

    if-eqz p3, :cond_2

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$F;->v()Z

    move-result p3

    if-nez p3, :cond_2

    iget-object p3, p2, Landroidx/recyclerview/widget/RecyclerView$F;->m:Landroid/view/View;
    ...
    :cond_2
    invoke-virtual {v0, p2, v2}, Landroidx/recyclerview/widget/RecyclerView$x;->a(Landroidx/recyclerview/widget/RecyclerView$F;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_3
    :goto_1
    invoke-virtual {p1, v2}, Landroidx/recyclerview/widget/RecyclerView;->W0(Z)V
...
.method f(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    :cond_1
    :goto_0
    iget-wide v0, p0, Landroidx/recyclerview/widget/k;->q:J
    ...
    iput-wide v0, p0, Landroidx/recyclerview/widget/k;->q:J

    invoke-virtual {p1, p0}, Landroid/view/View;->post(Ljava/lang/Runnable;)Z

    :cond_2
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView;->y0:Landroidx/recyclerview/widget/k$b;
...
.method public run()V
    ...
    iget-wide v4, p0, Landroidx/recyclerview/widget/k;->s:J
