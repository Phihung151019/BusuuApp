...
.method public static final toImageDecoderSourceOrNull(Lcoil3/decode/ImageSource;Lcoil3/request/Options;Z)Landroid/graphics/ImageDecoder$Source;
    ...
    invoke-interface {p0}, Lcoil3/decode/ImageSource;->getFileSystem()Lokio/l;

    move-result-object v0

    sget-object v1, Lokio/l;->SYSTEM:Lokio/l;

    if-ne v0, v1, :cond_0

    invoke-interface {p0}, Lcoil3/decode/ImageSource;->fileOrNull()Lokio/E;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lokio/E;->A()Ljava/io/File;
    ...
    new-instance p1, Lcoil3/decode/h;

    invoke-direct {p1, p0}, Lcoil3/decode/h;-><init>(Landroid/content/res/AssetFileDescriptor;)V

    invoke-static {p1}, Lcoil3/decode/g;->a(Ljava/util/concurrent/Callable;)Landroid/graphics/ImageDecoder$Source;
