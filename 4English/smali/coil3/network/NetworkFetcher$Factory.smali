...
# instance fields
.field private final cacheStrategyLazy:Lhc/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lhc/i<",
            "Lcoil3/network/CacheStrategy;",
...
.field private final networkClientLazy:Lhc/i;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lhc/i<",
            "Lcoil3/network/NetworkClient;",
...
# direct methods
.method public constructor <init>(Lwc/a;Lwc/a;Lwc/l;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcoil3/network/NetworkFetcher$Factory;->networkClientLazy:Lhc/i;

    invoke-static {p2}, Lhc/j;->b(Lwc/a;)Lhc/i;

    move-result-object p1

    iput-object p1, p0, Lcoil3/network/NetworkFetcher$Factory;->cacheStrategyLazy:Lhc/i;

    invoke-static {p3}, Lcoil3/network/internal/SingleParameterLazyKt;->singleParameterLazy(Lwc/l;)Lcoil3/network/internal/SingleParameterLazy;
...
.method public synthetic constructor <init>(Lwc/a;Lwc/a;Lwc/l;ILkotlin/jvm/internal/g;)V
    .locals 0
    ...
    new-instance p2, Lcoil3/network/c;

    invoke-direct {p2}, Lcoil3/network/c;-><init>()V
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3}, Lcoil3/network/NetworkFetcher$Factory;-><init>(Lwc/a;Lwc/a;Lwc/l;)V
...
.method public static synthetic b(Lcoil3/ImageLoader;)Lcoil3/disk/DiskCache;
    .locals 0
...
.method public create(Lcoil3/Uri;Lcoil3/request/Options;Lcoil3/ImageLoader;)Lcoil3/fetch/Fetcher;
    ...
    iget-object v3, p0, Lcoil3/network/NetworkFetcher$Factory;->networkClientLazy:Lhc/i;

    new-instance p1, Lcoil3/network/b;

    invoke-direct {p1, p3}, Lcoil3/network/b;-><init>(Lcoil3/ImageLoader;)V

    invoke-static {p1}, Lhc/j;->b(Lwc/a;)Lhc/i;

    move-result-object v4

    iget-object v5, p0, Lcoil3/network/NetworkFetcher$Factory;->cacheStrategyLazy:Lhc/i;
    ...
    invoke-direct/range {v0 .. v6}, Lcoil3/network/NetworkFetcher;-><init>(Ljava/lang/String;Lcoil3/request/Options;Lhc/i;Lhc/i;Lhc/i;Lcoil3/network/ConnectivityChecker;)V
