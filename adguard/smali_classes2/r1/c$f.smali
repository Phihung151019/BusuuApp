...
.method public constructor <init>(Lcom/google/android/material/progressindicator/LinearProgressIndicator;Landroidx/recyclerview/widget/RecyclerView;Lr1/c;Landroid/view/ViewGroup;Landroid/view/ViewGroup;Landroid/widget/Space;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;Landroid/widget/ImageView;)V
    ...
    iput-object p1, p0, Lr1/c$f;->e:Lcom/google/android/material/progressindicator/LinearProgressIndicator;

    iput-object p2, p0, Lr1/c$f;->g:Landroidx/recyclerview/widget/RecyclerView;

    iput-object p3, p0, Lr1/c$f;->h:Lr1/c;

    iput-object p4, p0, Lr1/c$f;->i:Landroid/view/ViewGroup;

    iput-object p5, p0, Lr1/c$f;->j:Landroid/view/ViewGroup;

    iput-object p6, p0, Lr1/c$f;->k:Landroid/widget/Space;

    iput-object p7, p0, Lr1/c$f;->l:Landroid/widget/ImageView;

    iput-object p8, p0, Lr1/c$f;->m:Landroid/widget/ImageView;

    iput-object p9, p0, Lr1/c$f;->n:Landroid/widget/ImageView;

    iput-object p10, p0, Lr1/c$f;->o:Landroid/widget/ImageView;

    iput-object p11, p0, Lr1/c$f;->p:Landroid/widget/ImageView;
...
.method public final a(Lcom/adguard/android/ui/view/ConstructIEII;)V
    ...
    iget-object p1, p0, Lr1/c$f;->e:Lcom/google/android/material/progressindicator/LinearProgressIndicator;

    invoke-virtual {p1}, Lcom/google/android/material/progressindicator/BaseProgressIndicator;->hide()V

    iget-object p1, p0, Lr1/c$f;->g:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p1, p0, Lr1/c$f;->h:Lr1/c;
    ...
    :cond_0
    iget-object p1, p0, Lr1/c$f;->i:Landroid/view/ViewGroup;

    invoke-static {p1}, LQ3/v;->c(Landroid/view/View;)V

    iget-object p1, p0, Lr1/c$f;->j:Landroid/view/ViewGroup;

    invoke-static {p1}, LQ3/v;->c(Landroid/view/View;)V

    iget-object p1, p0, Lr1/c$f;->k:Landroid/widget/Space;

    invoke-static {p1, v0, v1, v2}, LQ3/v;->b(Landroid/view/View;ZILjava/lang/Object;)V

    iget-object p1, p0, Lr1/c$f;->l:Landroid/widget/ImageView;

    invoke-virtual {p1, v1}, Landroid/view/View;->setEnabled(Z)V

    iget-object p1, p0, Lr1/c$f;->m:Landroid/widget/ImageView;

    invoke-virtual {p1, v0}, Landroid/view/View;->setEnabled(Z)V

    iget-object p1, p0, Lr1/c$f;->n:Landroid/widget/ImageView;

    invoke-virtual {p1, v0}, Landroid/view/View;->setEnabled(Z)V

    iget-object p1, p0, Lr1/c$f;->o:Landroid/widget/ImageView;

    invoke-virtual {p1, v0}, Landroid/view/View;->setEnabled(Z)V

    iget-object p1, p0, Lr1/c$f;->p:Landroid/widget/ImageView;
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lr1/c$f;->a(Lcom/adguard/android/ui/view/ConstructIEII;)V
