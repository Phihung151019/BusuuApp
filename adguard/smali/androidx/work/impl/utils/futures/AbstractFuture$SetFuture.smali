...
# direct methods
.method public constructor <init>(Landroidx/work/impl/utils/futures/AbstractFuture;LU4/a;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/futures/AbstractFuture$SetFuture;->future:LU4/a;
...
.method public run()V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/work/impl/utils/futures/AbstractFuture$SetFuture;->future:LU4/a;

    invoke-static {v0}, Landroidx/work/impl/utils/futures/AbstractFuture;->getFutureValue(LU4/a;)Ljava/lang/Object;
