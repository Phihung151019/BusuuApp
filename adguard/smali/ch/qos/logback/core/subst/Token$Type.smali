...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Lch/qos/logback/core/subst/Token$Type;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lch/qos/logback/core/subst/Token$Type;->START:Lch/qos/logback/core/subst/Token$Type;

    new-instance v2, Lch/qos/logback/core/subst/Token$Type;

    const-string v3, "CURLY_LEFT"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lch/qos/logback/core/subst/Token$Type;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lch/qos/logback/core/subst/Token$Type;->CURLY_LEFT:Lch/qos/logback/core/subst/Token$Type;

    new-instance v3, Lch/qos/logback/core/subst/Token$Type;

    const-string v4, "CURLY_RIGHT"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lch/qos/logback/core/subst/Token$Type;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lch/qos/logback/core/subst/Token$Type;->CURLY_RIGHT:Lch/qos/logback/core/subst/Token$Type;

    new-instance v4, Lch/qos/logback/core/subst/Token$Type;

    const-string v5, "DEFAULT"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lch/qos/logback/core/subst/Token$Type;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lch/qos/logback/core/subst/Token$Type;->DEFAULT:Lch/qos/logback/core/subst/Token$Type;

    filled-new-array {v0, v1, v2, v3, v4}, [Lch/qos/logback/core/subst/Token$Type;
