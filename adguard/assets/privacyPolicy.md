...
1. You are not required to share your personal data with us. You can delete your information by deleting your AdGuard account at [adguardaccount.com](adguardaccount.com) or by sending us a request at <privacy@adguard.com>.
...
**Right to data portability**: The right to receive provided Personal Data in a structured, commonly used, and machine-readable format and to transmit that data to another controller. You can export all Personal Data that we hold about you to a local file from your AdGuard account at <adguardaccount.com>.
