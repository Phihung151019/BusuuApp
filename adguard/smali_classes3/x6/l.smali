...
# static fields
.field public static final a:Lx6/l;
...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v1, v3, v2}, LQ6/A;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;

    move-result-object v2

    const-string v4, "java/lang/annotation/Annotation.annotationType()Ljava/lang/Class;"

    invoke-static {v2, v4}, LU5/U;->l(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/Set;

    move-result-object v2

    sput-object v2, Lx6/l;->b:Ljava/util/Set;

    invoke-virtual {v0}, Lx6/l;->b()Ljava/util/Set;
    ...
    invoke-virtual {v1, v5, v4}, LQ6/A;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;

    move-result-object v4

    invoke-static {v2, v4}, LU5/U;->k(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v6, v4}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v9, v8}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;

    move-result-object v8

    invoke-static {v2, v8}, LU5/U;->k(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v7, v4}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v8, v4}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    sput-object v2, Lx6/l;->c:Ljava/util/Set;
    ...
    invoke-virtual {v1, v5, v2}, LQ6/A;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;

    move-result-object v2

    sput-object v2, Lx6/l;->d:Ljava/util/Set;
    ...
    invoke-virtual {v1, v8, v2}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v8, v4}, LQ6/A;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v9, v4}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v3, v4}, LQ6/A;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    sput-object v2, Lx6/l;->e:Ljava/util/Set;
    ...
    invoke-virtual {v1, v5, v3}, LQ6/A;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;

    move-result-object v3

    invoke-static {v2, v3}, LU5/U;->k(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v8, v3}, LQ6/A;->f(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    sput-object v2, Lx6/l;->f:Ljava/util/Set;

    invoke-virtual {v0}, Lx6/l;->a()Ljava/util/Set;
    ...
    invoke-virtual {v1, v2}, LQ6/A;->b([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-virtual {v1, v7, v2}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-virtual {v1, v6, v2}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
    ...
    sput-object v0, Lx6/l;->g:Ljava/util/Set;
    ...
    invoke-virtual {v1, v0}, LQ6/A;->b([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-virtual {v1, v9, v0}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;

    move-result-object v0

    sput-object v0, Lx6/l;->h:Ljava/util/Set;
...
.method public final a()Ljava/util/Set;
    ...
    sget-object v5, Lg7/e;->BYTE:Lg7/e;

    sget-object v3, Lg7/e;->DOUBLE:Lg7/e;

    sget-object v4, Lg7/e;->FLOAT:Lg7/e;

    sget-object v6, Lg7/e;->INT:Lg7/e;

    sget-object v7, Lg7/e;->LONG:Lg7/e;

    sget-object v8, Lg7/e;->SHORT:Lg7/e;

    move-object v2, v5

    filled-new-array/range {v1 .. v8}, [Lg7/e;
    ...
    invoke-virtual {v3}, Lg7/e;->getWrapperFqName()LX6/c;
    ...
    invoke-virtual {v0, v4}, LQ6/A;->b([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-virtual {v0, v3, v4}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
...
.method public final b()Ljava/util/Set;
    ...
    sget-object v2, Lg7/e;->CHAR:Lg7/e;

    filled-new-array {v1, v2}, [Lg7/e;
    ...
    invoke-virtual {v4}, LX6/c;->g()LX6/f;
    ...
    invoke-virtual {v3}, Lg7/e;->getJavaKeywordName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v4, v3}, LQ6/A;->e(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Set;
...
.method public final c()Ljava/util/Set;
    ...
    sget-object v0, Lx6/l;->d:Ljava/util/Set;
...
.method public final d()Ljava/util/Set;
    ...
    sget-object v0, Lx6/l;->b:Ljava/util/Set;
...
.method public final e()Ljava/util/Set;
    ...
    sget-object v0, Lx6/l;->g:Ljava/util/Set;
...
.method public final f()Ljava/util/Set;
    ...
    sget-object v0, Lx6/l;->c:Ljava/util/Set;
...
.method public final g()Ljava/util/Set;
    ...
    sget-object v0, Lx6/l;->f:Ljava/util/Set;
...
.method public final h()Ljava/util/Set;
    ...
    sget-object v0, Lx6/l;->h:Ljava/util/Set;
...
.method public final i()Ljava/util/Set;
    ...
    sget-object v0, Lx6/l;->e:Ljava/util/Set;

    return-object v0
.end method

.method public final j(LX6/d;)Z
    .locals 1
    ...
    invoke-static {p1}, Lv6/k;->e(LX6/d;)Z
...
.method public final k(LX6/d;)Z
    ...
    invoke-virtual {p0, p1}, Lx6/l;->j(LX6/d;)Z
