...
.field private transient reflected:Lp6/c;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/d;->getReflected()Lp6/c;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1}, Lp6/c;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Lp6/c;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/d;->reflected:Lp6/c;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/d;->computeReflected()Lp6/c;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/d;->reflected:Lp6/c;

    :cond_0
    return-object v0
.end method

.method public abstract computeReflected()Lp6/c;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {v0}, Lp6/b;->getAnnotations()Ljava/util/List;
...
.method public getOwner()Lp6/e;
    ...
    invoke-static {v0}, Lkotlin/jvm/internal/F;->c(Ljava/lang/Class;)Lp6/e;
...
.method public getReflected()Lp6/c;
    .locals 1

    invoke-virtual {p0}, Lkotlin/jvm/internal/d;->compute()Lp6/c;
...
.method public getReturnType()Lp6/n;
    .locals 1
    ...
    invoke-interface {v0}, Lp6/c;->getReturnType()Lp6/n;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {v0}, Lp6/c;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Lp6/r;
    .locals 1
    ...
    invoke-interface {v0}, Lp6/c;->getVisibility()Lp6/r;
...
.method public isAbstract()Z
    ...
    invoke-interface {v0}, Lp6/c;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {v0}, Lp6/c;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {v0}, Lp6/c;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {v0}, Lp6/c;->isSuspend()Z
