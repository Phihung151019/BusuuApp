...
.method static constructor <clinit>()V
    ...
    sput-object v1, LE6/d;->a:Ljava/util/List;
    ...
    invoke-static {v4}, Lh6/a;->c(Lkotlin/reflect/KClass;)Ljava/lang/Class;

    move-result-object v5

    invoke-static {v4}, Lh6/a;->d(Lkotlin/reflect/KClass;)Ljava/lang/Class;
    ...
    sput-object v1, LE6/d;->b:Ljava/util/Map;

    sget-object v1, LE6/d;->a:Ljava/util/List;
    ...
    sput-object v1, LE6/d;->c:Ljava/util/Map;

    const-class v31, Li6/m;

    const-class v32, Li6/n;

    const-class v10, Li6/a;

    const-class v11, Lkotlin/jvm/functions/Function1;

    const-class v12, Li6/o;

    const-class v13, Li6/p;

    const-class v14, Li6/q;

    const-class v15, Li6/r;

    const-class v16, Li6/s;

    const-class v17, Li6/t;

    const-class v18, Li6/u;

    const-class v19, Li6/v;

    const-class v20, Li6/b;

    const-class v21, Li6/c;

    const-class v22, Li6/d;

    const-class v23, Li6/e;

    const-class v24, Li6/f;

    const-class v25, Li6/g;

    const-class v26, Li6/h;

    const-class v27, Li6/i;

    const-class v28, Li6/j;

    const-class v29, Li6/k;

    const-class v30, Li6/l;
    ...
    sput-object v0, LE6/d;->d:Ljava/util/Map;

    return-void
.end method

.method public static final a(Ljava/lang/Class;)LX6/b;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, v1}, LX6/b;->d(LX6/f;)LX6/b;
    ...
    invoke-direct {v0, p0}, LX6/c;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v1, v0, v2}, LX6/b;-><init>(LX6/c;LX6/c;Z)V
...
.method public static final b(Ljava/lang/Class;)Ljava/lang/String;
    ...
    invoke-static/range {v3 .. v8}, LC7/o;->A(Ljava/lang/String;CCZILjava/lang/Object;)Ljava/lang/String;
...
.method public static final c(Ljava/lang/reflect/Type;)Ljava/util/List;
    ...
    invoke-static {p0}, LU5/i;->p0([Ljava/lang/Object;)Ljava/util/List;
    ...
    :cond_1
    sget-object v0, LE6/d$a;->e:LE6/d$a;

    invoke-static {p0, v0}, LB7/k;->i(Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)LB7/h;

    move-result-object p0

    sget-object v0, LE6/d$b;->e:LE6/d$b;

    invoke-static {p0, v0}, LB7/k;->s(LB7/h;Lkotlin/jvm/functions/Function1;)LB7/h;
...
.method public static final d(Ljava/lang/Class;)Ljava/lang/Class;
    ...
    sget-object v0, LE6/d;->b:Ljava/util/Map;
...
.method public static final f(Ljava/lang/Class;)Ljava/lang/Class;
    ...
    sget-object v0, LE6/d;->c:Ljava/util/Map;
