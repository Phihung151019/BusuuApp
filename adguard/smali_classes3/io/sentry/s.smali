...
.method public constructor <init>(Lio/sentry/Q;)V
    ...
    iput-object p1, p0, Lio/sentry/s;->a:Lio/sentry/Q;
...
.method public a(Ljava/io/InputStream;)Lio/sentry/h1;
    ...
    invoke-virtual {p0, p1, v2, v4}, Lio/sentry/s;->b([BII)Lio/sentry/i1;
    ...
    invoke-virtual {p0, p1, v4, v6}, Lio/sentry/s;->c([BII)Lio/sentry/z1;

    move-result-object v4

    if-eqz v4, :cond_9

    invoke-virtual {v4}, Lio/sentry/z1;->a()I
    ...
    new-instance v9, Lio/sentry/y1;

    invoke-direct {v9, v4, v5}, Lio/sentry/y1;-><init>(Lio/sentry/z1;[B)V
    ...
    invoke-direct {p1, v0, v2}, Lio/sentry/h1;-><init>(Lio/sentry/i1;Ljava/lang/Iterable;)V
    :try_end_0
...
.method public final b([BII)Lio/sentry/i1;
    .locals 2
    ...
    iget-object p2, p0, Lio/sentry/s;->a:Lio/sentry/Q;

    const-class p3, Lio/sentry/i1;

    invoke-interface {p2, p1, p3}, Lio/sentry/Q;->c(Ljava/io/Reader;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public final c([BII)Lio/sentry/z1;
    .locals 2
