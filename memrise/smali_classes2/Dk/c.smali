...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    # --- Case 1: Launcher Logic (SỬA LỖI TẠI ĐÂY) ---
    :pswitch_0
    check-cast v3, LQc/e;
    ...
    # Nhảy thẳng đến nhãn xử lý Intent thành công
    goto :launcher_success

    :launcher_success
    # Ép kiểu thành e$a để lấy Intent khởi động
    ...
    move-result-object v0
    :try_end_1
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_1 .. :try_end_1} :catch_intent_fail

    if-eqz v0, :cond_launcher_start
