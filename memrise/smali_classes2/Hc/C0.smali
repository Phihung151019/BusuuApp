...
# instance fields
.field public final b:Lcom/memrise/android/session/learnscreen/LearnActivity;
...
.field public final f:Lmg/D;


# direct methods
.method public constructor <init>(LHc/Z;Lcom/memrise/android/session/learnscreen/LearnActivity;)V
    .locals 27
    ...
    iput-object v1, v0, LHc/C0;->c:LHc/Z;

    move-object/from16 v2, p2

    iput-object v2, v0, LHc/C0;->b:Lcom/memrise/android/session/learnscreen/LearnActivity;
    ...
    iput-object v3, v0, LHc/C0;->d:LUf/D;
    ...
    iget-object v15, v1, LHc/Z;->x2:LBd/q;

    iget-object v10, v1, LHc/Z;->w1:Lbl/d;
    ...
    new-instance v10, LTg/j;

    const/4 v11, 0x1

    invoke-direct {v10, v11, v8, v5}, LTg/j;-><init>(ILbl/b;Lbl/d;)V

    iget-object v5, v1, LHc/Z;->Y:Lbl/d;

    new-instance v11, LIc/b;

    invoke-direct {v11, v5}, LIc/b;-><init>(Lbl/d;)V

    iget-object v5, v1, LHc/Z;->m3:Lbl/d;

    iget-object v14, v1, LHc/Z;->G1:LCd/b;
    ...
    invoke-direct {v2, v5, v14, v11, v3}, LIe/b;-><init>(Lbl/d;Lbl/d;Lbl/d;I)V

    iget-object v3, v1, LHc/Z;->c4:Lbl/d;

    new-instance v5, LAf/l;

    const/4 v11, 0x2

    invoke-direct {v5, v3, v11}, LAf/l;-><init>(Lbl/d;I)V

    iget-object v11, v1, LHc/Z;->S0:Lbl/d;
    ...
    invoke-direct {v14, v11, v4}, LTg/n;-><init>(Lbl/d;I)V

    new-instance v4, LYb/h;

    const/4 v11, 0x1

    invoke-direct {v4, v11, v6, v3}, LYb/h;-><init>(ILbl/b;Lbl/d;)V
    ...
    iget-object v11, v1, LHc/Z;->r4:Lbl/d;
    ...
    invoke-direct {v15, v3, v11, v14}, LIc/x;-><init>(Lbl/d;Lbl/d;I)V

    new-instance v3, LEh/m;

    const/4 v11, 0x2

    invoke-direct {v3, v13, v11}, LEh/m;-><init>(Lbl/d;I)V

    new-instance v11, LCj/i;

    invoke-direct {v11, v3, v5, v6, v4}, LCj/i;-><init>(LEh/m;LAf/g;Lnf/b;Lbl/d;)V

    new-instance v3, LQc/c;

    const/4 v5, 0x1

    invoke-direct {v3, v12, v5}, LQc/c;-><init>(Lbl/b;I)V

    new-instance v5, Lsg/b;

    invoke-direct {v5, v11, v3, v9, v13}, Lsg/b;-><init>(LCj/i;LQc/c;LIc/L;LAf/p;)V

    new-instance v12, LUf/f;

    invoke-direct {v12, v11, v3, v9, v13}, LUf/f;-><init>(LCj/i;LQc/c;LIc/L;LAf/p;)V
    ...
    iget-object v14, v1, LHc/Z;->q4:Llf/c;
    ...
    invoke-direct {v2, v4, v8}, LIc/J;-><init>(ILjava/lang/Object;)V

    new-instance v4, LCc/w;

    const/4 v5, 0x2

    invoke-direct {v4, v2, v5}, LCc/w;-><init>(Lbl/b;I)V

    iput-object v4, v0, LHc/C0;->e:LCc/w;

    iget-object v2, v1, LHc/Z;->e3:LIc/v;

    move-object v15, v14

    new-instance v14, LIc/u;

    const/4 v4, 0x1

    invoke-direct {v14, v2, v4}, LIc/u;-><init>(Lbl/d;I)V

    iget-object v9, v1, LHc/Z;->v2:Lbl/d;

    iget-object v1, v1, LHc/Z;->E3:LCd/y;
    ...
    invoke-direct/range {v8 .. v15}, Lmg/D;-><init>(Lbl/d;LFf/x;LAf/p;Lgh/A;LCd/y;LIc/u;LBd/q;)V

    iput-object v8, v0, LHc/C0;->f:Lmg/D;
...
.method public final j(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, LHc/C0;->c:LHc/Z;
    ...
    iget-object v3, p0, LHc/C0;->d:LUf/D;
    ...
    iget-object v3, p0, LHc/C0;->e:LCc/w;

    invoke-virtual {v1, v2, v3}, LD9/w$a;->b(Ljava/lang/Object;Ljava/lang/Object;)V

    const-class v2, Lmg/C;

    iget-object v3, p0, LHc/C0;->f:Lmg/D;
    ...
    iput-object v1, p1, Lcom/memrise/android/session/learnscreen/LearnActivity;->r:LC4/b;
    ...
    iget-object v2, p0, LHc/C0;->b:Lcom/memrise/android/session/learnscreen/LearnActivity;
    ...
    iput-object v3, p1, Lcom/memrise/android/session/learnscreen/LearnActivity;->s:Lcom/memrise/android/session/learnscreen/i;

    invoke-virtual {v0}, LHc/Z;->b()Lvf/a;

    move-result-object v0

    iput-object v0, p1, Lcom/memrise/android/session/learnscreen/LearnActivity;->t:Lvf/a;
