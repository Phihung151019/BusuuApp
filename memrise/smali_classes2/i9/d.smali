...
.method public final f(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->w:Lcom/google/android/material/floatingactionbutton/FloatingActionButton$b;
...
.method public final g(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/d;->a:Lq9/i;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v1, Li9/d$a;

    invoke-direct {v1, v0}, Lq9/f;-><init>(Lq9/i;)V

    iput-object v1, p0, Lcom/google/android/material/floatingactionbutton/d;->b:Lq9/f;
    ...
    invoke-virtual {v0, p2}, Lq9/f;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V

    :cond_0
    iget-object p2, p0, Lcom/google/android/material/floatingactionbutton/d;->b:Lq9/f;
    ...
    invoke-virtual {p2, v1}, Lq9/f;->i(Landroid/content/Context;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/floatingactionbutton/d;->a:Lq9/i;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-direct {v1, v2}, Li9/a;-><init>(Lq9/i;)V
    ...
    iput v2, v1, Li9/a;->i:I

    iput v3, v1, Li9/a;->j:I

    iput v4, v1, Li9/a;->k:I

    iput v0, v1, Li9/a;->l:I

    int-to-float p4, p4

    iget v0, v1, Li9/a;->h:F
    ...
    iput p4, v1, Li9/a;->h:F

    const v0, 0x3faaa993    # 1.3333f

    mul-float/2addr p4, v0

    iget-object v0, v1, Li9/a;->b:Landroid/graphics/Paint;

    invoke-virtual {v0, p4}, Landroid/graphics/Paint;->setStrokeWidth(F)V

    iput-boolean v2, v1, Li9/a;->n:Z
    ...
    iget v0, v1, Li9/a;->m:I

    invoke-virtual {p1, p4, v0}, Landroid/content/res/ColorStateList;->getColorForState([II)I

    move-result p4

    iput p4, v1, Li9/a;->m:I

    :cond_2
    iput-object p1, v1, Li9/a;->p:Landroid/content/res/ColorStateList;

    iput-boolean v2, v1, Li9/a;->n:Z

    invoke-virtual {v1}, Landroid/graphics/drawable/Drawable;->invalidateSelf()V

    iput-object v1, p0, Lcom/google/android/material/floatingactionbutton/d;->d:Li9/a;

    new-instance p1, Landroid/graphics/drawable/LayerDrawable;

    iget-object p4, p0, Lcom/google/android/material/floatingactionbutton/d;->d:Li9/a;
    ...
    :cond_3
    iput-object p2, p0, Lcom/google/android/material/floatingactionbutton/d;->d:Li9/a;

    iget-object p1, p0, Lcom/google/android/material/floatingactionbutton/d;->b:Lq9/f;

    :goto_0
    new-instance p4, Landroid/graphics/drawable/RippleDrawable;

    invoke-static {p3}, Lo9/a;->a(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
...
.method public final k(FFF)V
    ...
    iget-object v2, p0, Li9/d;->N:Landroid/animation/StateListAnimator;
    ...
    invoke-virtual {p0, p1, p3}, Li9/d;->r(FF)Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p0, p1, p2}, Li9/d;->r(FF)Landroid/animation/AnimatorSet;
    ...
    sget-object p1, Lcom/google/android/material/floatingactionbutton/d;->C:LD2/a;
    ...
    invoke-virtual {p0, v3, v3}, Li9/d;->r(FF)Landroid/animation/AnimatorSet;

    move-result-object p2

    invoke-virtual {v1, p1, p2}, Landroid/animation/StateListAnimator;->addState([ILandroid/animation/Animator;)V

    iput-object v1, p0, Li9/d;->N:Landroid/animation/StateListAnimator;

    invoke-virtual {v0, v1}, Landroid/view/View;->setStateListAnimator(Landroid/animation/StateListAnimator;)V

    :cond_0
    invoke-virtual {p0}, Li9/d;->o()Z
