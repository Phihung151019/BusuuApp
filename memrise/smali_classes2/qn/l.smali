...
# direct methods
.method public constructor <init>(LKl/b;Ljava/nio/charset/Charset;)V
    .locals 2
    ...
    iput-object p1, p0, Lqn/l;->a:LKl/b;
    ...
    iput-object p1, p0, Lqn/l;->b:Ljava/nio/charset/CharsetDecoder;

    sget-object p1, Lqn/h;->c:Lqn/h;

    monitor-enter p1

    :try_start_0
    iget-object p2, p1, LP0/h;->b:Ljava/lang/Object;
    ...
    :cond_0
    invoke-virtual {p2}, Lnm/k;->removeLast()Ljava/lang/Object;
    ...
    iput-object p1, p0, Lqn/l;->c:Ljava/nio/ByteBuffer;
...
.method public final a([CII)I
    ...
    iget-boolean v1, p0, Lqn/l;->d:Z

    const/4 v2, 0x1

    if-eqz v1, :cond_2

    iget-char v1, p0, Lqn/l;->e:C
    ...
    iget-boolean p3, p0, Lqn/l;->d:Z

    if-eqz p3, :cond_3

    iput-boolean v0, p0, Lqn/l;->d:Z

    iget-char p3, p0, Lqn/l;->e:C
    ...
    invoke-virtual {p0, v4, v0, p3}, Lqn/l;->a([CII)I
    ...
    iput-char p3, p0, Lqn/l;->e:C

    iput-boolean v2, p0, Lqn/l;->d:Z
    ...
    :cond_b
    :goto_2
    iget-object p2, p0, Lqn/l;->b:Ljava/nio/charset/CharsetDecoder;

    iget-object p3, p0, Lqn/l;->c:Ljava/nio/ByteBuffer;
    ...
    :goto_3
    iget-object v7, p0, Lqn/l;->a:LKl/b;
    ...
    invoke-virtual {v7, v8, v9, v5}, LKl/b;->read([BII)I
    ...
    invoke-static {p2, p3, v0, v1, v1}, LA6/e;->c(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
