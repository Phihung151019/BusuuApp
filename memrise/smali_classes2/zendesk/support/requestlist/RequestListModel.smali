...
.field private final mapper:LUk/a;
...
.method public constructor <init>(Lzendesk/support/requestlist/RequestInfoDataSource;Lzendesk/core/MemoryCache;Lzendesk/support/SupportBlipsProvider;Lzendesk/support/SupportSettingsProvider;)V
    ...
    iput-object v0, p0, Lzendesk/support/requestlist/RequestListModel;->mapper:LUk/a;
...
.method public static bridge synthetic a(Lzendesk/support/requestlist/RequestListModel;)Lzendesk/core/MemoryCache;
    .locals 0
...
.method public static bridge synthetic b(Lzendesk/support/requestlist/RequestListModel;)LUk/a;
    .locals 0

    iget-object p0, p0, Lzendesk/support/requestlist/RequestListModel;->mapper:LUk/a;

    return-object p0
.end method

.method public static bridge synthetic c(Lzendesk/support/requestlist/RequestListModel;Ljava/util/List;Z)Ljava/util/List;
    .locals 0
...
.method private filterClosedRequests(Ljava/util/List;Z)Ljava/util/List;
    ...
    invoke-static {p1, p2}, LXk/a;->e(Ljava/util/Collection;LUk/a;)Ljava/util/ArrayList;
...
.method public loadItems(ZLzendesk/support/SupportSdkSettings;LWk/d;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-direct {v0, p0, p2, p3}, Lzendesk/support/requestlist/RequestListModel$1;-><init>(Lzendesk/support/requestlist/RequestListModel;Lzendesk/support/SupportSdkSettings;LWk/d;)V

    invoke-interface {p1, v0}, Lzendesk/support/requestlist/RequestInfoDataSource;->load(LWk/d;)V

    return-void
.end method

.method public loadSettings(LWk/d;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lzendesk/support/AggregatedCallback;->add(LWk/d;)Z
    ...
    invoke-interface {p1, v0}, Lzendesk/support/SupportSettingsProvider;->getSettings(LWk/d;)V
