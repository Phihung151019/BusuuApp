...
# direct methods
.method private constructor <init>(Landroid/view/View;Lzendesk/support/requestlist/RequestListView$OnItemClick;Lcom/squareup/picasso/j;)V
    .locals 0
    ...
    iput-object p3, p0, Lzendesk/support/requestlist/RequestListViewHolder;->picasso:Lcom/squareup/picasso/j;
    ...
    sget p3, Lzendesk/support/R$id;->request_list_item_avatar:I
    ...
    sget p3, Lzendesk/support/R$id;->request_list_item_time:I
    ...
    sget p3, Lzendesk/support/R$id;->request_list_item_user:I
    ...
    sget p3, Lzendesk/support/R$id;->request_list_item_subject:I
    ...
    sget p3, Lzendesk/support/R$id;->request_list_item_body:I
    ...
    sget p2, Lzendesk/support/R$dimen;->zs_request_list_avatar_radius:I
...
.method public static bridge synthetic a(Lzendesk/support/requestlist/RequestListViewHolder;)Lzendesk/support/requestlist/RequestListView$OnItemClick;
    .locals 0
...
.method private bindAvatar(ZLjava/util/List;Ljava/lang/String;)V
    ...
    invoke-static {p3}, LXk/d;->a(Ljava/lang/String;)Z
    ...
    iget-object v1, p0, Lzendesk/support/requestlist/RequestListViewHolder;->picasso:Lcom/squareup/picasso/j;
    ...
    invoke-virtual {p1, v1, p3, p2, v0}, Lzendesk/support/ZendeskAvatarView;->showUserWithAvatarImage(Lcom/squareup/picasso/j;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    sget p2, Lzendesk/support/R$string;->request_list_me:I
...
.method public static create(Landroid/content/Context;Landroid/view/ViewGroup;Lzendesk/support/requestlist/RequestListView$OnItemClick;Lcom/squareup/picasso/j;)Lzendesk/support/requestlist/RequestListViewHolder;
    .locals 2
    ...
    sget v0, Lzendesk/support/R$layout;->zs_request_list_ticket_item:I
    ...
    invoke-direct {p1, p0, p2, p3}, Lzendesk/support/requestlist/RequestListViewHolder;-><init>(Landroid/view/View;Lzendesk/support/requestlist/RequestListView$OnItemClick;Lcom/squareup/picasso/j;)V
...
.method private style(ZZZ)V
    ...
    sget v0, Lzendesk/support/R$color;->zs_request_list_dark_text_color:I
    ...
    sget p3, Lzendesk/support/R$attr;->colorPrimary:I

    iget-object v0, p0, Lzendesk/support/requestlist/RequestListViewHolder;->context:Landroid/content/Context;

    sget v1, Lzendesk/support/R$color;->zs_request_list_light_text_color:I
    ...
    sget v0, Lzendesk/support/R$color;->zs_request_list_light_text_color:I
    ...
    sget p3, Lzendesk/support/R$color;->zs_request_cell_label_color_error:I
    ...
    sget p3, Lzendesk/support/R$color;->zs_request_list_white:I
...
.method public bind(Lzendesk/support/requestlist/RequestListItem;)V
    ...
    sget v2, Lzendesk/support/R$string;->request_list_me:I
    ...
    sget v2, Lzendesk/support/R$string;->request_list_re:I
    ...
    sget v1, Lzendesk/support/R$string;->request_list_ticket_closed:I
    ...
    sget v1, Lzendesk/support/R$string;->ask_request_list_failed_request_message:I
