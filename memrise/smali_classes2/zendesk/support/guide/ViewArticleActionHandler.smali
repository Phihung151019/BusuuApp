...
.method public static data(JLjava/lang/String;)Ljava/util/Map;
    ...
    const-string v1, "help_center_article_id"
...
.method public handle(Ljava/util/Map;Landroid/content/Context;)V
    ...
    const-string p2, "Property map is null, cannot open article."
    ...
    invoke-static {p1, v2}, Lro/c;->a(Ljava/util/Map;Ljava/lang/Class;)Lro/a;

    move-result-object p1

    if-eqz p1, :cond_4

    invoke-interface {p1}, Lro/a;->getConfigurations()Ljava/util/List;
