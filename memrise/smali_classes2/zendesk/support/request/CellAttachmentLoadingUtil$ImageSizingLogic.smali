...
# direct methods
.method public constructor <init>(Lcom/squareup/picasso/j;Landroid/content/Context;)V
    .locals 1
    ...
    iput-object p1, p0, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic;->picasso:Lcom/squareup/picasso/j;
...
.method public static bridge synthetic a(Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic;)Ljava/util/Map;
    .locals 0
...
.method private calculateMaxWidth(Landroid/content/Context;)I
    ...
    sget v2, Lzendesk/support/R$dimen;->zs_request_message_margin_side:I
...
.method private getDimensionStrategy(Lzendesk/support/request/StateRequestAttachment;Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ImageDimensions;)Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$DimensionStrategy;
    ...
    iget-object v2, p0, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic;->picasso:Lcom/squareup/picasso/j;
    ...
    invoke-direct {v0, v3, p2, v1}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ReadFromPicasso;-><init>(Lcom/squareup/picasso/n;Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ImageDimensions;I)V
    ...
    invoke-virtual {v2, p1}, Lcom/squareup/picasso/j;->d(Ljava/lang/String;)Lcom/squareup/picasso/n;

    move-result-object p1

    invoke-direct {v0, p1, p2, v1}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ReadFromPicasso;-><init>(Lcom/squareup/picasso/n;Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ImageDimensions;I)V
    ...
    const-string p2, "Can\'t load dimensions. Id: %s"
    ...
    invoke-direct {p1, v1}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$DefaultStrategy;-><init>(I)V
...
.method public loadDimensionsForAttachment(Lzendesk/support/request/StateRequestAttachment;LWk/d;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, p1, p2}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$1;-><init>(Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic;Lzendesk/support/request/StateRequestAttachment;LWk/d;)V

    invoke-interface {v0, v1}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$DimensionStrategy;->findDimensions(LWk/d;)V
