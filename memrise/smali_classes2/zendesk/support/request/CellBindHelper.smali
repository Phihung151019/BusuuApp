...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/squareup/picasso/j;Lzendesk/support/request/ActionFactory;Lzendesk/support/suas/Dispatcher;Lzendesk/support/request/MediaResultUtility;)V
    .locals 0
    ...
    invoke-direct {p3, p2, p1}, Lzendesk/support/request/CellAttachmentLoadingUtil;-><init>(Lcom/squareup/picasso/j;Landroid/content/Context;)V
    ...
    sget p2, Lzendesk/support/R$string;->request_message_date_today:I
    ...
    sget p2, Lzendesk/support/R$string;->request_message_date_yesterday:I
    ...
    iput-object p5, p0, Lzendesk/support/request/CellBindHelper;->mediaResultUtility:Lzendesk/support/request/MediaResultUtility;

    return-void
.end method

.method public static bridge synthetic a(Lzendesk/support/request/CellBindHelper;)Lzendesk/support/request/ActionFactory;
    .locals 0
...
.method public static bridge synthetic b(Lzendesk/support/request/CellBindHelper;)Landroid/content/Context;
    .locals 0
...
.method public static bridge synthetic c(Lzendesk/support/request/CellBindHelper;)Lzendesk/support/suas/Dispatcher;
    .locals 0
...
.method public static bridge synthetic d(Lzendesk/support/request/CellBindHelper;Landroid/content/Context;Lzendesk/support/request/StateRequestAttachment;)V
    .locals 0
...
.method private openAttachment(Landroid/content/Context;Lzendesk/support/request/StateRequestAttachment;)V
    ...
    invoke-virtual {p0, v0, p2}, Lzendesk/support/request/CellBindHelper;->getViewIntent(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Intent;
...
.method public addOnClickListenerForFileAttachment(Landroid/view/View;Lzendesk/support/request/StateRequestAttachment;)V
    ...
    sget v0, Lzendesk/support/R$integer;->zs_request_file_attachment_downloading_cell_alpha:I
...
.method public bindStatusLabel(Landroid/widget/TextView;ZZ)V
    ...
    sget p2, Lzendesk/support/R$color;->zs_request_cell_label_color_error:I

    sget p3, Lzendesk/support/R$string;->request_messages_status_error:I
    ...
    sget p2, Lzendesk/support/R$color;->zs_request_cell_label_color:I

    sget p3, Lzendesk/support/R$string;->request_message_status_delivered:I
    ...
    invoke-direct {v2, p3, p3, v3, v1}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V
...
.method public colorForError(Z)I
    ...
    sget p1, Lzendesk/support/R$color;->zs_request_user_background_color_error:I

    goto :goto_0

    :cond_0
    sget p1, Lzendesk/support/R$color;->zs_request_user_background_color:I
...
.method public colorForErrorImage(Z)I
    ...
    sget v0, Lzendesk/support/R$color;->zs_request_user_background_image_color_error:I
...
.method public getAppInfo(Ljava/lang/String;)Landroid/content/pm/ResolveInfo;
    ...
    iget-object v1, p0, Lzendesk/support/request/CellBindHelper;->mediaResultUtility:Lzendesk/support/request/MediaResultUtility;

    const-string v2, "tmp"

    invoke-virtual {v1, v2, p1}, Lzendesk/support/request/MediaResultUtility;->getMediaResultFromFile(Ljava/lang/String;Ljava/lang/String;)Lzendesk/support/request/MediaResult;

    move-result-object p1

    invoke-static {v0, p1}, Lzendesk/support/request/UtilsAttachment;->getAppInfoForFile(Landroid/content/Context;Lzendesk/support/request/MediaResult;)Landroid/content/pm/ResolveInfo;
...
.method public getViewIntent(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Intent;
    ...
    :cond_0
    invoke-virtual {p0, v0, p1}, Lzendesk/support/request/CellBindHelper;->grantPermissionsForUri(Landroid/content/Intent;Landroid/net/Uri;)V
