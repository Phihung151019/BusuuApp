...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/squareup/picasso/j;Lzendesk/support/request/ActionFactory;Lzendesk/support/suas/Dispatcher;Lzendesk/core/ActionHandlerRegistry;Lro/b;Lro/a;Lzendesk/support/request/MediaResultUtility;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lzendesk/support/request/CellBindHelper;-><init>(Landroid/content/Context;Lcom/squareup/picasso/j;Lzendesk/support/request/ActionFactory;Lzendesk/support/suas/Dispatcher;Lzendesk/support/request/MediaResultUtility;)V

    iput-object v0, p0, Lzendesk/support/request/CellFactory;->utils:Lzendesk/support/request/CellBindHelper;

    new-instance p1, Lzendesk/support/request/DocumentRenderer$HtmlParser;

    invoke-direct {p1}, Lzendesk/support/request/DocumentRenderer$HtmlParser;-><init>()V

    iput-object p1, p0, Lzendesk/support/request/CellFactory;->htmlParser:Lzendesk/support/request/DocumentRenderer$HtmlParser;

    new-instance p1, Lzendesk/support/request/DocumentRenderer;

    invoke-direct {p1, v1, p5, p6, p7}, Lzendesk/support/request/DocumentRenderer;-><init>(Landroid/content/Context;Lzendesk/core/ActionHandlerRegistry;Lro/b;Lro/a;)V

    iput-object p1, p0, Lzendesk/support/request/CellFactory;->documentRenderer:Lzendesk/support/request/DocumentRenderer;
...
.method public calculatePositionTypes(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p1, v0}, LG1/a;->a(ILjava/util/ArrayList;)Ljava/lang/Object;
...
.method public generateCells(Ljava/util/List;Ljava/util/List;Lzendesk/support/RequestStatus;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {p0, p2, v4, v5}, Lzendesk/support/request/CellFactory;->findUserForId(Ljava/util/List;J)Lzendesk/support/request/StateRequestUser;
    ...
    invoke-virtual {p0, v3, v4, v1}, Lzendesk/support/request/CellFactory;->getViewModelsForMessage(Lzendesk/support/request/StateMessage;ZLzendesk/support/request/StateRequestUser;)Ljava/util/List;
...
.method public getUserAttachment(Lzendesk/support/request/StateMessage;Lzendesk/support/request/StateRequestAttachment;Ljava/util/Date;)Lzendesk/support/request/CellType$Base;
    ...
    invoke-static {p2}, Lzendesk/support/request/UtilsAttachment;->isImageAttachment(Lzendesk/support/request/StateRequestAttachment;)Z
    ...
    new-instance v2, Lzendesk/support/request/CellUserAttachmentImage;
    ...
    invoke-direct/range {v2 .. v10}, Lzendesk/support/request/CellUserAttachmentImage;-><init>(Lzendesk/support/request/CellBindHelper;Lzendesk/support/request/StateMessage;Lzendesk/support/request/StateRequestAttachment;Ljava/util/Date;ZZLjava/util/List;Z)V
    ...
    iget-object v4, p0, Lzendesk/support/request/CellFactory;->utils:Lzendesk/support/request/CellBindHelper;
    ...
    invoke-direct/range {v3 .. v11}, Lzendesk/support/request/CellUserAttachmentGeneric;-><init>(Lzendesk/support/request/CellBindHelper;Lzendesk/support/request/StateMessage;Lzendesk/support/request/StateRequestAttachment;Ljava/util/Date;ZZLjava/util/List;Z)V
...
.method public getUserMessage(Lzendesk/support/request/StateMessage;)Ljava/util/List;
    ...
    new-instance v2, Lzendesk/support/request/CellUserMessage;
...
.method public insertSystemMessage(Lzendesk/support/request/StateMessage;Lzendesk/support/request/StateMessage;Ljava/util/List;Ljava/lang/String;Z)Ljava/util/List;
    ...
    invoke-static {p4}, LXk/d;->a(Ljava/lang/String;)Z
