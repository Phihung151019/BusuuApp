...
.method public constructor <init>(Lzendesk/support/request/CellBindHelper;Lzendesk/support/request/StateMessage;Lzendesk/support/request/StateRequestAttachment;Ljava/util/Date;ZZLjava/util/List;Z)V
    ...
    sget v2, Lzendesk/support/R$layout;->zs_request_user_attachment_generic:I
    ...
    iput-object p3, p0, Lzendesk/support/request/CellUserAttachmentGeneric;->requestAttachment:Lzendesk/support/request/StateRequestAttachment;

    iput-boolean p5, p0, Lzendesk/support/request/CellUserAttachmentGeneric;->markAsDelivered:Z

    iput-object p2, p0, Lzendesk/support/request/CellUserAttachmentGeneric;->message:Lzendesk/support/request/StateMessage;

    iput-boolean p6, p0, Lzendesk/support/request/CellUserAttachmentGeneric;->showError:Z

    iput-object p7, p0, Lzendesk/support/request/CellUserAttachmentGeneric;->erroredMessages:Ljava/util/List;

    move/from16 p2, p8

    iput-boolean p2, p0, Lzendesk/support/request/CellUserAttachmentGeneric;->lastErrorCellOfBlock:Z
    ...
    iput-object p2, p0, Lzendesk/support/request/CellUserAttachmentGeneric;->appInfo:Landroid/content/pm/ResolveInfo;
    ...
    iput-object p1, p0, Lzendesk/support/request/CellUserAttachmentGeneric;->insets:Landroid/graphics/Rect;
...
.method private buildTalkBackString(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget v1, Lzendesk/support/R$string;->zs_request_message_user_file_accessibility:I
...
.method public bind(Lzendesk/support/request/ComponentRequestAdapter$RequestViewHolder;)V
    ...
    sget v0, Lzendesk/support/R$id;->request_user_attachment_generic_name:I
    ...
    sget v0, Lzendesk/support/R$id;->request_user_attachment_generic_type:I
    ...
    sget v1, Lzendesk/support/R$id;->request_user_attachment_generic_icon:I
    ...
    sget v0, Lzendesk/support/R$id;->request_user_attachment_generic_container:I
    ...
    sget v1, Lzendesk/support/R$id;->request_user_attachment_generic_status:I
...
.method public markAsDelivered()Lzendesk/support/request/CellType$Stateful;
    ...
    new-instance v0, Lzendesk/support/request/CellUserAttachmentGeneric;
