...
.method private setConfigurations(Ljava/util/List;)V
    ...
    invoke-static {p1}, Lzendesk/support/request/RequestConfiguration;->b(Lzendesk/support/request/RequestConfiguration;)J

    move-result-wide v0

    iput-wide v0, p0, Lzendesk/support/request/RequestConfiguration$Builder;->ticketFormId:J

    invoke-static {p1}, Lzendesk/support/request/RequestConfiguration;->a(Lzendesk/support/request/RequestConfiguration;)Ljava/util/List;
...
.method public config()Lro/a;
    ...
    new-instance v0, Lzendesk/support/request/RequestConfiguration;
...
.method public varargs deepLinkIntent(Landroid/content/Context;[Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-virtual {p0, p1, v1}, Lzendesk/support/request/RequestConfiguration$Builder;->intent(Landroid/content/Context;[Lro/a;)Landroid/content/Intent;
...
.method public intent(Landroid/content/Context;Ljava/util/List;)Landroid/content/Intent;
    ...
    invoke-virtual {p0}, Lzendesk/support/request/RequestConfiguration$Builder;->config()Lro/a;
...
.method public varargs show(Landroid/content/Context;[Lro/a;)V
    ...
    invoke-virtual {p0, p1, p2}, Lzendesk/support/request/RequestConfiguration$Builder;->intent(Landroid/content/Context;[Lro/a;)Landroid/content/Intent;
...
.method public withFiles(Ljava/util/List;)Lzendesk/support/request/RequestConfiguration$Builder;
    ...
    invoke-static {v2}, LK8/O;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, LXk/c;->b(Ljava/lang/String;)Ljava/lang/String;
