...
.method public constructor <init>(Lzendesk/support/request/CellBindHelper;Lzendesk/support/request/StateRequestAttachment;Lzendesk/support/request/StateRequestUser;Ljava/util/Date;)V
    ...
    sget v2, Lzendesk/support/R$layout;->zs_request_agent_attachment_generic:I
    ...
    iput-object p2, v0, Lzendesk/support/request/CellAgentAttachmentGeneric;->requestAttachment:Lzendesk/support/request/StateRequestAttachment;

    iput-object p3, v0, Lzendesk/support/request/CellAgentAttachmentGeneric;->user:Lzendesk/support/request/StateRequestUser;

    const/4 p1, 0x0

    iput-boolean p1, v0, Lzendesk/support/request/CellAgentAttachmentGeneric;->isAgentNameVisible:Z

    invoke-virtual {p2}, Lzendesk/support/request/StateRequestAttachment;->getName()Ljava/lang/String;

    move-result-object p2

    invoke-virtual {v1, p2}, Lzendesk/support/request/CellBindHelper;->getAppInfo(Ljava/lang/String;)Landroid/content/pm/ResolveInfo;

    move-result-object p2

    iput-object p2, v0, Lzendesk/support/request/CellAgentAttachmentGeneric;->appInfo:Landroid/content/pm/ResolveInfo;
    ...
    iput-object p1, v0, Lzendesk/support/request/CellAgentAttachmentGeneric;->insets:Landroid/graphics/Rect;
...
.method private buildTalkBackString(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget v1, Lzendesk/support/R$string;->zs_request_message_agent_file_accessibility:I
...
.method public bind(Lzendesk/support/request/ComponentRequestAdapter$RequestViewHolder;)V
    ...
    sget v0, Lzendesk/support/R$id;->request_agent_attachment_generic_name:I
    ...
    sget v0, Lzendesk/support/R$id;->request_agent_attachment_generic_type:I
    ...
    sget v1, Lzendesk/support/R$id;->request_agent_attachment_generic_icon:I
    ...
    sget v0, Lzendesk/support/R$id;->request_agent_attachment_generic_container:I
    ...
    sget v1, Lzendesk/support/R$id;->request_agent_attachment_generic_agent_name:I
