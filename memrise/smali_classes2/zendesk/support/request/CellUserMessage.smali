...
.method public constructor <init>(Lzendesk/support/request/CellBindHelper;Lzendesk/support/request/StateMessage;ZZLjava/lang/CharSequence;Ljava/util/List;Z)V
    ...
    sget v2, Lzendesk/support/R$layout;->zs_request_user_message:I
    ...
    iput-object p5, v0, Lzendesk/support/request/CellUserMessage;->textMessage:Ljava/lang/CharSequence;

    iput-object p2, v0, Lzendesk/support/request/CellUserMessage;->message:Lzendesk/support/request/StateMessage;

    iput-boolean p3, v0, Lzendesk/support/request/CellUserMessage;->markAsDelivered:Z

    iput-boolean p4, v0, Lzendesk/support/request/CellUserMessage;->showError:Z

    const/4 p1, 0x0

    sget p2, Lzendesk/support/R$dimen;->zs_request_message_inset_user_bottom:I

    invoke-virtual {v1, p1, p1, p1, p2}, Lzendesk/support/request/CellBindHelper;->getInsets(IIII)Landroid/graphics/Rect;

    move-result-object p1

    iput-object p1, v0, Lzendesk/support/request/CellUserMessage;->insets:Landroid/graphics/Rect;

    iput-object p6, v0, Lzendesk/support/request/CellUserMessage;->erroredMessages:Ljava/util/List;

    iput-boolean p7, v0, Lzendesk/support/request/CellUserMessage;->lastErrorCellOfBlock:Z
...
.method private buildTalkBackString(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget v1, Lzendesk/support/R$string;->zs_request_message_user_text_accessibility:I
...
.method public bind(Lzendesk/support/request/ComponentRequestAdapter$RequestViewHolder;)V
    ...
    sget v0, Lzendesk/support/R$id;->request_user_message_text:I
    ...
    sget v1, Lzendesk/support/R$id;->request_user_message_status:I
    ...
    sget v2, Lzendesk/support/R$id;->request_user_message_bubble:I
...
.method public markAsDelivered()Lzendesk/support/request/CellType$Stateful;
    ...
    invoke-virtual {v0, v1}, Lzendesk/support/request/CellBase;->setPositionType(I)V
...
.method public markAsErrored(Ljava/util/List;Z)Lzendesk/support/request/CellType$Stateful;
    ...
    invoke-virtual {v0, p1}, Lzendesk/support/request/CellBase;->setPositionType(I)V
