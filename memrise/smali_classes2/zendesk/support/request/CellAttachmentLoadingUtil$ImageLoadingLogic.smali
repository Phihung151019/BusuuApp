...
# direct methods
.method public constructor <init>(Lcom/squareup/picasso/j;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic;->picasso:Lcom/squareup/picasso/j;

    return-void
.end method

.method public static bridge synthetic a(Landroid/widget/ImageView;Lcom/squareup/picasso/n;Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ImageDimensions;LPk/b;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic;->loadImage(Landroid/widget/ImageView;Lcom/squareup/picasso/n;Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ImageDimensions;LPk/b;)V
...
.method private getLoadingStrategy(Lzendesk/support/request/StateRequestAttachment;)Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic$LoadingStrategy;
    ...
    iget-object v2, p0, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic;->picasso:Lcom/squareup/picasso/j;
    ...
    invoke-direct {p1, v2, v3}, Lcom/squareup/picasso/n;-><init>(Lcom/squareup/picasso/j;Landroid/net/Uri;)V
    ...
    invoke-direct {v3, v2, p1}, Lcom/squareup/picasso/n;-><init>(Lcom/squareup/picasso/j;Landroid/net/Uri;)V

    move-object p1, v3

    :goto_0
    invoke-direct {v0, p1, v1}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic$DisplayImageFromLocalSource;-><init>(Lcom/squareup/picasso/n;I)V
    ...
    invoke-direct {v0, v3, v1}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic$DisplayImageFromLocalSource;-><init>(Lcom/squareup/picasso/n;I)V
    ...
    invoke-direct {v0, v2, v3, p1, v1}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic$DisplayImageFromWeb;-><init>(Lcom/squareup/picasso/j;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string v0, "Can\'t load image. Id: %s"
    ...
    invoke-direct {p1, v1}, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic$DefaultDisplayStrategy;-><init>(I)V

    return-object p1
.end method

.method private static loadImage(Landroid/widget/ImageView;Lcom/squareup/picasso/n;Lzendesk/support/request/CellAttachmentLoadingUtil$ImageSizingLogic$ImageDimensions;LPk/b;)V
    .locals 3
    ...
    invoke-static {v1}, Lzendesk/support/PicassoTransformations;->getRoundedTransformation(I)LPk/k;

    move-result-object v1

    invoke-virtual {p1, v1}, Lcom/squareup/picasso/n;->d(LPk/k;)V

    div-int/lit8 v0, v0, 0x2

    div-int/lit8 p2, p2, 0x2

    iget-object v1, p1, Lcom/squareup/picasso/n;->b:Lcom/squareup/picasso/m$a;

    invoke-virtual {v1, v0, p2}, Lcom/squareup/picasso/m$a;->a(II)V

    invoke-virtual {p1}, Lcom/squareup/picasso/n;->a()V

    invoke-virtual {p1, p0, p3}, Lcom/squareup/picasso/n;->c(Landroid/widget/ImageView;LPk/b;)V
...
.method public initImageView(Landroid/widget/ImageView;)V
    ...
    iget-object v0, p0, Lzendesk/support/request/CellAttachmentLoadingUtil$ImageLoadingLogic;->picasso:Lcom/squareup/picasso/j;
