...
.method public reduce(Lzendesk/support/request/StateError;Lzendesk/support/suas/Action;)Lzendesk/support/request/StateError;
    ...
    invoke-virtual {v0}, Lzendesk/support/request/ActionFactory$ErrorAction;->getErrorResponse()LWk/a;

    move-result-object v0

    invoke-interface {v0}, LWk/a;->j()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-interface {v0}, LWk/a;->g()I
    ...
    invoke-interface {v0}, LWk/a;->i()Ljava/lang/String;
    ...
    :sswitch_4
    const-string v1, "LOAD_COMMENTS_INITIAL_ERROR"
    ...
    invoke-virtual {p2}, Lzendesk/support/request/ActionFactory$ErrorAction;->getErrorResponse()LWk/a;
