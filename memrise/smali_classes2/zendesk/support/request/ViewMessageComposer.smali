...
.method private bindViews()V
    ...
    sget v0, Lzendesk/support/R$id;->message_composer_input_text:I
    ...
    sget v0, Lzendesk/support/R$id;->message_composer_attachments_indicator:I
    ...
    sget v0, Lzendesk/support/R$id;->message_composer_send_btn:I
...
.method private initAnimationsAndAdjustLeftMargin()V
    ...
    sget v1, Lzendesk/support/R$integer;->zs_request_message_composer_animation_duration:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v1

    sget v2, Lzendesk/support/R$dimen;->zs_request_message_composer_collapsed_height:I

    invoke-virtual {v0, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v2

    sget v3, Lzendesk/support/R$dimen;->zs_request_message_composer_expanded_min_height:I

    invoke-virtual {v0, v3}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    sget v4, Lzendesk/support/R$dimen;->zs_request_message_composer_expanded_side_margin:I

    invoke-virtual {v0, v4}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v4

    sget v5, Lzendesk/support/R$dimen;->zs_request_message_composer_collapsed_side_margin:I

    invoke-virtual {v0, v5}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v5

    sget v6, Lzendesk/support/R$dimen;->zs_request_message_composer_expanded_top_padding:I

    invoke-virtual {v0, v6}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v6

    sget v7, Lzendesk/support/R$dimen;->zs_request_message_composer_collapsed_top_padding:I

    invoke-virtual {v0, v7}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v7

    sget v8, Lzendesk/support/R$dimen;->zs_request_message_composer_expanded_bottom_padding:I
    ...
    invoke-direct {v8}, LD2/c;-><init>()V

    new-instance v9, LD2/b;

    invoke-direct {v9}, LD2/b;-><init>()V
...
.method private isExpanded()Z
    ...
    sget v1, Lzendesk/support/R$dimen;->zs_request_message_composer_collapsed_height:I
...
.method private updateAttachmentButtonPosition()V
    ...
    sget v1, Lzendesk/support/R$dimen;->zs_request_message_composer_expanded_side_margin:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    sget v2, Lzendesk/support/R$dimen;->zs_request_message_composer_collapsed_side_margin:I
...
.method private updateSendBtn(ZZ)V
    ...
    sget v1, Lzendesk/support/R$attr;->colorPrimary:I
    ...
    :cond_0
    sget v1, Lzendesk/support/R$color;->zs_request_message_composer_send_btn_color_inactive:I
...
.method private viewInit(Landroid/content/Context;)V
    ...
    sget v0, Lzendesk/support/R$layout;->zs_view_request_message_composer:I
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Lzendesk/support/request/ViewMessageComposer;->stateHelper:Lzendesk/support/request/ViewMessageComposer$MessageComposerStateHelper;

    iget-boolean v0, p0, Lzendesk/support/request/ViewMessageComposer;->isSendButtonDisabled:Z

    iget-boolean v1, p0, Lzendesk/support/request/ViewMessageComposer;->isAttachmentsButtonDisabled:Z

    iget-object v2, p0, Lzendesk/support/request/ViewMessageComposer;->inputTextField:Landroid/widget/EditText;

    iget-object v3, p0, Lzendesk/support/request/ViewMessageComposer;->attachmentsIndicator:Lzendesk/support/request/ViewAttachmentsIndicator;

    invoke-virtual {p1, v0, v1, v2, v3}, Lzendesk/support/request/ViewMessageComposer$MessageComposerStateHelper;->onAttachmentClicked(ZZLandroid/widget/EditText;Lzendesk/support/request/ViewAttachmentsIndicator;)Lzendesk/support/request/ViewMessageComposer$MessageComposerState;
...
.method public triggerStateUpdate()V
    ...
    iget-object v0, p0, Lzendesk/support/request/ViewMessageComposer;->stateHelper:Lzendesk/support/request/ViewMessageComposer$MessageComposerStateHelper;

    iget-object v1, p0, Lzendesk/support/request/ViewMessageComposer;->inputTextField:Landroid/widget/EditText;

    iget-object v2, p0, Lzendesk/support/request/ViewMessageComposer;->attachmentsIndicator:Lzendesk/support/request/ViewAttachmentsIndicator;
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lzendesk/support/request/ViewMessageComposer$MessageComposerStateHelper;->getState(Landroid/widget/EditText;Lzendesk/support/request/ViewAttachmentsIndicator;ZZ)Lzendesk/support/request/ViewMessageComposer$MessageComposerState;
