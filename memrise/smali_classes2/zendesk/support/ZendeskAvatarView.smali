...
.method private getBackgroundShape(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v1, p1, v3}, Landroid/graphics/drawable/InsetDrawable;-><init>(Landroid/graphics/drawable/Drawable;I)V
...
.method public showUserWithAvatarImage(Lcom/squareup/picasso/j;Ljava/lang/String;Ljava/lang/String;I)V
    .locals 3
    ...
    invoke-virtual {p1, p2}, Lcom/squareup/picasso/j;->d(Ljava/lang/String;)Lcom/squareup/picasso/n;

    move-result-object p1

    mul-int/lit8 p2, p4, 0x2

    iget-object p3, p1, Lcom/squareup/picasso/n;->b:Lcom/squareup/picasso/m$a;

    invoke-virtual {p3, p2, p2}, Lcom/squareup/picasso/m$a;->a(II)V

    invoke-virtual {p1}, Lcom/squareup/picasso/n;->a()V

    iput-boolean v1, p1, Lcom/squareup/picasso/n;->e:Z

    iget p2, p0, Lzendesk/support/ZendeskAvatarView;->strokeColor:I

    iget p3, p0, Lzendesk/support/ZendeskAvatarView;->strokeWidth:I

    invoke-static {p4, p2, p3}, Lzendesk/support/PicassoTransformations;->getRoundWithBorderTransformation(III)LPk/k;

    move-result-object p2

    invoke-virtual {p1, p2}, Lcom/squareup/picasso/n;->d(LPk/k;)V

    iget-object p2, p0, Lzendesk/support/ZendeskAvatarView;->imageView:Landroid/widget/ImageView;

    const/4 p3, 0x0

    invoke-virtual {p1, p2, p3}, Lcom/squareup/picasso/n;->c(Landroid/widget/ImageView;LPk/b;)V
