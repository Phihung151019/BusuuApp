...
.method private static checkIdentityValid(Lzendesk/core/Identity;)Z
    ...
    const-string v1, "setIdentity(): The provided Identity object must be an Anonymous Identity or a JwtIdentity with a non-empty JWT identifier. Returning."

    if-nez p0, :cond_0

    new-array p0, v0, [Ljava/lang/Object;

    invoke-static {v1, p0}, LVk/a;->b(Ljava/lang/String;[Ljava/lang/Object;)V

    return v0

    :cond_0
    instance-of v2, p0, Lzendesk/core/AnonymousIdentity;

    if-nez v2, :cond_1

    instance-of v2, p0, Lzendesk/core/JwtIdentity;
    ...
    invoke-static {p0}, LXk/d;->b(Ljava/lang/String;)Z
...
.method public cleanupIfNewConfig(Lzendesk/core/ApplicationConfiguration;)V
    ...
    invoke-interface {p1, v0}, Lzendesk/core/PushRegistrationProvider;->unregisterDevice(LWk/d;)V
...
.method public reset()V
    ...
    invoke-interface {v0, v1}, Lzendesk/core/PushRegistrationProvider;->unregisterDevice(LWk/d;)V
