...
.method public getUuid()Ljava/lang/String;
    ...
    const-string v1, "Fetching UUID from preferences store"
...
.method public storeIdentity(Lzendesk/core/Identity;)V
    ...
    :cond_0
    instance-of v1, p1, Lzendesk/core/AnonymousIdentity;

    if-eqz v1, :cond_1

    const-string v1, "Storing anonymous identity"
    ...
    :cond_1
    instance-of v1, p1, Lzendesk/core/JwtIdentity;

    if-eqz v1, :cond_2

    const-string v1, "Storing jwt identity"
    ...
    :cond_2
    const-string v1, "Unknown authentication type, identity will not be stored"
...
.method public storeSdkGuid(Ljava/lang/String;)V
    ...
    const-string v1, "Storing new UUID in preference store"
...
.method public updateBlipsUuid()Ljava/lang/String;
    ...
    const-string v2, "Generate new Blips BUID"
