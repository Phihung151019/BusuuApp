...
# instance fields
.field private final boundaryByteString:LAn/h;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/MultipartBody$Companion;-><init>(LCm/g;)V
...
.method public constructor <init>(LAn/h;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundaryByteString:LAn/h;
...
.method private final writeOrCountBytes(LAn/f;Z)J
    .locals 12
    ...
    invoke-interface {p1, v8}, LAn/f;->write([B)LAn/f;

    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:LAn/h;

    invoke-interface {p1, v8}, LAn/f;->v(LAn/h;)LAn/f;
    ...
    invoke-interface {p1, v10}, LAn/f;->U(Ljava/lang/String;)LAn/f;

    move-result-object v10

    sget-object v11, Lokhttp3/MultipartBody;->COLONSPACE:[B

    invoke-interface {v10, v11}, LAn/f;->write([B)LAn/f;
    ...
    invoke-interface {v10, v11}, LAn/f;->U(Ljava/lang/String;)LAn/f;
    ...
    invoke-interface {p1, v8}, LAn/f;->U(Ljava/lang/String;)LAn/f;
    ...
    invoke-interface {v8, v7}, LAn/f;->U(Ljava/lang/String;)LAn/f;

    move-result-object v7

    sget-object v8, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v7, v8}, LAn/f;->write([B)LAn/f;
    ...
    invoke-interface {p1, v9}, LAn/f;->write([B)LAn/f;
    ...
    :cond_4
    invoke-virtual {v6, p1}, Lokhttp3/RequestBody;->writeTo(LAn/f;)V
    ...
    invoke-interface {p1, v1}, LAn/f;->write([B)LAn/f;

    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:LAn/h;
...
.method public final boundary()Ljava/lang/String;
    ...
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundaryByteString:LAn/h;
...
.method public contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(LAn/f;Z)J
...
.method public writeTo(LAn/f;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(LAn/f;Z)J
