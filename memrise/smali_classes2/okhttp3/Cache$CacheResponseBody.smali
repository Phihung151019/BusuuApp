...
# instance fields
.field private final bodySource:LAn/g;
...
.method public constructor <init>(Lokhttp3/internal/cache/DiskLruCache$Snapshot;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p2}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)LAn/P;

    move-result-object p1

    new-instance p2, Lokhttp3/Cache$CacheResponseBody$1;

    invoke-direct {p2, p1, p0}, Lokhttp3/Cache$CacheResponseBody$1;-><init>(LAn/P;Lokhttp3/Cache$CacheResponseBody;)V

    invoke-static {p2}, LAn/C;->c(LAn/P;)LAn/J;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/Cache$CacheResponseBody;->bodySource:LAn/g;
...
.method public source()LAn/g;
    ...
    iget-object v0, p0, Lokhttp3/Cache$CacheResponseBody;->bodySource:LAn/g;
