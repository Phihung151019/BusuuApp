...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/CertificatePinner$Companion;-><init>(LCm/g;)V
...
.method public synthetic constructor <init>(Ljava/util/Set;Lokhttp3/internal/tls/CertificateChainCleaner;ILCm/g;)V
    .locals 0
...
.method public static final sha1Hash(Ljava/security/cert/X509Certificate;)LAn/h;
    .locals 1

    sget-object v0, Lokhttp3/CertificatePinner;->Companion:Lokhttp3/CertificatePinner$Companion;

    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)LAn/h;
...
.method public static final sha256Hash(Ljava/security/cert/X509Certificate;)LAn/h;
    .locals 1

    sget-object v0, Lokhttp3/CertificatePinner;->Companion:Lokhttp3/CertificatePinner$Companion;

    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)LAn/h;
...
.method public final check(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {v0, p0, p2, p1, v1}, Lec/d;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-virtual {p0, p1, v0}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;LBm/a;)V
...
.method public final check$okhttp(Ljava/lang/String;LBm/a;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v4, v2}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)LAn/h;

    move-result-object v4

    :cond_3
    invoke-virtual {v6}, Lokhttp3/CertificatePinner$Pin;->getHash()LAn/h;
    ...
    invoke-virtual {v5, v2}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)LAn/h;
...
.method public final findMatchingPins(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v3}, LCm/F;->b(Ljava/util/List;)Ljava/util/List;
