...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/Cache$Entry$Companion;-><init>(LCm/g;)V
...
.method public constructor <init>(LAn/P;)V
    ...
    invoke-virtual {v1, v2, v3}, LAn/J;->J(J)Ljava/lang/String;
    ...
    invoke-virtual {v4, v1}, Lokhttp3/Cache$Companion;->readInt$okhttp(LAn/g;)I
    ...
    invoke-direct {p0, v1}, Lokhttp3/Cache$Entry;->readCertificateList(LAn/g;)Ljava/util/List;
...
.method private final readCertificateList(LAn/g;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(LAn/g;)I
    ...
    sget-object v6, LAn/h;->e:LAn/h;

    invoke-static {v4}, LAn/h$a;->a(Ljava/lang/String;)LAn/h;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v5, v4}, LAn/e;->o0(LAn/h;)V

    new-instance v4, LAn/e$b;

    invoke-direct {v4, v5}, LAn/e$b;-><init>(LAn/e;)V
...
.method private final writeCertList(LAn/f;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, LAn/f;->E0(J)LAn/f;
    ...
    invoke-static {v0}, LAn/h$a;->d([B)LAn/h;
...
.method public final response(Lokhttp3/internal/cache/DiskLruCache$Snapshot;)Lokhttp3/Response;
    ...
    invoke-direct/range {v2 .. v8}, Lokhttp3/Request;-><init>(Lokhttp3/HttpUrl;Lokhttp3/Headers;Ljava/lang/String;Lokhttp3/RequestBody;ILCm/g;)V
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)LAn/N;
    ...
    invoke-virtual {p1, v1}, LAn/I;->writeByte(I)LAn/f;

    iget-object v2, p0, Lokhttp3/Cache$Entry;->requestMethod:Ljava/lang/String;

    invoke-virtual {p1, v2}, LAn/I;->U(Ljava/lang/String;)LAn/f;
    ...
    invoke-virtual {p1, v2, v3}, LAn/I;->E0(J)LAn/f;
    ...
    invoke-virtual {p1, v5}, LAn/I;->U(Ljava/lang/String;)LAn/f;
    ...
    invoke-virtual {p1, v3}, LAn/I;->U(Ljava/lang/String;)LAn/f;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(LAn/f;Ljava/util/List;)V
