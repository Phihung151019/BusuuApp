...
.method private final cancelInFlightConnects()V
    ...
    invoke-interface {v2}, Lokhttp3/internal/connection/RoutePlanner;->getDeferredPlans()Lnm/k;
...
.method public find()Lokhttp3/internal/connection/RealConnection;
    ...
    invoke-interface {v3}, Lokhttp3/internal/connection/RoutePlanner;->getDeferredPlans()Lnm/k;

    move-result-object v3

    invoke-virtual {v3, v2}, Lnm/k;->addFirst(Ljava/lang/Object;)V
