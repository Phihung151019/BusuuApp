...
.field private final hpackBuffer:LAn/e;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Writer$Companion;-><init>(LCm/g;)V
...
.method public constructor <init>(LAn/f;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:LAn/f;
    ...
    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:LAn/e;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLAn/e;ILCm/g;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:LAn/f;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:LAn/e;

    invoke-interface {v0, v1, v2, v3}, LAn/N;->write(LAn/e;J)V
...
.method public final applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:LAn/f;
...
.method public final connectionPreface()V
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:LAn/h;

    invoke-interface {v0, v1}, LAn/f;->v(LAn/h;)LAn/f;
...
.method public final data(ZILAn/e;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILAn/e;I)V
...
.method public final dataFrame(IILAn/e;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, LAn/N;->write(LAn/e;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {p1, v5}, Lokhttp3/internal/_UtilCommonKt;->writeMedium(LAn/f;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:LAn/f;

    and-int/lit16 p2, v6, 0xff

    invoke-interface {p1, p2}, LAn/f;->writeByte(I)LAn/f;
    ...
    invoke-interface {p1, p2}, LAn/f;->writeInt(I)LAn/f;
    ...
    invoke-static {v4, p1}, LA6/d;->c(ILjava/lang/String;)Ljava/lang/String;
...
.method public final goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, LAn/f;->writeInt(I)LAn/f;
    ...
    invoke-interface {p1, p3}, LAn/f;->write([B)LAn/f;
...
.method public final headers(ZILjava/util/List;)V
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:LAn/e;

    iget-wide v0, p3, LAn/e;->c:J
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:LAn/e;

    invoke-interface {p1, v4, v2, v3}, LAn/N;->write(LAn/e;J)V
...
.method public final ping(ZII)V
    ...
    invoke-interface {p1, p3}, LAn/f;->writeInt(I)LAn/f;
...
.method public final pushPromise(IILjava/util/List;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:LAn/f;

    const v5, 0x7fffffff

    and-int/2addr p2, v5

    invoke-interface {v2, p2}, LAn/f;->writeInt(I)LAn/f;

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:LAn/f;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:LAn/e;

    invoke-interface {p2, v2, v3, v4}, LAn/N;->write(LAn/e;J)V
...
.method public final settings(Lokhttp3/internal/http2/Settings;)V
    ...
    invoke-interface {v0, v2}, LAn/f;->writeShort(I)LAn/f;
    ...
    invoke-interface {v0, v1}, LAn/f;->writeInt(I)LAn/f;
