...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(LCm/g;)V
...
.method public constructor <init>(LAn/g;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:LAn/g;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Reader;->client:Z

    new-instance v2, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(LAn/g;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(LAn/P;IIILCm/g;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:LAn/g;

    invoke-interface {v1}, LAn/g;->readByte()B
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:LAn/g;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILAn/g;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:LAn/g;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, LAn/g;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:LAn/g;

    invoke-interface {p4}, LAn/g;->readInt()I

    move-result p4

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:LAn/g;

    invoke-interface {v0}, LAn/g;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, LAn/g;->t(J)LAn/h;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;LAn/h;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:LAn/g;

    invoke-interface {p2}, LAn/g;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:LAn/g;

    invoke-interface {v3}, LAn/g;->readByte()B
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {p2, p3, p4}, LD8/H2;->c(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, LAn/g;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v1, p2}, LHm/j;->C(ILHm/g;)LHm/e;

    move-result-object p2

    iget v1, p2, LHm/e;->b:I

    iget v2, p2, LHm/e;->c:I

    iget p2, p2, LHm/e;->d:I
    ...
    invoke-interface {v3}, LAn/g;->readShort()S
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:LAn/g;

    invoke-interface {v4}, LAn/g;->readInt()I
    ...
    invoke-static {v4, p2}, LA6/d;->c(ILjava/lang/String;)Ljava/lang/String;
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/_UtilCommonKt;->readMedium(LAn/g;)I
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:LAn/h;
    ...
    invoke-interface {p1, v1, v2}, LAn/g;->t(J)LAn/h;
    ...
    :cond_2
    invoke-virtual {v0, p1}, LAn/h;->equals(Ljava/lang/Object;)Z
