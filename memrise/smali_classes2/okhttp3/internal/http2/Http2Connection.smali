...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Connection$Companion;-><init>(LCm/g;)V
...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    invoke-direct {v4, v5, v0}, Lokhttp3/internal/http2/Http2Writer;-><init>(LAn/f;Z)V
    ...
    invoke-direct {v5, v2, v0}, Lokhttp3/internal/http2/Http2Reader;-><init>(LAn/g;Z)V
    ...
    invoke-static {v1, p1}, LO2/h;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    new-instance v0, Lwn/b;

    invoke-direct {v0, p0, v4, v5}, Lwn/b;-><init>(Lokhttp3/internal/http2/Http2Connection;J)V

    invoke-virtual {v3, p1, v4, v5, v0}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Ljava/lang/String;JLBm/a;)V

    :cond_2
    return-void
.end method

.method public static synthetic D(Lokhttp3/internal/http2/Http2Connection;ILokhttp3/internal/http2/ErrorCode;)Lkotlin/Unit;
    .locals 0
...
.method public static synthetic c(Lokhttp3/internal/http2/Http2Connection;ILokhttp3/internal/http2/ErrorCode;)Lkotlin/Unit;
    .locals 0
...
.method public static synthetic j(Lokhttp3/internal/http2/Http2Connection;IJ)Lkotlin/Unit;
    .locals 0
...
.method public static synthetic k(Lokhttp3/internal/http2/Http2Connection;ILAn/e;IZ)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lokhttp3/internal/http2/Http2Connection;->pushDataLater$lambda$0(Lokhttp3/internal/http2/Http2Connection;ILAn/e;IZ)Lkotlin/Unit;
...
.method public static synthetic m(Lokhttp3/internal/http2/Http2Connection;J)J
    .locals 0
...
.method private static final pushDataLater$lambda$0(Lokhttp3/internal/http2/Http2Connection;ILAn/e;IZ)Lkotlin/Unit;
    .locals 1

    :try_start_0
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection;->pushObserver:Lokhttp3/internal/http2/PushObserver;

    invoke-interface {v0, p1, p2, p3, p4}, Lokhttp3/internal/http2/PushObserver;->onData(ILAn/g;IZ)Z
...
.method public static synthetic r(Lokhttp3/internal/http2/Http2Connection;ILjava/util/List;Z)Lkotlin/Unit;
    .locals 0
...
.method public static synthetic x(Lokhttp3/internal/http2/Http2Connection;)Lkotlin/Unit;
    .locals 0
...
.method public final pushDataLater$okhttp(ILAn/g;IZ)V
    .locals 14
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-direct {v5}, LAn/e;-><init>()V

    move/from16 v6, p3

    int-to-long v1, v6

    invoke-interface {v0, v1, v2}, LAn/g;->l(J)V

    invoke-interface {v0, v5, v1, v2}, LAn/P;->read(LAn/e;J)J
    ...
    invoke-direct/range {v2 .. v7}, Lwn/a;-><init>(Lokhttp3/internal/http2/Http2Connection;ILAn/e;IZ)V
    ...
    invoke-static/range {v6 .. v13}, Lokhttp3/internal/concurrent/TaskQueue;->execute$default(Lokhttp3/internal/concurrent/TaskQueue;Ljava/lang/String;JZLBm/a;ILjava/lang/Object;)V
...
.method public final pushHeadersLater$okhttp(ILjava/util/List;Z)V
    ...
    invoke-direct {v6, p0, p1, p2, p3}, Lwn/f;-><init>(Lokhttp3/internal/http2/Http2Connection;ILjava/util/List;Z)V
...
.method public final pushRequestLater$okhttp(ILjava/util/List;)V
    ...
    invoke-direct {v7, p0, p1, p2}, Lwn/e;-><init>(Lokhttp3/internal/http2/Http2Connection;ILjava/util/List;)V
    ...
    invoke-static/range {v2 .. v9}, Lokhttp3/internal/concurrent/TaskQueue;->execute$default(Lokhttp3/internal/concurrent/TaskQueue;Ljava/lang/String;JZLBm/a;ILjava/lang/Object;)V
...
.method public final pushResetLater$okhttp(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    new-instance v6, Lwn/g;

    invoke-direct {v6, p0, p1, p2}, Lwn/g;-><init>(Lokhttp3/internal/http2/Http2Connection;ILokhttp3/internal/http2/ErrorCode;)V
...
.method public final sendDegradedPingLater$okhttp()V
    ...
    invoke-direct {v6, v0, p0}, LQ4/b;-><init>(ILjava/lang/Object;)V
...
.method public final writeData(IZLAn/e;J)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p4, p2, p1, p3, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILAn/e;I)V
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v2}, Lokhttp3/internal/http2/Http2Writer;->data(ZILAn/e;I)V
...
.method public final writeSynResetLater$okhttp(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    new-instance v6, Lwn/d;

    invoke-direct {v6, p0, p1, p2}, Lwn/d;-><init>(Lokhttp3/internal/http2/Http2Connection;ILokhttp3/internal/http2/ErrorCode;)V
...
.method public final writeWindowUpdateLater$okhttp(IJ)V
    ...
    invoke-direct {v5, p0, p1, p2, p3}, Lwn/c;-><init>(Lokhttp3/internal/http2/Http2Connection;IJ)V
