...
.method public constructor <init>(LAn/g;)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:LAn/g;
...
.method private final readContinuationHeader()V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:LAn/g;

    invoke-static {v1}, Lokhttp3/internal/_UtilCommonKt;->readMedium(LAn/g;)I
...
.method public read(LAn/e;J)J
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:LAn/g;

    iget v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->padding:I

    int-to-long v3, v3

    invoke-interface {v0, v3, v4}, LAn/g;->skip(J)V
    ...
    :cond_1
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->source:LAn/g;
    ...
    invoke-interface {v3, p1, p2, p3}, LAn/P;->read(LAn/e;J)J
