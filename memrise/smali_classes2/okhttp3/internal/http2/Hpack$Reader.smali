...
# direct methods
.method public constructor <init>(LAn/P;I)V
    .locals 7
...
.method public constructor <init>(LAn/P;II)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:LAn/g;
...
.method public synthetic constructor <init>(LAn/P;IIILCm/g;)V
    .locals 0
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(LAn/P;II)V
...
.method private final getName(I)LAn/h;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:LAn/h;
...
.method private final readByte()I
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:LAn/g;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)LAn/h;

    move-result-object p1

    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()LAn/h;

    move-result-object v0

    new-instance v1, Lokhttp3/internal/http2/Header;

    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(LAn/h;LAn/h;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(LAn/h;)LAn/h;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(LAn/h;LAn/h;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(LAn/h;LAn/h;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(LAn/h;LAn/h;)V
...
.method public final readByteString()LAn/h;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:LAn/g;

    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(LAn/g;JLAn/f;)V

    iget-wide v1, v0, LAn/e;->c:J

    invoke-virtual {v0, v1, v2}, LAn/e;->t(J)LAn/h;
    ...
    invoke-interface {v0, v2, v3}, LAn/g;->t(J)LAn/h;
