...
# static fields
.field private static final QUOTED_STRING_DELIMITERS:LAn/h;

.field private static final TOKEN_DELIMITERS:LAn/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:LAn/h;
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:LAn/h;
...
.method public static final parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v3, v4}, LAn/e;->O0(Ljava/lang/String;)V

    :try_start_0
    invoke-static {v3, v0}, Lokhttp3/internal/http/HttpHeaders;->readChallengeHeader(LAn/e;Ljava/util/List;)V
    :try_end_0
...
.method private static final readChallengeHeader(LAn/e;Ljava/util/List;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->skipCommasAndWhitespace(LAn/e;)Z

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readToken(LAn/e;)Ljava/lang/String;
    ...
    invoke-static {p0, v4}, Lokhttp3/internal/_UtilCommonKt;->skipAll(LAn/e;B)I
    ...
    invoke-static {v5, v4}, LKm/l;->H(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v5}, Lokhttp3/internal/http/HttpHeaders;->startsWith(LAn/e;B)Z

    move-result v5

    if-eqz v5, :cond_8

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(LAn/e;)Ljava/lang/String;
...
.method private static final readQuotedString(LAn/e;)Ljava/lang/String;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/EOFException;
    ...
    :goto_0
    sget-object v2, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:LAn/h;

    invoke-virtual {p0, v2}, LAn/e;->D(LAn/h;)J
    ...
    invoke-virtual {v0, p0, v2, v3}, LAn/e;->write(LAn/e;J)V
    ...
    invoke-virtual {v0, p0, v8, v9}, LAn/e;->write(LAn/e;J)V
...
.method private static final readToken(LAn/e;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:LAn/h;

    invoke-virtual {p0, v0}, LAn/e;->D(LAn/h;)J
...
.method private static final skipCommasAndWhitespace(LAn/e;)Z
    .locals 3
...
.method private static final startsWith(LAn/e;B)Z
    .locals 2
    ...
    invoke-virtual {p0, v0, v1}, LAn/e;->m(J)B
