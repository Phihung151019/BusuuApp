...
.method public constructor <init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;)V
    ...
    invoke-virtual {v3}, Lokhttp3/internal/cache/DiskLruCache;->getDirectory()LAn/F;
...
.method private final newSource(I)LAn/P;
    .locals 2
    ...
    invoke-direct {v0, p1, v1, p0}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(LAn/P;Lokhttp3/internal/cache/DiskLruCache;Lokhttp3/internal/cache/DiskLruCache$Entry;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-direct {p0, v3}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)LAn/P;
...
.method public final writeLengths$okhttp(LAn/f;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, v5}, LAn/f;->writeByte(I)LAn/f;

    move-result-object v5

    invoke-interface {v5, v3, v4}, LAn/f;->E0(J)LAn/f;
