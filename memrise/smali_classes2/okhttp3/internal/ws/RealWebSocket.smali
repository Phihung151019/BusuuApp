...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/ws/RealWebSocket$Companion;-><init>(LCm/g;)V
...
.method public constructor <init>(Lokhttp3/internal/concurrent/TaskRunner;Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;JLokhttp3/internal/ws/WebSocketExtensions;JJ)V
    ...
    invoke-static {p1}, LAn/h$a;->d([B)LAn/h;
...
.method public static synthetic c(LCm/A;)Lkotlin/Unit;
    .locals 0

    invoke-static {p0}, Lokhttp3/internal/ws/RealWebSocket;->failWebSocket$lambda$0$0(LCm/A;)Lkotlin/Unit;
...
.method private static final failWebSocket$lambda$0$0(LCm/A;)Lkotlin/Unit;
    .locals 0
...
.method private final declared-synchronized send(LAn/h;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILAn/h;)V
...
.method public final checkUpgradeSuccess$okhttp(Lokhttp3/Response;)LAn/O;
    .locals 6
    ...
    invoke-virtual {v1, v3}, LAn/h;->c(Ljava/lang/String;)LAn/h;
...
.method public final declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-static {p2}, LAn/h$a;->c(Ljava/lang/String;)LAn/h;

    move-result-object v1

    iget-object v2, v1, LAn/h;->b:[B
    ...
    invoke-direct {v2, p1, v1, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILAn/h;J)V
...
.method public final failWebSocket(Ljava/lang/Exception;Lokhttp3/Response;Z)V
    ...
    iget-object v2, p0, Lokhttp3/internal/ws/RealWebSocket;->socket:LAn/O;
    ...
    invoke-direct {v9, v0, v1}, LBc/M;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static/range {v4 .. v11}, Lokhttp3/internal/concurrent/TaskQueue;->execute$default(Lokhttp3/internal/concurrent/TaskQueue;Ljava/lang/String;JZLBm/a;ILjava/lang/Object;)V
    ...
    invoke-interface {v2}, LAn/O;->cancel()V
...
.method public final finishReader()V
    ...
    invoke-direct {v10, v3, v4}, LMf/s;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static/range {v5 .. v12}, Lokhttp3/internal/concurrent/TaskQueue;->execute$default(Lokhttp3/internal/concurrent/TaskQueue;Ljava/lang/String;JZLBm/a;ILjava/lang/Object;)V
...
.method public final initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/connection/BufferedSocket;Z)V
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/RealWebSocket;->socket:LAn/O;
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLAn/f;Ljava/util/Random;ZZJ)V
    ...
    invoke-direct {v3, p0, v0, v1}, Lzn/a;-><init>(Lokhttp3/internal/ws/RealWebSocket;J)V

    invoke-virtual {v2, p1, v0, v1, v3}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Ljava/lang/String;JLBm/a;)V
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLAn/g;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
...
.method public onReadMessage(LAn/h;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;LAn/h;)V
...
.method public declared-synchronized onReadPing(LAn/h;)V
    .locals 1
...
.method public declared-synchronized onReadPong(LAn/h;)V
    .locals 1
...
.method public final declared-synchronized pong(LAn/h;)Z
    .locals 1
...
.method public send(LAn/h;)Z
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(LAn/h;I)Z
...
.method public final writeOneFrame$okhttp()Z
    ...
    invoke-direct {v6, v10, v1}, LFa/s;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static/range {v12 .. v19}, Lokhttp3/internal/concurrent/TaskQueue;->execute$default(Lokhttp3/internal/concurrent/TaskQueue;Ljava/lang/String;JZLBm/a;ILjava/lang/Object;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(LAn/h;)V
    ...
    invoke-virtual {v3}, Lokhttp3/internal/ws/RealWebSocket$Message;->getData()LAn/h;

    move-result-object v3

    invoke-virtual {v0, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;->writeMessageFrame(ILAn/h;)V
    ...
    invoke-virtual {v5}, Lokhttp3/internal/ws/RealWebSocket$Message;->getData()LAn/h;
    ...
    invoke-virtual {v5}, Lokhttp3/internal/ws/RealWebSocket$Close;->getReason()LAn/h;

    move-result-object v5

    invoke-virtual {v0, v3, v5}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILAn/h;)V
...
.method public final writePingFrame$okhttp()V
    ...
    invoke-static {v3, v4, v0}, LA6/e;->a(ILjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(LAn/h;)V
    :try_end_3
