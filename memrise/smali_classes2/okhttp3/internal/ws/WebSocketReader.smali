...
.field private final controlFrameBuffer:LAn/e;
...
.field private final messageFrameBuffer:LAn/e;
...
# direct methods
.method public constructor <init>(ZLAn/g;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
    .locals 1
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:LAn/g;
    ...
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:LAn/e;

    new-instance p2, LAn/e;

    invoke-direct {p2}, LAn/e;-><init>()V

    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:LAn/e;
    ...
    :goto_1
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:LAn/e$a;
...
.method private final readControlFrame()V
    ...
    iget-object v4, p0, Lokhttp3/internal/ws/WebSocketReader;->source:LAn/g;

    iget-object v5, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:LAn/e;

    invoke-interface {v4, v5, v0, v1}, LAn/g;->Y(LAn/e;J)V

    iget-boolean v0, p0, Lokhttp3/internal/ws/WebSocketReader;->isClient:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:LAn/e;

    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:LAn/e$a;

    invoke-static {v1}, LCm/m;->c(Ljava/lang/Object;)V

    invoke-virtual {v0, v1}, LAn/e;->N(LAn/e$a;)LAn/e$a;

    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:LAn/e$a;

    invoke-virtual {v0, v2, v3}, LAn/e$a;->c(J)I
    ...
    invoke-virtual {v0, v1, v4}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(LAn/e$a;[B)V
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->controlFrameBuffer:LAn/e;
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPong(LAn/h;)V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPing(LAn/h;)V
...
.method private final readHeader()V
    ...
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->source:LAn/g;
    ...
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:LAn/g;

    invoke-interface {v2}, LAn/P;->timeout()LAn/Q;

    move-result-object v2

    invoke-virtual {v2}, LAn/Q;->clearTimeout()LAn/Q;

    :try_start_0
    iget-object v2, p0, Lokhttp3/internal/ws/WebSocketReader;->source:LAn/g;

    invoke-interface {v2}, LAn/g;->readByte()B
    ...
    invoke-interface {v4}, LAn/P;->timeout()LAn/Q;

    move-result-object v4

    sget-object v5, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v4, v0, v1, v5}, LAn/Q;->timeout(JLjava/util/concurrent/TimeUnit;)LAn/Q;
    ...
    invoke-interface {v0}, LAn/g;->readByte()B
    ...
    invoke-interface {v0}, LAn/g;->readShort()S
    ...
    invoke-interface {v0}, LAn/g;->readLong()J
    ...
    invoke-interface {v0, v1}, LAn/g;->readFully([B)V
    ...
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->source:LAn/g;
    ...
    invoke-virtual {v3, v0, v1, v4}, LAn/Q;->timeout(JLjava/util/concurrent/TimeUnit;)LAn/Q;
...
.method private final readMessage()V
    ...
    iget-object v3, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:LAn/e;

    invoke-interface {v2, v3, v0, v1}, LAn/g;->Y(LAn/e;J)V

    iget-boolean v0, p0, Lokhttp3/internal/ws/WebSocketReader;->isClient:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:LAn/e;
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->messageFrameBuffer:LAn/e;

    iget-wide v1, v1, LAn/e;->c:J

    iget-wide v3, p0, Lokhttp3/internal/ws/WebSocketReader;->frameLength:J

    sub-long/2addr v1, v3

    invoke-virtual {v0, v1, v2}, LAn/e$a;->c(J)I
...
.method private final readMessageFrame()V
    ...
    invoke-virtual {v2, v3}, Lokhttp3/internal/ws/MessageInflater;->inflate(LAn/e;)V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadMessage(LAn/h;)V
...
.method public final getSource()LAn/g;
    .locals 1
