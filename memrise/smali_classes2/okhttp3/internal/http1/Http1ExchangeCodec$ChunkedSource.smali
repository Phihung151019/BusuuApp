...
.method private final readChunkSize()V
    ...
    invoke-interface {v1}, Lokhttp3/internal/connection/BufferedSocket;->getSource()LAn/g;

    move-result-object v1

    invoke-interface {v1}, LAn/g;->m0()Ljava/lang/String;
    ...
    invoke-interface {v1}, LAn/g;->J0()J
    ...
    invoke-static {v1, v2, v3}, LKm/l;->M(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public read(LAn/e;J)J
    ...
    invoke-super {p0, p1, p2, p3}, Lokhttp3/internal/http1/Http1ExchangeCodec$AbstractSource;->read(LAn/e;J)J
