...
.field public static final i:LNm/G;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LNm/G;->i:LNm/G;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, LNm/X;->O0(Z)V
...
.method public final R0()Ljava/lang/Thread;
    ...
    sget-object v0, LNm/G;->_thread:Ljava/lang/Thread;
    ...
    sput-object v0, LNm/G;->_thread:Ljava/lang/Thread;

    sget-object v1, LNm/G;->i:LNm/G;
...
.method public final S0(JLNm/Y$c;)V
    .locals 0
...
.method public final T0(Ljava/lang/Runnable;)V
    ...
    sget v0, LNm/G;->debugStatus:I

    const/4 v1, 0x4

    if-eq v0, v1, :cond_0

    invoke-super {p0, p1}, LNm/Y;->T0(Ljava/lang/Runnable;)V
...
.method public final invokeOnTimeout(JLjava/lang/Runnable;Lqm/f;)LNm/T;
    ...
    new-instance p4, LNm/Y$b;

    add-long/2addr v0, p1

    invoke-direct {p4, p3, v0, v1}, LNm/Y$b;-><init>(Ljava/lang/Runnable;J)V

    invoke-virtual {p0, p1, p2, p4}, LNm/Y;->X0(JLNm/Y$c;)V
...
.method public final run()V
    ...
    sput-object v2, LNm/G;->_thread:Ljava/lang/Thread;

    invoke-virtual {v1}, LNm/G;->Y0()V

    invoke-virtual {v1}, LNm/Y;->W0()Z

    move-result v0

    if-nez v0, :cond_a

    invoke-virtual {v1}, LNm/G;->R0()Ljava/lang/Thread;

    return-void

    :cond_2
    :try_start_3
    sput v6, LNm/G;->debugStatus:I
...
.method public final shutdown()V
    ...
    sput v0, LNm/G;->debugStatus:I

    invoke-super {p0}, LNm/Y;->shutdown()V
