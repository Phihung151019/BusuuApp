.class public final synthetic Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;
.end annotation
...
# static fields
.field public static final INSTANCE:Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;

    invoke-direct {v0}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;-><init>()V

    sput-object v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;->INSTANCE:Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;

    new-instance v1, Lon/r0;

    const-string v2, "com.memrise.memlib.network.ApiLearnable.ApiScreen.Tapping"
    ...
    sput-object v1, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;->descriptor:Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public final childSerializers()[Lkotlinx/serialization/KSerializer;
    ...
    sget-object v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->j:[Lmm/i;
...
.method public final deserialize(Lkotlinx/serialization/encoding/Decoder;)Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;
    .locals 17
    ...
    sget-object v1, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;->descriptor:Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    sget-object v2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->j:[Lmm/i;
    ...
    new-instance v6, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;

    move-object/from16 v16, v5

    invoke-direct/range {v6 .. v16}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;-><init>(ILjava/util/List;Lcom/memrise/memlib/network/ApiLearnable$ApiPrompt;Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;Ljava/util/List;Ljava/util/List;Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;Ljava/lang/Boolean;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;->deserialize(Lkotlinx/serialization/encoding/Decoder;)Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;
...
.method public final getDescriptor()Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    sget-object v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;->descriptor:Lkotlinx/serialization/descriptors/SerialDescriptor;

    return-object v0
.end method

.method public final serialize(Lkotlinx/serialization/encoding/Encoder;Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;)V
    .locals 8
    ...
    sget-object v1, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->j:[Lmm/i;
    ...
    iget-object v4, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->a:Ljava/util/List;

    iget-object v5, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->i:Ljava/lang/Boolean;

    iget-object v6, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->g:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
    ...
    iget-object v3, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->b:Lcom/memrise/memlib/network/ApiLearnable$ApiPrompt;
    ...
    iget-object v3, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->c:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
    ...
    iget-object v7, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->d:Ljava/util/List;
    ...
    iget-object v4, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->e:Ljava/util/List;

    invoke-interface {p1, v0, v3, v1, v4}, Lnn/b;->z(Lkotlinx/serialization/descriptors/SerialDescriptor;ILkn/e;Ljava/lang/Object;)V

    const/4 v1, 0x5

    iget-object v3, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->f:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
    ...
    iget-object p2, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;->h:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;

    invoke-virtual {p0, p1, p2}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping$$serializer;->serialize(Lkotlinx/serialization/encoding/Encoder;Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$Tapping;)V
