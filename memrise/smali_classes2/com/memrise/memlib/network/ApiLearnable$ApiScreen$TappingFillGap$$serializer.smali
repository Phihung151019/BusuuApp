.class public final synthetic Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;
.end annotation
...
# static fields
.field public static final INSTANCE:Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;

    invoke-direct {v0}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;-><init>()V

    sput-object v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;->INSTANCE:Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;

    new-instance v1, Lon/r0;

    const-string v2, "com.memrise.memlib.network.ApiLearnable.ApiScreen.TappingFillGap"
    ...
    sput-object v1, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;->descriptor:Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public final childSerializers()[Lkotlinx/serialization/KSerializer;
    ...
    sget-object v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->l:[Lmm/i;
...
.method public final deserialize(Lkotlinx/serialization/encoding/Decoder;)Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;
    .locals 19
    ...
    sget-object v1, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;->descriptor:Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    sget-object v2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->l:[Lmm/i;
    ...
    new-instance v6, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;->deserialize(Lkotlinx/serialization/encoding/Decoder;)Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;
...
.method public final getDescriptor()Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    sget-object v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;->descriptor:Lkotlinx/serialization/descriptors/SerialDescriptor;

    return-object v0
.end method

.method public final serialize(Lkotlinx/serialization/encoding/Encoder;Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;)V
    .locals 8
    ...
    sget-object v1, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->l:[Lmm/i;
    ...
    iget-object v4, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->a:Ljava/util/List;

    iget-object v5, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->k:Ljava/lang/Boolean;

    iget-object v6, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->i:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;

    iget-object v7, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->b:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
    ...
    iget-object v3, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->c:Lcom/memrise/memlib/network/ApiLearnable$ApiPrompt;
    ...
    iget-object v3, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->d:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue$Text;
    ...
    iget-object v3, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->e:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
    ...
    iget-object v7, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->f:Ljava/util/List;
    ...
    iget-object v4, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->g:Ljava/util/List;

    invoke-interface {p1, v0, v3, v1, v4}, Lnn/b;->z(Lkotlinx/serialization/descriptors/SerialDescriptor;ILkn/e;Ljava/lang/Object;)V

    const/4 v1, 0x7

    iget-object v3, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->h:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
    ...
    iget-object p2, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;->j:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;

    invoke-virtual {p0, p1, p2}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap$$serializer;->serialize(Lkotlinx/serialization/encoding/Encoder;Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$TappingFillGap;)V
