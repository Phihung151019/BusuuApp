.class public final synthetic Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;
.end annotation
...
# static fields
.field public static final INSTANCE:Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;

    invoke-direct {v0}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;-><init>()V

    sput-object v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;->INSTANCE:Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;

    new-instance v1, Lon/r0;

    const-string v2, "com.memrise.memlib.network.ApiLearnable.ApiScreen.ReversedMultipleChoice"
    ...
    sput-object v1, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;->descriptor:Lkotlinx/serialization/descriptors/SerialDescriptor;
...
.method public final childSerializers()[Lkotlinx/serialization/KSerializer;
    ...
    sget-object v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->j:[Lmm/i;
...
.method public final deserialize(Lkotlinx/serialization/encoding/Decoder;)Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;
    .locals 17
    ...
    sget-object v1, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;->descriptor:Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    sget-object v2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->j:[Lmm/i;
    ...
    new-instance v6, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;

    move-object/from16 v16, v5

    invoke-direct/range {v6 .. v16}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;-><init>(ILjava/util/List;Lcom/memrise/memlib/network/ApiLearnable$ApiPrompt;Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;Ljava/util/List;Ljava/util/List;Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;Ljava/lang/Boolean;)V
...
.method public bridge synthetic deserialize(Lkotlinx/serialization/encoding/Decoder;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;->deserialize(Lkotlinx/serialization/encoding/Decoder;)Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;
...
.method public final getDescriptor()Lkotlinx/serialization/descriptors/SerialDescriptor;
    ...
    sget-object v0, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;->descriptor:Lkotlinx/serialization/descriptors/SerialDescriptor;

    return-object v0
.end method

.method public final serialize(Lkotlinx/serialization/encoding/Encoder;Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;)V
    .locals 8
    ...
    sget-object v1, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->j:[Lmm/i;
    ...
    iget-object v4, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->a:Ljava/util/List;

    iget-object v5, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->i:Ljava/lang/Boolean;

    iget-object v6, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->g:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
    ...
    iget-object v3, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->b:Lcom/memrise/memlib/network/ApiLearnable$ApiPrompt;
    ...
    iget-object v3, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->c:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
    ...
    iget-object v7, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->d:Ljava/util/List;
    ...
    iget-object v4, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->e:Ljava/util/List;

    invoke-interface {p1, v0, v3, v1, v4}, Lnn/b;->z(Lkotlinx/serialization/descriptors/SerialDescriptor;ILkn/e;Ljava/lang/Object;)V

    const/4 v1, 0x5

    iget-object v3, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->f:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
    ...
    iget-object p2, p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;->h:Lcom/memrise/memlib/network/ApiLearnable$ApiLearnableValue;
...
.method public bridge synthetic serialize(Lkotlinx/serialization/encoding/Encoder;Ljava/lang/Object;)V
    ...
    check-cast p2, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;

    invoke-virtual {p0, p1, p2}, Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice$$serializer;->serialize(Lkotlinx/serialization/encoding/Encoder;Lcom/memrise/memlib/network/ApiLearnable$ApiScreen$ReversedMultipleChoice;)V
