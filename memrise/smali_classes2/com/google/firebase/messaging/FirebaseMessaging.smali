...
.field static transportFactory:Lpa/b;
...
.field private final firebaseApp:LI9/e;

.field private final gmsRpc:Lwa/s;

.field private final iid:Loa/a;
...
.field private final metadata:Lwa/v;

.field private final requestDeduplicator:Lwa/E;

.field private syncScheduledOrRunning:Z

.field private final topicsSubscriberTask:LO8/g;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LO8/g<",
            "Lwa/L;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/messaging/FirebaseMessaging;->transportFactory:Lpa/b;

    return-void
.end method

.method public constructor <init>(LI9/e;Loa/a;Lpa/b;Lma/d;Lwa/v;Lwa/s;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sput-object p3, Lcom/google/firebase/messaging/FirebaseMessaging;->transportFactory:Lpa/b;

    iput-object p1, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->firebaseApp:LI9/e;

    iput-object p2, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->iid:Loa/a;

    new-instance p3, Lcom/google/firebase/messaging/FirebaseMessaging$a;

    invoke-direct {p3, p0, p4}, Lcom/google/firebase/messaging/FirebaseMessaging$a;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;Lma/d;)V
    ...
    new-instance p3, Lwa/m;

    invoke-direct {p3}, Lwa/m;-><init>()V
    ...
    iput-object p5, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->metadata:Lwa/v;

    iput-object p6, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->gmsRpc:Lwa/s;

    new-instance p4, Lwa/E;

    invoke-direct {p4, p7}, Lwa/E;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p4, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->requestDeduplicator:Lwa/E;
    ...
    invoke-direct {p1, p2, p0}, Lc2/x;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {p1, p3}, Ls8/a;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, Lwa/K;-><init>(Landroid/content/Context;Ljava/util/concurrent/ScheduledThreadPoolExecutor;Lcom/google/firebase/messaging/FirebaseMessaging;Lwa/v;Lwa/s;)V

    invoke-static {v2, v0}, LO8/j;->c(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)LO8/A;

    move-result-object p1

    iput-object p1, v3, Lcom/google/firebase/messaging/FirebaseMessaging;->topicsSubscriberTask:LO8/g;

    new-instance p3, LIc/h;

    invoke-direct {p3, p0}, LIc/h;-><init>(Ljava/lang/Object;)V

    invoke-virtual {p1, p8, p3}, LO8/A;->e(Ljava/util/concurrent/Executor;LO8/e;)LO8/A;

    new-instance p1, LY2/c;

    invoke-direct {p1, p2, p0}, LY2/c;-><init>(ILjava/lang/Object;)V
...
.method public constructor <init>(LI9/e;Loa/a;Lpa/b;Lpa/b;Lqa/e;Lpa/b;Lma/d;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v8, Lwa/v;

    invoke-virtual {p1}, LI9/e;->a()V

    iget-object v0, p1, LI9/e;->a:Landroid/content/Context;

    invoke-direct {v8, v0}, Lwa/v;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct/range {v0 .. v8}, Lcom/google/firebase/messaging/FirebaseMessaging;-><init>(LI9/e;Loa/a;Lpa/b;Lpa/b;Lqa/e;Lpa/b;Lma/d;Lwa/v;)V

    return-void
.end method

.method public constructor <init>(LI9/e;Loa/a;Lpa/b;Lpa/b;Lqa/e;Lpa/b;Lma/d;Lwa/v;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v5}, Lwa/s;-><init>(LI9/e;Lwa/v;Lpa/b;Lpa/b;Lqa/e;)V
    ...
    invoke-direct {v8, v2, v1}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V
    ...
    invoke-direct/range {v0 .. v9}, Lcom/google/firebase/messaging/FirebaseMessaging;-><init>(LI9/e;Loa/a;Lpa/b;Lma/d;Lwa/v;Lwa/s;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;Ljava/util/concurrent/Executor;)V
...
.method public static synthetic access$000(Lcom/google/firebase/messaging/FirebaseMessaging;)LI9/e;
    .locals 0

    iget-object p0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->firebaseApp:LI9/e;
...
.method public static synthetic b(Lcom/google/firebase/messaging/FirebaseMessaging;Ljava/lang/String;Lcom/google/firebase/messaging/a$a;Ljava/lang/String;)LO8/g;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$blockingGetToken$13(Ljava/lang/String;Lcom/google/firebase/messaging/a$a;Ljava/lang/String;)LO8/g;
...
.method public static synthetic d(Lcom/google/firebase/messaging/FirebaseMessaging;LO8/h;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$getToken$7(LO8/h;)V

    return-void
.end method

.method public static synthetic e(Lcom/google/firebase/messaging/FirebaseMessaging;LO8/h;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$deleteToken$8(LO8/h;)V

    return-void
.end method

.method public static synthetic f(Ljava/lang/String;Lwa/L;)LO8/g;
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$unsubscribeFromTopic$11(Ljava/lang/String;Lwa/L;)LO8/g;
...
.method public static synthetic g()LS6/i;
    .locals 1

    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$static$0()LS6/i;
...
.method public static declared-synchronized getInstance()Lcom/google/firebase/messaging/FirebaseMessaging;
    ...
    invoke-static {v1}, Lcom/google/firebase/messaging/FirebaseMessaging;->getInstance(LI9/e;)Lcom/google/firebase/messaging/FirebaseMessaging;
...
.method public static declared-synchronized getInstance(LI9/e;)Lcom/google/firebase/messaging/FirebaseMessaging;
    .locals 2
    ...
    invoke-virtual {p0, v1}, LI9/e;->b(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-static {p0, v1}, Lm8/m;->h(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private getSubtype()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->firebaseApp:LI9/e;
    ...
    invoke-virtual {v0}, LI9/e;->d()Ljava/lang/String;
...
.method public static getTransportFactory()LS6/i;
    .locals 1

    sget-object v0, Lcom/google/firebase/messaging/FirebaseMessaging;->transportFactory:Lpa/b;
...
.method private handleProxiedNotificationData()V
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->gmsRpc:Lwa/s;

    iget-object v0, v0, Lwa/s;->c:Li8/c;

    iget-object v1, v0, Li8/c;->c:Li8/y;
    ...
    sget-object v1, Li8/A;->b:Li8/A;

    sget-object v2, Li8/f;->b:Li8/f;

    invoke-virtual {v0, v1, v2}, LO8/A;->f(Ljava/util/concurrent/Executor;LO8/a;)LO8/g;
    ...
    invoke-direct {v2, p0}, LAa/g;-><init>(Ljava/lang/Object;)V
...
.method public static synthetic i(Lcom/google/firebase/messaging/FirebaseMessaging;Li8/a;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$handleProxiedNotificationData$5(Li8/a;)V
...
.method private initializeProxyNotifications()V
    ...
    invoke-static {v0}, Lwa/y;->a(Landroid/content/Context;)V

    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->context:Landroid/content/Context;

    iget-object v1, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->gmsRpc:Lwa/s;

    invoke-direct {p0}, Lcom/google/firebase/messaging/FirebaseMessaging;->shouldRetainProxyNotifications()Z

    move-result v2

    invoke-static {v0, v1, v2}, Lwa/A;->b(Landroid/content/Context;Lwa/s;Z)V
...
.method private invokeOnTokenRefresh(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->firebaseApp:LI9/e;

    invoke-virtual {v2}, LI9/e;->a()V

    iget-object v2, v2, LI9/e;->b:Ljava/lang/String;
    ...
    invoke-direct {p1, v1}, Lwa/l;-><init>(Landroid/content/Context;)V

    invoke-virtual {p1, v0}, Lwa/l;->b(Landroid/content/Intent;)LO8/g;

    :cond_1
    return-void
.end method

.method public static synthetic j()LS6/i;
    .locals 1

    invoke-static {}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$clearTransportFactoryForTest$12()LS6/i;
...
.method public static synthetic k(Lcom/google/firebase/messaging/FirebaseMessaging;Lwa/L;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$new$3(Lwa/L;)V

    return-void
.end method

.method public static synthetic l(Ljava/lang/String;Lwa/L;)LO8/g;
    .locals 0

    invoke-static {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$subscribeToTopic$10(Ljava/lang/String;Lwa/L;)LO8/g;
...
.method private lambda$blockingGetToken$13(Ljava/lang/String;Lcom/google/firebase/messaging/a$a;Ljava/lang/String;)LO8/g;
    .locals 5
    ...
    iget-object v2, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->metadata:Lwa/v;

    invoke-virtual {v2}, Lwa/v;->a()Ljava/lang/String;
    ...
    invoke-static {p3, v3, v4, v2}, Lcom/google/firebase/messaging/a$a;->a(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    invoke-static {p3}, LO8/j;->e(Ljava/lang/Object;)LO8/A;
...
.method private lambda$blockingGetToken$14(Ljava/lang/String;Lcom/google/firebase/messaging/a$a;)LO8/g;
    .locals 4

    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->gmsRpc:Lwa/s;

    iget-object v1, v0, Lwa/s;->a:LI9/e;

    invoke-static {v1}, Lwa/v;->b(LI9/e;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v3, v2}, Lwa/s;->c(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)LO8/g;

    move-result-object v1

    invoke-virtual {v0, v1}, Lwa/s;->a(LO8/g;)LO8/g;
    ...
    invoke-direct {v2, p0, p1, p2}, Lwa/p;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;Ljava/lang/String;Lcom/google/firebase/messaging/a$a;)V

    invoke-virtual {v0, v1, v2}, LO8/g;->o(Ljava/util/concurrent/Executor;LO8/f;)LO8/g;
...
.method private static synthetic lambda$clearTransportFactoryForTest$12()LS6/i;
    .locals 1
...
.method private synthetic lambda$deleteToken$8(LO8/h;)V
    .locals 2

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->iid:Loa/a;

    iget-object v1, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->firebaseApp:LI9/e;

    invoke-static {v1}, Lwa/v;->b(LI9/e;)Ljava/lang/String;

    invoke-interface {v0}, Loa/a;->b()V
    ...
    invoke-virtual {p1, v0}, LO8/h;->a(Ljava/lang/Exception;)V

    return-void
.end method

.method private lambda$deleteToken$9(LO8/h;)V
    .locals 4
    ...
    iget-object v2, v0, Lwa/s;->a:LI9/e;

    invoke-static {v2}, Lwa/v;->b(LI9/e;)Ljava/lang/String;

    move-result-object v2

    const-string v3, "*"

    invoke-virtual {v0, v2, v3, v1}, Lwa/s;->c(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)LO8/g;
    ...
    invoke-static {v0}, LO8/j;->a(LO8/g;)Ljava/lang/Object;
...
.method private synthetic lambda$getToken$7(LO8/h;)V
    .locals 1
...
.method private lambda$handleProxiedNotificationData$5(Li8/a;)V
    .locals 0

    if-eqz p1, :cond_0

    iget-object p1, p1, Li8/a;->b:Landroid/content/Intent;
...
.method private synthetic lambda$new$3(Lwa/L;)V
    .locals 1
...
.method private synthetic lambda$setNotificationDelegationEnabled$6(Ljava/lang/Void;)V
    ...
    invoke-static {p1, v0, v1}, Lwa/A;->b(Landroid/content/Context;Lwa/s;Z)V

    return-void
.end method

.method private static synthetic lambda$static$0()LS6/i;
    .locals 1
...
.method private static lambda$subscribeToTopic$10(Ljava/lang/String;Lwa/L;)LO8/g;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {v0, v1, p0}, Lwa/I;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1, v0}, Lwa/L;->d(Lwa/I;)LO8/A;
...
.method private static lambda$unsubscribeFromTopic$11(Ljava/lang/String;Lwa/L;)LO8/g;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public static synthetic m(Lcom/google/firebase/messaging/FirebaseMessaging;LO8/h;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$deleteToken$9(LO8/h;)V
...
.method private shouldRetainProxyNotifications()Z
    ...
    invoke-static {v0}, Lwa/y;->b(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v2}, LI9/e;->b(Ljava/lang/Class;)Ljava/lang/Object;
...
.method public blockingGetToken()Ljava/lang/String;
    ...
    :try_start_0
    invoke-interface {v0}, Loa/a;->c()LO8/g;
    ...
    iget-object v2, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->requestDeduplicator:Lwa/E;
    ...
    :try_start_1
    iget-object v5, v2, Lwa/E;->b:Ly/a;

    invoke-virtual {v5, v1}, Ly/a0;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_4
    invoke-direct {p0, v1, v0}, Lcom/google/firebase/messaging/FirebaseMessaging;->lambda$blockingGetToken$14(Ljava/lang/String;Lcom/google/firebase/messaging/a$a;)LO8/g;

    move-result-object v0

    iget-object v3, v2, Lwa/E;->a:Ljava/util/concurrent/Executor;

    new-instance v4, Lwa/D;

    invoke-direct {v4, v2, v1}, Lwa/D;-><init>(Lwa/E;Ljava/lang/String;)V

    invoke-virtual {v0, v3, v4}, LO8/g;->g(Ljava/util/concurrent/Executor;LO8/a;)LO8/g;

    move-result-object v5

    iget-object v0, v2, Lwa/E;->b:Ly/a;

    invoke-virtual {v0, v1, v5}, Ly/a0;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    :goto_2
    :try_start_3
    invoke-static {v5}, LO8/j;->a(LO8/g;)Ljava/lang/Object;
...
.method public deleteToken()LO8/g;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-direct {v2, p0, v0}, Lwa/q;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;LO8/h;)V
...
.method public getToken()LO8/g;
    ...
    invoke-direct {v2, v3, p0, v0}, LY2/g;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public getTopicsSubscriberTask()LO8/g;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->topicsSubscriberTask:LO8/g;
...
.method public isGmsCorePresent()Z
    ...
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessaging;->metadata:Lwa/v;

    invoke-virtual {v0}, Lwa/v;->d()Z
...
.method public send(Lwa/B;)V
    .locals 5
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    iget-object v0, p1, Lwa/B;->b:Landroid/os/Bundle;
    ...
    iget-object p1, p1, Lwa/B;->b:Landroid/os/Bundle;
...
.method public setAutoInitEnabled(Z)V
    ...
    iget-object v1, v0, Lcom/google/firebase/messaging/FirebaseMessaging$a;->c:Lwa/r;

    if-eqz v1, :cond_0

    iget-object v2, v0, Lcom/google/firebase/messaging/FirebaseMessaging$a;->a:Lma/d;

    invoke-interface {v2, v1}, Lma/d;->a(Lwa/r;)V

    const/4 v1, 0x0

    iput-object v1, v0, Lcom/google/firebase/messaging/FirebaseMessaging$a;->c:Lwa/r;
    ...
    invoke-static {v1}, Lcom/google/firebase/messaging/FirebaseMessaging;->access$000(Lcom/google/firebase/messaging/FirebaseMessaging;)LI9/e;
...
.method public setDeliveryMetricsExportToBigQuery(Z)V
    ...
    iget-object v0, v0, LI9/e;->a:Landroid/content/Context;
...
.method public setNotificationDelegationEnabled(Z)LO8/g;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z)",
    ...
    invoke-direct {v3, v1, p1, v2}, Lwa/x;-><init>(Landroid/content/Context;ZLO8/h;)V

    invoke-interface {v0, v3}, Ljava/util/concurrent/Executor;->execute(Ljava/lang/Runnable;)V

    iget-object p1, v2, LO8/h;->a:LO8/A;
    ...
    invoke-direct {v1, p0}, LMa/j;-><init>(Ljava/lang/Object;)V
...
.method public subscribeToTopic(Ljava/lang/String;)LO8/g;
    .locals 2
    .annotation build Landroid/annotation/SuppressLint;
        value = {
            "TaskMainThread"
    ...
    invoke-direct {v1, p1}, LMa/f;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0, v1}, LO8/g;->n(LO8/f;)LO8/g;
...
.method public declared-synchronized syncWithDelaySecondsInternal(J)V
    ...
    invoke-direct {v2, p0, v0, v1}, Lwa/H;-><init>(Lcom/google/firebase/messaging/FirebaseMessaging;J)V
...
.method public tokenNeedsRefresh(Lcom/google/firebase/messaging/a$a;)Z
    ...
    invoke-virtual {v0}, Lwa/v;->a()Ljava/lang/String;
...
.method public unsubscribeFromTopic(Ljava/lang/String;)LO8/g;
    .locals 2
    .annotation build Landroid/annotation/SuppressLint;
        value = {
            "TaskMainThread"
    ...
    invoke-direct {v1, p1}, LV2/t;-><init>(Ljava/lang/Object;)V
