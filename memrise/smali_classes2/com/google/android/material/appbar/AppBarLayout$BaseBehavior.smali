...
.field public k:Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, LR8/f;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-void
.end method

.method public static i(Landroid/view/KeyEvent;Landroid/view/View;Lcom/google/android/material/appbar/AppBarLayout;)V
    .locals 6
...
.method public static o(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lcom/google/android/material/appbar/AppBarLayout;IIZ)V
    ...
    iget-object p2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->c:LO1/c;
    ...
    invoke-virtual {p3}, Lcom/google/android/material/appbar/d;->getOverlayTop()I
...
.method public final b(Landroid/view/View;)Z
    ...
    iget-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->l:Ljava/lang/ref/WeakReference;
...
.method public final f(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    invoke-static/range {p3 .. p5}, LDk/e;->c(III)I
    ...
    :goto_2
    invoke-virtual {v0, v8}, LR8/g;->setTopAndBottomOffset(I)Z
    ...
    iput v8, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->h:I
    ...
    iget-object v13, v11, Lcom/google/android/material/appbar/AppBarLayout$b;->b:Landroid/graphics/Rect;

    iget-object v11, v11, Lcom/google/android/material/appbar/AppBarLayout$b;->a:Landroid/graphics/Rect;
    ...
    :cond_d
    iput v5, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->h:I

    :cond_e
    :goto_6
    invoke-virtual {v0, v1, v3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->n(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lcom/google/android/material/appbar/AppBarLayout;)V
...
.method public final h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lcom/google/android/material/appbar/AppBarLayout;I)V
    ...
    :cond_2
    iget-object v2, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->j:Landroid/animation/ValueAnimator;
    ...
    iput-object v2, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->j:Landroid/animation/ValueAnimator;

    sget-object v3, LQ8/a;->e:Landroid/view/animation/DecelerateInterpolator;
...
.method public final l(Landroid/os/Parcelable;Lcom/google/android/material/appbar/AppBarLayout;)Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-direct {v1, p1}, Lj2/a;-><init>(Landroid/os/Parcelable;)V
...
.method public final m(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lcom/google/android/material/appbar/AppBarLayout;)V
    ...
    invoke-static {v8, v0, v3}, LDk/e;->c(III)I
...
.method public final n(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lcom/google/android/material/appbar/AppBarLayout;)V
    ...
    sget-object v0, Ld2/j$a;->h:Ld2/j$a;

    invoke-virtual {v0}, Ld2/j$a;->a()I

    move-result v0

    invoke-static {p1, v0}, Lc2/O;->l(Landroid/view/View;I)V

    const/4 v0, 0x0

    invoke-static {p1, v0}, Lc2/O;->i(Landroid/view/View;I)V

    sget-object v1, Ld2/j$a;->i:Ld2/j$a;

    invoke-virtual {v1}, Ld2/j$a;->a()I

    move-result v1

    invoke-static {p1, v1}, Lc2/O;->l(Landroid/view/View;I)V
    ...
    invoke-static {p1}, Lc2/O;->e(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-static {p1, v1}, Lc2/O;->o(Landroid/view/View;Lc2/a;)V
    ...
    sget-object v1, Ld2/j$a;->h:Ld2/j$a;
    ...
    invoke-static {p1, v1, v2}, Lc2/O;->m(Landroid/view/View;Ld2/j$a;Ld2/l;)V
    ...
    sget-object v0, Ld2/j$a;->i:Ld2/j$a;
    ...
    invoke-static {v6, v0, v4}, Lc2/O;->m(Landroid/view/View;Ld2/j$a;Ld2/l;)V
    ...
    sget-object p1, Ld2/j$a;->i:Ld2/j$a;

    new-instance p2, Lcom/google/android/material/appbar/c;

    invoke-direct {p2, v7, v3}, Lcom/google/android/material/appbar/c;-><init>(Lcom/google/android/material/appbar/AppBarLayout;Z)V

    invoke-static {v6, p1, p2}, Lc2/O;->m(Landroid/view/View;Ld2/j$a;Ld2/l;)V
    ...
    :goto_7
    iput-boolean v3, v5, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Z
...
.method public final onLayoutChild(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-super {p0, p1, p2, p3}, LR8/g;->onLayoutChild(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    iget-object v1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->k:Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;
    ...
    iget-boolean v0, v1, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;->d:Z
    ...
    invoke-virtual {p0, p1, p2, v0}, LR8/f;->g(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)V

    goto :goto_2

    :cond_0
    iget-boolean v0, v1, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;->e:Z

    if-eqz v0, :cond_1

    invoke-virtual {p0, p1, p2, v3}, LR8/f;->g(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)V

    goto :goto_2

    :cond_1
    iget v0, v1, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;->f:I
    ...
    iget-object v4, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->k:Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;

    iget-boolean v4, v4, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;->h:Z
    ...
    iget v4, v4, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;->g:F
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v4}, LR8/f;->g(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    :cond_8
    :goto_2
    iput v3, p2, Lcom/google/android/material/appbar/AppBarLayout;->g:I

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->k:Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;
    ...
    invoke-static {v0, v1, v3}, LDk/e;->c(III)I

    move-result v0

    invoke-virtual {p0, v0}, LR8/g;->setTopAndBottomOffset(I)Z

    invoke-virtual {p0}, LR8/g;->getTopAndBottomOffset()I

    move-result v0

    invoke-static {p1, p2, v0, v3, v2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->o(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lcom/google/android/material/appbar/AppBarLayout;IIZ)V

    invoke-virtual {p0}, LR8/g;->getTopAndBottomOffset()I

    move-result v0

    iput v0, p2, Lcom/google/android/material/appbar/AppBarLayout;->b:I
    ...
    invoke-direct {v0, p0, p1, p2}, LR8/d;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Landroid/view/View;Lcom/google/android/material/appbar/AppBarLayout;)V

    invoke-static {p1, v0}, LR8/c;->d(Landroid/view/View;LR8/d;)V
    ...
    invoke-direct {v0, p0, p1, p2}, LR8/e;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Landroid/view/View;Lcom/google/android/material/appbar/AppBarLayout;)V
...
.method public final onMeasureChild(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;IIII)Z
    ...
    invoke-virtual/range {p1 .. p6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->s(Landroid/view/View;IIII)V
...
.method public final onNestedScroll(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;IIIII[I)V
    ...
    invoke-virtual/range {p1 .. p6}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->f(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    invoke-virtual {p0, p2, p3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->n(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lcom/google/android/material/appbar/AppBarLayout;)V
...
.method public final onRestoreInstanceState(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    iput-object p3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->k:Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;

    iget-object p3, p3, Lj2/a;->b:Landroid/os/Parcelable;
    ...
    iput-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->k:Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;
...
.method public final onSaveInstanceState(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->l(Landroid/os/Parcelable;Lcom/google/android/material/appbar/AppBarLayout;)Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior$b;
...
.method public final onStartNestedScroll(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)Z
    ...
    iput-object p2, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->l:Ljava/lang/ref/WeakReference;
...
.method public final onStopNestedScroll(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V
    ...
    iput-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->l:Ljava/lang/ref/WeakReference;
