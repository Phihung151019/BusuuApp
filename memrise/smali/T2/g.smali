...
# direct methods
.method public constructor <init>(IILT2/j;)V
    .locals 1

    const/4 v0, 0x1

    invoke-direct {p0, v0}, LT2/a;-><init>(Z)V

    iput p1, p0, LT2/g;->e:I

    iput p2, p0, LT2/g;->f:I

    iput-object p3, p0, LT2/g;->g:LT2/j;

    new-instance p1, LT2/j;

    invoke-direct {p1}, LT2/j;-><init>()V

    iput-object p1, p0, LT2/g;->h:LT2/j;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, LT2/g;->j:Ljava/io/InputStream;

    if-eqz v2, :cond_1

    iget-wide v3, p0, LT2/g;->m:J
    ...
    :goto_0
    iget-object v3, p0, LT2/g;->i:Ljava/net/HttpURLConnection;

    invoke-static {v3, v5, v6}, LT2/g;->t(Ljava/net/HttpURLConnection;J)V
    :try_end_0
    ...
    :cond_1
    :goto_1
    iput-object v1, p0, LT2/g;->j:Ljava/io/InputStream;

    invoke-virtual {p0}, LT2/g;->r()V
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object v0, p0, LT2/g;->i:Ljava/net/HttpURLConnection;
...
.method public final h()Ljava/util/Map;
    ...
    invoke-direct {v1, v0}, LT2/g$b;-><init>(Ljava/util/Map;)V
...
.method public final l(LT2/e;)J
    ...
    iput-wide v12, v1, LT2/g;->n:J

    iput-wide v12, v1, LT2/g;->m:J

    invoke-virtual/range {p0 .. p1}, LT2/a;->p(LT2/e;)V
    ...
    iget-object v3, v0, LT2/e;->a:Landroid/net/Uri;
    ...
    iget v3, v0, LT2/e;->b:I

    iget-object v4, v0, LT2/e;->c:[B

    iget-wide v5, v0, LT2/e;->e:J

    iget-wide v7, v0, LT2/e;->f:J

    iget v9, v0, LT2/e;->h:I
    ...
    :goto_0
    iget-object v11, v0, LT2/e;->d:Ljava/util/Map;

    const/4 v10, 0x1

    invoke-virtual/range {v1 .. v11}, LT2/g;->s(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v2

    iget-wide v3, v0, LT2/e;->e:J

    iget-wide v5, v0, LT2/e;->f:J

    iput-object v2, v1, LT2/g;->i:Ljava/net/HttpURLConnection;

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v7

    iput v7, v1, LT2/g;->l:I

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseMessage()Ljava/lang/String;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_5

    iget v7, v1, LT2/g;->l:I
    ...
    sget-object v8, LT2/k;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v11, v9}, LR2/k;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v9, LT2/k;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v11, v5}, LR2/k;->f(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v11, v5}, LR2/k;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v2, v1, LT2/g;->j:Ljava/io/InputStream;

    if-eqz v7, :cond_a

    new-instance v2, Ljava/util/zip/GZIPInputStream;

    iget-object v6, v1, LT2/g;->j:Ljava/io/InputStream;
    ...
    :goto_6
    iput-boolean v9, v1, LT2/g;->k:Z

    invoke-virtual/range {p0 .. p1}, LT2/a;->q(LT2/e;)V

    :try_start_4
    invoke-virtual {v1, v3, v4}, LT2/g;->u(J)V
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_3

    iget-wide v2, v1, LT2/g;->m:J
    ...
    invoke-direct {v2, v0, v5, v9}, Landroidx/media3/datasource/HttpDataSource$HttpDataSourceException;-><init>(Ljava/io/IOException;II)V
    ...
    sget-object v10, LT2/k;->a:Ljava/util/regex/Pattern;
    ...
    :cond_c
    sget-object v10, LT2/k;->b:Ljava/util/regex/Pattern;
...
.method public final r()V
    ...
    iput-object v0, p0, LT2/g;->i:Ljava/net/HttpURLConnection;
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, LT2/g;->j:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, LT2/g;->n:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, LT2/g;->n:J

    invoke-virtual {p0, p1}, LT2/a;->f(I)V
    :try_end_0
...
.method public final s(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, LT2/g;->g:LT2/j;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, LT2/j;->a()Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, p0, LT2/g;->h:LT2/j;
    ...
    :cond_1
    sget-object p10, LT2/k;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {p10, p4, p5, v2}, LA0/G;->b(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final u(J)V
    ...
    iget-object v5, p0, LT2/g;->j:Ljava/io/InputStream;
    ...
    invoke-virtual {p0, v4}, LT2/a;->f(I)V
