...
# static fields
.field public static final a:LD/Z0;
...
.method public final b(Landroid/view/View;ZJFFZLB1/d;F)LD/W0;
    ...
    :cond_0
    invoke-interface {p8, p3, p4}, LB1/d;->w1(J)J

    move-result-wide p2

    invoke-interface {p8, p5}, LB1/d;->T0(F)F

    move-result p4

    invoke-interface {p8, p6}, LB1/d;->T0(F)F
    ...
    invoke-direct {p2, p1}, LD/Y0$a;-><init>(Landroid/widget/Magnifier;)V
