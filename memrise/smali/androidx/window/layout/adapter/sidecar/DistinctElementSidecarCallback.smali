...
# direct methods
.method public constructor <init>(Ly4/f;Landroidx/window/sidecar/SidecarInterface$SidecarCallback;)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/window/layout/adapter/sidecar/DistinctElementSidecarCallback;->d:Ly4/f;
...
.method public onDeviceStateChanged(Landroidx/window/sidecar/SidecarDeviceState;)V
    ...
    :try_start_0
    iget-object v1, p0, Landroidx/window/layout/adapter/sidecar/DistinctElementSidecarCallback;->d:Ly4/f;
    ...
    :cond_2
    invoke-static {v2}, Ly4/f$a;->b(Landroidx/window/sidecar/SidecarDeviceState;)I

    move-result v1

    invoke-static {p1}, Ly4/f$a;->b(Landroidx/window/sidecar/SidecarDeviceState;)I
...
.method public onWindowLayoutChanged(Landroid/os/IBinder;Landroidx/window/sidecar/SidecarWindowLayoutInfo;)V
    ...
    iget-object v2, p0, Landroidx/window/layout/adapter/sidecar/DistinctElementSidecarCallback;->d:Ly4/f;
    ...
    :cond_2
    invoke-static {v1}, Ly4/f$a;->c(Landroidx/window/sidecar/SidecarWindowLayoutInfo;)Ljava/util/List;

    move-result-object v1

    invoke-static {p2}, Ly4/f$a;->c(Landroidx/window/sidecar/SidecarWindowLayoutInfo;)Ljava/util/List;

    move-result-object v2

    invoke-static {v1, v2}, Ly4/f;->b(Ljava/util/List;Ljava/util/List;)Z
