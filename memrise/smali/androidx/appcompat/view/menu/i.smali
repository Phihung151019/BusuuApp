...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/f;Landroid/view/View;ZII)V
    ...
    new-instance p6, Landroidx/appcompat/view/menu/i$a;

    invoke-direct {p6, p0}, Landroidx/appcompat/view/menu/i$a;-><init>(Landroidx/appcompat/view/menu/i;)V

    iput-object p6, p0, Landroidx/appcompat/view/menu/i;->k:Landroidx/appcompat/view/menu/i$a;

    iput-object p1, p0, Landroidx/appcompat/view/menu/i;->a:Landroid/content/Context;

    iput-object p2, p0, Landroidx/appcompat/view/menu/i;->b:Landroidx/appcompat/view/menu/f;
...
.method public final a()Lq/d;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/i;->i:Lq/d;
    ...
    iget-object v6, p0, Landroidx/appcompat/view/menu/i;->a:Landroid/content/Context;

    iget-object v7, p0, Landroidx/appcompat/view/menu/i;->b:Landroidx/appcompat/view/menu/f;

    invoke-direct/range {v5 .. v10}, Landroidx/appcompat/view/menu/l;-><init>(Landroid/content/Context;Landroidx/appcompat/view/menu/f;Landroid/view/View;IZ)V
    ...
    invoke-virtual {v0, v1}, Lq/d;->l(Landroidx/appcompat/view/menu/f;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->k:Landroidx/appcompat/view/menu/i$a;

    invoke-virtual {v0, v1}, Lq/d;->r(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->e:Landroid/view/View;

    invoke-virtual {v0, v1}, Lq/d;->n(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Lq/d;->o(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/i;->f:I

    invoke-virtual {v0, v1}, Lq/d;->p(I)V

    iput-object v0, p0, Landroidx/appcompat/view/menu/i;->i:Lq/d;
...
.method public c()V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/i;->j:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public final d(IIZZ)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/i;->a()Lq/d;

    move-result-object v0

    invoke-virtual {v0, p4}, Lq/d;->s(Z)V
    ...
    :cond_0
    invoke-virtual {v0, p1}, Lq/d;->q(I)V
    ...
    iput-object p4, v0, Lq/d;->b:Landroid/graphics/Rect;

    :cond_1
    invoke-interface {v0}, Lq/f;->a()V
