...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v2, Lk/a;->w:[I

    invoke-static {p1, p2, v2, v5}, Lr/d0;->e(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lr/d0;

    move-result-object v10

    iget-object v4, v10, Lr/d0;->b:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v10, p1}, Lr/d0;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v10, p2}, Lr/d0;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    iput-object p2, v0, Landroidx/appcompat/widget/SwitchCompat;->g:Landroid/graphics/drawable/Drawable;
    ...
    iput-boolean v2, v0, Landroidx/appcompat/widget/SwitchCompat;->t:Z
    ...
    iput v2, v0, Landroidx/appcompat/widget/SwitchCompat;->n:I
    ...
    invoke-virtual {v10, v2}, Lr/d0;->a(I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, v6}, Lr/I;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/SwitchCompat;->h:Landroid/content/res/ColorStateList;
    ...
    iget-object v12, v0, Landroidx/appcompat/widget/SwitchCompat;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v12, v2, :cond_7

    iput-object v2, v0, Landroidx/appcompat/widget/SwitchCompat;->i:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v8, v0, Landroidx/appcompat/widget/SwitchCompat;->k:Z
    ...
    iget-boolean v2, v0, Landroidx/appcompat/widget/SwitchCompat;->k:Z
    ...
    invoke-static {v4, v1}, LR1/a;->b(ILandroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    iput-object v4, v0, Landroidx/appcompat/widget/SwitchCompat;->K:Landroid/content/res/ColorStateList;
    ...
    iput-object p1, v0, Landroidx/appcompat/widget/SwitchCompat;->N:Lo/a;

    goto :goto_7

    :cond_15
    iput-object v6, v0, Landroidx/appcompat/widget/SwitchCompat;->N:Lo/a;

    :goto_7
    iget-object p1, v0, Landroidx/appcompat/widget/SwitchCompat;->p:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v3, v5}, Lr/y;->f(Landroid/util/AttributeSet;I)V

    invoke-virtual {v10}, Lr/d0;->f()V
    ...
    iput p2, v0, Landroidx/appcompat/widget/SwitchCompat;->v:I

    invoke-virtual {p1}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result p1

    iput p1, v0, Landroidx/appcompat/widget/SwitchCompat;->z:I

    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lr/k;

    move-result-object p1

    invoke-virtual {p1, v3, v5}, Lr/k;->b(Landroid/util/AttributeSet;I)V
...
.method private getEmojiTextViewHelper()Lr/k;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->P:Lr/k;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->P:Lr/k;
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Lr/I;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Lr/I;->c:Landroid/graphics/Rect;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, Lr/k;->b:Lx2/f;

    iget-object v0, v0, Lx2/f;->a:Lx2/f$b;

    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Lo/a;

    invoke-virtual {v0, v1}, Lx2/f$b;->e(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->P:Lr/k;

    iget-object p1, p1, Lr/k;->b:Lx2/f;

    iget-object p1, p1, Lx2/f;->a:Lx2/f$b;

    invoke-virtual {p1}, Lx2/f$b;->b()Z
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Lr/I;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Lr/I;->c:Landroid/graphics/Rect;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Lr/I;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p2, p1, Landroidx/appcompat/widget/SwitchCompat;->g:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p2}, Lr/I;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget p4, p1, Landroidx/appcompat/widget/SwitchCompat;->B:I
    ...
    iget p2, p1, Landroidx/appcompat/widget/SwitchCompat;->B:I
    ...
    iget p5, p1, Landroidx/appcompat/widget/SwitchCompat;->C:I
    ...
    iget p3, p1, Landroidx/appcompat/widget/SwitchCompat;->C:I
    ...
    :goto_3
    iput p2, p1, Landroidx/appcompat/widget/SwitchCompat;->E:I

    iput p3, p1, Landroidx/appcompat/widget/SwitchCompat;->F:I

    iput p5, p1, Landroidx/appcompat/widget/SwitchCompat;->H:I

    iput p4, p1, Landroidx/appcompat/widget/SwitchCompat;->G:I
...
.method public setChecked(Z)V
    ...
    invoke-direct {v5, v2, v1, v0, v3}, Lc2/O$b;-><init>(ILjava/lang/Class;II)V

    invoke-virtual {v5, p0, v4}, Lc2/O$b;->c(Landroid/view/View;Ljava/lang/Object;)V
...
.method public setTextOff(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v1, v4, v2, v3, v0}, Lc2/O$b;-><init>(ILjava/lang/Class;II)V

    invoke-virtual {v1, p0, p1}, Lc2/O$b;->c(Landroid/view/View;Ljava/lang/Object;)V
