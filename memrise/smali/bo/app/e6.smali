...
# virtual methods
.method public final a(Lorg/json/JSONObject;Lbo/app/r1;)Lcom/braze/models/inappmessage/IInAppMessage;
    .locals 9
    ...
    sget-object v3, Lbo/app/e6;->b:Ljava/lang/String;

    sget-object v6, Lbo/app/e6$a;->b:Lbo/app/e6$a;
    ...
    new-instance v6, Lbo/app/e6$b;

    invoke-direct {v6, v0}, Lbo/app/e6$b;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v4, p1}, Lbo/app/e6$c;-><init>(Lorg/json/JSONObject;)V

    invoke-virtual {v0, v2, v3, p2, v4}, Lcom/braze/support/BrazeLogger;->brazelog(Ljava/lang/String;Lcom/braze/support/BrazeLogger$Priority;Ljava/lang/Throwable;LBm/a;)V
...
.method public final a(Lorg/json/JSONArray;)Ljava/util/List;
    ...
    invoke-direct {v4, v3}, Lbo/app/w3;-><init>(Lorg/json/JSONObject;)V
    ...
    invoke-direct {v4, v3}, Lbo/app/s3;-><init>(Lorg/json/JSONObject;)V
    ...
    invoke-direct {v4, v3}, Lbo/app/s2;-><init>(Lorg/json/JSONObject;)V
    ...
    invoke-direct {v4, v3}, Lbo/app/u3;-><init>(Lorg/json/JSONObject;)V
...
.method public final a(Lorg/json/JSONArray;Lbo/app/r1;)Ljava/util/List;
    .locals 9
    ...
    sget-object v6, Lbo/app/e6$h;->b:Lbo/app/e6$h;
    ...
    invoke-virtual {p0, v4, p2}, Lbo/app/e6;->b(Lorg/json/JSONObject;Lbo/app/r1;)Lbo/app/q2;
    ...
    invoke-direct {v4, p1}, Lbo/app/e6$i;-><init>(Lorg/json/JSONArray;)V
...
.method public final b(Lorg/json/JSONObject;Lbo/app/r1;)Lbo/app/q2;
    .locals 9
    ...
    invoke-direct {v0, p1, p2}, Lbo/app/w2;-><init>(Lorg/json/JSONObject;Lbo/app/r1;)V
    ...
    invoke-direct {v0, p1, p2}, Lbo/app/q5;-><init>(Lorg/json/JSONObject;Lbo/app/r1;)V
    ...
    new-instance v6, Lbo/app/e6$f;

    invoke-direct {v6, v0}, Lbo/app/e6$f;-><init>(Ljava/lang/String;)V
    ...
    new-instance v4, Lbo/app/e6$g;

    invoke-direct {v4, p1}, Lbo/app/e6$g;-><init>(Lorg/json/JSONObject;)V
