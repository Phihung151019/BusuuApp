...
.method public final apply(LQ1/l;)V
    ...
    iget-object v2, v2, LQ1/w;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v2, v0, LQ1/v;->mBigContentTitle:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, LQ1/p;->a:Landroidx/core/graphics/drawable/IconCompat;
    ...
    iget-object v7, v7, LQ1/w;->a:Landroid/content/Context;
    ...
    :goto_0
    invoke-virtual {v3, v7}, Landroidx/core/graphics/drawable/IconCompat;->e(Landroid/content/Context;)Landroid/graphics/drawable/Icon;

    move-result-object v3

    invoke-static {v2, v3}, LQ1/p$b;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_6
    :goto_2
    iget-boolean v3, v0, LQ1/p;->c:Z

    if-eqz v3, :cond_9

    iget-object v3, v0, LQ1/p;->b:Landroidx/core/graphics/drawable/IconCompat;
    ...
    :cond_7
    instance-of v4, v1, LQ1/w;

    if-eqz v4, :cond_8

    check-cast v1, LQ1/w;

    iget-object v1, v1, LQ1/w;->a:Landroid/content/Context;
    ...
    invoke-static {v2, v1}, LQ1/p$a;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_9
    :goto_4
    iget-boolean v1, v0, LQ1/v;->mSummaryTextSet:Z

    if-eqz v1, :cond_a

    iget-object v1, v0, LQ1/v;->mSummaryText:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v1}, LQ1/p$b;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v6}, LQ1/p$b;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
