...
.method public constructor <init>(Ljava/util/ArrayList;IIIFLjava/lang/String;)V
    ...
    iput-object p1, p0, LZ7/a;->a:Ljava/util/ArrayList;

    iput p2, p0, LZ7/a;->b:I

    iput p3, p0, LZ7/a;->c:I

    iput p4, p0, LZ7/a;->d:I

    iput p5, p0, LZ7/a;->e:F
...
.method public static a(LY7/o;)LZ7/a;
    .locals 12
    ...
    :goto_0
    sget-object v6, LY7/c;->a:[B

    if-ge v3, v1, :cond_0

    :try_start_1
    invoke-virtual {p0}, LY7/o;->t()I

    move-result v7

    iget v8, p0, LY7/o;->b:I

    invoke-virtual {p0, v7}, LY7/o;->z(I)V

    iget-object v9, p0, LY7/o;->a:[B
    ...
    iget v9, p0, LY7/o;->b:I

    invoke-virtual {p0, v8}, LY7/o;->z(I)V

    iget-object v10, p0, LY7/o;->a:[B
    ...
    invoke-static {v0, v5, p0}, LY7/m;->c([BII)LY7/m$b;

    move-result-object p0

    iget v0, p0, LY7/m$b;->e:I

    iget v1, p0, LY7/m$b;->f:I

    iget v2, p0, LY7/m$b;->g:F

    iget v3, p0, LY7/m$b;->a:I

    iget v6, p0, LY7/m$b;->b:I

    iget p0, p0, LY7/m$b;->c:I
    ...
    invoke-direct/range {v3 .. v9}, LZ7/a;-><init>(Ljava/util/ArrayList;IIIFLjava/lang/String;)V
