...
# interfaces
.implements Lcom/google/android/exoplayer2/mediacodec/a;
...
.method public final a()V
    ...
    iput-object v0, p0, Lcom/google/android/exoplayer2/mediacodec/d;->b:[Ljava/nio/ByteBuffer;

    iput-object v0, p0, Lcom/google/android/exoplayer2/mediacodec/d;->c:[Ljava/nio/ByteBuffer;
...
.method public final f(Landroid/media/MediaCodec$BufferInfo;)I
    ...
    iput-object v2, p0, Lcom/google/android/exoplayer2/mediacodec/d;->c:[Ljava/nio/ByteBuffer;
...
.method public final j(I)Ljava/nio/ByteBuffer;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/mediacodec/d;->b:[Ljava/nio/ByteBuffer;
...
.method public final l(I)Ljava/nio/ByteBuffer;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/mediacodec/d;->c:[Ljava/nio/ByteBuffer;
...
.method public final m(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;)V
    .locals 2
    ...
    invoke-virtual {v1, p1, p2, p3, v0}, Landroid/media/MediaCodec;->configure(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V

    return-void
.end method

.method public final n(ILk7/a;J)V
    .locals 7

    iget-object v0, p0, Lcom/google/android/exoplayer2/mediacodec/d;->a:Landroid/media/MediaCodec;

    iget-object v3, p2, Lk7/a;->d:Landroid/media/MediaCodec$CryptoInfo;
...
.method public final o(LZ7/f$b;Landroid/os/Handler;)V
    .locals 1

    new-instance v0, Ly7/d;

    invoke-direct {v0, p0, p1}, Ly7/d;-><init>(Lcom/google/android/exoplayer2/mediacodec/d;LZ7/f$b;)V
...
.method public final start()V
    ...
    iput-object v1, p0, Lcom/google/android/exoplayer2/mediacodec/d;->b:[Ljava/nio/ByteBuffer;
