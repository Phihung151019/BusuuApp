...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput p1, p0, LU7/j;->a:F

    iput p1, p0, LU7/j;->b:F

    iput p1, p0, LU7/j;->c:F

    new-instance p1, Landroid/text/TextPaint;

    invoke-direct {p1}, Landroid/text/TextPaint;-><init>()V

    iput-object p1, p0, LU7/j;->f:Landroid/text/TextPaint;
    ...
    iput-object p1, p0, LU7/j;->g:Landroid/graphics/Paint;
    ...
    iput-object p1, p0, LU7/j;->h:Landroid/graphics/Paint;
...
.method public final a(Landroid/graphics/Canvas;Z)V
    ...
    iget-object p2, p0, LU7/j;->E:Landroid/text/StaticLayout;

    iget-object v0, p0, LU7/j;->F:Landroid/text/StaticLayout;
    ...
    iget v3, p0, LU7/j;->H:I

    int-to-float v3, v3

    invoke-virtual {p1, v2, v3}, Landroid/graphics/Canvas;->translate(FF)V

    iget v2, p0, LU7/j;->u:I
    ...
    iget-object v8, p0, LU7/j;->g:Landroid/graphics/Paint;
    ...
    :goto_0
    iget p1, p0, LU7/j;->w:I

    const/4 v2, 0x0

    const/4 v4, 0x1

    iget-object v5, p0, LU7/j;->f:Landroid/text/TextPaint;
    ...
    iget v7, p0, LU7/j;->b:F

    if-ne p1, v6, :cond_3

    iget p1, p0, LU7/j;->c:F

    iget v0, p0, LU7/j;->v:I
    ...
    iget-object p1, p0, LU7/j;->J:Landroid/graphics/Rect;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p1, p0, LU7/j;->k:Landroid/graphics/Bitmap;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p1, p0, LU7/j;->k:Landroid/graphics/Bitmap;

    iget-object p2, p0, LU7/j;->J:Landroid/graphics/Rect;

    iget-object v0, p0, LU7/j;->h:Landroid/graphics/Paint;
