...
.method public constructor <init>(Lo5/F;Ly5/e;)V
    ...
    iput-object p1, p0, Ly5/h;->D:Landroid/graphics/RectF;

    new-instance p1, Lp5/a;

    invoke-direct {p1}, Landroid/graphics/Paint;-><init>()V

    iput-object p1, p0, Ly5/h;->E:Lp5/a;

    const/16 v0, 0x8

    new-array v0, v0, [F

    iput-object v0, p0, Ly5/h;->F:[F

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Ly5/h;->G:Landroid/graphics/Path;

    iput-object p2, p0, Ly5/h;->H:Ly5/e;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Lp5/a;->setAlpha(I)V

    sget-object v0, Landroid/graphics/Paint$Style;->FILL:Landroid/graphics/Paint$Style;

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setStyle(Landroid/graphics/Paint$Style;)V

    iget p2, p2, Ly5/e;->l:I
...
.method public final c(LC5/c;Ljava/lang/Object;)V
    ...
    iput-object p2, p0, Ly5/h;->I:Lr5/u;
    ...
    iput-object p2, p0, Ly5/h;->J:Lr5/u;
...
.method public final e(Landroid/graphics/RectF;Landroid/graphics/Matrix;Z)V
    ...
    iget-object p2, p0, Ly5/h;->H:Ly5/e;

    iget p3, p2, Ly5/e;->j:I

    int-to-float p3, p3

    iget p2, p2, Ly5/e;->k:I

    int-to-float p2, p2

    iget-object v0, p0, Ly5/h;->D:Landroid/graphics/RectF;
...
.method public final m(Landroid/graphics/Canvas;Landroid/graphics/Matrix;ILB5/b;)V
    ...
    iget-object v0, p0, Ly5/h;->H:Ly5/e;

    iget v1, v0, Ly5/e;->l:I
    ...
    :cond_0
    iget-object v2, p0, Ly5/h;->J:Lr5/u;
    ...
    :goto_0
    iget-object v3, p0, Ly5/h;->E:Lp5/a;
    ...
    :cond_2
    iget v2, v0, Ly5/e;->l:I

    invoke-virtual {v3, v2}, Landroid/graphics/Paint;->setColor(I)V

    :goto_1
    iget-object v2, p0, Ly5/b;->w:Lr5/t;

    iget-object v2, v2, Lr5/t;->p:Lr5/a;
    ...
    iget v2, p4, LB5/b;->b:F

    iget v4, p4, LB5/b;->c:F

    iget p4, p4, LB5/b;->d:I
    ...
    :goto_3
    iget-object p4, p0, Ly5/h;->I:Lr5/u;

    if-eqz p4, :cond_6

    invoke-virtual {p4}, Lr5/u;->e()Ljava/lang/Object;
    ...
    iget-object p2, p0, Ly5/h;->G:Landroid/graphics/Path;
