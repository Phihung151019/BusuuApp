...
# direct methods
.method public static a(LR2/v;)Ljava/util/ArrayList;
    .locals 30
    ...
    :try_start_0
    invoke-static {v0, v3, v4}, LR2/C;->z(LR2/v;LR2/v;Ljava/util/zip/Inflater;)Z
    ...
    iget v4, v0, LR2/v;->b:I

    iget v6, v0, LR2/v;->c:I
    ...
    invoke-direct {v2, v9, v5}, LR2/u;-><init>(I[B)V

    iget v5, v0, LR2/v;->b:I

    const/16 v9, 0x8

    mul-int/2addr v5, v9

    invoke-virtual {v2, v5}, LR2/u;->l(I)V
    ...
    invoke-virtual {v2, v1}, LR2/u;->g(I)I
    ...
    invoke-virtual {v2, v1}, LR2/u;->l(I)V
    ...
    invoke-virtual {v2, v11}, LR2/u;->g(I)I
    ...
    new-instance v2, Lg3/e$b;

    invoke-direct {v2, v12, v15, v5, v1}, Lg3/e$b;-><init>(II[F[F)V
