...
.method static constructor <clinit>()V
    ...
    sput-object v0, LZ1/e;->a:Ly/v;

    new-instance v0, LZ1/d;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, LZ1/e;->b:LZ1/d;

    return-void
.end method

.method public static a(Landroid/content/Context;Ljava/util/List;)LZ1/l$a;
    .locals 5
    ...
    invoke-static {v3, v2, v4}, LZ1/e;->b(Landroid/content/pm/PackageManager;LZ1/f;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;

    move-result-object v3

    if-nez v3, :cond_0

    new-instance p0, LZ1/l$a;
    ...
    invoke-static {p0, v2, v3}, LZ1/e;->c(Landroid/content/Context;LZ1/f;Ljava/lang/String;)[LZ1/l$b;
    ...
    invoke-direct {p0, v0}, LZ1/l$a;-><init>(Ljava/util/ArrayList;)V
    :try_end_1
...
.method public static b(Landroid/content/pm/PackageManager;LZ1/f;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/content/pm/PackageManager$NameNotFoundException;
    ...
    sget-object v0, LZ1/e;->b:LZ1/d;

    sget-object v1, LZ1/e;->a:Ly/v;
    ...
    :try_start_0
    iget-object v4, p1, LZ1/f;->d:Ljava/util/List;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v5, p1, LZ1/f;->a:Ljava/lang/String;

    iget-object v6, p1, LZ1/f;->b:Ljava/lang/String;
    ...
    :cond_0
    :try_start_1
    iget p1, p1, LZ1/f;->e:I

    invoke-static {p2, p1}, LT1/e;->b(Landroid/content/res/Resources;I)Ljava/util/List;
    ...
    iput-object v5, p1, LZ1/e$a;->a:Ljava/lang/String;

    iput-object v6, p1, LZ1/e$a;->b:Ljava/lang/String;

    iput-object v4, p1, LZ1/e$a;->c:Ljava/util/List;

    invoke-virtual {v1, p1}, Ly/v;->b(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_5
    invoke-virtual {v1, p1, v7}, Ly/v;->c(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_2
...
.method public static c(Landroid/content/Context;LZ1/f;Ljava/lang/String;)[LZ1/l$b;
    .locals 18
    ...
    invoke-static {v2}, Lk4/a;->a(Ljava/lang/String;)V
    ...
    iget-object v0, v0, LZ1/f;->c:Ljava/lang/String;
    ...
    :goto_7
    new-instance v12, LZ1/l$b;

    invoke-direct/range {v12 .. v17}, LZ1/l$b;-><init>(Landroid/net/Uri;IIZI)V
